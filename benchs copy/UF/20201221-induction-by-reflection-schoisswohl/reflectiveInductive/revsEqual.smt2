...
(declare-fun revPrimeR (term_lst) term_lst)
(declare-fun revAccR (term_lst term_lst) term_lst)
...
(assert (forall ((env env) (t0 term_lst)) (= (eval_lst env (revPrimeR t0)) (revPrime (eval_lst env t0)))))
(assert (forall ((env env) (t0 term_lst) (t1 term_lst)) (= (eval_lst env (revAccR t0 t1)) (revAcc (eval_lst env t0) (eval_lst env t1)))))
