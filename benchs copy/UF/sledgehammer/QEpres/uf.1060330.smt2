...
(assert (= (f25 f56 (f7 (f75 (f53 f54 (f41 f42 (f43 (f44 f45 f29) f27)))) (f26 f27))) f1))
...
(assert (forall ((?v0 S5) (?v1 S22)) (= (= (f34 (f70 f71 ?v0) ?v1) f84) (forall ((?v2 S6)) (=> (= (f25 ?v2 (f26 ?v1)) f1) (not (= (f6 ?v0 ?v2) f1)))))))
...
(assert (forall ((?v0 S21) (?v1 S22)) (= (f26 (f34 (f51 f52 ?v0) ?v1)) (f7 (f75 ?v0) (f26 ?v1)))))
