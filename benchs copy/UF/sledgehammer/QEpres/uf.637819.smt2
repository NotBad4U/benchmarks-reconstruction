...
(assert (forall ((?v0 S5) (?v1 S6) (?v2 S6) (?v3 S2) (?v4 S2) (?v5 S3)) (= (= (f42 ?v0 ?v1 ?v2 (f27 (f28 (f29 f30 ?v3) ?v4) ?v5)) f1) (= (f3 (f4 (f5 ?v2 ?v3) ?v4) ?v5) f1))))
...
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S3) (?v3 S3)) (= (= (f10 (f27 (f28 (f29 f30 ?v0) ?v1) ?v2) ?v3) f1) (not (= (f52 (f53 ?v0) (f8 (f18 f20 ?v1) (f22 (f23 f24 ?v2) ?v3))) f1)))))
...
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S3) (?v3 S3)) (= (= (f10 (f27 (f28 (f29 f54 ?v0) ?v1) ?v2) ?v3) f1) (= (f52 (f53 ?v0) (f8 (f18 f20 ?v1) (f22 (f23 f24 ?v2) ?v3))) f1))))
...
(assert (forall ((?v0 S5) (?v1 S6) (?v2 S6) (?v3 S2) (?v4 S2) (?v5 S3)) (= (= (f42 ?v0 ?v1 ?v2 (f27 (f28 (f29 f54 ?v3) ?v4) ?v5)) f1) (= (f3 (f4 (f5 ?v1 ?v3) ?v4) ?v5) f1))))
...
(assert (forall ((?v0 S8)) (=> (forall ((?v1 S2) (?v2 S3)) (=> (= ?v0 (f27 (f28 f62 ?v1) ?v2)) false)) (=> (forall ((?v1 S2) (?v2 S2) (?v3 S3)) (=> (= ?v0 (f27 (f28 (f29 f54 ?v1) ?v2) ?v3)) false)) (=> (forall ((?v1 S2) (?v2 S2) (?v3 S3)) (=> (= ?v0 (f27 (f28 (f29 f30 ?v1) ?v2) ?v3)) false)) false)))))
