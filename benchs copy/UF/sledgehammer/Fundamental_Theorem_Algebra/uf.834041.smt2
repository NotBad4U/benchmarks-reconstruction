...
(assert (forall ((?v0 S3) (?v1 S3)) (= (f3 (f39 (f25 f28 (f25 (f26 f29 (f25 f43 ?v0)) (f25 f43 ?v1)))) (f25 f43 (f25 (f26 f29 ?v0) ?v1))) f1)))
(assert (forall ((?v0 S5) (?v1 S5)) (= (f3 (f39 (f25 f28 (f25 (f26 f29 (f5 f6 ?v0)) (f5 f6 ?v1)))) (f5 f6 (f7 (f8 f9 ?v0) ?v1))) f1)))
(assert (forall ((?v0 S5) (?v1 S3) (?v2 S5) (?v3 S3)) (=> (= (f3 (f4 (f5 f6 ?v0)) ?v1) f1) (=> (= (f3 (f4 (f5 f6 ?v2)) ?v3) f1) (= (f3 (f4 (f5 f6 (f7 (f8 f58 ?v0) ?v2))) (f25 (f26 f27 ?v1) ?v3)) f1)))))
(assert (forall ((?v0 S3) (?v1 S3) (?v2 S3) (?v3 S3)) (=> (= (f3 (f4 (f25 f43 ?v0)) ?v1) f1) (=> (= (f3 (f4 (f25 f43 ?v2)) ?v3) f1) (= (f3 (f4 (f25 f43 (f25 (f26 f27 ?v0) ?v2))) (f25 (f26 f27 ?v1) ?v3)) f1)))))
(assert (forall ((?v0 S3) (?v1 S3)) (= (f3 (f39 (f25 f43 (f25 (f26 f29 ?v0) ?v1))) (f25 (f26 f27 (f25 f43 ?v0)) (f25 f43 ?v1))) f1)))
(assert (forall ((?v0 S5) (?v1 S5)) (= (f3 (f39 (f5 f6 (f7 (f8 f9 ?v0) ?v1))) (f25 (f26 f27 (f5 f6 ?v0)) (f5 f6 ?v1))) f1)))
(assert (forall ((?v0 S18) (?v1 S18) (?v2 S18) (?v3 S18)) (=> (= (f35 (f44 f45 ?v0) ?v1) (f35 (f44 f45 ?v2) ?v3)) (= (= ?v0 ?v1) (= ?v2 ?v3)))))
(assert (forall ((?v0 S3) (?v1 S3) (?v2 S3) (?v3 S3)) (=> (= (f25 (f26 f29 ?v0) ?v1) (f25 (f26 f29 ?v2) ?v3)) (= (= ?v0 ?v1) (= ?v2 ?v3)))))
(assert (forall ((?v0 S5) (?v1 S5) (?v2 S5) (?v3 S5)) (=> (= (f7 (f8 f9 ?v0) ?v1) (f7 (f8 f9 ?v2) ?v3)) (= (= ?v0 ?v1) (= ?v2 ?v3)))))
(assert (=> (forall ((?v0 S9) (?v1 S9)) (=> (forall ((?v2 S9)) (=> (= (f47 ?v0 ?v2) f1) (= (f3 (f4 (f25 f28 (f25 (f26 f29 (f5 f30 (f10 f11 (f12 f16 ?v2)))) f22))) (f25 (f26 f32 f24) (f33 f34 (f35 f36 (f35 f37 f38))))) f1))) (=> (forall ((?v2 S9)) (=> (= (f47 ?v1 ?v2) f1) (= (f3 (f4 (f25 f28 (f25 (f26 f29 (f5 f31 (f10 f11 (f12 f16 (f12 f17 ?v2))))) f23))) (f25 (f26 f32 f24) (f33 f34 (f35 f36 (f35 f37 f38))))) f1))) false))) false))
(assert (forall ((?v0 S3) (?v1 S3)) (let ((?v_0 (f33 f34 (f35 f36 (f35 f37 f38))))) (= (f25 (f26 f29 (f25 (f26 f32 (f25 (f26 f27 ?v0) ?v1)) ?v_0)) ?v0) (f25 (f26 f32 (f25 (f26 f29 ?v1) ?v0)) ?v_0)))))
(assert (forall ((?v0 S3) (?v1 S3)) (let ((?v_0 (f33 f34 (f35 f36 (f35 f37 f38))))) (= (f25 (f26 f29 (f25 (f26 f32 (f25 (f26 f27 ?v0) ?v1)) ?v_0)) ?v1) (f25 (f26 f32 (f25 (f26 f29 ?v0) ?v1)) ?v_0)))))
(assert (forall ((?v0 S3) (?v1 S3)) (let ((?v_0 (f4 ?v0))) (=> (= (f3 ?v_0 ?v1) f1) (= (f3 ?v_0 (f25 (f26 f32 (f25 (f26 f27 ?v0) ?v1)) (f33 f34 (f35 f36 (f35 f37 f38))))) f1)))))
(assert (forall ((?v0 S3) (?v1 S3)) (=> (= (f3 (f4 ?v0) ?v1) f1) (= (f3 (f4 (f25 (f26 f32 (f25 (f26 f27 ?v0) ?v1)) (f33 f34 (f35 f36 (f35 f37 f38))))) ?v1) f1))))
(assert (forall ((?v0 S3)) (let ((?v_0 (f4 f42))) (= (= (f3 ?v_0 (f25 (f26 f32 ?v0) (f33 f34 (f35 f36 (f35 f37 f38))))) f1) (= (f3 ?v_0 ?v0) f1)))))
(assert (forall ((?v0 S3)) (let ((?v_0 (f4 f42))) (=> (= (f3 ?v_0 ?v0) f1) (= (f3 ?v_0 (f25 (f26 f32 ?v0) (f33 f34 (f35 f36 (f35 f37 f38))))) f1)))))
(assert (forall ((?v0 S9)) (= (f3 (f39 (f25 f28 (f5 f31 (f10 f11 ?v0)))) (f25 (f26 f27 f41) f63)) f1)))
(assert (forall ((?v0 S3)) (let ((?v_0 (f25 (f26 f32 ?v0) (f33 f34 (f35 f36 (f35 f37 f38)))))) (= (f25 (f26 f27 ?v_0) ?v_0) ?v0))))
(assert (= (f3 (f39 (f5 f6 (f10 f11 f59))) f41) f1))
(assert (= f53 (f35 f64 f38)))
(assert (forall ((?v0 S3)) (= (= f63 ?v0) (= ?v0 f63))))
(assert (forall ((?v0 S18)) (= (= f65 ?v0) (= ?v0 f65))))
(assert (= (f25 f43 f63) f63))
(assert (= (f5 f6 f66) f63))
(assert (forall ((?v0 S18)) (= (f35 (f44 f56 ?v0) f38) ?v0)))
(assert (forall ((?v0 S18)) (= (f35 (f44 f56 f38) ?v0) ?v0)))
(assert (forall ((?v0 S18) (?v1 S18)) (= (f35 (f44 f56 (f35 f36 ?v0)) (f35 f36 ?v1)) (f35 f36 (f35 (f44 f56 ?v0) ?v1)))))
(assert (forall ((?v0 S18)) (= (f35 f36 ?v0) (f35 (f44 f56 ?v0) ?v0))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f52 (f35 f37 ?v0) (f35 f37 ?v1)) f1) (= (f52 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f52 (f35 f37 ?v0) (f35 f37 ?v1)) f1) (= (f52 ?v0 ?v1) f1))))
(assert (= (= (f52 f38 f38) f1) true))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f52 (f35 f36 ?v0) (f35 f36 ?v1)) f1) (= (f52 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f52 (f35 f36 ?v0) (f35 f36 ?v1)) f1) (= (f52 ?v0 ?v1) f1))))
(assert (not (= f42 f63)))
(assert (forall ((?v0 S18)) (= (= (f46 (f35 f37 ?v0) f53) f1) (= (f46 ?v0 f53) f1))))
(assert (= (= (f46 f38 f53) f1) false))
(assert (= f38 f53))
(assert (forall ((?v0 S18)) (= (= (f46 (f35 f36 ?v0) f53) f1) (= (f46 ?v0 f53) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (f35 (f44 f56 (f35 f37 ?v0)) (f35 f36 ?v1)) (f35 f37 (f35 (f44 f56 ?v0) ?v1)))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (f35 (f44 f56 (f35 f36 ?v0)) (f35 f37 ?v1)) (f35 f37 (f35 (f44 f56 ?v0) ?v1)))))
(assert (forall ((?v0 S18)) (= (= (f52 (f35 f37 ?v0) f38) f1) (= (f46 ?v0 f38) f1))))
(assert (forall ((?v0 S18)) (= (= (f52 f38 (f35 f37 ?v0)) f1) (= (f52 f38 ?v0) f1))))
(assert (forall ((?v0 S18)) (= (= (f46 f38 (f35 f37 ?v0)) f1) (= (f52 f38 ?v0) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f52 (f35 f37 ?v0) (f35 f36 ?v1)) f1) (= (f46 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f52 (f35 f37 ?v0) (f35 f36 ?v1)) f1) (= (f46 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f52 (f35 f36 ?v0) (f35 f37 ?v1)) f1) (= (f52 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f52 (f35 f36 ?v0) (f35 f37 ?v1)) f1) (= (f52 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f46 (f35 f36 ?v0) (f35 f37 ?v1)) f1) (= (f52 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f46 (f35 f36 ?v0) (f35 f37 ?v1)) f1) (= (f52 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18)) (= (= (f52 (f35 f36 ?v0) f38) f1) (= (f52 ?v0 f38) f1))))
(assert (forall ((?v0 S18)) (= (= (f52 f38 (f35 f36 ?v0)) f1) (= (f52 f38 ?v0) f1))))
(assert (forall ((?v0 S18)) (let ((?v_0 (f33 f34 ?v0))) (= (f33 f34 (f35 f37 ?v0)) (f25 (f26 f27 (f25 (f26 f27 f63) ?v_0)) ?v_0)))))
(assert (forall ((?v0 S18)) (let ((?v_0 (f35 f64 ?v0))) (= (f35 f64 (f35 f37 ?v0)) (f35 (f44 f56 (f35 (f44 f56 f65) ?v_0)) ?v_0)))))
(assert (forall ((?v0 S18)) (let ((?v_0 (f61 f62 ?v0))) (= (f61 f62 (f35 f37 ?v0)) (f7 (f8 f58 (f7 (f8 f58 f66) ?v_0)) ?v_0)))))
(assert (= (f33 f34 (f35 f37 f38)) f63))
(assert (= (f35 f64 (f35 f37 f38)) f65))
(assert (= (f61 f62 (f35 f37 f38)) f66))
(assert (= (f33 f34 (f35 f37 f38)) f63))
(assert (= (f35 f64 (f35 f37 f38)) f65))
(assert (= (f61 f62 (f35 f37 f38)) f66))
(assert (forall ((?v0 S18)) (= (f5 f31 (f61 f62 ?v0)) f42)))
(assert (forall ((?v0 S18)) (= (f5 f30 (f61 f62 ?v0)) (f33 f34 ?v0))))
(assert (forall ((?v0 S5) (?v1 S5)) (= (f5 f30 (f7 (f8 f58 ?v0) ?v1)) (f25 (f26 f27 (f5 f30 ?v0)) (f5 f30 ?v1)))))
(assert (forall ((?v0 S5) (?v1 S5)) (= (f5 f31 (f7 (f8 f58 ?v0) ?v1)) (f25 (f26 f27 (f5 f31 ?v0)) (f5 f31 ?v1)))))
(assert (forall ((?v0 S3) (?v1 S3) (?v2 S3) (?v3 S3)) (= (f7 (f8 f58 (f19 (f20 f21 ?v0) ?v1)) (f19 (f20 f21 ?v2) ?v3)) (f19 (f20 f21 (f25 (f26 f27 ?v0) ?v2)) (f25 (f26 f27 ?v1) ?v3)))))
(assert (forall ((?v0 S3)) (not (= (f3 (f4 (f25 (f26 f27 (f25 f28 ?v0)) f63)) ?v0) f1))))
(assert (= (f5 f30 f55) f42))
(assert (= (f5 f31 f55) f42))
(assert (forall ((?v0 S3) (?v1 S3)) (= (= (f19 (f20 f21 ?v0) ?v1) f55) (and (= ?v0 f42) (= ?v1 f42)))))
(assert (= f55 (f19 (f20 f21 f42) f42)))
(assert (forall ((?v0 S18)) (= (= (f3 (f39 (f33 f34 ?v0)) f63) f1) (= (f52 ?v0 (f35 f37 f38)) f1))))
(assert (forall ((?v0 S18)) (= (= (f52 (f35 f64 ?v0) f65) f1) (= (f52 ?v0 (f35 f37 f38)) f1))))
(assert (forall ((?v0 S18)) (= (= (f3 (f39 f63) (f33 f34 ?v0)) f1) (= (f52 (f35 f37 f38) ?v0) f1))))
(assert (forall ((?v0 S18)) (= (= (f52 f65 (f35 f64 ?v0)) f1) (= (f52 (f35 f37 f38) ?v0) f1))))
(assert (forall ((?v0 S18)) (= (= (f3 (f4 (f33 f34 ?v0)) f63) f1) (= (f46 ?v0 (f35 f37 f38)) f1))))
(assert (forall ((?v0 S18)) (= (= (f46 (f35 f64 ?v0) f65) f1) (= (f46 ?v0 (f35 f37 f38)) f1))))
(assert (forall ((?v0 S18)) (= (= (f3 (f4 f63) (f33 f34 ?v0)) f1) (= (f46 (f35 f37 f38) ?v0) f1))))
(assert (forall ((?v0 S18)) (= (= (f46 f65 (f35 f64 ?v0)) f1) (= (f46 (f35 f37 f38) ?v0) f1))))
(assert (forall ((?v0 S18)) (= (f25 (f26 f27 (f33 f34 ?v0)) f63) (f33 f34 (f35 (f44 f56 ?v0) (f35 f37 f38))))))
(assert (forall ((?v0 S18)) (= (f35 (f44 f56 (f35 f64 ?v0)) f65) (f35 f64 (f35 (f44 f56 ?v0) (f35 f37 f38))))))
(assert (forall ((?v0 S18)) (= (f7 (f8 f58 (f61 f62 ?v0)) f66) (f61 f62 (f35 (f44 f56 ?v0) (f35 f37 f38))))))
(assert (forall ((?v0 S18)) (= (f25 (f26 f27 f63) (f33 f34 ?v0)) (f33 f34 (f35 (f44 f56 (f35 f37 f38)) ?v0)))))
(assert (forall ((?v0 S18)) (= (f35 (f44 f56 f65) (f35 f64 ?v0)) (f35 f64 (f35 (f44 f56 (f35 f37 f38)) ?v0)))))
(assert (forall ((?v0 S18)) (= (f7 (f8 f58 f66) (f61 f62 ?v0)) (f61 f62 (f35 (f44 f56 (f35 f37 f38)) ?v0)))))
(assert (forall ((?v0 S3)) (= (f3 (f4 f42) (f25 (f26 f27 f63) (f25 f28 ?v0))) f1)))
(assert (forall ((?v0 S3) (?v1 S3) (?v2 S18)) (= (= (f19 (f20 f21 ?v0) ?v1) (f61 f62 ?v2)) (and (= ?v0 (f33 f34 ?v2)) (= ?v1 f42)))))
(assert (forall ((?v0 S5) (?v1 S5)) (= (f3 (f39 (f5 f6 ?v0)) (f25 (f26 f27 (f5 f6 (f7 (f8 f58 ?v0) ?v1))) (f5 f6 ?v1))) f1)))
(assert (forall ((?v0 S5) (?v1 S5)) (= (f3 (f39 (f25 (f26 f29 (f5 f6 (f7 (f8 f58 ?v0) ?v1))) (f5 f6 ?v0))) (f5 f6 ?v1)) f1)))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f61 f62 ?v0) (f61 f62 ?v1)) (= ?v0 ?v1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f35 f64 ?v0) (f35 f64 ?v1)) (= ?v0 ?v1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f33 f34 ?v0) (f33 f34 ?v1)) (= ?v0 ?v1))))
(assert (forall ((?v0 S18) (?v1 S5)) (let ((?v_0 (f61 f62 ?v0))) (= (= ?v_0 ?v1) (= ?v1 ?v_0)))))
(assert (forall ((?v0 S18) (?v1 S18)) (let ((?v_0 (f35 f64 ?v0))) (= (= ?v_0 ?v1) (= ?v1 ?v_0)))))
(assert (forall ((?v0 S18) (?v1 S3)) (let ((?v_0 (f33 f34 ?v0))) (= (= ?v_0 ?v1) (= ?v1 ?v_0)))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f46 (f35 f37 ?v0) (f35 f37 ?v1)) f1) (= (f46 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f46 (f35 f37 ?v0) (f35 f37 ?v1)) f1) (= (f46 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f35 f37 ?v0) (f35 f37 ?v1)) (= ?v0 ?v1))))
(assert (forall ((?v0 S18)) (= (f35 (f44 f45 ?v0) f38) ?v0)))
(assert (= (= (f46 f38 f38) f1) false))
(assert (= (= f38 f38) true))
(assert (forall ((?v0 S3) (?v1 S3)) (=> (= (f3 (f39 ?v0) ?v1) f1) (=> (= (f3 (f39 ?v1) ?v0) f1) (= ?v0 ?v1)))))
(assert (forall ((?v0 S3) (?v1 S3) (?v2 S3)) (let ((?v_0 (f39 ?v0))) (=> (= (f3 ?v_0 ?v1) f1) (=> (= (f3 (f39 ?v1) ?v2) f1) (= (f3 ?v_0 ?v2) f1))))))
(assert (forall ((?v0 S3) (?v1 S3)) (or (= (f3 (f39 ?v0) ?v1) f1) (= (f3 (f39 ?v1) ?v0) f1))))
(assert (forall ((?v0 S3)) (= (f3 (f39 ?v0) ?v0) f1)))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f46 (f35 f36 ?v0) (f35 f36 ?v1)) f1) (= (f46 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f46 (f35 f36 ?v0) (f35 f36 ?v1)) f1) (= (f46 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f35 f36 ?v0) (f35 f36 ?v1)) (= ?v0 ?v1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (f35 (f44 f45 (f35 f36 ?v0)) (f35 f36 ?v1)) (f35 f36 (f35 (f44 f45 ?v0) ?v1)))))
(assert (= (f25 (f26 f27 f63) f63) (f33 f34 (f35 f36 (f35 f37 f38)))))
(assert (= (f35 (f44 f56 f65) f65) (f35 f64 (f35 f36 (f35 f37 f38)))))
(assert (= (f7 (f8 f58 f66) f66) (f61 f62 (f35 f36 (f35 f37 f38)))))
(assert (= (f12 (f50 f51 f67) f67) (f68 f69 (f35 f36 (f35 f37 f38)))))
(assert (= (f25 (f26 f27 f63) f63) (f33 f34 (f35 f36 (f35 f37 f38)))))
(assert (= (f35 (f44 f56 f65) f65) (f35 f64 (f35 f36 (f35 f37 f38)))))
(assert (= (f7 (f8 f58 f66) f66) (f61 f62 (f35 f36 (f35 f37 f38)))))
(assert (forall ((?v0 S5) (?v1 S5)) (= (f7 (f8 f58 ?v0) ?v1) (f19 (f20 f21 (f25 (f26 f27 (f5 f30 ?v0)) (f5 f30 ?v1))) (f25 (f26 f27 (f5 f31 ?v0)) (f5 f31 ?v1))))))
(assert (forall ((?v0 S18)) (= (= (f35 (f44 f56 ?v0) ?v0) f53) (= ?v0 f53))))
(assert (forall ((?v0 S3)) (= (= (f25 (f26 f27 ?v0) ?v0) f42) (= ?v0 f42))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f52 (f35 f64 ?v0) (f35 f64 ?v1)) f1) (= (f52 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f3 (f39 (f33 f34 ?v0)) (f33 f34 ?v1)) f1) (= (f52 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f46 (f35 f64 ?v0) (f35 f64 ?v1)) f1) (= (f46 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f3 (f4 (f33 f34 ?v0)) (f33 f34 ?v1)) f1) (= (f46 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18) (?v1 S18) (?v2 S5)) (= (f7 (f8 f58 (f61 f62 ?v0)) (f7 (f8 f58 (f61 f62 ?v1)) ?v2)) (f7 (f8 f58 (f61 f62 (f35 (f44 f56 ?v0) ?v1))) ?v2))))
(assert (forall ((?v0 S18) (?v1 S18) (?v2 S18)) (= (f35 (f44 f56 (f35 f64 ?v0)) (f35 (f44 f56 (f35 f64 ?v1)) ?v2)) (f35 (f44 f56 (f35 f64 (f35 (f44 f56 ?v0) ?v1))) ?v2))))
(assert (forall ((?v0 S18) (?v1 S18) (?v2 S3)) (= (f25 (f26 f27 (f33 f34 ?v0)) (f25 (f26 f27 (f33 f34 ?v1)) ?v2)) (f25 (f26 f27 (f33 f34 (f35 (f44 f56 ?v0) ?v1))) ?v2))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (f7 (f8 f58 (f61 f62 ?v0)) (f61 f62 ?v1)) (f61 f62 (f35 (f44 f56 ?v0) ?v1)))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (f35 (f44 f56 (f35 f64 ?v0)) (f35 f64 ?v1)) (f35 f64 (f35 (f44 f56 ?v0) ?v1)))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (f25 (f26 f27 (f33 f34 ?v0)) (f33 f34 ?v1)) (f33 f34 (f35 (f44 f56 ?v0) ?v1)))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (f61 f62 (f35 (f44 f56 ?v0) ?v1)) (f7 (f8 f58 (f61 f62 ?v0)) (f61 f62 ?v1)))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (f35 f64 (f35 (f44 f56 ?v0) ?v1)) (f35 (f44 f56 (f35 f64 ?v0)) (f35 f64 ?v1)))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (f33 f34 (f35 (f44 f56 ?v0) ?v1)) (f25 (f26 f27 (f33 f34 ?v0)) (f33 f34 ?v1)))))
(assert (forall ((?v0 S5) (?v1 S5) (?v2 S5) (?v3 S5)) (= (f7 (f8 f9 (f7 (f8 f58 ?v0) ?v1)) (f7 (f8 f58 ?v2) ?v3)) (f7 (f8 f58 (f7 (f8 f9 ?v0) ?v2)) (f7 (f8 f9 ?v1) ?v3)))))
(assert (forall ((?v0 S18) (?v1 S18) (?v2 S18) (?v3 S18)) (= (f35 (f44 f45 (f35 (f44 f56 ?v0) ?v1)) (f35 (f44 f56 ?v2) ?v3)) (f35 (f44 f56 (f35 (f44 f45 ?v0) ?v2)) (f35 (f44 f45 ?v1) ?v3)))))
(assert (forall ((?v0 S3) (?v1 S3) (?v2 S3) (?v3 S3)) (= (f25 (f26 f29 (f25 (f26 f27 ?v0) ?v1)) (f25 (f26 f27 ?v2) ?v3)) (f25 (f26 f27 (f25 (f26 f29 ?v0) ?v2)) (f25 (f26 f29 ?v1) ?v3)))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (f35 f64 (f35 (f44 f45 ?v0) ?v1)) (f35 (f44 f45 (f35 f64 ?v0)) (f35 f64 ?v1)))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (f33 f34 (f35 (f44 f45 ?v0) ?v1)) (f25 (f26 f29 (f33 f34 ?v0)) (f33 f34 ?v1)))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (f61 f62 (f35 (f44 f45 ?v0) ?v1)) (f7 (f8 f9 (f61 f62 ?v0)) (f61 f62 ?v1)))))
(assert (forall ((?v0 S18)) (= (= (f46 (f35 f37 ?v0) f38) f1) (= (f46 ?v0 f38) f1))))
(assert (forall ((?v0 S18)) (= (= (f35 f37 ?v0) f38) false)))
(assert (forall ((?v0 S18)) (= (= f38 (f35 f37 ?v0)) false)))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f46 (f35 f37 ?v0) (f35 f36 ?v1)) f1) (= (f46 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f46 (f35 f37 ?v0) (f35 f36 ?v1)) f1) (= (f46 ?v0 ?v1) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (f35 (f44 f45 (f35 f37 ?v0)) (f35 f37 ?v1)) (f35 f36 (f35 (f44 f45 ?v0) ?v1)))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (f35 (f44 f45 (f35 f37 ?v0)) (f35 f36 ?v1)) (f35 f37 (f35 (f44 f45 ?v0) ?v1)))))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f35 f37 ?v0) (f35 f36 ?v1)) false)))
(assert (forall ((?v0 S18) (?v1 S18)) (= (= (f35 f36 ?v0) (f35 f37 ?v1)) false)))
(assert (forall ((?v0 S18)) (= (= (f46 (f35 f36 ?v0) f38) f1) (= (f46 ?v0 f38) f1))))
(assert (forall ((?v0 S18)) (= (= (f35 f36 ?v0) f38) (= ?v0 f38))))
(assert (forall ((?v0 S18)) (= (= (f46 f38 (f35 f36 ?v0)) f1) (= (f46 f38 ?v0) f1))))
(assert (forall ((?v0 S18)) (= (= f38 (f35 f36 ?v0)) (= f38 ?v0))))
(assert (forall ((?v0 S18)) (let ((?v_0 (f44 f45 f38))) (= (f35 ?v_0 (f35 f36 ?v0)) (f35 f36 (f35 ?v_0 ?v0))))))
(assert (= (f35 f36 f38) f38))
(assert (forall ((?v0 S3) (?v1 S3)) (= (= (f3 (f4 ?v0) ?v1) f1) (and (= (f3 (f39 ?v0) ?v1) f1) (not (= ?v0 ?v1))))))
(assert (forall ((?v0 S3) (?v1 S3)) (= (= (f3 (f39 ?v0) ?v1) f1) (or (= (f3 (f4 ?v0) ?v1) f1) (= ?v0 ?v1)))))
(assert (forall ((?v0 S3) (?v1 S3) (?v2 S3)) (let ((?v_0 (f26 f27 ?v2))) (=> (= (f3 (f39 ?v0) ?v1) f1) (= (f3 (f39 (f25 ?v_0 ?v0)) (f25 ?v_0 ?v1)) f1)))))
(assert (forall ((?v0 S18)) (= (= (f46 (f35 (f44 f56 ?v0) ?v0) f53) f1) (= (f46 ?v0 f53) f1))))
(assert (forall ((?v0 S3)) (= (= (f3 (f4 (f25 (f26 f27 ?v0) ?v0)) f42) f1) (= (f3 (f4 ?v0) f42) f1))))
(assert (forall ((?v0 S18) (?v1 S18)) (let ((?v_1 (f35 f64 ?v0)) (?v_0 (f35 f64 ?v1))) (= (= (f52 ?v_1 ?v_0) f1) (not (= (f46 ?v_0 ?v_1) f1))))))
(assert (forall ((?v0 S18) (?v1 S18)) (let ((?v_1 (f33 f34 ?v0)) (?v_0 (f33 f34 ?v1))) (= (= (f3 (f39 ?v_1) ?v_0) f1) (not (= (f3 (f4 ?v_0) ?v_1) f1))))))
(assert (forall ((?v0 S18) (?v1 S18)) (let ((?v_1 (f68 f69 ?v0)) (?v_0 (f68 f69 ?v1))) (= (= (f47 ?v_1 ?v_0) f1) (not (= (f60 ?v_0 ?v_1) f1))))))
(assert (= (f61 f62 f38) f55))
(assert (= (f68 f69 f38) f59))
(assert (= (f33 f34 f38) f42))
(assert (= (f35 f64 f38) f53))
(assert (= (f61 f62 f38) f55))
(assert (= (f33 f34 f38) f42))
(assert (= (f35 f64 f38) f53))
(assert (forall ((?v0 S18) (?v1 S18) (?v2 S5)) (= (f7 (f8 f58 (f61 f62 ?v0)) (f7 (f8 f9 (f61 f62 ?v1)) ?v2)) (f7 (f8 f9 (f61 f62 (f35 (f44 f56 ?v0) ?v1))) ?v2))))
(assert (forall ((?v0 S18) (?v1 S18) (?v2 S18)) (= (f35 (f44 f56 (f35 f64 ?v0)) (f35 (f44 f45 (f35 f64 ?v1)) ?v2)) (f35 (f44 f45 (f35 f64 (f35 (f44 f56 ?v0) ?v1))) ?v2))))
(assert (forall ((?v0 S18) (?v1 S18) (?v2 S3)) (= (f25 (f26 f27 (f33 f34 ?v0)) (f25 (f26 f29 (f33 f34 ?v1)) ?v2)) (f25 (f26 f29 (f33 f34 (f35 (f44 f56 ?v0) ?v1))) ?v2))))
(assert (forall ((?v0 S5)) (= (f7 (f8 f58 (f61 f62 f38)) ?v0) ?v0)))
(assert (forall ((?v0 S18)) (= (f35 (f44 f56 (f35 f64 f38)) ?v0) ?v0)))
(assert (forall ((?v0 S3)) (= (f25 (f26 f27 (f33 f34 f38)) ?v0) ?v0)))
(assert (forall ((?v0 S18)) (= (f35 (f44 f56 ?v0) (f35 f64 f38)) ?v0)))
(assert (forall ((?v0 S3)) (= (f25 (f26 f27 ?v0) (f33 f34 f38)) ?v0)))
(assert (forall ((?v0 S3) (?v1 S3)) (let ((?v_0 (f39 f42))) (= (= (f3 ?v_0 (f25 (f26 f32 ?v0) ?v1)) f1) (and (or (= (f3 (f39 ?v0) f42) f1) (= (f3 ?v_0 ?v1) f1)) (or (= (f3 ?v_0 ?v0) f1) (= (f3 (f39 ?v1) f42) f1)))))))
(assert (forall ((?v0 S3) (?v1 S3)) (= (= (f3 (f39 ?v0) ?v1) f1) (= (f3 (f39 (f25 (f26 f29 ?v0) ?v1)) f42) f1))))
(check-sat)
(exit)
