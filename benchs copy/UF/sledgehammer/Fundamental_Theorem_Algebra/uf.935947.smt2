...
(assert (forall ((?v0 S6)) (let ((?v_0 (f7 f8 ?v0))) (= (f4 f36 ?v_0) (f4 f13 ?v_0)))))
(assert (forall ((?v0 S6)) (= (f15 f16 (f37 f38 ?v0)) (f4 f13 (f7 f8 ?v0)))))
(assert (forall ((?v0 S2)) (= (f4 (f5 f6 ?v0) (f7 f8 (f9 f11 f12))) ?v0)))
(assert (forall ((?v0 S9)) (= (f17 (f33 f39 ?v0) (f37 f38 (f9 f11 f12))) ?v0)))
(assert (forall ((?v0 S2)) (= (f4 (f5 f6 ?v0) (f7 f8 (f9 f11 f12))) ?v0)))
(assert (forall ((?v0 S9)) (= (f17 (f33 f39 ?v0) (f37 f38 (f9 f11 f12))) ?v0)))
...
(assert (forall ((?v0 S2) (?v1 S2)) (= (f4 f36 (f4 (f5 f6 ?v0) ?v1)) (f4 (f5 f6 (f4 f36 ?v0)) (f4 f36 ?v1)))))
(assert (forall ((?v0 S9) (?v1 S9)) (= (f15 f16 (f17 (f33 f39 ?v0) ?v1)) (f4 (f5 f6 (f15 f16 ?v0)) (f15 f16 ?v1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2) (?v3 S2)) (=> (= (f3 (f4 f36 ?v0) ?v1) f1) (=> (= (f3 (f4 f36 ?v2) ?v3) f1) (= (f3 (f4 f36 (f4 (f5 f40 ?v0) ?v2)) (f4 (f5 f40 ?v1) ?v3)) f1)))))
...
(assert (forall ((?v0 S9)) (= (f17 (f33 f46 ?v0) (f37 f38 f12)) ?v0)))
...
(assert (= (f4 f36 f32) f32))
(assert (= (f15 f16 f49) f32))
(assert (forall ((?v0 S2)) (= (= (f4 f36 ?v0) f32) (= ?v0 f32))))
...
(assert (forall ((?v0 S2)) (= (f4 f36 ?v0) (f4 f13 ?v0))))
...
(assert (forall ((?v0 S6) (?v1 S6)) (= (f17 (f33 f34 (f37 f38 ?v0)) (f37 f38 ?v1)) (f37 f38 (f9 (f43 f45 ?v0) (f9 f47 ?v1))))))
(assert (forall ((?v0 S6) (?v1 S6)) (= (f4 (f5 f14 (f7 f8 ?v0)) (f7 f8 ?v1)) (f7 f8 (f9 (f43 f45 ?v0) (f9 f47 ?v1))))))
(assert (forall ((?v0 S2)) (= (= (f3 f32 (f4 f36 ?v0)) f1) (not (= ?v0 f32)))))
...
(assert (forall ((?v0 S2)) (not (= (f3 (f4 f36 ?v0) f32) f1))))
...
(assert (forall ((?v0 S6) (?v1 S9) (?v2 S6)) (= (f17 (f33 f46 (f37 f38 ?v0)) (f17 (f33 f34 ?v1) (f37 f38 ?v2))) (f17 (f33 f46 (f37 f38 (f9 (f43 f45 ?v0) (f9 f47 ?v2)))) ?v1))))
...
(assert (forall ((?v0 S6)) (let ((?v_0 (f37 f38 ?v0))) (= (f37 f38 (f9 f10 ?v0)) (f17 (f33 f46 (f17 (f33 f46 f49) ?v_0)) ?v_0)))))
(check-sat)
(exit)
