...
(assert (= (f5 f21 f4) f4))
(assert (forall ((?v0 S6) (?v1 S6)) (= (f9 f10 (f17 (f22 f24 ?v0) ?v1)) (f5 (f6 f13 (f9 f10 ?v0)) (f9 f10 ?v1)))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (f5 f21 (f5 (f6 f13 ?v0) ?v1)) (f5 (f6 f13 (f5 f21 ?v0)) (f5 f21 ?v1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f6 f13 ?v0))) (=> (= (f3 f4 ?v0) f1) (=> (= (f3 ?v1 ?v2) f1) (= (f3 (f5 ?v_0 ?v1) (f5 ?v_0 ?v2)) f1))))))
(assert (forall ((?v0 S2) (?v1 S2)) (=> (= (f3 f4 ?v0) f1) (=> (= (f3 f4 ?v1) f1) (= (f3 f4 (f5 (f6 f13 ?v0) ?v1)) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (=> (= (f3 f4 ?v0) f1) (= (= (f3 (f5 (f6 f13 ?v1) ?v0) (f5 (f6 f13 ?v2) ?v0)) f1) (= (f3 ?v1 ?v2) f1)))))
(assert (forall ((?v0 S6)) (exists ((?v1 S2)) (and (= (f3 f4 ?v1) f1) (forall ((?v2 S6)) (= (f16 (f9 f10 (f17 (f22 f24 ?v2) ?v0)) (f5 (f6 f13 (f9 f10 ?v2)) ?v1)) f1))))))
(assert (forall ((?v0 S2)) (exists ((?v1 S2)) (and (= (f3 f4 ?v1) f1) (forall ((?v2 S2)) (= (f16 (f5 f21 (f5 (f6 f13 ?v2) ?v0)) (f5 (f6 f13 (f5 f21 ?v2)) ?v1)) f1))))))
(assert (forall ((?v0 S6)) (exists ((?v1 S2)) (and (= (f3 f4 ?v1) f1) (forall ((?v2 S6)) (= (f16 (f9 f10 (f17 (f22 f24 ?v0) ?v2)) (f5 (f6 f13 (f9 f10 ?v2)) ?v1)) f1))))))
(assert (forall ((?v0 S2)) (exists ((?v1 S2)) (and (= (f3 f4 ?v1) f1) (forall ((?v2 S2)) (= (f16 (f5 f21 (f5 (f6 f13 ?v0) ?v2)) (f5 (f6 f13 (f5 f21 ?v2)) ?v1)) f1))))))
(assert (exists ((?v0 S2)) (and (= (f3 f4 ?v0) f1) (forall ((?v1 S6) (?v2 S6)) (= (f16 (f9 f10 (f17 (f22 f24 ?v1) ?v2)) (f5 (f6 f13 (f5 (f6 f13 (f9 f10 ?v1)) (f9 f10 ?v2))) ?v0)) f1)))))
(assert (exists ((?v0 S2)) (and (= (f3 f4 ?v0) f1) (forall ((?v1 S2) (?v2 S2)) (= (f16 (f5 f21 (f5 (f6 f13 ?v1) ?v2)) (f5 (f6 f13 (f5 (f6 f13 (f5 f21 ?v1)) (f5 f21 ?v2))) ?v0)) f1)))))
(assert (forall ((?v0 S6)) (exists ((?v1 S2)) (and (= (f16 f4 ?v1) f1) (forall ((?v2 S6)) (= (f16 (f9 f10 (f17 (f22 f24 ?v2) ?v0)) (f5 (f6 f13 (f9 f10 ?v2)) ?v1)) f1))))))
(assert (forall ((?v0 S2)) (exists ((?v1 S2)) (and (= (f16 f4 ?v1) f1) (forall ((?v2 S2)) (= (f16 (f5 f21 (f5 (f6 f13 ?v2) ?v0)) (f5 (f6 f13 (f5 f21 ?v2)) ?v1)) f1))))))
(assert (forall ((?v0 S6)) (exists ((?v1 S2)) (and (= (f16 f4 ?v1) f1) (forall ((?v2 S6)) (= (f16 (f9 f10 (f17 (f22 f24 ?v0) ?v2)) (f5 (f6 f13 (f9 f10 ?v2)) ?v1)) f1))))))
(assert (forall ((?v0 S2)) (exists ((?v1 S2)) (and (= (f16 f4 ?v1) f1) (forall ((?v2 S2)) (= (f16 (f5 f21 (f5 (f6 f13 ?v0) ?v2)) (f5 (f6 f13 (f5 f21 ?v2)) ?v1)) f1))))))
(assert (exists ((?v0 S2)) (and (= (f16 f4 ?v0) f1) (forall ((?v1 S6) (?v2 S6)) (= (f16 (f9 f10 (f17 (f22 f24 ?v1) ?v2)) (f5 (f6 f13 (f5 (f6 f13 (f9 f10 ?v1)) (f9 f10 ?v2))) ?v0)) f1)))))
(assert (exists ((?v0 S2)) (and (= (f16 f4 ?v0) f1) (forall ((?v1 S2) (?v2 S2)) (= (f16 (f5 f21 (f5 (f6 f13 ?v1) ?v2)) (f5 (f6 f13 (f5 (f6 f13 (f5 f21 ?v1)) (f5 f21 ?v2))) ?v0)) f1)))))
(assert (forall ((?v0 S2) (?v1 S6) (?v2 S6)) (=> (= (f16 ?v0 f4) f1) (=> (= (f16 (f9 f10 ?v1) (f5 (f6 f13 ?v0) (f9 f10 ?v2))) f1) (= ?v1 f25)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (=> (= (f16 ?v0 f4) f1) (=> (= (f16 (f5 f21 ?v1) (f5 (f6 f13 ?v0) (f5 f21 ?v2))) f1) (= ?v1 f4)))))
(assert (forall ((?v0 S6)) (exists ((?v1 S2)) (forall ((?v2 S6)) (= (f16 (f9 f10 (f17 (f22 f24 ?v2) ?v0)) (f5 (f6 f13 (f9 f10 ?v2)) ?v1)) f1)))))
(assert (forall ((?v0 S2)) (exists ((?v1 S2)) (forall ((?v2 S2)) (= (f16 (f5 f21 (f5 (f6 f13 ?v2) ?v0)) (f5 (f6 f13 (f5 f21 ?v2)) ?v1)) f1)))))
(assert (forall ((?v0 S6)) (exists ((?v1 S2)) (forall ((?v2 S6)) (= (f16 (f9 f10 (f17 (f22 f24 ?v0) ?v2)) (f5 (f6 f13 (f9 f10 ?v2)) ?v1)) f1)))))
(assert (forall ((?v0 S2)) (exists ((?v1 S2)) (forall ((?v2 S2)) (= (f16 (f5 f21 (f5 (f6 f13 ?v0) ?v2)) (f5 (f6 f13 (f5 f21 ?v2)) ?v1)) f1)))))
(assert (exists ((?v0 S2)) (forall ((?v1 S6) (?v2 S6)) (= (f16 (f9 f10 (f17 (f22 f24 ?v1) ?v2)) (f5 (f6 f13 (f5 (f6 f13 (f9 f10 ?v1)) (f9 f10 ?v2))) ?v0)) f1))))
(assert (exists ((?v0 S2)) (forall ((?v1 S2) (?v2 S2)) (= (f16 (f5 f21 (f5 (f6 f13 ?v1) ?v2)) (f5 (f6 f13 (f5 (f6 f13 (f5 f21 ?v1)) (f5 f21 ?v2))) ?v0)) f1))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (=> (= (f16 ?v0 f4) f1) (=> (= (f16 (f5 f12 ?v1) (f5 (f6 f13 ?v0) (f5 f12 ?v2))) f1) (= ?v1 f4)))))
(assert (forall ((?v0 S11) (?v1 S11)) (=> (= (f26 f27 ?v0) f1) (=> (= (f34 f27 ?v1) f1) (= (f26 f27 (f28 (f29 f30 ?v0) ?v1)) f1)))))
(assert (forall ((?v0 S2) (?v1 S2)) (=> (= (f3 f4 ?v0) f1) (=> (= (f16 f4 ?v1) f1) (= (f3 f4 (f5 (f6 f7 ?v0) ?v1)) f1)))))
(assert (forall ((?v0 S11) (?v1 S11)) (=> (= (f34 f27 ?v0) f1) (=> (= (f26 f27 ?v1) f1) (= (f26 f27 (f28 (f29 f30 ?v0) ?v1)) f1)))))
(assert (forall ((?v0 S2) (?v1 S2)) (=> (= (f16 f4 ?v0) f1) (=> (= (f3 f4 ?v1) f1) (= (f3 f4 (f5 (f6 f7 ?v0) ?v1)) f1)))))
(assert (forall ((?v0 S11) (?v1 S11) (?v2 S11)) (=> (= (f26 f27 ?v0) f1) (=> (= (f34 ?v1 ?v2) f1) (= (f26 ?v1 (f28 (f29 f30 ?v0) ?v2)) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (=> (= (f3 f4 ?v0) f1) (=> (= (f16 ?v1 ?v2) f1) (= (f3 ?v1 (f5 (f6 f7 ?v0) ?v2)) f1)))))
(assert (forall ((?v0 S6)) (= (= f25 ?v0) (= ?v0 f25))))
(assert (forall ((?v0 S2)) (= (= f4 ?v0) (= ?v0 f4))))
(assert (forall ((?v0 S11)) (= (= f27 ?v0) (= ?v0 f27))))
(assert (forall ((?v0 S11) (?v1 S11) (?v2 S11)) (let ((?v_0 (f29 f32 ?v0))) (= (f28 (f29 f32 (f28 ?v_0 ?v1)) ?v2) (f28 ?v_0 (f28 (f29 f32 ?v1) ?v2))))))
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6)) (let ((?v_0 (f22 f24 ?v0))) (= (f17 (f22 f24 (f17 ?v_0 ?v1)) ?v2) (f17 ?v_0 (f17 (f22 f24 ?v1) ?v2))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f6 f13 ?v0))) (= (f5 (f6 f13 (f5 ?v_0 ?v1)) ?v2) (f5 ?v_0 (f5 (f6 f13 ?v1) ?v2))))))
...
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6)) (=> (= (f17 (f22 f23 ?v0) ?v1) (f17 (f22 f23 ?v2) ?v1)) (= ?v0 ?v2))))
...
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6)) (let ((?v_0 (f22 f23 ?v0))) (=> (= (f17 ?v_0 ?v1) (f17 ?v_0 ?v2)) (= ?v1 ?v2)))))
(assert (forall ((?v0 S11) (?v1 S11) (?v2 S11)) (let ((?v_0 (f29 f30 ?v0))) (=> (= (f28 ?v_0 ?v1) (f28 ?v_0 ?v2)) (= ?v1 ?v2)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f6 f7 ?v0))) (=> (= (f5 ?v_0 ?v1) (f5 ?v_0 ?v2)) (= ?v1 ?v2)))))
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6)) (let ((?v_0 (f22 f23 ?v0))) (=> (= (f17 ?v_0 ?v1) (f17 ?v_0 ?v2)) (= ?v1 ?v2)))))
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6)) (= (= (f17 (f22 f23 ?v0) ?v1) (f17 (f22 f23 ?v2) ?v1)) (= ?v0 ?v2))))
...
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6)) (let ((?v_0 (f22 f23 ?v0))) (= (= (f17 ?v_0 ?v1) (f17 ?v_0 ?v2)) (= ?v1 ?v2)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f6 f7 ?v0))) (= (= (f5 ?v_0 ?v1) (f5 ?v_0 ?v2)) (= ?v1 ?v2)))))
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6)) (let ((?v_0 (f22 f23 ?v0))) (= (f17 (f22 f23 (f17 ?v_0 ?v1)) ?v2) (f17 ?v_0 (f17 (f22 f23 ?v1) ?v2))))))
...
(assert (forall ((?v0 S2)) (let ((?v_0 (f5 f12 ?v0))) (= (f5 f12 ?v_0) ?v_0))))
(assert (forall ((?v0 S6)) (= (f17 (f22 f23 ?v0) f25) ?v0)))
(assert (forall ((?v0 S2)) (= (f5 (f6 f7 ?v0) f4) ?v0)))
(assert (forall ((?v0 S11)) (= (f28 (f29 f30 ?v0) f27) ?v0)))
(assert (forall ((?v0 S6)) (= (f17 (f22 f23 ?v0) f25) ?v0)))
(assert (forall ((?v0 S2)) (= (f5 (f6 f7 ?v0) f4) ?v0)))
(assert (forall ((?v0 S11)) (= (f28 (f29 f30 ?v0) f27) ?v0)))
(assert (forall ((?v0 S2)) (= (= f4 (f5 (f6 f7 ?v0) ?v0)) (= ?v0 f4))))
(assert (forall ((?v0 S11)) (= (= f27 (f28 (f29 f30 ?v0) ?v0)) (= ?v0 f27))))
(assert (forall ((?v0 S6)) (= (f17 (f22 f23 f25) ?v0) ?v0)))
(assert (forall ((?v0 S2)) (= (f5 (f6 f7 f4) ?v0) ?v0)))
(assert (forall ((?v0 S11)) (= (f28 (f29 f30 f27) ?v0) ?v0)))
(assert (forall ((?v0 S6)) (= (f17 (f22 f23 f25) ?v0) ?v0)))
(assert (forall ((?v0 S2)) (= (f5 (f6 f7 f4) ?v0) ?v0)))
(assert (forall ((?v0 S11)) (= (f28 (f29 f30 f27) ?v0) ?v0)))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f6 f7 ?v0))) (=> (= (f16 (f5 ?v_0 ?v1) (f5 ?v_0 ?v2)) f1) (= (f16 ?v1 ?v2) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (=> (= (f16 (f5 (f6 f7 ?v0) ?v1) (f5 (f6 f7 ?v2) ?v1)) f1) (= (f16 ?v0 ?v2) f1))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2) (?v3 S2)) (=> (= (f16 ?v0 ?v1) f1) (=> (= (f16 ?v2 ?v3) f1) (= (f16 (f5 (f6 f7 ?v0) ?v2) (f5 (f6 f7 ?v1) ?v3)) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f6 f7 ?v2))) (=> (= (f16 ?v0 ?v1) f1) (= (f16 (f5 ?v_0 ?v0) (f5 ?v_0 ?v1)) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (=> (= (f16 ?v0 ?v1) f1) (= (f16 (f5 (f6 f7 ?v0) ?v2) (f5 (f6 f7 ?v1) ?v2)) f1))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f6 f7 ?v0))) (= (= (f16 (f5 ?v_0 ?v1) (f5 ?v_0 ?v2)) f1) (= (f16 ?v1 ?v2) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (= (= (f16 (f5 (f6 f7 ?v0) ?v1) (f5 (f6 f7 ?v2) ?v1)) f1) (= (f16 ?v0 ?v2) f1))))
...
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2) (?v3 S2)) (=> (= (f3 ?v0 ?v1) f1) (=> (= (f3 ?v2 ?v3) f1) (= (f3 (f5 (f6 f7 ?v0) ?v2) (f5 (f6 f7 ?v1) ?v3)) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f6 f7 ?v2))) (=> (= (f3 ?v0 ?v1) f1) (= (f3 (f5 ?v_0 ?v0) (f5 ?v_0 ?v1)) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (=> (= (f3 ?v0 ?v1) f1) (= (f3 (f5 (f6 f7 ?v0) ?v2) (f5 (f6 f7 ?v1) ?v2)) f1))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f6 f7 ?v0))) (= (= (f3 (f5 ?v_0 ?v1) (f5 ?v_0 ?v2)) f1) (= (f3 ?v1 ?v2) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (= (= (f3 (f5 (f6 f7 ?v0) ?v1) (f5 (f6 f7 ?v2) ?v1)) f1) (= (f3 ?v0 ?v2) f1))))
(assert (forall ((?v0 S11)) (= (f28 (f29 f32 ?v0) f31) ?v0)))
(assert (forall ((?v0 S2)) (= (f5 (f6 f13 ?v0) f8) ?v0)))
(assert (forall ((?v0 S11)) (= (f28 (f29 f32 ?v0) f31) ?v0)))
(assert (forall ((?v0 S2)) (= (f5 (f6 f13 ?v0) f8) ?v0)))
(assert (forall ((?v0 S11)) (= (f28 (f29 f32 f31) ?v0) ?v0)))
(assert (forall ((?v0 S2)) (= (f5 (f6 f13 f8) ?v0) ?v0)))
(assert (forall ((?v0 S11)) (= (f28 (f29 f32 f31) ?v0) ?v0)))
(assert (forall ((?v0 S2)) (= (f5 (f6 f13 f8) ?v0) ?v0)))
(assert (forall ((?v0 S2)) (= (= (f5 f12 ?v0) f4) (= ?v0 f4))))
(assert (forall ((?v0 S11)) (= (= (f28 f35 ?v0) f27) (= ?v0 f27))))
(assert (= (f5 f12 f4) f4))
(assert (= (f28 f35 f27) f27))
(assert (forall ((?v0 S2) (?v1 S2)) (=> (= (f16 (f5 f12 ?v0) ?v1) f1) (= (f16 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2)) (= (f16 ?v0 (f5 f12 ?v0)) f1)))
(assert (forall ((?v0 S2) (?v1 S2)) (let ((?v_0 (f5 (f6 f7 (f5 f12 ?v0)) (f5 f12 ?v1)))) (= (f5 f12 ?v_0) ?v_0))))
(assert (forall ((?v0 S2) (?v1 S2)) (=> (= (f16 ?v0 f4) f1) (=> (= (f16 ?v1 f4) f1) (= (f16 (f5 (f6 f7 ?v0) ?v1) f4) f1)))))
(assert (forall ((?v0 S11) (?v1 S11)) (=> (= (f34 ?v0 f27) f1) (=> (= (f34 ?v1 f27) f1) (= (f34 (f28 (f29 f30 ?v0) ?v1) f27) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (=> (= (f16 f4 ?v0) f1) (=> (= (f16 ?v1 ?v2) f1) (= (f16 ?v1 (f5 (f6 f7 ?v2) ?v0)) f1)))))
(assert (forall ((?v0 S11) (?v1 S11) (?v2 S11)) (=> (= (f34 f27 ?v0) f1) (=> (= (f34 ?v1 ?v2) f1) (= (f34 ?v1 (f28 (f29 f30 ?v2) ?v0)) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (=> (= (f16 f4 ?v0) f1) (=> (= (f16 ?v1 ?v2) f1) (= (f16 ?v1 (f5 (f6 f7 ?v0) ?v2)) f1)))))
(assert (forall ((?v0 S11) (?v1 S11) (?v2 S11)) (=> (= (f34 f27 ?v0) f1) (=> (= (f34 ?v1 ?v2) f1) (= (f34 ?v1 (f28 (f29 f30 ?v0) ?v2)) f1)))))
(assert (forall ((?v0 S2) (?v1 S2)) (=> (= (f16 f4 ?v0) f1) (=> (= (f16 f4 ?v1) f1) (= (= (f5 (f6 f7 ?v0) ?v1) f4) (and (= ?v0 f4) (= ?v1 f4)))))))
(assert (forall ((?v0 S11) (?v1 S11)) (=> (= (f34 f27 ?v0) f1) (=> (= (f34 f27 ?v1) f1) (= (= (f28 (f29 f30 ?v0) ?v1) f27) (and (= ?v0 f27) (= ?v1 f27)))))))
(assert (forall ((?v0 S2) (?v1 S2)) (=> (= (f16 f4 ?v0) f1) (=> (= (f16 f4 ?v1) f1) (= (f16 f4 (f5 (f6 f7 ?v0) ?v1)) f1)))))
(assert (forall ((?v0 S11) (?v1 S11)) (=> (= (f34 f27 ?v0) f1) (=> (= (f34 f27 ?v1) f1) (= (f34 f27 (f28 (f29 f30 ?v0) ?v1)) f1)))))
(assert (forall ((?v0 S2)) (= (= (f16 (f5 (f6 f7 ?v0) ?v0) f4) f1) (= (f16 ?v0 f4) f1))))
(assert (forall ((?v0 S11)) (= (= (f34 (f28 (f29 f30 ?v0) ?v0) f27) f1) (= (f34 ?v0 f27) f1))))
(assert (forall ((?v0 S2)) (= (= (f16 f4 (f5 (f6 f7 ?v0) ?v0)) f1) (= (f16 f4 ?v0) f1))))
(assert (forall ((?v0 S11)) (= (= (f34 f27 (f28 (f29 f30 ?v0) ?v0)) f1) (= (f34 f27 ?v0) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (=> (= (f3 ?v0 f4) f1) (=> (= (f3 ?v1 f4) f1) (= (f3 (f5 (f6 f7 ?v0) ?v1) f4) f1)))))
(assert (forall ((?v0 S11) (?v1 S11)) (=> (= (f26 ?v0 f27) f1) (=> (= (f26 ?v1 f27) f1) (= (f26 (f28 (f29 f30 ?v0) ?v1) f27) f1)))))
(assert (forall ((?v0 S2) (?v1 S2)) (=> (= (f3 f4 ?v0) f1) (=> (= (f3 f4 ?v1) f1) (= (f3 f4 (f5 (f6 f7 ?v0) ?v1)) f1)))))
(assert (forall ((?v0 S11) (?v1 S11)) (=> (= (f26 f27 ?v0) f1) (=> (= (f26 f27 ?v1) f1) (= (f26 f27 (f28 (f29 f30 ?v0) ?v1)) f1)))))
(assert (forall ((?v0 S2)) (= (= (f3 (f5 (f6 f7 ?v0) ?v0) f4) f1) (= (f3 ?v0 f4) f1))))
(assert (forall ((?v0 S11)) (= (= (f26 (f28 (f29 f30 ?v0) ?v0) f27) f1) (= (f26 ?v0 f27) f1))))
(assert (forall ((?v0 S2)) (= (= (f3 f4 (f5 (f6 f7 ?v0) ?v0)) f1) (= (f3 f4 ?v0) f1))))
(assert (forall ((?v0 S11)) (= (= (f26 f27 (f28 (f29 f30 ?v0) ?v0)) f1) (= (f26 f27 ?v0) f1))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2) (?v3 S2)) (=> (= (f16 ?v0 ?v1) f1) (=> (= (f3 ?v2 ?v3) f1) (= (f3 (f5 (f6 f7 ?v0) ?v2) (f5 (f6 f7 ?v1) ?v3)) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2) (?v3 S2)) (=> (= (f3 ?v0 ?v1) f1) (=> (= (f16 ?v2 ?v3) f1) (= (f3 (f5 (f6 f7 ?v0) ?v2) (f5 (f6 f7 ?v1) ?v3)) f1)))))
(assert (forall ((?v0 S2)) (=> (= (f16 f4 ?v0) f1) (= (f5 f12 ?v0) ?v0))))
(assert (forall ((?v0 S11)) (=> (= (f34 f27 ?v0) f1) (= (f28 f35 ?v0) ?v0))))
(assert (forall ((?v0 S2)) (= (= (f16 (f5 f12 ?v0) f4) f1) (= ?v0 f4))))
(assert (forall ((?v0 S11)) (= (= (f34 (f28 f35 ?v0) f27) f1) (= ?v0 f27))))
(assert (forall ((?v0 S2)) (= (f16 f4 (f5 f12 ?v0)) f1)))
(assert (forall ((?v0 S11)) (= (f34 f27 (f28 f35 ?v0)) f1)))
(assert (forall ((?v0 S2)) (=> (= (f3 f4 ?v0) f1) (= (f5 f12 ?v0) ?v0))))
(assert (forall ((?v0 S11)) (=> (= (f26 f27 ?v0) f1) (= (f28 f35 ?v0) ?v0))))
(assert (forall ((?v0 S2)) (= (= (f3 f4 (f5 f12 ?v0)) f1) (not (= ?v0 f4)))))
(assert (forall ((?v0 S11)) (= (= (f26 f27 (f28 f35 ?v0)) f1) (not (= ?v0 f27)))))
(assert (forall ((?v0 S2)) (not (= (f3 (f5 f12 ?v0) f4) f1))))
(assert (forall ((?v0 S11)) (not (= (f26 (f28 f35 ?v0) f27) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (f16 (f5 f12 (f5 (f6 f7 ?v0) ?v1)) (f5 (f6 f7 (f5 f12 ?v0)) (f5 f12 ?v1))) f1)))
(assert (forall ((?v0 S2) (?v1 S2)) (=> (= (f16 ?v0 f4) f1) (=> (= (f3 ?v1 f4) f1) (= (f3 (f5 (f6 f7 ?v0) ?v1) f4) f1)))))
(assert (forall ((?v0 S11) (?v1 S11)) (=> (= (f34 ?v0 f27) f1) (=> (= (f26 ?v1 f27) f1) (= (f26 (f28 (f29 f30 ?v0) ?v1) f27) f1)))))
(assert (forall ((?v0 S2) (?v1 S2)) (=> (= (f3 ?v0 f4) f1) (=> (= (f16 ?v1 f4) f1) (= (f3 (f5 (f6 f7 ?v0) ?v1) f4) f1)))))
(assert (forall ((?v0 S11) (?v1 S11)) (=> (= (f26 ?v0 f27) f1) (=> (= (f34 ?v1 f27) f1) (= (f26 (f28 (f29 f30 ?v0) ?v1) f27) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (=> (= (f16 f4 ?v0) f1) (=> (= (f3 ?v1 ?v2) f1) (= (f3 ?v1 (f5 (f6 f7 ?v0) ?v2)) f1)))))
(assert (forall ((?v0 S11) (?v1 S11) (?v2 S11)) (=> (= (f34 f27 ?v0) f1) (=> (= (f26 ?v1 ?v2) f1) (= (f26 ?v1 (f28 (f29 f30 ?v0) ?v2)) f1)))))
(assert (forall ((?v0 S2)) (= (not (= (f3 f4 (f5 (f6 f13 ?v0) ?v0)) f1)) (= ?v0 f4))))
(assert (forall ((?v0 S11) (?v1 S11)) (= (f28 (f29 f30 (f28 (f29 f32 ?v0) ?v1)) ?v1) (f28 (f29 f32 (f28 (f29 f30 ?v0) f31)) ?v1))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (f5 (f6 f7 (f5 (f6 f13 ?v0) ?v1)) ?v1) (f5 (f6 f13 (f5 (f6 f7 ?v0) f8)) ?v1))))
(assert (forall ((?v0 S6) (?v1 S6)) (= (f17 (f22 f23 (f17 (f22 f24 ?v0) ?v1)) ?v1) (f17 (f22 f24 (f17 (f22 f23 ?v0) f33)) ?v1))))
(assert (forall ((?v0 S11) (?v1 S11)) (= (f28 (f29 f30 ?v0) (f28 (f29 f32 ?v1) ?v0)) (f28 (f29 f32 (f28 (f29 f30 ?v1) f31)) ?v0))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (f5 (f6 f7 ?v0) (f5 (f6 f13 ?v1) ?v0)) (f5 (f6 f13 (f5 (f6 f7 ?v1) f8)) ?v0))))
(assert (forall ((?v0 S6) (?v1 S6)) (= (f17 (f22 f23 ?v0) (f17 (f22 f24 ?v1) ?v0)) (f17 (f22 f24 (f17 (f22 f23 ?v1) f33)) ?v0))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (f5 (f6 f13 ?v0) ?v1) (f5 (f6 f13 ?v1) ?v0))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_1 (f6 f13 ?v0)) (?v_0 (f6 f13 ?v1))) (= (f5 ?v_1 (f5 ?v_0 ?v2)) (f5 ?v_0 (f5 ?v_1 ?v2))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f6 f13 ?v0))) (= (f5 ?v_0 (f5 (f6 f13 ?v1) ?v2)) (f5 (f6 f13 (f5 ?v_0 ?v1)) ?v2)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f6 f13 ?v0))) (= (f5 (f6 f13 (f5 ?v_0 ?v1)) ?v2) (f5 ?v_0 (f5 (f6 f13 ?v1) ?v2))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f6 f13 ?v0))) (= (f5 (f6 f13 (f5 ?v_0 ?v1)) ?v2) (f5 (f6 f13 (f5 ?v_0 ?v2)) ?v1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2) (?v3 S2)) (let ((?v_0 (f6 f13 ?v0)) (?v_1 (f5 (f6 f13 ?v2) ?v3))) (= (f5 (f6 f13 (f5 ?v_0 ?v1)) ?v_1) (f5 ?v_0 (f5 (f6 f13 ?v1) ?v_1))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2) (?v3 S2)) (let ((?v_1 (f6 f13 (f5 (f6 f13 ?v0) ?v1))) (?v_0 (f6 f13 ?v2))) (= (f5 ?v_1 (f5 ?v_0 ?v3)) (f5 ?v_0 (f5 ?v_1 ?v3))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2) (?v3 S2)) (let ((?v_0 (f6 f13 ?v0))) (= (f5 (f6 f13 (f5 ?v_0 ?v1)) (f5 (f6 f13 ?v2) ?v3)) (f5 (f6 f13 (f5 ?v_0 ?v2)) (f5 (f6 f13 ?v1) ?v3))))))
(assert (forall ((?v0 S6) (?v1 S6)) (= (f17 (f22 f23 ?v0) ?v1) (f17 (f22 f23 ?v1) ?v0))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (f5 (f6 f7 ?v0) ?v1) (f5 (f6 f7 ?v1) ?v0))))
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6)) (let ((?v_1 (f22 f23 ?v0)) (?v_0 (f22 f23 ?v1))) (= (f17 ?v_1 (f17 ?v_0 ?v2)) (f17 ?v_0 (f17 ?v_1 ?v2))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_1 (f6 f7 ?v0)) (?v_0 (f6 f7 ?v1))) (= (f5 ?v_1 (f5 ?v_0 ?v2)) (f5 ?v_0 (f5 ?v_1 ?v2))))))
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6)) (let ((?v_0 (f22 f23 ?v0))) (= (f17 ?v_0 (f17 (f22 f23 ?v1) ?v2)) (f17 (f22 f23 (f17 ?v_0 ?v1)) ?v2)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f6 f7 ?v0))) (= (f5 ?v_0 (f5 (f6 f7 ?v1) ?v2)) (f5 (f6 f7 (f5 ?v_0 ?v1)) ?v2)))))
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6)) (let ((?v_0 (f22 f23 ?v0))) (= (f17 (f22 f23 (f17 ?v_0 ?v1)) ?v2) (f17 ?v_0 (f17 (f22 f23 ?v1) ?v2))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f6 f7 ?v0))) (= (f5 (f6 f7 (f5 ?v_0 ?v1)) ?v2) (f5 ?v_0 (f5 (f6 f7 ?v1) ?v2))))))
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6)) (let ((?v_0 (f22 f23 ?v0))) (= (f17 (f22 f23 (f17 ?v_0 ?v1)) ?v2) (f17 (f22 f23 (f17 ?v_0 ?v2)) ?v1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f6 f7 ?v0))) (= (f5 (f6 f7 (f5 ?v_0 ?v1)) ?v2) (f5 (f6 f7 (f5 ?v_0 ?v2)) ?v1)))))
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6) (?v3 S6)) (let ((?v_0 (f22 f23 ?v0))) (= (f17 (f22 f23 (f17 ?v_0 ?v1)) (f17 (f22 f23 ?v2) ?v3)) (f17 (f22 f23 (f17 ?v_0 ?v2)) (f17 (f22 f23 ?v1) ?v3))))))
...
(assert (forall ((?v0 S2)) (= (f5 (f6 f7 ?v0) f4) ?v0)))
(assert (forall ((?v0 S11)) (= (f28 (f29 f30 ?v0) f27) ?v0)))
(assert (forall ((?v0 S6) (?v1 S6)) (= (= ?v0 (f17 (f22 f23 ?v0) ?v1)) (= ?v1 f25))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= ?v0 (f5 (f6 f7 ?v0) ?v1)) (= ?v1 f4))))
(assert (forall ((?v0 S11) (?v1 S11)) (= (= ?v0 (f28 (f29 f30 ?v0) ?v1)) (= ?v1 f27))))
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6)) (let ((?v_0 (f22 f24 ?v0))) (= (f17 ?v_0 (f17 (f22 f23 ?v1) ?v2)) (f17 (f22 f23 (f17 ?v_0 ?v1)) (f17 ?v_0 ?v2))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f6 f13 ?v0))) (= (f5 ?v_0 (f5 (f6 f7 ?v1) ?v2)) (f5 (f6 f7 (f5 ?v_0 ?v1)) (f5 ?v_0 ?v2))))))
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6) (?v3 S6)) (let ((?v_0 (f22 f24 ?v0)) (?v_1 (f22 f24 ?v1))) (= (and (not (= ?v0 ?v1)) (not (= ?v2 ?v3))) (not (= (f17 (f22 f23 (f17 ?v_0 ?v2)) (f17 ?v_1 ?v3)) (f17 (f22 f23 (f17 ?v_0 ?v3)) (f17 ?v_1 ?v2))))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2) (?v3 S2)) (let ((?v_0 (f6 f13 ?v0)) (?v_1 (f6 f13 ?v1))) (= (and (not (= ?v0 ?v1)) (not (= ?v2 ?v3))) (not (= (f5 (f6 f7 (f5 ?v_0 ?v2)) (f5 ?v_1 ?v3)) (f5 (f6 f7 (f5 ?v_0 ?v3)) (f5 ?v_1 ?v2))))))))
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6)) (= (f17 (f22 f24 (f17 (f22 f23 ?v0) ?v1)) ?v2) (f17 (f22 f23 (f17 (f22 f24 ?v0) ?v2)) (f17 (f22 f24 ?v1) ?v2)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (= (f5 (f6 f13 (f5 (f6 f7 ?v0) ?v1)) ?v2) (f5 (f6 f7 (f5 (f6 f13 ?v0) ?v2)) (f5 (f6 f13 ?v1) ?v2)))))
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6)) (= (f17 (f22 f23 (f17 (f22 f24 ?v0) ?v1)) (f17 (f22 f24 ?v2) ?v1)) (f17 (f22 f24 (f17 (f22 f23 ?v0) ?v2)) ?v1))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (= (f5 (f6 f7 (f5 (f6 f13 ?v0) ?v1)) (f5 (f6 f13 ?v2) ?v1)) (f5 (f6 f13 (f5 (f6 f7 ?v0) ?v2)) ?v1))))
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6) (?v3 S6)) (let ((?v_0 (f22 f24 ?v0)) (?v_1 (f22 f24 ?v2))) (= (= (f17 (f22 f23 (f17 ?v_0 ?v1)) (f17 ?v_1 ?v3)) (f17 (f22 f23 (f17 ?v_0 ?v3)) (f17 ?v_1 ?v1))) (or (= ?v0 ?v2) (= ?v1 ?v3))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2) (?v3 S2)) (let ((?v_0 (f6 f13 ?v0)) (?v_1 (f6 f13 ?v2))) (= (= (f5 (f6 f7 (f5 ?v_0 ?v1)) (f5 ?v_1 ?v3)) (f5 (f6 f7 (f5 ?v_0 ?v3)) (f5 ?v_1 ?v1))) (or (= ?v0 ?v2) (= ?v1 ?v3))))))
(assert (forall ((?v0 S11)) (= (f28 (f29 f32 f31) ?v0) ?v0)))
(assert (forall ((?v0 S2)) (= (f5 (f6 f13 f8) ?v0) ?v0)))
(assert (forall ((?v0 S11)) (= (f28 (f29 f32 ?v0) f31) ?v0)))
(assert (forall ((?v0 S2)) (= (f5 (f6 f13 ?v0) f8) ?v0)))
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S6) (?v3 S6) (?v4 S6)) (let ((?v_0 (f22 f24 ?v0))) (=> (not (= ?v0 f25)) (=> (and (= ?v1 ?v2) (not (= ?v3 ?v4))) (not (= (f17 (f22 f23 ?v1) (f17 ?v_0 ?v3)) (f17 (f22 f23 ?v2) (f17 ?v_0 ?v4)))))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2) (?v3 S2) (?v4 S2)) (let ((?v_0 (f6 f13 ?v0))) (=> (not (= ?v0 f4)) (=> (and (= ?v1 ?v2) (not (= ?v3 ?v4))) (not (= (f5 (f6 f7 ?v1) (f5 ?v_0 ?v3)) (f5 (f6 f7 ?v2) (f5 ?v_0 ?v4)))))))))
(assert (forall ((?v0 S11) (?v1 S11) (?v2 S11) (?v3 S11) (?v4 S11)) (let ((?v_0 (f29 f32 ?v0))) (=> (not (= ?v0 f27)) (=> (and (= ?v1 ?v2) (not (= ?v3 ?v4))) (not (= (f28 (f29 f30 ?v1) (f28 ?v_0 ?v3)) (f28 (f29 f30 ?v2) (f28 ?v_0 ?v4)))))))))
(assert (forall ((?v0 S11)) (= (f28 (f29 f30 ?v0) ?v0) (f28 (f29 f32 (f28 (f29 f30 f31) f31)) ?v0))))
(assert (forall ((?v0 S2)) (= (f5 (f6 f7 ?v0) ?v0) (f5 (f6 f13 (f5 (f6 f7 f8) f8)) ?v0))))
(assert (forall ((?v0 S6)) (= (f17 (f22 f23 ?v0) ?v0) (f17 (f22 f24 (f17 (f22 f23 f33) f33)) ?v0))))
(assert (forall ((?v0 S2)) (= (= (f3 (f5 (f6 f7 ?v0) ?v0) f4) f1) (= (f3 ?v0 f4) f1))))
(assert (forall ((?v0 S11)) (= (= (f26 (f28 (f29 f30 ?v0) ?v0) f27) f1) (= (f26 ?v0 f27) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (=> (forall ((?v2 S2)) (=> (= (f3 f4 ?v2) f1) (=> (= (f3 ?v2 f8) f1) (= (f16 (f5 (f6 f13 ?v2) ?v0) ?v1) f1)))) (= (f16 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2)) (= (= (f5 (f6 f7 ?v0) ?v0) f4) (= ?v0 f4))))
(assert (forall ((?v0 S11)) (= (= (f28 (f29 f30 ?v0) ?v0) f27) (= ?v0 f27))))
(assert (forall ((?v0 S2) (?v1 S2)) (=> (forall ((?v2 S2)) (=> (= (f3 f4 ?v2) f1) (= (f16 ?v0 (f5 (f6 f7 ?v1) ?v2)) f1))) (= (f16 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2)) (= (f16 ?v0 ?v0) f1)))
(assert (forall ((?v0 S2) (?v1 S2)) (or (= (f16 ?v0 ?v1) f1) (= (f16 ?v1 ?v0) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= ?v0 ?v1) (and (= (f16 ?v0 ?v1) f1) (= (f16 ?v1 ?v0) f1)))))
(assert (forall ((?v0 S2) (?v1 S2)) (=> (= ?v0 ?v1) (= (f16 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (=> (= (f16 ?v0 ?v1) f1) (= (= (f16 ?v1 ?v0) f1) (= ?v1 ?v0)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (=> (= ?v0 ?v1) (=> (= (f16 ?v1 ?v2) f1) (= (f16 ?v0 ?v2) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (=> (= ?v0 ?v1) (=> (= (f16 ?v2 ?v1) f1) (= (f16 ?v2 ?v0) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (=> (= (f16 ?v0 ?v1) f1) (=> (= ?v1 ?v2) (= (f16 ?v0 ?v2) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (=> (= (f16 ?v0 ?v1) f1) (=> (= ?v0 ?v2) (= (f16 ?v2 ?v1) f1)))))
(check-sat)
(exit)
