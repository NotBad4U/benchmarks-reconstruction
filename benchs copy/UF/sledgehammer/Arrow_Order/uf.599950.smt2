...
(declare-fun f79 (S38 S9) S1)
(declare-fun f80 (S38 S9) S1)
(declare-fun f81 (S35 S14) S1)
(declare-fun f82 (S35 S14) S1)
(declare-fun f83 (S32 S19) S1)
(declare-fun f84 (S32 S19) S1)
(declare-fun f85 (S29 S24) S1)
(declare-fun f86 (S29 S24) S1)
(declare-fun f87 (S14 S29) S1)
(declare-fun f88 (S14 S29) S1)
(declare-fun f89 (S9 S32) S1)
(declare-fun f90 (S9 S32) S1)
(declare-fun f91 (S5 S35) S1)
(declare-fun f92 (S5 S35) S1)
(declare-fun f93 (S4 S38) S1)
(declare-fun f94 (S4 S38) S1)
(declare-fun f95 (S19 S41) S1)
(declare-fun f96 (S42 S41) S1)
(declare-fun f97 (S21 S21) S42)
(declare-fun f98 (S24 S43) S1)
(declare-fun f99 (S44 S43) S1)
(declare-fun f100 (S26 S26) S44)
(declare-fun f101 (S45 S2) S4)
(declare-fun f102 (S4) S45)
(declare-fun f103 () S4)
(declare-fun f104 () S2)
(assert (not (= f1 f2)))
...
(assert (forall ((?v0 S38) (?v1 S9)) (= (= (f79 ?v0 ?v1) f1) (and (= (f12 ?v1) f1) (and (= (f53 ?v1) f1) (= (f80 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S35) (?v1 S14)) (= (= (f81 ?v0 ?v1) f1) (and (= (f17 ?v1) f1) (and (= (f54 ?v1) f1) (= (f82 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S32) (?v1 S19)) (= (= (f83 ?v0 ?v1) f1) (and (= (f22 ?v1) f1) (and (= (f55 ?v1) f1) (= (f84 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S29) (?v1 S24)) (= (= (f85 ?v0 ?v1) f1) (and (= (f27 ?v1) f1) (and (= (f56 ?v1) f1) (= (f86 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S14) (?v1 S29)) (= (= (f87 ?v0 ?v1) f1) (and (= (f32 ?v1) f1) (and (= (f57 ?v1) f1) (= (f88 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S9) (?v1 S32)) (= (= (f89 ?v0 ?v1) f1) (and (= (f37 ?v1) f1) (and (= (f58 ?v1) f1) (= (f90 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S5) (?v1 S35)) (= (= (f91 ?v0 ?v1) f1) (and (= (f42 ?v1) f1) (and (= (f59 ?v1) f1) (= (f92 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S4) (?v1 S38)) (= (= (f93 ?v0 ?v1) f1) (and (= (f47 ?v1) f1) (and (= (f60 ?v1) f1) (= (f94 ?v0 ?v1) f1))))))
...
(assert (forall ((?v0 S4) (?v1 S38)) (= (= (f94 ?v0 ?v1) f1) (forall ((?v2 S6)) (=> (= (f5 (f8 ?v2) ?v0) f1) (forall ((?v3 S6)) (=> (= (f5 (f8 ?v3) ?v0) f1) (=> (not (= ?v2 ?v3)) (or (= (f48 (f49 (f50 f51 ?v2) ?v3) ?v1) f1) (= (f48 (f49 (f50 f51 ?v3) ?v2) ?v1) f1))))))))))
(assert (forall ((?v0 S5) (?v1 S35)) (= (= (f92 ?v0 ?v1) f1) (forall ((?v2 S4)) (=> (= (f66 ?v2 ?v0) f1) (forall ((?v3 S4)) (=> (= (f66 ?v3 ?v0) f1) (=> (not (= ?v2 ?v3)) (or (= (f43 (f44 (f45 f46 ?v2) ?v3) ?v1) f1) (= (f43 (f44 (f45 f46 ?v3) ?v2) ?v1) f1))))))))))
(assert (forall ((?v0 S9) (?v1 S32)) (= (= (f90 ?v0 ?v1) f1) (forall ((?v2 S11)) (=> (= (f13 ?v2 ?v0) f1) (forall ((?v3 S11)) (=> (= (f13 ?v3 ?v0) f1) (=> (not (= ?v2 ?v3)) (or (= (f38 (f39 (f40 f41 ?v2) ?v3) ?v1) f1) (= (f38 (f39 (f40 f41 ?v3) ?v2) ?v1) f1))))))))))
(assert (forall ((?v0 S14) (?v1 S29)) (= (= (f88 ?v0 ?v1) f1) (forall ((?v2 S16)) (=> (= (f18 ?v2 ?v0) f1) (forall ((?v3 S16)) (=> (= (f18 ?v3 ?v0) f1) (=> (not (= ?v2 ?v3)) (or (= (f33 (f34 (f35 f36 ?v2) ?v3) ?v1) f1) (= (f33 (f34 (f35 f36 ?v3) ?v2) ?v1) f1))))))))))
(assert (forall ((?v0 S19) (?v1 S41)) (= (= (f95 ?v0 ?v1) f1) (forall ((?v2 S21)) (=> (= (f23 ?v2 ?v0) f1) (forall ((?v3 S21)) (=> (= (f23 ?v3 ?v0) f1) (=> (not (= ?v2 ?v3)) (or (= (f96 (f97 ?v2 ?v3) ?v1) f1) (= (f96 (f97 ?v3 ?v2) ?v1) f1))))))))))
(assert (forall ((?v0 S24) (?v1 S43)) (= (= (f98 ?v0 ?v1) f1) (forall ((?v2 S26)) (=> (= (f28 ?v2 ?v0) f1) (forall ((?v3 S26)) (=> (= (f28 ?v3 ?v0) f1) (=> (not (= ?v2 ?v3)) (or (= (f99 (f100 ?v2 ?v3) ?v1) f1) (= (f99 (f100 ?v3 ?v2) ?v1) f1))))))))))
(assert (forall ((?v0 S29) (?v1 S24)) (= (= (f86 ?v0 ?v1) f1) (forall ((?v2 S25)) (=> (= (f33 ?v2 ?v0) f1) (forall ((?v3 S25)) (=> (= (f33 ?v3 ?v0) f1) (=> (not (= ?v2 ?v3)) (or (= (f28 (f29 (f30 f31 ?v2) ?v3) ?v1) f1) (= (f28 (f29 (f30 f31 ?v3) ?v2) ?v1) f1))))))))))
(assert (forall ((?v0 S32) (?v1 S19)) (= (= (f84 ?v0 ?v1) f1) (forall ((?v2 S20)) (=> (= (f38 ?v2 ?v0) f1) (forall ((?v3 S20)) (=> (= (f38 ?v3 ?v0) f1) (=> (not (= ?v2 ?v3)) (or (= (f23 (f24 (f25 f26 ?v2) ?v3) ?v1) f1) (= (f23 (f24 (f25 f26 ?v3) ?v2) ?v1) f1))))))))))
(assert (forall ((?v0 S35) (?v1 S14)) (= (= (f82 ?v0 ?v1) f1) (forall ((?v2 S15)) (=> (= (f43 ?v2 ?v0) f1) (forall ((?v3 S15)) (=> (= (f43 ?v3 ?v0) f1) (=> (not (= ?v2 ?v3)) (or (= (f18 (f19 (f20 f21 ?v2) ?v3) ?v1) f1) (= (f18 (f19 (f20 f21 ?v3) ?v2) ?v1) f1))))))))))
(assert (forall ((?v0 S38) (?v1 S9)) (= (= (f80 ?v0 ?v1) f1) (forall ((?v2 S10)) (=> (= (f48 ?v2 ?v0) f1) (forall ((?v3 S10)) (=> (= (f48 ?v3 ?v0) f1) (=> (not (= ?v2 ?v3)) (or (= (f13 (f14 (f15 f16 ?v2) ?v3) ?v1) f1) (= (f13 (f14 (f15 f16 ?v3) ?v2) ?v1) f1))))))))))
(assert (forall ((?v0 S4) (?v1 S2) (?v2 S2)) (=> (= (f66 ?v0 f61) f1) (=> (not (= ?v1 ?v2)) (= (not (= (f5 (f8 (f9 (f10 f11 ?v1) ?v2)) ?v0) f1)) (= (f5 (f8 (f9 (f10 f11 ?v2) ?v1)) ?v0) f1))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S4) (?v3 S2)) (let ((?v_0 (f8 (f9 (f10 f11 ?v0) ?v1)))) (= (= (f5 ?v_0 (f101 (f102 ?v2) ?v3)) f1) (and (not (= ?v1 ?v3)) (ite (= ?v0 ?v3) (not (= ?v0 ?v1)) (= (f5 ?v_0 ?v2) f1)))))))
(assert (not (=> (= (f66 f103 f61) f1) (= (f66 (f101 (f102 f103) f104) f61) f1))))
(check-sat)
(exit)
