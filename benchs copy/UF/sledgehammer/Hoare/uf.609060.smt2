...
(assert (forall ((?v0 S23)) (= (= (f59 ?v0) f42) (forall ((?v1 S4)) (not (= (f33 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S24)) (= (= (f60 ?v0) f50) (forall ((?v1 S2)) (not (= (f35 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S2)) (= (= (f47 ?v0 f50) f1) false)))
(assert (forall ((?v0 S4)) (= (= (f57 ?v0 f42) f1) false)))
(assert (forall ((?v0 S23)) (= (= f42 (f59 ?v0)) (forall ((?v1 S4)) (not (= (f33 ?v0 ?v1) f1))))))
...
(assert (forall ((?v0 S4) (?v1 S23)) (=> (= (f57 ?v0 ?v1) f1) (= (f39 (f40 ?v0) ?v1) ?v1))))
(assert (forall ((?v0 S2) (?v1 S24)) (=> (= (f47 ?v0 ?v1) f1) (= (f53 (f54 ?v0) ?v1) ?v1))))
(assert (forall ((?v0 S4) (?v1 S23) (?v2 S4)) (=> (= (f57 ?v0 ?v1) f1) (= (f57 ?v0 (f39 (f40 ?v2) ?v1)) f1))))
(assert (forall ((?v0 S2) (?v1 S24) (?v2 S2)) (=> (= (f47 ?v0 ?v1) f1) (= (f47 ?v0 (f53 (f54 ?v2) ?v1)) f1))))
(assert (forall ((?v0 S4) (?v1 S23) (?v2 S23)) (let ((?v_0 (f40 ?v0))) (=> (not (= (f57 ?v0 ?v1) f1)) (=> (not (= (f57 ?v0 ?v2) f1)) (= (= (f39 ?v_0 ?v1) (f39 ?v_0 ?v2)) (= ?v1 ?v2)))))))
(assert (forall ((?v0 S2) (?v1 S24) (?v2 S24)) (let ((?v_0 (f54 ?v0))) (=> (not (= (f47 ?v0 ?v1) f1)) (=> (not (= (f47 ?v0 ?v2) f1)) (= (= (f53 ?v_0 ?v1) (f53 ?v_0 ?v2)) (= ?v1 ?v2)))))))
(check-sat)
(exit)
