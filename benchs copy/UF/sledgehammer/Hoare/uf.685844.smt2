...
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S3)) (=> (= (f24 ?v0 (f7 (f8 ?v1) ?v2)) f1) (=> (=> (= ?v0 ?v1) false) (=> (=> (= (f24 ?v0 ?v2) f1) false) false)))))
(assert (forall ((?v0 S2) (?v1 S3) (?v2 S2)) (=> (=> (not (= (f24 ?v0 ?v1) f1)) (= ?v0 ?v2)) (= (f24 ?v0 (f7 (f8 ?v2) ?v1)) f1))))
(assert (forall ((?v0 S2)) (=> (= (f24 ?v0 f18) f1) false)))
(assert (forall ((?v0 S2) (?v1 S3)) (not (= f18 (f7 (f8 ?v0) ?v1)))))
(assert (forall ((?v0 S2) (?v1 S3)) (not (= (f7 (f8 ?v0) ?v1) f18))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f24 ?v0 (f7 (f8 ?v1) f18)) f1) (= ?v0 ?v1))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2) (?v3 S2)) (= (= (f7 (f8 ?v0) (f7 (f8 ?v1) f18)) (f7 (f8 ?v2) (f7 (f8 ?v3) f18))) (or (and (= ?v0 ?v2) (= ?v1 ?v3)) (and (= ?v0 ?v3) (= ?v1 ?v2))))))
(assert (forall ((?v0 S3) (?v1 S2)) (=> (= ?v0 f18) (not (= (f24 ?v1 ?v0) f1)))))
(assert (forall ((?v0 S3)) (= (= (f25 ?v0) f18) (forall ((?v1 S2)) (not (= (f3 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S2)) (= (= (f24 ?v0 f18) f1) false)))
(assert (forall ((?v0 S3)) (= (= f18 (f25 ?v0)) (forall ((?v1 S2)) (not (= (f3 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S3)) (= (forall ((?v1 S2)) (=> (= (f24 ?v1 f18) f1) (= (f3 ?v0 ?v1) f1))) true)))
(assert (forall ((?v0 S3)) (= (exists ((?v1 S2)) (and (= (f24 ?v1 f18) f1) (= (f3 ?v0 ?v1) f1))) false)))
(assert (forall ((?v0 S3)) (= (exists ((?v1 S2)) (= (f24 ?v1 ?v0) f1)) (not (= ?v0 f18)))))
(assert (forall ((?v0 S3)) (= (forall ((?v1 S2)) (not (= (f24 ?v1 ?v0) f1))) (= ?v0 f18))))
(assert (= f18 (f25 f4)))
(assert (forall ((?v0 S2) (?v1 S3)) (=> (= (f24 ?v0 ?v1) f1) (= (f7 (f8 ?v0) ?v1) ?v1))))
(assert (forall ((?v0 S2) (?v1 S3) (?v2 S2)) (=> (= (f24 ?v0 ?v1) f1) (= (f24 ?v0 (f7 (f8 ?v2) ?v1)) f1))))
(assert (forall ((?v0 S2) (?v1 S3) (?v2 S3)) (let ((?v_0 (f8 ?v0))) (=> (not (= (f24 ?v0 ?v1) f1)) (=> (not (= (f24 ?v0 ?v2) f1)) (= (= (f7 ?v_0 ?v1) (f7 ?v_0 ?v2)) (= ?v1 ?v2)))))))
(assert (forall ((?v0 S2) (?v1 S3) (?v2 S2)) (= (= (f3 (f7 (f8 ?v0) ?v1) ?v2) f1) (or (= ?v0 ?v2) (= (f3 ?v1 ?v2) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S3)) (= (= (f24 ?v0 (f7 (f8 ?v1) ?v2)) f1) (or (= ?v0 ?v1) (= (f24 ?v0 ?v2) f1)))))
