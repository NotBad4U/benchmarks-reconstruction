...
(declare-fun f78 () S48)
(declare-fun f79 (S49 S13) S43)
(declare-fun f80 (S50 S9) S49)
(declare-fun f81 () S50)
(declare-fun f82 () S1)
(declare-fun f83 () S43)
(declare-fun f84 (S51 S4) S45)
(declare-fun f85 () S51)
(declare-fun f86 (S52 S43) S45)
(declare-fun f87 () S52)
(assert (not (= f1 f2)))
...
(assert (forall ((?v0 S15) (?v1 S5) (?v2 S9) (?v3 S13)) (= (f23 (f61 f62 ?v0) (f20 (f21 f64 (f65 (f66 (f67 f68 (f50 (f51 (f52 f53 ?v1) ?v2) ?v3)) (f79 (f80 f81 ?v2) ?v3)) ?v1)) f75)) f1)))
(assert (forall ((?v0 S14)) (= (= (f16 f75 ?v0) f1) (= f82 f1))))
(assert (forall ((?v0 S14)) (= (= (f16 f75 ?v0) f1) (= f82 f1))))
(assert (forall ((?v0 S15) (?v1 S5)) (= (f23 (f61 f62 ?v0) (f20 (f21 f64 (f65 (f66 (f67 f68 ?v1) f83) ?v1)) f75)) f1)))
(assert (forall ((?v0 S15) (?v1 S5) (?v2 S4) (?v3 S43)) (= (f23 (f61 f62 ?v0) (f20 (f21 f64 (f65 (f66 (f67 f68 (f37 (f38 f39 ?v1) ?v2)) (f69 (f84 f85 ?v2) ?v3)) ?v1)) f75)) f1)))
(assert (forall ((?v0 S15) (?v1 S5) (?v2 S43) (?v3 S5) (?v4 S43) (?v5 S5)) (let ((?v_0 (f61 f62 ?v0)) (?v_1 (f67 f68 ?v1))) (=> (= (f23 ?v_0 (f20 (f21 f64 (f65 (f66 ?v_1 ?v2) ?v3)) f75)) f1) (=> (= (f23 ?v_0 (f20 (f21 f64 (f65 (f66 (f67 f68 ?v3) ?v4) ?v5)) f75)) f1) (= (f23 ?v_0 (f20 (f21 f64 (f65 (f66 ?v_1 (f69 (f86 f87 ?v2) ?v4)) ?v5)) f75)) f1))))))
(assert (forall ((?v0 S14)) (=> (forall ((?v1 S5) (?v2 S43) (?v3 S5)) (=> (= ?v0 (f65 (f66 (f67 f68 ?v1) ?v2) ?v3)) false)) false)))
(assert (forall ((?v0 S5) (?v1 S5) (?v2 S15)) (=> (forall ((?v3 S2) (?v4 S3)) (=> (= (f3 (f4 ?v0 ?v3) ?v4) f1) (= (f3 (f4 ?v1 ?v3) ?v4) f1))) (= (f23 (f61 f62 ?v2) (f20 (f21 f64 (f65 (f66 (f67 f68 ?v0) f83) ?v1)) f75)) f1))))
(assert (forall ((?v0 S43) (?v1 S43)) (not (= (f69 (f86 f87 ?v0) ?v1) f83))))
(assert (forall ((?v0 S9) (?v1 S13)) (not (= (f79 (f80 f81 ?v0) ?v1) f83))))
(assert (forall ((?v0 S43) (?v1 S43)) (not (= f83 (f69 (f86 f87 ?v0) ?v1)))))
(check-sat)
(exit)
