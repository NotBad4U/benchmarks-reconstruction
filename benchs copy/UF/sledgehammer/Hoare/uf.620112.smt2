...
(assert (let ((?v_0 (f9 f10 f11))) (= (f3 (f5 (f6 (f7 (f8 ?v_0 (f12 f13 f14)) f15)) f4) (f5 (f6 (f7 (f8 ?v_0 (f17 f18 (f19 f14))) f15)) f16)) f1)))
...
(assert (forall ((?v0 S4) (?v1 S4) (?v2 S2)) (=> (= (f22 ?v0 (f5 (f6 ?v1) ?v2)) f1) (=> (=> (= ?v0 ?v1) false) (=> (=> (= (f22 ?v0 ?v2) f1) false) false)))))
(assert (forall ((?v0 S4) (?v1 S2) (?v2 S4)) (=> (=> (not (= (f22 ?v0 ?v1) f1)) (= ?v0 ?v2)) (= (f22 ?v0 (f5 (f6 ?v2) ?v1)) f1))))
(assert (forall ((?v0 S4)) (=> (= (f22 ?v0 f16) f1) false)))
(assert (forall ((?v0 S4) (?v1 S2)) (not (= f16 (f5 (f6 ?v0) ?v1)))))
(assert (forall ((?v0 S4) (?v1 S2)) (not (= (f5 (f6 ?v0) ?v1) f16))))
(assert (forall ((?v0 S4) (?v1 S4)) (= (= (f22 ?v0 (f5 (f6 ?v1) f16)) f1) (= ?v0 ?v1))))
(assert (forall ((?v0 S4) (?v1 S4) (?v2 S4) (?v3 S4)) (= (= (f5 (f6 ?v0) (f5 (f6 ?v1) f16)) (f5 (f6 ?v2) (f5 (f6 ?v3) f16))) (or (and (= ?v0 ?v2) (= ?v1 ?v3)) (and (= ?v0 ?v3) (= ?v1 ?v2))))))
(check-sat)
(exit)
