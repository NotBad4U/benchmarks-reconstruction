...
(assert (let ((?v_0 (f16 f17 f18))) (= (f6 (f11 (f4 (f13 (f14 (f15 ?v_0 (f19 f20 f21)) f22)) f12)) (f4 (f13 (f14 (f15 ?v_0 (f24 f25 (f26 f21))) f22)) f23)) f1)))
...
(assert (forall ((?v0 S2) (?v1 S3) (?v2 S3)) (=> (= (f6 (f7 ?v0) ?v1) f1) (= (f4 (f84 (f4 (f13 ?v0) ?v2)) ?v1) (f4 (f84 ?v2) ?v1)))))
(check-sat)
(exit)
