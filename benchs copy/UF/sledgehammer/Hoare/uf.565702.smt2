...
(declare-fun f10 () S10)
(declare-fun f11 (S6 S11) S1)
(declare-fun f12 (S2 S3 S2) S11)
(declare-fun f13 () S2)
(declare-fun f14 () S3)
(declare-fun f15 () S2)
(assert (not (= f1 f2)))
...
(assert (not (= (= (f11 f6 (f12 f13 f14 f15)) f1) (forall ((?v0 S7) (?v1 S8)) (=> (= (f7 (f8 f13 ?v0) ?v1) f1) (forall ((?v2 S8)) (=> (= (f9 f14 ?v1 f10 ?v2) f1) (= (f7 (f8 f15 ?v0) ?v2) f1))))))))
(assert (forall ((?v0 S6) (?v1 S2) (?v2 S3) (?v3 S2)) (= (= (f11 ?v0 (f12 ?v1 ?v2 ?v3)) f1) (= (f3 (f4 (f5 ?v0 ?v1) ?v2) ?v3) f1))))
(check-sat)
(exit)
