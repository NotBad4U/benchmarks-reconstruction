...
(assert (forall ((?v0 S10) (?v1 S10)) (= (= ?v0 (f15 (f43 f46 ?v0) ?v1)) (= ?v1 f51))))
(assert (forall ((?v0 S4) (?v1 S4)) (= (= ?v0 (f5 (f6 f48 ?v0) ?v1)) (= ?v1 f52))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= ?v0 (f9 (f11 f23 ?v0) ?v1)) (= ?v1 f34))))
(assert (forall ((?v0 S10)) (= (f15 (f43 f46 ?v0) f51) ?v0)))
(assert (forall ((?v0 S4)) (= (f5 (f6 f48 ?v0) f52) ?v0)))
(assert (forall ((?v0 S2)) (= (f9 (f11 f23 ?v0) f34) ?v0)))
(assert (forall ((?v0 S10)) (= (f15 (f43 f46 f51) ?v0) ?v0)))
(assert (forall ((?v0 S4)) (= (f5 (f6 f48 f52) ?v0) ?v0)))
(assert (forall ((?v0 S2)) (= (f9 (f11 f23 f34) ?v0) ?v0)))
(assert (forall ((?v0 S10) (?v1 S10) (?v2 S10) (?v3 S10)) (let ((?v_0 (f43 f44 ?v0)) (?v_1 (f43 f44 ?v2))) (= (= (f15 (f43 f46 (f15 ?v_0 ?v1)) (f15 ?v_1 ?v3)) (f15 (f43 f46 (f15 ?v_0 ?v3)) (f15 ?v_1 ?v1))) (or (= ?v0 ?v2) (= ?v1 ?v3))))))
(assert (forall ((?v0 S4) (?v1 S4) (?v2 S4) (?v3 S4)) (let ((?v_0 (f6 f35 ?v0)) (?v_1 (f6 f35 ?v2))) (= (= (f5 (f6 f48 (f5 ?v_0 ?v1)) (f5 ?v_1 ?v3)) (f5 (f6 f48 (f5 ?v_0 ?v3)) (f5 ?v_1 ?v1))) (or (= ?v0 ?v2) (= ?v1 ?v3))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2) (?v3 S2)) (let ((?v_0 (f11 f12 ?v0)) (?v_1 (f11 f12 ?v2))) (= (= (f9 (f11 f23 (f9 ?v_0 ?v1)) (f9 ?v_1 ?v3)) (f9 (f11 f23 (f9 ?v_0 ?v3)) (f9 ?v_1 ?v1))) (or (= ?v0 ?v2) (= ?v1 ?v3))))))
(assert (forall ((?v0 S10) (?v1 S10) (?v2 S10)) (= (f15 (f43 f46 (f15 (f43 f44 ?v0) ?v1)) (f15 (f43 f44 ?v2) ?v1)) (f15 (f43 f44 (f15 (f43 f46 ?v0) ?v2)) ?v1))))
(assert (forall ((?v0 S4) (?v1 S4) (?v2 S4)) (= (f5 (f6 f48 (f5 (f6 f35 ?v0) ?v1)) (f5 (f6 f35 ?v2) ?v1)) (f5 (f6 f35 (f5 (f6 f48 ?v0) ?v2)) ?v1))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (= (f9 (f11 f23 (f9 (f11 f12 ?v0) ?v1)) (f9 (f11 f12 ?v2) ?v1)) (f9 (f11 f12 (f9 (f11 f23 ?v0) ?v2)) ?v1))))
(assert (forall ((?v0 S10) (?v1 S10) (?v2 S10)) (= (f15 (f43 f44 (f15 (f43 f46 ?v0) ?v1)) ?v2) (f15 (f43 f46 (f15 (f43 f44 ?v0) ?v2)) (f15 (f43 f44 ?v1) ?v2)))))
(assert (forall ((?v0 S4) (?v1 S4) (?v2 S4)) (= (f5 (f6 f35 (f5 (f6 f48 ?v0) ?v1)) ?v2) (f5 (f6 f48 (f5 (f6 f35 ?v0) ?v2)) (f5 (f6 f35 ?v1) ?v2)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (= (f9 (f11 f12 (f9 (f11 f23 ?v0) ?v1)) ?v2) (f9 (f11 f23 (f9 (f11 f12 ?v0) ?v2)) (f9 (f11 f12 ?v1) ?v2)))))
(assert (forall ((?v0 S10) (?v1 S10) (?v2 S10) (?v3 S10)) (let ((?v_0 (f43 f44 ?v0)) (?v_1 (f43 f44 ?v1))) (= (and (not (= ?v0 ?v1)) (not (= ?v2 ?v3))) (not (= (f15 (f43 f46 (f15 ?v_0 ?v2)) (f15 ?v_1 ?v3)) (f15 (f43 f46 (f15 ?v_0 ?v3)) (f15 ?v_1 ?v2))))))))
(assert (forall ((?v0 S4) (?v1 S4) (?v2 S4) (?v3 S4)) (let ((?v_0 (f6 f35 ?v0)) (?v_1 (f6 f35 ?v1))) (= (and (not (= ?v0 ?v1)) (not (= ?v2 ?v3))) (not (= (f5 (f6 f48 (f5 ?v_0 ?v2)) (f5 ?v_1 ?v3)) (f5 (f6 f48 (f5 ?v_0 ?v3)) (f5 ?v_1 ?v2))))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2) (?v3 S2)) (let ((?v_0 (f11 f12 ?v0)) (?v_1 (f11 f12 ?v1))) (= (and (not (= ?v0 ?v1)) (not (= ?v2 ?v3))) (not (= (f9 (f11 f23 (f9 ?v_0 ?v2)) (f9 ?v_1 ?v3)) (f9 (f11 f23 (f9 ?v_0 ?v3)) (f9 ?v_1 ?v2))))))))
(assert (forall ((?v0 S10) (?v1 S10) (?v2 S10)) (let ((?v_0 (f43 f44 ?v0))) (= (f15 ?v_0 (f15 (f43 f46 ?v1) ?v2)) (f15 (f43 f46 (f15 ?v_0 ?v1)) (f15 ?v_0 ?v2))))))
(assert (forall ((?v0 S4) (?v1 S4) (?v2 S4)) (let ((?v_0 (f6 f35 ?v0))) (= (f5 ?v_0 (f5 (f6 f48 ?v1) ?v2)) (f5 (f6 f48 (f5 ?v_0 ?v1)) (f5 ?v_0 ?v2))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f11 f12 ?v0))) (= (f9 ?v_0 (f9 (f11 f23 ?v1) ?v2)) (f9 (f11 f23 (f9 ?v_0 ?v1)) (f9 ?v_0 ?v2))))))
(assert (forall ((?v0 S2)) (= (f9 (f11 f12 ?v0) f53) ?v0)))
(assert (forall ((?v0 S4)) (= (f5 (f6 f35 ?v0) f36) ?v0)))
(assert (forall ((?v0 S10)) (= (f15 (f43 f44 ?v0) f54) ?v0)))
(assert (forall ((?v0 S2)) (= (f9 (f11 f12 f53) ?v0) ?v0)))
(assert (forall ((?v0 S4)) (= (f5 (f6 f35 f36) ?v0) ?v0)))
(assert (forall ((?v0 S10)) (= (f15 (f43 f44 f54) ?v0) ?v0)))
(assert (forall ((?v0 S10) (?v1 S10) (?v2 S2)) (= (f40 (f41 f42 (f15 (f43 f44 ?v0) ?v1)) ?v2) (f15 (f43 f44 (f40 (f41 f42 ?v0) ?v2)) (f40 (f41 f42 ?v1) ?v2)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (= (f9 (f11 f45 (f9 (f11 f12 ?v0) ?v1)) ?v2) (f9 (f11 f12 (f9 (f11 f45 ?v0) ?v2)) (f9 (f11 f45 ?v1) ?v2)))))
(assert (forall ((?v0 S4) (?v1 S4) (?v2 S2)) (= (f3 (f19 f20 (f5 (f6 f35 ?v0) ?v1)) ?v2) (f5 (f6 f35 (f3 (f19 f20 ?v0) ?v2)) (f3 (f19 f20 ?v1) ?v2)))))
(assert (forall ((?v0 S10) (?v1 S2) (?v2 S2)) (let ((?v_0 (f41 f42 ?v0))) (= (f40 (f41 f42 (f40 ?v_0 ?v1)) ?v2) (f40 ?v_0 (f9 (f11 f12 ?v1) ?v2))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f11 f45 ?v0))) (= (f9 (f11 f45 (f9 ?v_0 ?v1)) ?v2) (f9 ?v_0 (f9 (f11 f12 ?v1) ?v2))))))
(assert (forall ((?v0 S4) (?v1 S2) (?v2 S2)) (let ((?v_0 (f19 f20 ?v0))) (= (f3 (f19 f20 (f3 ?v_0 ?v1)) ?v2) (f3 ?v_0 (f9 (f11 f12 ?v1) ?v2))))))
(assert (forall ((?v0 S10) (?v1 S10) (?v2 S10) (?v3 S10) (?v4 S10)) (let ((?v_0 (f43 f44 ?v0))) (=> (not (= ?v0 f51)) (=> (and (= ?v1 ?v2) (not (= ?v3 ?v4))) (not (= (f15 (f43 f46 ?v1) (f15 ?v_0 ?v3)) (f15 (f43 f46 ?v2) (f15 ?v_0 ?v4)))))))))
(assert (forall ((?v0 S4) (?v1 S4) (?v2 S4) (?v3 S4) (?v4 S4)) (let ((?v_0 (f6 f35 ?v0))) (=> (not (= ?v0 f52)) (=> (and (= ?v1 ?v2) (not (= ?v3 ?v4))) (not (= (f5 (f6 f48 ?v1) (f5 ?v_0 ?v3)) (f5 (f6 f48 ?v2) (f5 ?v_0 ?v4)))))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2) (?v3 S2) (?v4 S2)) (let ((?v_0 (f11 f12 ?v0))) (=> (not (= ?v0 f34)) (=> (and (= ?v1 ?v2) (not (= ?v3 ?v4))) (not (= (f9 (f11 f23 ?v1) (f9 ?v_0 ?v3)) (f9 (f11 f23 ?v2) (f9 ?v_0 ?v4)))))))))
(assert (forall ((?v0 S10) (?v1 S10)) (= (= (f15 (f43 f46 (f15 (f43 f44 ?v0) ?v0)) (f15 (f43 f44 ?v1) ?v1)) f51) (and (= ?v0 f51) (= ?v1 f51)))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (f9 (f11 f23 (f9 (f11 f12 ?v0) ?v1)) ?v1) (f9 (f11 f12 (f9 (f11 f23 ?v0) f53)) ?v1))))
(assert (forall ((?v0 S4) (?v1 S4)) (= (f5 (f6 f48 (f5 (f6 f35 ?v0) ?v1)) ?v1) (f5 (f6 f35 (f5 (f6 f48 ?v0) f36)) ?v1))))
(assert (forall ((?v0 S10) (?v1 S10)) (= (f15 (f43 f46 (f15 (f43 f44 ?v0) ?v1)) ?v1) (f15 (f43 f44 (f15 (f43 f46 ?v0) f54)) ?v1))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (f9 (f11 f23 ?v0) (f9 (f11 f12 ?v1) ?v0)) (f9 (f11 f12 (f9 (f11 f23 ?v1) f53)) ?v0))))
(assert (forall ((?v0 S4) (?v1 S4)) (= (f5 (f6 f48 ?v0) (f5 (f6 f35 ?v1) ?v0)) (f5 (f6 f35 (f5 (f6 f48 ?v1) f36)) ?v0))))
(assert (forall ((?v0 S10) (?v1 S10)) (= (f15 (f43 f46 ?v0) (f15 (f43 f44 ?v1) ?v0)) (f15 (f43 f44 (f15 (f43 f46 ?v1) f54)) ?v0))))
(assert (forall ((?v0 S2)) (= (f9 (f11 f23 ?v0) ?v0) (f9 (f11 f12 (f9 (f11 f23 f53) f53)) ?v0))))
(assert (forall ((?v0 S4)) (= (f5 (f6 f48 ?v0) ?v0) (f5 (f6 f35 (f5 (f6 f48 f36) f36)) ?v0))))
(assert (forall ((?v0 S10)) (= (f15 (f43 f46 ?v0) ?v0) (f15 (f43 f44 (f15 (f43 f46 f54) f54)) ?v0))))
(assert (= f51 (f15 f47 f18)))
(assert (= f52 (f49 f50 f18)))
(assert (forall ((?v0 S10) (?v1 S2)) (let ((?v_0 (f41 f42 ?v0))) (= (f15 (f43 f44 (f40 ?v_0 ?v1)) ?v0) (f40 ?v_0 (f9 f10 ?v1))))))
(assert (forall ((?v0 S2) (?v1 S2)) (let ((?v_0 (f11 f45 ?v0))) (= (f9 (f11 f12 (f9 ?v_0 ?v1)) ?v0) (f9 ?v_0 (f9 f10 ?v1))))))
(assert (forall ((?v0 S4) (?v1 S2)) (let ((?v_0 (f19 f20 ?v0))) (= (f5 (f6 f35 (f3 ?v_0 ?v1)) ?v0) (f3 ?v_0 (f9 f10 ?v1))))))
(assert (forall ((?v0 S10) (?v1 S2)) (let ((?v_0 (f41 f42 ?v0))) (= (f15 (f43 f44 ?v0) (f40 ?v_0 ?v1)) (f40 ?v_0 (f9 f10 ?v1))))))
(assert (forall ((?v0 S2) (?v1 S2)) (let ((?v_0 (f11 f45 ?v0))) (= (f9 (f11 f12 ?v0) (f9 ?v_0 ?v1)) (f9 ?v_0 (f9 f10 ?v1))))))
(assert (forall ((?v0 S4) (?v1 S2)) (let ((?v_0 (f19 f20 ?v0))) (= (f5 (f6 f35 ?v0) (f3 ?v_0 ?v1)) (f3 ?v_0 (f9 f10 ?v1))))))
(assert (forall ((?v0 S10) (?v1 S2)) (let ((?v_0 (f41 f42 ?v0))) (= (f40 ?v_0 (f9 f10 ?v1)) (f15 (f43 f44 ?v0) (f40 ?v_0 ?v1))))))
(assert (forall ((?v0 S2) (?v1 S2)) (let ((?v_0 (f11 f45 ?v0))) (= (f9 ?v_0 (f9 f10 ?v1)) (f9 (f11 f12 ?v0) (f9 ?v_0 ?v1))))))
(assert (forall ((?v0 S4) (?v1 S2)) (let ((?v_0 (f19 f20 ?v0))) (= (f3 ?v_0 (f9 f10 ?v1)) (f5 (f6 f35 ?v0) (f3 ?v_0 ?v1))))))
(assert (forall ((?v0 S2)) (= (f9 (f11 f45 ?v0) f34) f53)))
(assert (forall ((?v0 S4)) (= (f3 (f19 f20 ?v0) f34) f36)))
(assert (forall ((?v0 S10)) (= (f40 (f41 f42 ?v0) f34) f54)))
(assert (forall ((?v0 S10) (?v1 S2) (?v2 S2)) (let ((?v_0 (f41 f42 ?v0))) (= (f15 (f43 f44 (f40 ?v_0 ?v1)) (f40 ?v_0 ?v2)) (f40 ?v_0 (f9 (f11 f23 ?v1) ?v2))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f11 f45 ?v0))) (= (f9 (f11 f12 (f9 ?v_0 ?v1)) (f9 ?v_0 ?v2)) (f9 ?v_0 (f9 (f11 f23 ?v1) ?v2))))))
(assert (forall ((?v0 S4) (?v1 S2) (?v2 S2)) (let ((?v_0 (f19 f20 ?v0))) (= (f5 (f6 f35 (f3 ?v_0 ?v1)) (f3 ?v_0 ?v2)) (f3 ?v_0 (f9 (f11 f23 ?v1) ?v2))))))
(assert (= (f13 f14 f18) f34))
(assert (= f34 (f13 f14 f18)))
(assert (= f36 (f49 f50 (f15 f17 f18))))
(assert (= f54 (f15 f47 (f15 f17 f18))))
(assert (forall ((?v0 S10)) (= (f40 (f41 f42 ?v0) (f13 f14 (f15 f17 (f15 f17 f18)))) (f15 (f43 f44 (f15 (f43 f44 ?v0) ?v0)) ?v0))))
(assert (forall ((?v0 S2)) (= (f9 (f11 f45 ?v0) (f13 f14 (f15 f17 (f15 f17 f18)))) (f9 (f11 f12 (f9 (f11 f12 ?v0) ?v0)) ?v0))))
(assert (forall ((?v0 S4)) (= (f3 (f19 f20 ?v0) (f13 f14 (f15 f17 (f15 f17 f18)))) (f5 (f6 f35 (f5 (f6 f35 ?v0) ?v0)) ?v0))))
(assert (= (f13 f14 (f15 f17 (f15 f17 f18))) (f9 f10 (f9 f10 (f9 f10 f34)))))
(assert (= (f13 f14 (f15 f17 f18)) (f9 f10 f34)))
(assert (forall ((?v0 S2)) (= (f9 f10 (f9 f10 (f9 f10 ?v0))) (f9 (f11 f23 (f13 f14 (f15 f17 (f15 f17 f18)))) ?v0))))
(assert (forall ((?v0 S10)) (= (= (f40 (f41 f42 ?v0) (f13 f14 (f15 f16 (f15 f17 f18)))) f51) (= ?v0 f51))))
(assert (forall ((?v0 S4)) (= (= (f3 (f19 f20 ?v0) (f13 f14 (f15 f16 (f15 f17 f18)))) f52) (= ?v0 f52))))
(check-sat)
(exit)
