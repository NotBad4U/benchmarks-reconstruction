...
(assert (forall ((?v0 S11) (?v1 S2)) (let ((?v_1 (f14 f15 (f16 f17 (f16 f18 f19)))) (?v_0 (f37 f38 ?v0))) (= (f36 ?v_0 (f11 f23 (f11 (f12 f13 ?v_1) ?v1))) (f16 (f39 f40 ?v0) (f36 (f37 f38 (f36 ?v_0 ?v1)) ?v_1))))))
(assert (forall ((?v0 S2) (?v1 S2)) (let ((?v_1 (f14 f15 (f16 f17 (f16 f18 f19)))) (?v_0 (f12 f41 ?v0))) (= (f11 ?v_0 (f11 f23 (f11 (f12 f13 ?v_1) ?v1))) (f11 (f12 f13 ?v0) (f11 (f12 f41 (f11 ?v_0 ?v1)) ?v_1))))))
...
(assert (forall ((?v0 S11) (?v1 S2)) (let ((?v_0 (f37 f38 ?v0))) (let ((?v_1 (f36 ?v_0 ?v1))) (= (f36 ?v_0 (f11 f23 (f11 (f12 f13 (f14 f15 (f16 f17 (f16 f18 f19)))) ?v1))) (f16 (f39 f40 ?v0) (f16 (f39 f40 ?v_1) ?v_1)))))))
(assert (forall ((?v0 S2) (?v1 S2)) (let ((?v_0 (f12 f41 ?v0))) (let ((?v_1 (f11 ?v_0 ?v1))) (= (f11 ?v_0 (f11 f23 (f11 (f12 f13 (f14 f15 (f16 f17 (f16 f18 f19)))) ?v1))) (f11 (f12 f13 ?v0) (f11 (f12 f13 ?v_1) ?v_1)))))))
...
(assert (forall ((?v0 S11) (?v1 S2)) (let ((?v_0 (f37 f38 ?v0))) (let ((?v_1 (f36 ?v_0 ?v1))) (= (f36 ?v_0 (f11 (f12 f13 (f14 f15 (f16 f17 (f16 f18 f19)))) ?v1)) (f16 (f39 f40 ?v_1) ?v_1))))))
(assert (forall ((?v0 S2) (?v1 S2)) (let ((?v_0 (f12 f41 ?v0))) (let ((?v_1 (f11 ?v_0 ?v1))) (= (f11 ?v_0 (f11 (f12 f13 (f14 f15 (f16 f17 (f16 f18 f19)))) ?v1)) (f11 (f12 f13 ?v_1) ?v_1))))))
...
(assert (forall ((?v0 S11)) (let ((?v_0 (f16 f42 ?v0))) (= (f36 (f37 f38 ?v_0) (f14 f15 (f16 f17 (f16 f18 f19)))) (f16 (f39 f40 ?v_0) ?v_0)))))
(assert (forall ((?v0 S11)) (let ((?v_0 (f14 f15 ?v0))) (= (f11 (f12 f41 ?v_0) (f14 f15 (f16 f17 (f16 f18 f19)))) (f11 (f12 f13 ?v_0) ?v_0)))))
...
(assert (forall ((?v0 S11) (?v1 S2)) (let ((?v_1 (f14 f15 (f16 f17 (f16 f18 f19)))) (?v_0 (f37 f38 ?v0))) (= (f36 ?v_0 (f11 (f12 f13 ?v_1) ?v1)) (f36 (f37 f38 (f36 ?v_0 ?v1)) ?v_1)))))
(assert (forall ((?v0 S2) (?v1 S2)) (let ((?v_1 (f14 f15 (f16 f17 (f16 f18 f19)))) (?v_0 (f12 f41 ?v0))) (= (f11 ?v_0 (f11 (f12 f13 ?v_1) ?v1)) (f11 (f12 f41 (f11 ?v_0 ?v1)) ?v_1)))))
...
(assert (forall ((?v0 S11)) (= (f16 (f39 f40 ?v0) ?v0) (f36 (f37 f38 ?v0) (f14 f15 (f16 f17 (f16 f18 f19)))))))
(assert (forall ((?v0 S2)) (= (f11 (f12 f13 ?v0) ?v0) (f11 (f12 f41 ?v0) (f14 f15 (f16 f17 (f16 f18 f19)))))))
(assert (forall ((?v0 S4)) (= (f5 (f6 f7 ?v0) ?v0) (f3 (f8 f9 ?v0) (f14 f15 (f16 f17 (f16 f18 f19)))))))
(assert (forall ((?v0 S11)) (= (f36 (f37 f38 ?v0) (f14 f15 (f16 f17 (f16 f18 f19)))) (f16 (f39 f40 ?v0) ?v0))))
(assert (forall ((?v0 S2)) (= (f11 (f12 f41 ?v0) (f14 f15 (f16 f17 (f16 f18 f19)))) (f11 (f12 f13 ?v0) ?v0))))
(assert (forall ((?v0 S4)) (= (f3 (f8 f9 ?v0) (f14 f15 (f16 f17 (f16 f18 f19)))) (f5 (f6 f7 ?v0) ?v0))))
(assert (= (f11 (f12 f41 f33) (f14 f15 (f16 f17 (f16 f18 f19)))) f33))
(assert (= (f36 (f37 f38 f48) (f14 f15 (f16 f17 (f16 f18 f19)))) f48))
(assert (= (f3 (f8 f9 f49) (f14 f15 (f16 f17 (f16 f18 f19)))) f49))
(assert (forall ((?v0 S11)) (= (= (f36 (f37 f38 ?v0) (f14 f15 (f16 f17 (f16 f18 f19)))) f48) (= ?v0 f48))))
(assert (forall ((?v0 S4)) (= (= (f3 (f8 f9 ?v0) (f14 f15 (f16 f17 (f16 f18 f19)))) f49) (= ?v0 f49))))
(assert (forall ((?v0 S2)) (not (= (f3 f10 ?v0) f49))))
(assert (forall ((?v0 S2) (?v1 S2)) (let ((?v_0 (f14 f15 (f16 f17 (f16 f18 f19))))) (=> (= (f34 (f11 (f12 f41 ?v0) ?v_0) (f11 (f12 f41 ?v1) ?v_0)) f1) (=> (= (f35 f33 ?v1) f1) (= (f34 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S11) (?v1 S11)) (let ((?v_0 (f14 f15 (f16 f17 (f16 f18 f19))))) (=> (= (f50 (f36 (f37 f38 ?v0) ?v_0) (f36 (f37 f38 ?v1) ?v_0)) f1) (=> (= (f51 f48 ?v1) f1) (= (f50 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S11) (?v1 S11) (?v2 S11) (?v3 S11)) (let ((?v_0 (f39 f40 ?v0))) (= (f16 (f39 f40 (f16 ?v_0 ?v1)) (f16 (f39 f40 ?v2) ?v3)) (f16 (f39 f40 (f16 ?v_0 ?v2)) (f16 (f39 f40 ?v1) ?v3))))))
...
(assert (forall ((?v0 S11) (?v1 S11) (?v2 S11) (?v3 S11)) (let ((?v_1 (f39 f40 (f16 (f39 f40 ?v0) ?v1))) (?v_0 (f39 f40 ?v2))) (= (f16 ?v_1 (f16 ?v_0 ?v3)) (f16 ?v_0 (f16 ?v_1 ?v3))))))
...
(assert (forall ((?v0 S11) (?v1 S11) (?v2 S11) (?v3 S11)) (let ((?v_0 (f39 f40 ?v0)) (?v_1 (f16 (f39 f40 ?v2) ?v3))) (= (f16 (f39 f40 (f16 ?v_0 ?v1)) ?v_1) (f16 ?v_0 (f16 (f39 f40 ?v1) ?v_1))))))
...
(assert (forall ((?v0 S11) (?v1 S11) (?v2 S11)) (let ((?v_0 (f39 f40 ?v0))) (= (f16 (f39 f40 (f16 ?v_0 ?v1)) ?v2) (f16 (f39 f40 (f16 ?v_0 ?v2)) ?v1)))))
...
(assert (forall ((?v0 S11) (?v1 S11) (?v2 S11)) (let ((?v_0 (f39 f40 ?v0))) (= (f16 (f39 f40 (f16 ?v_0 ?v1)) ?v2) (f16 ?v_0 (f16 (f39 f40 ?v1) ?v2))))))
...
(assert (forall ((?v0 S11) (?v1 S11) (?v2 S11)) (let ((?v_0 (f39 f40 ?v0))) (= (f16 ?v_0 (f16 (f39 f40 ?v1) ?v2)) (f16 (f39 f40 (f16 ?v_0 ?v1)) ?v2)))))
...
(assert (forall ((?v0 S11) (?v1 S11) (?v2 S11)) (let ((?v_1 (f39 f40 ?v0)) (?v_0 (f39 f40 ?v1))) (= (f16 ?v_1 (f16 ?v_0 ?v2)) (f16 ?v_0 (f16 ?v_1 ?v2))))))
...
(assert (forall ((?v0 S11) (?v1 S11)) (= (f16 (f39 f40 ?v0) ?v1) (f16 (f39 f40 ?v1) ?v0))))
...
(assert (forall ((?v0 S11)) (= (= (f50 f48 (f36 (f37 f38 ?v0) (f14 f15 (f16 f17 (f16 f18 f19))))) f1) (not (= ?v0 f48)))))
(assert (forall ((?v0 S11)) (not (= (f50 (f36 (f37 f38 ?v0) (f14 f15 (f16 f17 (f16 f18 f19)))) f48) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (let ((?v_0 (f14 f15 (f16 f17 (f16 f18 f19))))) (=> (= (f11 (f12 f41 ?v0) ?v_0) (f11 (f12 f41 ?v1) ?v_0)) (=> (= (f35 f33 ?v0) f1) (=> (= (f35 f33 ?v1) f1) (= ?v0 ?v1)))))))
(assert (forall ((?v0 S11) (?v1 S11)) (let ((?v_0 (f14 f15 (f16 f17 (f16 f18 f19))))) (=> (= (f36 (f37 f38 ?v0) ?v_0) (f36 (f37 f38 ?v1) ?v_0)) (=> (= (f51 f48 ?v0) f1) (=> (= (f51 f48 ?v1) f1) (= ?v0 ?v1)))))))
(assert (forall ((?v0 S2) (?v1 S2)) (let ((?v_0 (f14 f15 (f16 f17 (f16 f18 f19))))) (=> (= (f35 (f11 (f12 f41 ?v0) ?v_0) (f11 (f12 f41 ?v1) ?v_0)) f1) (=> (= (f35 f33 ?v1) f1) (= (f35 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S11) (?v1 S11)) (let ((?v_0 (f14 f15 (f16 f17 (f16 f18 f19))))) (=> (= (f51 (f36 (f37 f38 ?v0) ?v_0) (f36 (f37 f38 ?v1) ?v_0)) f1) (=> (= (f51 f48 ?v1) f1) (= (f51 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S11)) (= (f51 f48 (f36 (f37 f38 ?v0) (f14 f15 (f16 f17 (f16 f18 f19))))) f1)))
