...
(assert (forall ((?v0 S8) (?v1 S11)) (let ((?v_0 (f57 f58 ?v0))) (= (= ?v_0 ?v1) (= ?v1 ?v_0)))))
(assert (forall ((?v0 S8) (?v1 S2)) (let ((?v_0 (f10 f11 ?v0))) (= (= ?v_0 ?v1) (= ?v1 ?v_0)))))
(assert (forall ((?v0 S8) (?v1 S8)) (let ((?v_0 (f12 f60 ?v0))) (= (= ?v_0 ?v1) (= ?v1 ?v_0)))))
(assert (forall ((?v0 S8) (?v1 S8)) (= (= (f12 f14 ?v0) (f12 f14 ?v1)) (= ?v0 ?v1))))
(assert (= (= f15 f15) true))
(assert (forall ((?v0 S8) (?v1 S8)) (= (= (f12 f13 ?v0) (f12 f13 ?v1)) (= ?v0 ?v1))))
(assert (forall ((?v0 S8)) (= (= (f12 (f51 f52 ?v0) ?v0) f63) (= ?v0 f63))))
(assert (forall ((?v0 S11)) (= (= (f53 (f54 f55 ?v0) ?v0) f64) (= ?v0 f64))))
(assert (forall ((?v0 S8) (?v1 S8) (?v2 S11)) (= (f53 (f54 f62 (f57 f58 ?v0)) (f53 (f54 f62 (f57 f58 ?v1)) ?v2)) (f53 (f54 f62 (f57 f58 (f12 (f51 f61 ?v0) ?v1))) ?v2))))
(assert (forall ((?v0 S8) (?v1 S8) (?v2 S8)) (= (f12 (f51 f61 (f12 f60 ?v0)) (f12 (f51 f61 (f12 f60 ?v1)) ?v2)) (f12 (f51 f61 (f12 f60 (f12 (f51 f61 ?v0) ?v1))) ?v2))))
(assert (forall ((?v0 S8) (?v1 S8)) (= (f53 (f54 f62 (f57 f58 ?v0)) (f57 f58 ?v1)) (f57 f58 (f12 (f51 f61 ?v0) ?v1)))))
(assert (forall ((?v0 S8) (?v1 S8)) (= (f12 (f51 f61 (f12 f60 ?v0)) (f12 f60 ?v1)) (f12 f60 (f12 (f51 f61 ?v0) ?v1)))))
(assert (forall ((?v0 S8) (?v1 S8)) (= (f57 f58 (f12 (f51 f61 ?v0) ?v1)) (f53 (f54 f62 (f57 f58 ?v0)) (f57 f58 ?v1)))))
(assert (forall ((?v0 S8) (?v1 S8)) (= (f12 f60 (f12 (f51 f61 ?v0) ?v1)) (f12 (f51 f61 (f12 f60 ?v0)) (f12 f60 ?v1)))))
(assert (forall ((?v0 S8) (?v1 S8) (?v2 S8)) (= (f12 (f51 f52 (f12 f60 ?v0)) (f12 (f51 f52 (f12 f60 ?v1)) ?v2)) (f12 (f51 f52 (f12 f60 (f12 (f51 f52 ?v0) ?v1))) ?v2))))
(assert (forall ((?v0 S8) (?v1 S8) (?v2 S11)) (= (f53 (f54 f55 (f57 f58 ?v0)) (f53 (f54 f55 (f57 f58 ?v1)) ?v2)) (f53 (f54 f55 (f57 f58 (f12 (f51 f52 ?v0) ?v1))) ?v2))))
(assert (forall ((?v0 S8) (?v1 S8)) (= (f12 (f51 f52 (f12 f60 ?v0)) (f12 f60 ?v1)) (f12 f60 (f12 (f51 f52 ?v0) ?v1)))))
(assert (forall ((?v0 S8) (?v1 S8)) (= (f53 (f54 f55 (f57 f58 ?v0)) (f57 f58 ?v1)) (f57 f58 (f12 (f51 f52 ?v0) ?v1)))))
(assert (forall ((?v0 S8) (?v1 S8)) (= (f12 f60 (f12 (f51 f52 ?v0) ?v1)) (f12 (f51 f52 (f12 f60 ?v0)) (f12 f60 ?v1)))))
(assert (forall ((?v0 S8) (?v1 S8)) (= (f57 f58 (f12 (f51 f52 ?v0) ?v1)) (f53 (f54 f55 (f57 f58 ?v0)) (f57 f58 ?v1)))))
...
(assert (forall ((?v0 S8) (?v1 S8)) (= (= (f12 (f51 f52 (f12 (f51 f61 ?v0) ?v0)) (f12 (f51 f61 ?v1) ?v1)) f63) (and (= ?v0 f63) (= ?v1 f63)))))
(assert (forall ((?v0 S11) (?v1 S11)) (= (= (f53 (f54 f55 (f53 (f54 f62 ?v0) ?v0)) (f53 (f54 f62 ?v1) ?v1)) f64) (and (= ?v0 f64) (= ?v1 f64)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S8)) (let ((?v_0 (f10 f11 ?v2))) (= (f6 (f7 f9 (f6 (f7 f8 ?v0) ?v1)) ?v_0) (f6 (f7 f8 (f6 (f7 f9 ?v0) ?v_0)) (f6 (f7 f9 ?v1) ?v_0))))))
(assert (forall ((?v0 S8) (?v1 S8) (?v2 S8)) (let ((?v_0 (f12 f60 ?v2))) (= (f12 (f51 f61 (f12 (f51 f52 ?v0) ?v1)) ?v_0) (f12 (f51 f52 (f12 (f51 f61 ?v0) ?v_0)) (f12 (f51 f61 ?v1) ?v_0))))))
(assert (forall ((?v0 S11) (?v1 S11) (?v2 S8)) (let ((?v_0 (f57 f58 ?v2))) (= (f53 (f54 f62 (f53 (f54 f55 ?v0) ?v1)) ?v_0) (f53 (f54 f55 (f53 (f54 f62 ?v0) ?v_0)) (f53 (f54 f62 ?v1) ?v_0))))))
(assert (forall ((?v0 S8) (?v1 S2) (?v2 S2)) (let ((?v_0 (f7 f9 (f10 f11 ?v0)))) (= (f6 ?v_0 (f6 (f7 f8 ?v1) ?v2)) (f6 (f7 f8 (f6 ?v_0 ?v1)) (f6 ?v_0 ?v2))))))
(assert (forall ((?v0 S8) (?v1 S8) (?v2 S8)) (let ((?v_0 (f51 f61 (f12 f60 ?v0)))) (= (f12 ?v_0 (f12 (f51 f52 ?v1) ?v2)) (f12 (f51 f52 (f12 ?v_0 ?v1)) (f12 ?v_0 ?v2))))))
(assert (forall ((?v0 S8) (?v1 S11) (?v2 S11)) (let ((?v_0 (f54 f62 (f57 f58 ?v0)))) (= (f53 ?v_0 (f53 (f54 f55 ?v1) ?v2)) (f53 (f54 f55 (f53 ?v_0 ?v1)) (f53 ?v_0 ?v2))))))
(assert (= (f57 f58 f15) f64))
(assert (= (f10 f11 f15) f48))
(assert (= (f12 f60 f15) f63))
(assert (= (f57 f58 f15) f64))
(assert (= (f12 f60 f15) f63))
(assert (= f64 (f57 f58 f15)))
(assert (= f63 (f12 f60 f15)))
(assert (forall ((?v0 S8)) (= (f12 (f51 f52 (f12 f60 f15)) ?v0) ?v0)))
(assert (forall ((?v0 S11)) (= (f53 (f54 f55 (f57 f58 f15)) ?v0) ?v0)))
(assert (forall ((?v0 S8)) (= (f12 (f51 f52 ?v0) (f12 f60 f15)) ?v0)))
(assert (forall ((?v0 S11)) (= (f53 (f54 f55 ?v0) (f57 f58 f15)) ?v0)))
(assert (= (f10 f11 f15) f48))
(assert (= f48 (f10 f11 f15)))
(assert (forall ((?v0 S8)) (let ((?v_0 (f12 f60 ?v0))) (= (f12 f60 (f12 f13 ?v0)) (f12 (f51 f52 (f12 (f51 f52 f63) ?v_0)) ?v_0)))))
(assert (forall ((?v0 S8)) (let ((?v_0 (f57 f58 ?v0))) (= (f57 f58 (f12 f13 ?v0)) (f53 (f54 f55 (f53 (f54 f55 f64) ?v_0)) ?v_0)))))
(assert (forall ((?v0 S8)) (let ((?v_0 (f57 f58 ?v0))) (= (f57 f58 (f12 f14 ?v0)) (f53 (f54 f55 (f53 (f54 f55 f56) ?v_0)) ?v_0)))))
(assert (forall ((?v0 S8)) (let ((?v_0 (f12 f60 ?v0))) (= (f12 f60 (f12 f14 ?v0)) (f12 (f51 f52 (f12 (f51 f52 f59) ?v_0)) ?v_0)))))
(assert (forall ((?v0 S11)) (= (f53 (f54 f62 (f57 f58 (f12 f14 f15))) ?v0) ?v0)))
(assert (forall ((?v0 S8)) (= (f12 (f51 f61 (f12 f60 (f12 f14 f15))) ?v0) ?v0)))
(check-sat)
(exit)
