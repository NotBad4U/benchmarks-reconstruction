...
(declare-fun f34 (S4 S5) S2)
(declare-fun f35 (S4 S5) S2)
(declare-fun f36 (S4) S14)
(declare-fun f37 (S8 S18) S1)
(declare-fun f38 (S9 S16) S18)
(declare-fun f39 () S16)
(declare-fun f40 () S12)
(declare-fun f41 (S19 S13) S13)
(declare-fun f42 (S20 S2) S19)
(declare-fun f43 () S20)
(declare-fun f44 (S14 S5) S1)
(declare-fun f45 (S14) S14)
(declare-fun f46 (S13) S14)
(declare-fun f47 (S22 S21) S9)
(declare-fun f48 () S22)
(assert (not (= f1 f2)))
...
(assert (forall ((?v0 S4) (?v1 S8)) (not (= (f15 f16 ?v0) (f18 f19 ?v1)))))
(assert (forall ((?v0 S8) (?v1 S4)) (not (= (f18 f19 ?v0) (f15 f16 ?v1)))))
(assert (forall ((?v0 S5) (?v1 S5) (?v2 S4)) (not (= (f7 (f12 f13 ?v0) ?v1) (f15 f16 ?v2)))))
(assert (forall ((?v0 S4) (?v1 S5) (?v2 S5)) (not (= (f15 f16 ?v0) (f7 (f12 f13 ?v1) ?v2)))))
(assert (forall ((?v0 S8) (?v1 S5) (?v2 S4)) (not (= (f7 (f8 f9 ?v0) ?v1) (f15 f16 ?v2)))))
(assert (forall ((?v0 S13) (?v1 S4)) (=> (= (f31 ?v0 f32) f1) (= (= (f24 (f18 f19 (f10 f11 ?v1)) (f33 (f26 (f27 f28) ?v0))) f1) (= (f29 ?v1 f30) f1)))))
(assert (forall ((?v0 S4) (?v1 S5) (?v2 S13)) (=> (= (f3 (f34 ?v0 ?v1) (f22 ?v2)) f1) (=> (= (f29 ?v0 f30) f1) (= (f24 ?v1 (f26 (f27 f28) ?v2)) f1)))))
(assert (forall ((?v0 S4) (?v1 S5) (?v2 S13)) (let ((?v_0 (f33 (f26 (f27 f28) ?v2)))) (=> (= (f24 (f7 (f8 f9 (f10 f11 ?v0)) ?v1) ?v_0) f1) (=> (= (f29 ?v0 f30) f1) (= (f24 ?v1 ?v_0) f1))))))
(assert (forall ((?v0 S4) (?v1 S5) (?v2 S13)) (=> (not (= ?v0 f28)) (=> (= (f3 (f35 ?v0 ?v1) (f22 ?v2)) f1) (= (f24 ?v1 (f26 (f27 ?v0) ?v2)) f1)))))
(assert (forall ((?v0 S4)) (= (f24 (f18 f19 (f10 f11 ?v0)) (f36 ?v0)) f1)))
(assert (forall ((?v0 S4) (?v1 S8) (?v2 S5) (?v3 S4) (?v4 S8) (?v5 S5) (?v6 S13)) (let ((?v_0 (f12 f13 (f18 f19 ?v4)))) (=> (= (f3 (f4 f5 ?v0 (f7 (f8 f9 ?v1) (f7 (f12 f13 ?v2) (f7 (f12 f13 (f15 f16 ?v3)) (f7 ?v_0 ?v5))))) (f22 ?v6)) f1) (=> (= (f31 ?v6 f32) f1) (and (not (= (f37 ?v4 (f38 f11 f39)) f1)) (and (= ?v5 (f7 (f8 f9 (f10 f11 ?v3)) (f7 ?v_0 (f15 f16 ?v0)))) (= ?v1 (f10 f11 ?v0)))))))))
(assert (forall ((?v0 S13) (?v1 S4) (?v2 S4) (?v3 S8) (?v4 S4) (?v5 S8) (?v6 S5)) (let ((?v_1 (f18 f40 ?v3)) (?v_0 (f12 f13 (f15 f16 ?v4))) (?v_2 (f22 ?v0))) (=> (= (f31 ?v0 f32) f1) (=> (not (= ?v1 f5)) (=> (= (f3 (f4 ?v2 ?v1 (f7 (f8 f9 (f10 f11 ?v1)) (f7 (f12 f13 ?v_1) (f7 ?v_0 (f7 (f12 f13 (f18 f19 ?v5)) ?v6))))) ?v_2) f1) (=> (= (f3 (f4 ?v1 f5 (f7 (f12 f13 (f15 f16 ?v1)) (f7 ?v_0 ?v_1))) ?v_2) f1) (= (f31 (f41 (f42 f43 (f4 ?v1 ?v4 ?v6)) ?v0) f32) f1))))))))
(assert (forall ((?v0 S14) (?v1 S5) (?v2 S8)) (let ((?v_0 (f45 ?v0))) (=> (= (f44 ?v_0 ?v1) f1) (=> (= (f44 ?v0 (f18 f19 ?v2)) f1) (= (f44 ?v_0 (f7 (f8 f9 ?v2) ?v1)) f1))))))
(assert (forall ((?v0 S5) (?v1 S13)) (=> (= (f24 ?v0 (f25 (f26 (f27 f28) ?v1))) f1) (= (f24 ?v0 (f46 ?v1)) f1))))
(assert (forall ((?v0 S21) (?v1 S4) (?v2 S13)) (= (f24 (f18 f19 (f10 (f47 f48 ?v0) ?v1)) (f26 (f27 f28) ?v2)) f1)))
(assert (forall ((?v0 S5) (?v1 S14)) (=> (= (f24 ?v0 ?v1) f1) (= (f24 ?v0 (f33 ?v1)) f1))))
(assert (forall ((?v0 S14) (?v1 S5)) (=> (= (f44 ?v0 ?v1) f1) (= (f44 (f45 ?v0) ?v1) f1))))
(assert (forall ((?v0 S5) (?v1 S5) (?v2 S14)) (let ((?v_0 (f33 ?v2))) (=> (= (f24 (f7 (f12 f13 ?v0) ?v1) ?v_0) f1) (=> (=> (= (f24 ?v0 ?v_0) f1) (=> (= (f24 ?v1 ?v_0) f1) false)) false)))))
(assert (forall ((?v0 S5) (?v1 S5) (?v2 S13)) (let ((?v_0 (f46 ?v2))) (=> (= (f24 (f7 (f12 f13 ?v0) ?v1) ?v_0) f1) (=> (=> (= (f24 ?v0 ?v_0) f1) (=> (= (f24 ?v1 ?v_0) f1) false)) false)))))
(assert (forall ((?v0 S14) (?v1 S5) (?v2 S5)) (let ((?v_0 (f45 ?v0))) (=> (= (f44 ?v_0 ?v1) f1) (=> (= (f44 ?v_0 ?v2) f1) (= (f44 ?v_0 (f7 (f12 f13 ?v1) ?v2)) f1))))))
(assert (forall ((?v0 S14) (?v1 S4)) (= (f44 (f45 ?v0) (f15 f16 ?v1)) f1)))
(assert (forall ((?v0 S4) (?v1 S13)) (= (f24 (f18 f19 (f10 f11 ?v0)) (f46 ?v1)) f1)))
(assert (forall ((?v0 S21) (?v1 S4) (?v2 S13)) (= (f24 (f18 f19 (f10 (f47 f48 ?v0) ?v1)) (f46 ?v2)) f1)))
(assert (forall ((?v0 S21) (?v1 S4) (?v2 S4)) (= (f24 (f18 f19 (f10 (f47 f48 ?v0) ?v1)) (f36 ?v2)) f1)))
(assert (forall ((?v0 S4) (?v1 S5) (?v2 S4) (?v3 S5)) (not (= (f35 ?v0 ?v1) (f34 ?v2 ?v3)))))
(assert (forall ((?v0 S4) (?v1 S5) (?v2 S4) (?v3 S5)) (not (= (f34 ?v0 ?v1) (f35 ?v2 ?v3)))))
(assert (forall ((?v0 S14)) (let ((?v_0 (f33 ?v0))) (= (f33 ?v_0) ?v_0))))
(assert (forall ((?v0 S4) (?v1 S5) (?v2 S13)) (= (f46 (f41 (f42 f43 (f35 ?v0 ?v1)) ?v2)) (f46 ?v2))))
(assert (forall ((?v0 S8) (?v1 S8)) (= (= (f18 f40 ?v0) (f18 f40 ?v1)) (= ?v0 ?v1))))
(assert (forall ((?v0 S4) (?v1 S5) (?v2 S4) (?v3 S5)) (= (= (f35 ?v0 ?v1) (f35 ?v2 ?v3)) (and (= ?v0 ?v2) (= ?v1 ?v3)))))
(check-sat)
(exit)
