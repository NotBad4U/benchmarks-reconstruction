...
(declare-fun f109 (S70 S15) S14)
(declare-fun f110 (S71 S72) S1)
(declare-fun f111 (S18 S18) S71)
(declare-fun f112 (S16 S70) S72)
(declare-fun f113 (S73 S3) S2)
(declare-fun f114 (S74 S75) S1)
(declare-fun f115 (S6 S6) S74)
(declare-fun f116 (S4 S73) S75)
(declare-fun f117 (S76 S27) S26)
(declare-fun f118 (S77 S78) S1)
(declare-fun f119 (S30 S30) S77)
(declare-fun f120 (S28 S76) S78)
(declare-fun f121 (S79 S42) S28)
(declare-fun f122 (S80 S79) S26)
(declare-fun f123 (S43) S80)
(declare-fun f124 (S81 S9) S4)
(declare-fun f125 (S82 S81) S2)
(declare-fun f126 (S10) S82)
(declare-fun f127 (S83 S33) S16)
(declare-fun f128 (S84 S83) S14)
(declare-fun f129 (S34) S84)
(declare-fun f130 (S85 S42) S42)
(declare-fun f131 (S42) S85)
(declare-fun f132 (S53) S1)
(declare-fun f133 (S10) S10)
(declare-fun f134 (S87 S86) S54)
(declare-fun f135 (S88 S86) S87)
(declare-fun f136 (S89 S38) S88)
...
(assert (forall ((?v0 S14)) (= (forall ((?v1 S18)) (= (f90 ?v0 ?v1) f1)) (forall ((?v1 S15) (?v2 S15)) (= (f90 ?v0 (f21 (f22 f23 ?v1) ?v2)) f1)))))
...
(assert (forall ((?v0 S14) (?v1 S18)) (=> (forall ((?v2 S15) (?v3 S33) (?v4 S47) (?v5 S42)) (= (f90 ?v0 (f21 (f22 f23 ?v2) (f42 (f43 f44 ?v3) (f61 (f62 f63 ?v4) ?v5)))) f1)) (= (f90 ?v0 ?v1) f1))))
...
(assert (forall ((?v0 S14) (?v1 S18)) (=> (forall ((?v2 S15) (?v3 S33) (?v4 S33)) (= (f90 ?v0 (f21 (f22 f23 ?v2) (f42 (f43 f44 ?v3) ?v4))) f1)) (= (f90 ?v0 ?v1) f1))))
...
(assert (forall ((?v0 S16) (?v1 S15) (?v2 S15) (?v3 S15) (?v4 S70)) (let ((?v_0 (f22 f23 ?v1))) (=> (= (f17 ?v0 ?v1) f1) (=> (= (f20 (f21 (f22 f23 ?v2) ?v3) (f109 ?v4 ?v1)) f1) (= (f110 (f111 (f21 ?v_0 ?v2) (f21 ?v_0 ?v3)) (f112 ?v0 ?v4)) f1))))))
(assert (forall ((?v0 S4) (?v1 S3) (?v2 S3) (?v3 S3) (?v4 S73)) (let ((?v_0 (f8 f9 ?v1))) (=> (= (f3 ?v0 ?v1) f1) (=> (= (f6 (f7 (f8 f9 ?v2) ?v3) (f113 ?v4 ?v1)) f1) (= (f114 (f115 (f7 ?v_0 ?v2) (f7 ?v_0 ?v3)) (f116 ?v0 ?v4)) f1))))))
(assert (forall ((?v0 S28) (?v1 S27) (?v2 S27) (?v3 S27) (?v4 S76)) (let ((?v_0 (f36 f37 ?v1))) (=> (= (f31 ?v0 ?v1) f1) (=> (= (f34 (f35 (f36 f37 ?v2) ?v3) (f117 ?v4 ?v1)) f1) (= (f118 (f119 (f35 ?v_0 ?v2) (f35 ?v_0 ?v3)) (f120 ?v0 ?v4)) f1))))))
(assert (forall ((?v0 S43) (?v1 S42) (?v2 S42) (?v3 S42) (?v4 S79)) (let ((?v_0 (f56 f57 ?v1))) (=> (= (f51 ?v0 ?v1) f1) (=> (= (f54 (f55 (f56 f57 ?v2) ?v3) (f121 ?v4 ?v1)) f1) (= (f34 (f35 (f36 f37 (f55 ?v_0 ?v2)) (f55 ?v_0 ?v3)) (f122 (f123 ?v0) ?v4)) f1))))))
(assert (forall ((?v0 S10) (?v1 S9) (?v2 S9) (?v3 S9) (?v4 S81)) (let ((?v_0 (f15 f16 ?v1))) (=> (= (f10 ?v0 ?v1) f1) (=> (= (f13 (f14 (f15 f16 ?v2) ?v3) (f124 ?v4 ?v1)) f1) (= (f6 (f7 (f8 f9 (f14 ?v_0 ?v2)) (f14 ?v_0 ?v3)) (f125 (f126 ?v0) ?v4)) f1))))))
...
(assert (forall ((?v0 S51) (?v1 S47) (?v2 S52) (?v3 S38) (?v4 S53) (?v5 S53)) (=> (= (f64 ?v0 ?v1 ?v2 ?v3 ?v4) f1) (=> (= (f132 ?v4) f1) (= (f64 ?v0 ?v1 ?v2 (f68 f98 ?v3) ?v5) f1)))))
(assert (forall ((?v0 S38) (?v1 S47) (?v2 S42) (?v3 S38) (?v4 S47) (?v5 S42) (?v6 S51) (?v7 S42)) (let ((?v_0 (f49 f50 ?v0)) (?v_1 (f62 f63 ?v1)) (?v_2 (f49 f50 ?v3)) (?v_3 (f62 f63 ?v4)) (?v_5 (f133 (f89 ?v6))) (?v_4 (f131 ?v7))) (=> (= (f27 (f28 (f29 f30 (f48 ?v_0 (f61 ?v_1 ?v2))) (f48 ?v_2 (f61 ?v_3 ?v5))) ?v_5) f1) (= (f27 (f28 (f29 f30 (f48 ?v_0 (f61 ?v_1 (f130 ?v_4 ?v2)))) (f48 ?v_2 (f61 ?v_3 (f130 ?v_4 ?v5)))) ?v_5) f1)))))
(assert (forall ((?v0 S59) (?v1 S86) (?v2 S86) (?v3 S38) (?v4 S33) (?v5 S51)) (let ((?v_0 (f68 f98 ?v3))) (= (f27 (f28 (f29 f30 (f48 (f49 f50 (f68 (f134 (f135 (f136 f137 (f72 f73 ?v0)) ?v1) ?v2) ?v_0)) ?v4)) (f48 (f49 f50 ?v_0) ?v4)) (f89 ?v5)) f1))))
...
(assert (forall ((?v0 S14)) (= (exists ((?v1 S18)) (= (f90 ?v0 ?v1) f1)) (exists ((?v1 S15) (?v2 S15)) (= (f90 ?v0 (f21 (f22 f23 ?v1) ?v2)) f1)))))
