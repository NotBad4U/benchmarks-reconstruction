...
(declare-fun f111 (S69 S15) S14)
(declare-fun f112 (S70 S71) S1)
(declare-fun f113 (S18 S18) S70)
(declare-fun f114 (S16 S69) S71)
(declare-fun f115 (S72 S3) S2)
(declare-fun f116 (S73 S74) S1)
(declare-fun f117 (S6 S6) S73)
(declare-fun f118 (S4 S72) S74)
(declare-fun f119 (S75 S27) S26)
(declare-fun f120 (S76 S77) S1)
(declare-fun f121 (S30 S30) S76)
(declare-fun f122 (S28 S75) S77)
(declare-fun f123 (S78 S42) S28)
(declare-fun f124 (S79 S78) S26)
(declare-fun f125 (S43) S79)
(declare-fun f126 (S80 S9) S4)
(declare-fun f127 (S81 S80) S2)
(declare-fun f128 (S10) S81)
(declare-fun f129 (S82 S33) S16)
(declare-fun f130 (S83 S82) S14)
(declare-fun f131 (S34) S83)
(declare-fun f132 (S84 S42) S42)
(declare-fun f133 (S42) S84)
(declare-fun f134 (S10) S10)
(declare-fun f135 (S85 S38) S60)
...
(assert (forall ((?v0 S16) (?v1 S15) (?v2 S15) (?v3 S15) (?v4 S69)) (let ((?v_0 (f22 f23 ?v1))) (=> (= (f17 ?v0 ?v1) f1) (=> (= (f20 (f21 (f22 f23 ?v2) ?v3) (f111 ?v4 ?v1)) f1) (= (f112 (f113 (f21 ?v_0 ?v2) (f21 ?v_0 ?v3)) (f114 ?v0 ?v4)) f1))))))
(assert (forall ((?v0 S4) (?v1 S3) (?v2 S3) (?v3 S3) (?v4 S72)) (let ((?v_0 (f8 f9 ?v1))) (=> (= (f3 ?v0 ?v1) f1) (=> (= (f6 (f7 (f8 f9 ?v2) ?v3) (f115 ?v4 ?v1)) f1) (= (f116 (f117 (f7 ?v_0 ?v2) (f7 ?v_0 ?v3)) (f118 ?v0 ?v4)) f1))))))
(assert (forall ((?v0 S28) (?v1 S27) (?v2 S27) (?v3 S27) (?v4 S75)) (let ((?v_0 (f36 f37 ?v1))) (=> (= (f31 ?v0 ?v1) f1) (=> (= (f34 (f35 (f36 f37 ?v2) ?v3) (f119 ?v4 ?v1)) f1) (= (f120 (f121 (f35 ?v_0 ?v2) (f35 ?v_0 ?v3)) (f122 ?v0 ?v4)) f1))))))
(assert (forall ((?v0 S43) (?v1 S42) (?v2 S42) (?v3 S42) (?v4 S78)) (let ((?v_0 (f56 f57 ?v1))) (=> (= (f51 ?v0 ?v1) f1) (=> (= (f54 (f55 (f56 f57 ?v2) ?v3) (f123 ?v4 ?v1)) f1) (= (f34 (f35 (f36 f37 (f55 ?v_0 ?v2)) (f55 ?v_0 ?v3)) (f124 (f125 ?v0) ?v4)) f1))))))
(assert (forall ((?v0 S10) (?v1 S9) (?v2 S9) (?v3 S9) (?v4 S80)) (let ((?v_0 (f15 f16 ?v1))) (=> (= (f10 ?v0 ?v1) f1) (=> (= (f13 (f14 (f15 f16 ?v2) ?v3) (f126 ?v4 ?v1)) f1) (= (f6 (f7 (f8 f9 (f14 ?v_0 ?v2)) (f14 ?v_0 ?v3)) (f127 (f128 ?v0) ?v4)) f1))))))
(assert (forall ((?v0 S34) (?v1 S33) (?v2 S33) (?v3 S33) (?v4 S82)) (let ((?v_0 (f43 f44 ?v1))) (=> (= (f38 ?v0 ?v1) f1) (=> (= (f41 (f42 (f43 f44 ?v2) ?v3) (f129 ?v4 ?v1)) f1) (= (f20 (f21 (f22 f23 (f42 ?v_0 ?v2)) (f42 ?v_0 ?v3)) (f130 (f131 ?v0) ?v4)) f1))))))
(assert (forall ((?v0 S38) (?v1 S47) (?v2 S42) (?v3 S38) (?v4 S47) (?v5 S42) (?v6 S52) (?v7 S42)) (let ((?v_0 (f49 f50 ?v0)) (?v_1 (f62 f63 ?v1)) (?v_2 (f49 f50 ?v3)) (?v_3 (f62 f63 ?v4)) (?v_5 (f88 ?v6)) (?v_4 (f133 ?v7))) (=> (= (f27 (f28 (f29 f30 (f48 ?v_0 (f61 ?v_1 ?v2))) (f48 ?v_2 (f61 ?v_3 ?v5))) ?v_5) f1) (= (f27 (f28 (f29 f30 (f48 ?v_0 (f61 ?v_1 (f132 ?v_4 ?v2)))) (f48 ?v_2 (f61 ?v_3 (f132 ?v_4 ?v5)))) ?v_5) f1)))))
...
(assert (forall ((?v0 S38) (?v1 S47) (?v2 S42) (?v3 S38) (?v4 S47) (?v5 S42) (?v6 S52) (?v7 S42)) (let ((?v_0 (f49 f50 ?v0)) (?v_1 (f62 f63 ?v1)) (?v_2 (f49 f50 ?v3)) (?v_3 (f62 f63 ?v4)) (?v_5 (f134 (f88 ?v6))) (?v_4 (f133 ?v7))) (=> (= (f27 (f28 (f29 f30 (f48 ?v_0 (f61 ?v_1 ?v2))) (f48 ?v_2 (f61 ?v_3 ?v5))) ?v_5) f1) (= (f27 (f28 (f29 f30 (f48 ?v_0 (f61 ?v_1 (f132 ?v_4 ?v2)))) (f48 ?v_2 (f61 ?v_3 (f132 ?v_4 ?v5)))) ?v_5) f1)))))
(assert (forall ((?v0 S52) (?v1 S47) (?v2 S53) (?v3 S38) (?v4 S38) (?v5 S51) (?v6 S38) (?v7 S51) (?v8 S51)) (let ((?v_0 (= (f86 ?v0 ?v5 ?v7) f1)) (?v_1 (= (f86 ?v0 ?v7 ?v5) f1))) (=> (= (f67 ?v0 ?v1 ?v2 ?v3 f66) f1) (=> (= (f67 ?v0 ?v1 ?v2 ?v4 ?v5) f1) (=> (= (f67 ?v0 ?v1 ?v2 ?v6 ?v7) f1) (=> (or ?v_0 ?v_1) (=> (=> ?v_0 (= ?v8 ?v7)) (=> (=> ?v_1 (= ?v8 ?v5)) (= (f67 ?v0 ?v1 ?v2 (f73 (f89 (f135 f136 ?v3) ?v4) ?v6) ?v8) f1))))))))))
(check-sat)
(exit)
