...
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f19 (f5 f14 ?v0) (f5 f14 ?v1)) f1) (= (f19 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (=> (= (f19 ?v0 ?v1) f1) (= (f19 (f5 (f6 f8 ?v0) ?v2) (f5 (f6 f8 ?v1) ?v2)) f1))))
(assert (= (f20 f21 (f5 f16 f17)) f25))
(assert (= f25 (f20 f21 (f5 f16 f17))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f30 (f20 f21 ?v0) (f20 f21 ?v1)) f1) (ite (= (f3 ?v0 ?v1) f1) true (= (f3 ?v0 f17) f1)))))
(assert (forall ((?v0 S2)) (= (= (f20 f21 ?v0) f28) (= (f3 ?v0 f17) f1))))
(assert (forall ((?v0 S2)) (= (= f28 (f20 f21 ?v0)) (= (f3 ?v0 f17) f1))))
(assert (forall ((?v0 S6)) (= (f22 (f23 f29 (f20 f21 (f5 f15 (f5 f16 f17)))) ?v0) (f22 (f23 f24 ?v0) ?v0))))
(assert (forall ((?v0 S6)) (= (f22 (f23 f29 ?v0) (f20 f21 (f5 f15 (f5 f16 f17)))) (f22 (f23 f24 ?v0) ?v0))))
(assert (= (f22 (f23 f24 f25) f25) (f20 f21 (f5 f15 (f5 f16 f17)))))
(assert (forall ((?v0 S2)) (= (= (f19 (f5 f14 ?v0) f4) f1) (= (f19 ?v0 f17) f1))))
(assert (forall ((?v0 S2)) (= (= (f19 f4 (f5 f14 ?v0)) f1) (= (f19 f17 ?v0) f1))))
(assert (forall ((?v0 S2)) (= (= (f19 (f5 (f6 f8 ?v0) ?v0) f4) f1) (= (f19 ?v0 f4) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (let ((?v_1 (f20 f21 ?v0)) (?v_0 (f20 f21 ?v1))) (= (= (f30 ?v_1 ?v_0) f1) (not (= (f27 ?v_0 ?v_1) f1))))))
(assert (forall ((?v0 S2) (?v1 S2)) (let ((?v_1 (f5 f14 ?v0)) (?v_0 (f5 f14 ?v1))) (= (= (f3 ?v_1 ?v_0) f1) (not (= (f19 ?v_0 ?v_1) f1))))))
(assert (forall ((?v0 S2)) (= (= (f19 (f5 f16 ?v0) f17) f1) (= (f19 ?v0 f17) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f19 (f5 f16 ?v0) (f5 f15 ?v1)) f1) (= (f19 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f19 (f5 f16 ?v0) (f5 f15 ?v1)) f1) (= (f19 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2)) (= (= (f19 (f5 f15 ?v0) f17) f1) (= (f19 ?v0 f17) f1))))
(assert (forall ((?v0 S2)) (= (= (f19 f17 (f5 f15 ?v0)) f1) (= (f19 f17 ?v0) f1))))
(assert (forall ((?v0 S2)) (= (= (f19 (f5 f16 ?v0) f4) f1) (= (f19 ?v0 f4) f1))))
(assert (= (= (f19 f17 f4) f1) false))
(assert (forall ((?v0 S2)) (= (= (f19 (f5 f15 ?v0) f4) f1) (= (f19 ?v0 f4) f1))))
(assert (= (f19 f4 f9) f1))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f6 f7 ?v2))) (=> (= (f19 ?v0 ?v1) f1) (=> (= (f19 f4 ?v2) f1) (= (f19 (f5 ?v_0 ?v0) (f5 ?v_0 ?v1)) f1))))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f19 ?v0 (f5 (f6 f8 ?v1) f9)) f1) (or (= (f19 ?v0 ?v1) f1) (= ?v0 ?v1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2) (?v3 S2)) (=> (= (f19 ?v0 ?v1) f1) (=> (= (f3 ?v2 ?v3) f1) (= (f19 (f5 (f6 f8 ?v0) ?v2) (f5 (f6 f8 ?v1) ?v3)) f1)))))
(assert (forall ((?v0 S6)) (not (= (f19 (f10 f11 ?v0) f4) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f19 ?v0 ?v1) f1) (= (f19 (f5 (f6 f13 ?v0) ?v1) f4) f1))))
(assert (forall ((?v0 S6) (?v1 S6) (?v2 S2)) (= (f5 (f6 f8 (f10 f11 ?v0)) (f5 (f6 f8 (f10 f11 ?v1)) ?v2)) (f5 (f6 f8 (f10 f11 (f22 (f23 f24 ?v0) ?v1))) ?v2))))
(assert (forall ((?v0 S6) (?v1 S6)) (= (f5 (f6 f8 (f10 f11 ?v0)) (f10 f11 ?v1)) (f10 f11 (f22 (f23 f24 ?v0) ?v1)))))
(assert (forall ((?v0 S6) (?v1 S6)) (= (f5 (f6 f8 (f10 f11 ?v0)) (f10 f11 ?v1)) (f10 f11 (f22 (f23 f24 ?v0) ?v1)))))
(check-sat)
(exit)
