...
(assert (forall ((?v0 Dag$) (?v1 Dag$) (?v2 Dag_ref_bool_fun_fun$) (?v3 Ref_bool_fun$)) (=> (and (less$ ?v0 ?v1) (and (less$b (fun_app$j ?v2 ?v1) ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less$ ?v4 ?v5) (less$b (fun_app$j ?v2 ?v4) (fun_app$j ?v2 ?v5))) ))) (less$b (fun_app$j ?v2 ?v0) ?v3)) ))
...
(assert (forall ((?v0 Ref_set$) (?v1 Ref_set$)) (=> (and (less_eq$ ?v0 ?v1) (finite$ ?v1)) (finite$ ?v0)) ))
(check-sat)
(exit)
