...
(declare-fun fun_app$g (Ref_bool_fun_ref_set_fun$ Ref_bool_fun$) Ref_set$)
(declare-fun fun_app$h (Ref_bool_fun_dag_fun$ Ref_bool_fun$) Dag$)
...
(assert (not (= (forall ((?v0 Dag$)) (=> (fun_app$a (dag$ p$ l$ r$) ?v0) (p$a ?v0)) ) (p$a t$))))
(assert (fun_app$a (dag$ p$ l$ r$) t$))
...
(assert (forall ((?v0 Ref$) (?v1 Ref_ref_fun$) (?v2 Ref_ref_fun$) (?v3 Dag$)) (=> (fun_app$a (dag$ ?v0 ?v1 ?v2) ?v3) (dag$a ?v3)) ))
(assert (forall ((?v0 Ref_ref_fun$) (?v1 Ref$) (?v2 Ref_ref_fun$) (?v3 Dag$)) (=> (fun_app$a (dag$ (fun_app$b ?v0 ?v1) ?v2 ?v0) ?v3) (not (member$ ?v1 (set_of$ ?v3)))) ))
...
(assert (forall ((?v0 Ref$) (?v1 Ref_ref_fun$) (?v2 Ref_ref_fun$) (?v3 Dag$) (?v4 Ref_ref_fun$) (?v5 Ref_ref_fun$)) (=> (and (fun_app$a (dag$ ?v0 ?v1 ?v2) ?v3) (forall ((?v6 Ref$)) (=> (member$ ?v6 (set_of$ ?v3)) (and (= (fun_app$b ?v4 ?v6) (fun_app$b ?v1 ?v6)) (= (fun_app$b ?v5 ?v6) (fun_app$b ?v2 ?v6)))) )) (fun_app$a (dag$ ?v0 ?v4 ?v5) ?v3)) ))
(assert (forall ((?v0 Ref$) (?v1 Ref_ref_fun$) (?v2 Ref_ref_fun$) (?v3 Dag$) (?v4 Ref_ref_fun$) (?v5 Ref_ref_fun$)) (=> (and (fun_app$a (dag$ ?v0 ?v1 ?v2) ?v3) (forall ((?v6 Ref$)) (=> (member$ ?v6 (set_of$ ?v3)) (and (= (fun_app$b ?v1 ?v6) (fun_app$b ?v4 ?v6)) (= (fun_app$b ?v2 ?v6) (fun_app$b ?v5 ?v6)))) )) (fun_app$a (dag$ ?v0 ?v4 ?v5) ?v3)) ))
(assert (forall ((?v0 Dag$) (?v1 Ref_ref_fun$) (?v2 Ref_ref_fun$) (?v3 Ref_ref_fun$) (?v4 Ref_ref_fun$) (?v5 Ref$)) (=> (forall ((?v6 Ref$)) (=> (member$ ?v6 (set_of$ ?v0)) (and (= (fun_app$b ?v1 ?v6) (fun_app$b ?v2 ?v6)) (= (fun_app$b ?v3 ?v6) (fun_app$b ?v4 ?v6)))) ) (= (fun_app$a (dag$ ?v5 ?v1 ?v3) ?v0) (fun_app$a (dag$ ?v5 ?v2 ?v4) ?v0))) ))
...
(assert (forall ((?v0 Ref_set$) (?v1 Ref_bool_fun_ref_set_fun$) (?v2 Ref_bool_fun$) (?v3 Ref_bool_fun$)) (=> (and (less_eq$ ?v0 (fun_app$g ?v1 ?v2)) (and (less_eq$a ?v2 ?v3) (forall ((?v4 Ref_bool_fun$) (?v5 Ref_bool_fun$)) (=> (less_eq$a ?v4 ?v5) (less_eq$ (fun_app$g ?v1 ?v4) (fun_app$g ?v1 ?v5))) ))) (less_eq$ ?v0 (fun_app$g ?v1 ?v3))) ))
(assert (forall ((?v0 Dag$) (?v1 Ref_bool_fun_dag_fun$) (?v2 Ref_bool_fun$) (?v3 Ref_bool_fun$)) (=> (and (less_eq$b ?v0 (fun_app$h ?v1 ?v2)) (and (less_eq$a ?v2 ?v3) (forall ((?v4 Ref_bool_fun$) (?v5 Ref_bool_fun$)) (=> (less_eq$a ?v4 ?v5) (less_eq$b (fun_app$h ?v1 ?v4) (fun_app$h ?v1 ?v5))) ))) (less_eq$b ?v0 (fun_app$h ?v1 ?v3))) ))
...
(assert (forall ((?v0 Ref_bool_fun$) (?v1 Dag_ref_bool_fun_fun$) (?v2 Dag$) (?v3 Dag$)) (=> (and (less_eq$a ?v0 (fun_app$j ?v1 ?v2)) (and (less_eq$b ?v2 ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less_eq$b ?v4 ?v5) (less_eq$a (fun_app$j ?v1 ?v4) (fun_app$j ?v1 ?v5))) ))) (less_eq$a ?v0 (fun_app$j ?v1 ?v3))) ))
...
(assert (forall ((?v0 Ref_set$) (?v1 Dag_ref_set_fun$) (?v2 Dag$) (?v3 Dag$)) (=> (and (less_eq$ ?v0 (fun_app$m ?v1 ?v2)) (and (less_eq$b ?v2 ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less_eq$b ?v4 ?v5) (less_eq$ (fun_app$m ?v1 ?v4) (fun_app$m ?v1 ?v5))) ))) (less_eq$ ?v0 (fun_app$m ?v1 ?v3))) ))
(assert (forall ((?v0 Dag$) (?v1 Ref_set_dag_fun$) (?v2 Ref_set$) (?v3 Ref_set$)) (=> (and (less_eq$b ?v0 (fun_app$n ?v1 ?v2)) (and (less_eq$ ?v2 ?v3) (forall ((?v4 Ref_set$) (?v5 Ref_set$)) (=> (less_eq$ ?v4 ?v5) (less_eq$b (fun_app$n ?v1 ?v4) (fun_app$n ?v1 ?v5))) ))) (less_eq$b ?v0 (fun_app$n ?v1 ?v3))) ))
...
(assert (forall ((?v0 Dag$) (?v1 Dag$) (?v2 Dag_ref_bool_fun_fun$) (?v3 Ref_bool_fun$)) (=> (and (less_eq$b ?v0 ?v1) (and (less_eq$a (fun_app$j ?v2 ?v1) ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less_eq$b ?v4 ?v5) (less_eq$a (fun_app$j ?v2 ?v4) (fun_app$j ?v2 ?v5))) ))) (less_eq$a (fun_app$j ?v2 ?v0) ?v3)) ))
(assert (forall ((?v0 Ref_bool_fun$) (?v1 Ref_bool_fun$) (?v2 Ref_bool_fun_ref_set_fun$) (?v3 Ref_set$)) (=> (and (less_eq$a ?v0 ?v1) (and (less_eq$ (fun_app$g ?v2 ?v1) ?v3) (forall ((?v4 Ref_bool_fun$) (?v5 Ref_bool_fun$)) (=> (less_eq$a ?v4 ?v5) (less_eq$ (fun_app$g ?v2 ?v4) (fun_app$g ?v2 ?v5))) ))) (less_eq$ (fun_app$g ?v2 ?v0) ?v3)) ))
(assert (forall ((?v0 Ref_bool_fun$) (?v1 Ref_bool_fun$) (?v2 Ref_bool_fun_dag_fun$) (?v3 Dag$)) (=> (and (less_eq$a ?v0 ?v1) (and (less_eq$b (fun_app$h ?v2 ?v1) ?v3) (forall ((?v4 Ref_bool_fun$) (?v5 Ref_bool_fun$)) (=> (less_eq$a ?v4 ?v5) (less_eq$b (fun_app$h ?v2 ?v4) (fun_app$h ?v2 ?v5))) ))) (less_eq$b (fun_app$h ?v2 ?v0) ?v3)) ))
...
(assert (forall ((?v0 Ref_set$) (?v1 Ref_set$) (?v2 Ref_set_dag_fun$) (?v3 Dag$)) (=> (and (less_eq$ ?v0 ?v1) (and (less_eq$b (fun_app$n ?v2 ?v1) ?v3) (forall ((?v4 Ref_set$) (?v5 Ref_set$)) (=> (less_eq$ ?v4 ?v5) (less_eq$b (fun_app$n ?v2 ?v4) (fun_app$n ?v2 ?v5))) ))) (less_eq$b (fun_app$n ?v2 ?v0) ?v3)) ))
(assert (forall ((?v0 Dag$) (?v1 Dag$) (?v2 Dag_ref_set_fun$) (?v3 Ref_set$)) (=> (and (less_eq$b ?v0 ?v1) (and (less_eq$ (fun_app$m ?v2 ?v1) ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less_eq$b ?v4 ?v5) (less_eq$ (fun_app$m ?v2 ?v4) (fun_app$m ?v2 ?v5))) ))) (less_eq$ (fun_app$m ?v2 ?v0) ?v3)) ))
...
(assert (forall ((?v0 Dag$) (?v1 Dag$) (?v2 Dag_ref_bool_fun_fun$) (?v3 Ref_bool_fun$)) (=> (and (less_eq$b ?v0 ?v1) (and (= (fun_app$j ?v2 ?v1) ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less_eq$b ?v4 ?v5) (less_eq$a (fun_app$j ?v2 ?v4) (fun_app$j ?v2 ?v5))) ))) (less_eq$a (fun_app$j ?v2 ?v0) ?v3)) ))
(assert (forall ((?v0 Ref_bool_fun$) (?v1 Ref_bool_fun$) (?v2 Ref_bool_fun_ref_set_fun$) (?v3 Ref_set$)) (=> (and (less_eq$a ?v0 ?v1) (and (= (fun_app$g ?v2 ?v1) ?v3) (forall ((?v4 Ref_bool_fun$) (?v5 Ref_bool_fun$)) (=> (less_eq$a ?v4 ?v5) (less_eq$ (fun_app$g ?v2 ?v4) (fun_app$g ?v2 ?v5))) ))) (less_eq$ (fun_app$g ?v2 ?v0) ?v3)) ))
(assert (forall ((?v0 Ref_bool_fun$) (?v1 Ref_bool_fun$) (?v2 Ref_bool_fun_dag_fun$) (?v3 Dag$)) (=> (and (less_eq$a ?v0 ?v1) (and (= (fun_app$h ?v2 ?v1) ?v3) (forall ((?v4 Ref_bool_fun$) (?v5 Ref_bool_fun$)) (=> (less_eq$a ?v4 ?v5) (less_eq$b (fun_app$h ?v2 ?v4) (fun_app$h ?v2 ?v5))) ))) (less_eq$b (fun_app$h ?v2 ?v0) ?v3)) ))
...
(assert (forall ((?v0 Ref_set$) (?v1 Ref_set$) (?v2 Ref_set_dag_fun$) (?v3 Dag$)) (=> (and (less_eq$ ?v0 ?v1) (and (= (fun_app$n ?v2 ?v1) ?v3) (forall ((?v4 Ref_set$) (?v5 Ref_set$)) (=> (less_eq$ ?v4 ?v5) (less_eq$b (fun_app$n ?v2 ?v4) (fun_app$n ?v2 ?v5))) ))) (less_eq$b (fun_app$n ?v2 ?v0) ?v3)) ))
(assert (forall ((?v0 Dag$) (?v1 Dag$) (?v2 Dag_ref_set_fun$) (?v3 Ref_set$)) (=> (and (less_eq$b ?v0 ?v1) (and (= (fun_app$m ?v2 ?v1) ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less_eq$b ?v4 ?v5) (less_eq$ (fun_app$m ?v2 ?v4) (fun_app$m ?v2 ?v5))) ))) (less_eq$ (fun_app$m ?v2 ?v0) ?v3)) ))
...
(assert (forall ((?v0 Ref_bool_fun$) (?v1 Dag_ref_bool_fun_fun$) (?v2 Dag$) (?v3 Dag$)) (=> (and (= ?v0 (fun_app$j ?v1 ?v2)) (and (less_eq$b ?v2 ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less_eq$b ?v4 ?v5) (less_eq$a (fun_app$j ?v1 ?v4) (fun_app$j ?v1 ?v5))) ))) (less_eq$a ?v0 (fun_app$j ?v1 ?v3))) ))
(assert (forall ((?v0 Ref_set$) (?v1 Ref_bool_fun_ref_set_fun$) (?v2 Ref_bool_fun$) (?v3 Ref_bool_fun$)) (=> (and (= ?v0 (fun_app$g ?v1 ?v2)) (and (less_eq$a ?v2 ?v3) (forall ((?v4 Ref_bool_fun$) (?v5 Ref_bool_fun$)) (=> (less_eq$a ?v4 ?v5) (less_eq$ (fun_app$g ?v1 ?v4) (fun_app$g ?v1 ?v5))) ))) (less_eq$ ?v0 (fun_app$g ?v1 ?v3))) ))
(assert (forall ((?v0 Dag$) (?v1 Ref_bool_fun_dag_fun$) (?v2 Ref_bool_fun$) (?v3 Ref_bool_fun$)) (=> (and (= ?v0 (fun_app$h ?v1 ?v2)) (and (less_eq$a ?v2 ?v3) (forall ((?v4 Ref_bool_fun$) (?v5 Ref_bool_fun$)) (=> (less_eq$a ?v4 ?v5) (less_eq$b (fun_app$h ?v1 ?v4) (fun_app$h ?v1 ?v5))) ))) (less_eq$b ?v0 (fun_app$h ?v1 ?v3))) ))
...
(assert (forall ((?v0 Dag$) (?v1 Ref_set_dag_fun$) (?v2 Ref_set$) (?v3 Ref_set$)) (=> (and (= ?v0 (fun_app$n ?v1 ?v2)) (and (less_eq$ ?v2 ?v3) (forall ((?v4 Ref_set$) (?v5 Ref_set$)) (=> (less_eq$ ?v4 ?v5) (less_eq$b (fun_app$n ?v1 ?v4) (fun_app$n ?v1 ?v5))) ))) (less_eq$b ?v0 (fun_app$n ?v1 ?v3))) ))
(assert (forall ((?v0 Ref_set$) (?v1 Dag_ref_set_fun$) (?v2 Dag$) (?v3 Dag$)) (=> (and (= ?v0 (fun_app$m ?v1 ?v2)) (and (less_eq$b ?v2 ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less_eq$b ?v4 ?v5) (less_eq$ (fun_app$m ?v1 ?v4) (fun_app$m ?v1 ?v5))) ))) (less_eq$ ?v0 (fun_app$m ?v1 ?v3))) ))
...
(assert (forall ((?v0 Dag$) (?v1 Ref_bool_fun_dag_fun$) (?v2 Ref_bool_fun$) (?v3 Ref_bool_fun$)) (=> (and (less$ ?v0 (fun_app$h ?v1 ?v2)) (and (less$b ?v2 ?v3) (forall ((?v4 Ref_bool_fun$) (?v5 Ref_bool_fun$)) (=> (less$b ?v4 ?v5) (less$ (fun_app$h ?v1 ?v4) (fun_app$h ?v1 ?v5))) ))) (less$ ?v0 (fun_app$h ?v1 ?v3))) ))
(assert (forall ((?v0 Ref_set$) (?v1 Ref_bool_fun_ref_set_fun$) (?v2 Ref_bool_fun$) (?v3 Ref_bool_fun$)) (=> (and (less$c ?v0 (fun_app$g ?v1 ?v2)) (and (less$b ?v2 ?v3) (forall ((?v4 Ref_bool_fun$) (?v5 Ref_bool_fun$)) (=> (less$b ?v4 ?v5) (less$c (fun_app$g ?v1 ?v4) (fun_app$g ?v1 ?v5))) ))) (less$c ?v0 (fun_app$g ?v1 ?v3))) ))
(assert (forall ((?v0 Ref_bool_fun$) (?v1 Dag_ref_bool_fun_fun$) (?v2 Dag$) (?v3 Dag$)) (=> (and (less$b ?v0 (fun_app$j ?v1 ?v2)) (and (less$ ?v2 ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less$ ?v4 ?v5) (less$b (fun_app$j ?v1 ?v4) (fun_app$j ?v1 ?v5))) ))) (less$b ?v0 (fun_app$j ?v1 ?v3))) ))
...
(assert (forall ((?v0 Dag$) (?v1 Ref_set_dag_fun$) (?v2 Ref_set$) (?v3 Ref_set$)) (=> (and (less$ ?v0 (fun_app$n ?v1 ?v2)) (and (less$c ?v2 ?v3) (forall ((?v4 Ref_set$) (?v5 Ref_set$)) (=> (less$c ?v4 ?v5) (less$ (fun_app$n ?v1 ?v4) (fun_app$n ?v1 ?v5))) ))) (less$ ?v0 (fun_app$n ?v1 ?v3))) ))
(assert (forall ((?v0 Ref_set$) (?v1 Dag_ref_set_fun$) (?v2 Dag$) (?v3 Dag$)) (=> (and (less$c ?v0 (fun_app$m ?v1 ?v2)) (and (less$ ?v2 ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less$ ?v4 ?v5) (less$c (fun_app$m ?v1 ?v4) (fun_app$m ?v1 ?v5))) ))) (less$c ?v0 (fun_app$m ?v1 ?v3))) ))
...
(assert (forall ((?v0 Ref_bool_fun$) (?v1 Ref_bool_fun$) (?v2 Ref_bool_fun_dag_fun$) (?v3 Dag$)) (=> (and (less$b ?v0 ?v1) (and (less$ (fun_app$h ?v2 ?v1) ?v3) (forall ((?v4 Ref_bool_fun$) (?v5 Ref_bool_fun$)) (=> (less$b ?v4 ?v5) (less$ (fun_app$h ?v2 ?v4) (fun_app$h ?v2 ?v5))) ))) (less$ (fun_app$h ?v2 ?v0) ?v3)) ))
(assert (forall ((?v0 Ref_bool_fun$) (?v1 Ref_bool_fun$) (?v2 Ref_bool_fun_ref_set_fun$) (?v3 Ref_set$)) (=> (and (less$b ?v0 ?v1) (and (less$c (fun_app$g ?v2 ?v1) ?v3) (forall ((?v4 Ref_bool_fun$) (?v5 Ref_bool_fun$)) (=> (less$b ?v4 ?v5) (less$c (fun_app$g ?v2 ?v4) (fun_app$g ?v2 ?v5))) ))) (less$c (fun_app$g ?v2 ?v0) ?v3)) ))
...
(assert (forall ((?v0 Dag$) (?v1 Dag$) (?v2 Dag_ref_set_fun$) (?v3 Ref_set$)) (=> (and (less$ ?v0 ?v1) (and (less$c (fun_app$m ?v2 ?v1) ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less$ ?v4 ?v5) (less$c (fun_app$m ?v2 ?v4) (fun_app$m ?v2 ?v5))) ))) (less$c (fun_app$m ?v2 ?v0) ?v3)) ))
(assert (forall ((?v0 Ref_set$) (?v1 Ref_set$) (?v2 Ref_set_dag_fun$) (?v3 Dag$)) (=> (and (less$c ?v0 ?v1) (and (less$ (fun_app$n ?v2 ?v1) ?v3) (forall ((?v4 Ref_set$) (?v5 Ref_set$)) (=> (less$c ?v4 ?v5) (less$ (fun_app$n ?v2 ?v4) (fun_app$n ?v2 ?v5))) ))) (less$ (fun_app$n ?v2 ?v0) ?v3)) ))
...
(assert (forall ((?v0 Dag$) (?v1 Dag$) (?v2 Dag_ref_set_fun$) (?v3 Ref_set$)) (=> (and (less$ ?v0 ?v1) (and (= (fun_app$m ?v2 ?v1) ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less$ ?v4 ?v5) (less$c (fun_app$m ?v2 ?v4) (fun_app$m ?v2 ?v5))) ))) (less$c (fun_app$m ?v2 ?v0) ?v3)) ))
(assert (forall ((?v0 Ref_set$) (?v1 Ref_set$) (?v2 Ref_set_dag_fun$) (?v3 Dag$)) (=> (and (less$c ?v0 ?v1) (and (= (fun_app$n ?v2 ?v1) ?v3) (forall ((?v4 Ref_set$) (?v5 Ref_set$)) (=> (less$c ?v4 ?v5) (less$ (fun_app$n ?v2 ?v4) (fun_app$n ?v2 ?v5))) ))) (less$ (fun_app$n ?v2 ?v0) ?v3)) ))
...
(assert (forall ((?v0 Ref_set$) (?v1 Dag_ref_set_fun$) (?v2 Dag$) (?v3 Dag$)) (=> (and (= ?v0 (fun_app$m ?v1 ?v2)) (and (less$ ?v2 ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less$ ?v4 ?v5) (less$c (fun_app$m ?v1 ?v4) (fun_app$m ?v1 ?v5))) ))) (less$c ?v0 (fun_app$m ?v1 ?v3))) ))
(assert (forall ((?v0 Dag$) (?v1 Ref_set_dag_fun$) (?v2 Ref_set$) (?v3 Ref_set$)) (=> (and (= ?v0 (fun_app$n ?v1 ?v2)) (and (less$c ?v2 ?v3) (forall ((?v4 Ref_set$) (?v5 Ref_set$)) (=> (less$c ?v4 ?v5) (less$ (fun_app$n ?v1 ?v4) (fun_app$n ?v1 ?v5))) ))) (less$ ?v0 (fun_app$n ?v1 ?v3))) ))
...
(assert (forall ((?v0 Ref_set$) (?v1 Dag_ref_set_fun$) (?v2 Dag$) (?v3 Dag$)) (=> (and (less_eq$ ?v0 (fun_app$m ?v1 ?v2)) (and (less$ ?v2 ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less$ ?v4 ?v5) (less$c (fun_app$m ?v1 ?v4) (fun_app$m ?v1 ?v5))) ))) (less$c ?v0 (fun_app$m ?v1 ?v3))) ))
...
(assert (forall ((?v0 Dag$) (?v1 Ref_set_dag_fun$) (?v2 Ref_set$) (?v3 Ref_set$)) (=> (and (less_eq$b ?v0 (fun_app$n ?v1 ?v2)) (and (less$c ?v2 ?v3) (forall ((?v4 Ref_set$) (?v5 Ref_set$)) (=> (less$c ?v4 ?v5) (less$ (fun_app$n ?v1 ?v4) (fun_app$n ?v1 ?v5))) ))) (less$ ?v0 (fun_app$n ?v1 ?v3))) ))
...
(assert (forall ((?v0 Ref_set$) (?v1 Ref_set$) (?v2 Ref_set_dag_fun$) (?v3 Dag$)) (=> (and (less_eq$ ?v0 ?v1) (and (less$ (fun_app$n ?v2 ?v1) ?v3) (forall ((?v4 Ref_set$) (?v5 Ref_set$)) (=> (less_eq$ ?v4 ?v5) (less_eq$b (fun_app$n ?v2 ?v4) (fun_app$n ?v2 ?v5))) ))) (less$ (fun_app$n ?v2 ?v0) ?v3)) ))
(assert (forall ((?v0 Dag$) (?v1 Dag$) (?v2 Dag_ref_set_fun$) (?v3 Ref_set$)) (=> (and (less_eq$b ?v0 ?v1) (and (less$c (fun_app$m ?v2 ?v1) ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less_eq$b ?v4 ?v5) (less_eq$ (fun_app$m ?v2 ?v4) (fun_app$m ?v2 ?v5))) ))) (less$c (fun_app$m ?v2 ?v0) ?v3)) ))
...
(assert (forall ((?v0 Dag$) (?v1 Ref_set_dag_fun$) (?v2 Ref_set$) (?v3 Ref_set$)) (=> (and (less$ ?v0 (fun_app$n ?v1 ?v2)) (and (less_eq$ ?v2 ?v3) (forall ((?v4 Ref_set$) (?v5 Ref_set$)) (=> (less_eq$ ?v4 ?v5) (less_eq$b (fun_app$n ?v1 ?v4) (fun_app$n ?v1 ?v5))) ))) (less$ ?v0 (fun_app$n ?v1 ?v3))) ))
(assert (forall ((?v0 Ref_set$) (?v1 Dag_ref_set_fun$) (?v2 Dag$) (?v3 Dag$)) (=> (and (less$c ?v0 (fun_app$m ?v1 ?v2)) (and (less_eq$b ?v2 ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less_eq$b ?v4 ?v5) (less_eq$ (fun_app$m ?v1 ?v4) (fun_app$m ?v1 ?v5))) ))) (less$c ?v0 (fun_app$m ?v1 ?v3))) ))
...
(assert (forall ((?v0 Dag$) (?v1 Dag$) (?v2 Dag_ref_set_fun$) (?v3 Ref_set$)) (=> (and (less$ ?v0 ?v1) (and (less_eq$ (fun_app$m ?v2 ?v1) ?v3) (forall ((?v4 Dag$) (?v5 Dag$)) (=> (less$ ?v4 ?v5) (less$c (fun_app$m ?v2 ?v4) (fun_app$m ?v2 ?v5))) ))) (less$c (fun_app$m ?v2 ?v0) ?v3)) ))
...
(assert (forall ((?v0 Ref_set$) (?v1 Ref_set$) (?v2 Ref_set_dag_fun$) (?v3 Dag$)) (=> (and (less$c ?v0 ?v1) (and (less_eq$b (fun_app$n ?v2 ?v1) ?v3) (forall ((?v4 Ref_set$) (?v5 Ref_set$)) (=> (less$c ?v4 ?v5) (less$ (fun_app$n ?v2 ?v4) (fun_app$n ?v2 ?v5))) ))) (less$ (fun_app$n ?v2 ?v0) ?v3)) ))
(assert (forall ((?v0 Ref_set$) (?v1 Ref_set$)) (! (= (less_eq$ ?v0 ?v1) (or (less$c ?v0 ?v1) (= ?v0 ?v1))) :pattern ((less_eq$ ?v0 ?v1)))))
...
(assert (forall ((?v0 Ref_set$)) (=> (finite$ ?v0) (not (member$ (new$ ?v0) ?v0))) ))
(check-sat)
(exit)
