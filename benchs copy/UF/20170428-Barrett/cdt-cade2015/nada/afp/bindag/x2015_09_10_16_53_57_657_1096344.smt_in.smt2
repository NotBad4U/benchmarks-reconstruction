...
(assert (not (fun_app$a (dag$ p$ l$ r$) t$)))
(assert (fun_app$a (dag$ p$ l$a r$a) t$))
(assert (forall ((?v0 Ref$)) (=> (member$ ?v0 (set_of$ t$)) (and (= (fun_app$b l$ ?v0) (fun_app$b l$a ?v0)) (= (fun_app$b r$ ?v0) (fun_app$b r$a ?v0)))) ))
