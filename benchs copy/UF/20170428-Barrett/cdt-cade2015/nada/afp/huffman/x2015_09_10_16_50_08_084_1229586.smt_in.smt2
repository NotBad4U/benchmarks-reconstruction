...
(assert (not (= (fun_app$b (plus$ (fun_app$b (plus$ (cost$ (mergeSibling$ t$ a$))) (fun_app$a (freq$ t$) a$))) (fun_app$a (freq$ t$) (sibling$ t$ a$))) (cost$ t$))))
(assert (consistent$ t$))
...
(assert (forall ((?v0 A_tree$) (?v1 A$) (?v2 A$) (?v3 Nat$) (?v4 Nat$)) (=> (and (consistent$ ?v0) (not (= ?v1 ?v2))) (= (freq$ (fun_app$c (swapLeaves$ ?v0 ?v3 ?v1 ?v4) ?v2)) (uub$ ?v0 ?v1 ?v2 ?v3 ?v4))) ))
