...
(assert (not (= (fun_app$b (plus$ (fun_app$b (plus$ (cost$ (fun_app$c (swapSyms$ t$ a$) b$))) (fun_app$b (times$ (fun_app$a (freq$ t$) a$)) (depth$ t$ a$)))) (fun_app$b (times$ (fun_app$a (freq$ t$) b$)) (depth$ t$ b$))) (fun_app$b (plus$ (fun_app$b (plus$ (cost$ t$)) (fun_app$b (times$ (fun_app$a (freq$ t$) a$)) (depth$ t$ b$)))) (fun_app$b (times$ (fun_app$a (freq$ t$) b$)) (depth$ t$ a$))))))
(assert (consistent$ t$))
(assert (not (= a$ b$)))
(assert (member$ a$ (alphabet$ t$)))
(assert (member$ b$ (alphabet$ t$)))
(assert (= (fun_app$b (plus$ (fun_app$b (plus$ (cost$ (fun_app$c (swapLeaves$ t$ (fun_app$a (freq$ t$) a$) a$ (fun_app$a (freq$ t$) b$)) b$))) (fun_app$b (times$ (fun_app$a (freq$ t$) a$)) (depth$ t$ a$)))) (fun_app$b (times$ (fun_app$a (freq$ t$) b$)) (depth$ t$ b$))) (fun_app$b (plus$ (fun_app$b (plus$ (cost$ t$)) (fun_app$b (times$ (fun_app$a (freq$ t$) a$)) (depth$ t$ b$)))) (fun_app$b (times$ (fun_app$a (freq$ t$) b$)) (depth$ t$ a$)))))
...
(assert (forall ((?v0 A_tree$) (?v1 A_tree$) (?v2 Nat$) (?v3 A$)) (! (=> (or (less$ zero$ (height$ ?v0)) (less$ zero$ (height$ ?v1))) (= (sibling$ (innerNode$ ?v2 ?v0 ?v1) ?v3) (ite (member$ ?v3 (alphabet$ ?v0)) (sibling$ ?v0 ?v3) (sibling$ ?v1 ?v3)))) :pattern ((sibling$ (innerNode$ ?v2 ?v0 ?v1) ?v3)))))
