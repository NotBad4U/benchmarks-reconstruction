...
(assert (not (consistent$ (splitLeaf$ t$ w_a$ a$ w_b$ b$))))
(assert (consistent$ t$))
...
(assert (forall ((?v0 Nat$) (?v1 Nat$) (?v2 Nat$) (?v3 Nat$)) (=> (and (fun_app$d (less_eq$ ?v0) ?v1) (fun_app$d (less_eq$ ?v2) ?v3)) (fun_app$d (less_eq$ (fun_app$b (plus$ (fun_app$b (times$ ?v0) ?v3)) (fun_app$b (times$ ?v1) ?v2))) (fun_app$b (plus$ (fun_app$b (times$ ?v0) ?v2)) (fun_app$b (times$ ?v1) ?v3)))) ))
(assert (forall ((?v0 Nat$) (?v1 Nat$)) (=> (= ?v0 (fun_app$b (times$ ?v0) ?v1)) (or (= ?v1 one$) (= ?v0 zero$))) ))
...
(assert (not (fun_app$d (less_eq$ one$) zero$)))
(assert (forall ((?v0 Nat$) (?v1 Nat$)) (=> (and (fun_app$d (less_eq$ ?v0) one$) (and (fun_app$d (less_eq$ zero$) ?v1) (fun_app$d (less_eq$ ?v1) one$))) (fun_app$d (less_eq$ (fun_app$b (times$ ?v0) ?v1)) one$)) ))
(assert (forall ((?v0 Nat$) (?v1 Nat$)) (=> (and (fun_app$d (less_eq$ ?v0) one$) (fun_app$d (less_eq$ zero$) ?v1)) (fun_app$d (less_eq$ (fun_app$b (times$ ?v1) ?v0)) ?v1)) ))
(assert (forall ((?v0 Nat$)) (fun_app$d (less_eq$ ?v0) ?v0) ))
