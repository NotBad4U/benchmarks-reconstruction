...
(assert (not (= (fun_app$b (plus$ (cost$ (fun_app$c (swapSyms$ t$ a$) b$))) (fun_app$b (plus$ (fun_app$b (times$ (fun_app$a (freq$ t$) a$)) (depth$ t$ a$))) (fun_app$b (times$ (fun_app$a (freq$ t$) b$)) (depth$ t$ b$)))) (fun_app$b (plus$ (cost$ t$)) (fun_app$b (plus$ (fun_app$b (times$ (fun_app$a (freq$ t$) a$)) (depth$ t$ b$))) (fun_app$b (times$ (fun_app$a (freq$ t$) b$)) (depth$ t$ a$)))))))
(assert (consistent$ t$))
(assert (member$ a$ (alphabet$ t$)))
(assert (member$ b$ (alphabet$ t$)))
(assert (fun_app$d (less_eq$ (fun_app$a (freq$ t$) a$)) (fun_app$a (freq$ t$) b$)))
(assert (fun_app$d (less_eq$ (depth$ t$ a$)) (depth$ t$ b$)))
...
(assert (fun_app$d (less_eq$ (fun_app$b (plus$ (fun_app$b (times$ (fun_app$a (freq$ t$) a$)) (depth$ t$ b$))) (fun_app$b (times$ (fun_app$a (freq$ t$) b$)) (depth$ t$ a$)))) (fun_app$b (plus$ (fun_app$b (times$ (fun_app$a (freq$ t$) a$)) (depth$ t$ a$))) (fun_app$b (times$ (fun_app$a (freq$ t$) b$)) (depth$ t$ b$)))))
...
(assert (forall ((?v0 Nat$) (?v1 Nat$) (?v2 Nat$)) (=> (and (fun_app$d (less$ ?v0) ?v1) (fun_app$d (less$ zero$) ?v2)) (fun_app$d (less$ (fun_app$b (times$ ?v2) ?v0)) (fun_app$b (times$ ?v2) ?v1))) ))
(assert (forall ((?v0 Nat$) (?v1 Nat$) (?v2 Nat$)) (=> (and (fun_app$d (less$ ?v0) ?v1) (fun_app$d (less$ zero$) ?v2)) (fun_app$d (less$ (fun_app$b (times$ ?v0) ?v2)) (fun_app$b (times$ ?v1) ?v2))) ))
(assert (forall ((?v0 Nat$) (?v1 Nat$) (?v2 Nat$)) (=> (and (fun_app$d (less$ ?v0) ?v1) (fun_app$d (less$ zero$) ?v2)) (fun_app$d (less$ (fun_app$b (times$ ?v2) ?v0)) (fun_app$b (times$ ?v2) ?v1))) ))
(assert (forall ((?v0 Nat$) (?v1 Nat$)) (=> (and (fun_app$d (less$ ?v0) zero$) (fun_app$d (less$ zero$) ?v1)) (fun_app$d (less$ (fun_app$b (times$ ?v0) ?v1)) zero$)) ))
(assert (forall ((?v0 Nat$) (?v1 Nat$)) (=> (and (fun_app$d (less$ zero$) (fun_app$b (times$ ?v0) ?v1)) (fun_app$d (less$ zero$) ?v1)) (fun_app$d (less$ zero$) ?v0)) ))
(assert (forall ((?v0 Nat$) (?v1 Nat$)) (=> (and (fun_app$d (less$ zero$) (fun_app$b (times$ ?v0) ?v1)) (fun_app$d (less$ zero$) ?v0)) (fun_app$d (less$ zero$) ?v1)) ))
