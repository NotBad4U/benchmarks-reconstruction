...
(declare-fun uu$ (A_tree$ A$) A_nat_fun$)
...
(assert (forall ((?v0 A_tree$) (?v1 A$) (?v2 A$)) (! (= (fun_app$a (uu$ ?v0 ?v1) ?v2) (ite (= ?v2 ?v1) (fun_app$b (plus$ (fun_app$a (freq$ ?v0) ?v1)) (fun_app$a (freq$ ?v0) (sibling$ ?v0 ?v1))) (ite (= ?v2 (sibling$ ?v0 ?v1)) zero$ (fun_app$a (freq$ ?v0) ?v2)))) :pattern ((fun_app$a (uu$ ?v0 ?v1) ?v2)))))
...
(assert (not (fun_app$ (fun_app$c (minima$ u$) a$) b$)))
...
(assert (forall ((?v0 A_tree$) (?v1 A$) (?v2 A$)) (= (fun_app$ (fun_app$c (minima$ ?v0) ?v1) ?v2) (and (member$ ?v1 (alphabet$ ?v0)) (and (member$ ?v2 (alphabet$ ?v0)) (and (not (= ?v1 ?v2)) (and (fun_app$d (less_eq$ (fun_app$a (freq$ ?v0) ?v1)) (fun_app$a (freq$ ?v0) ?v2)) (forall ((?v3 A$)) (=> (and (member$ ?v3 (alphabet$ ?v0)) (and (not (= ?v3 ?v1)) (not (= ?v3 ?v2)))) (and (fun_app$d (less_eq$ (fun_app$a (freq$ ?v0) ?v1)) (fun_app$a (freq$ ?v0) ?v3)) (fun_app$d (less_eq$ (fun_app$a (freq$ ?v0) ?v2)) (fun_app$a (freq$ ?v0) ?v3)))) )))))) ))
...
(assert (fun_app$d (less_eq$ (cost$ (splitLeaf$ t$ w_a$ a$ w_b$ b$))) (cost$ (swapFourSyms$ u$ a$ b$ c$ (sibling$ u$ c$)))))
(assert (fun_app$d (less_eq$ (fun_app$b (plus$ (fun_app$b (plus$ (cost$ t$)) w_a$)) w_b$)) (fun_app$b (plus$ (fun_app$b (plus$ (cost$ (mergeSibling$ (swapFourSyms$ u$ a$ b$ c$ (sibling$ u$ c$)) a$))) w_a$)) w_b$)))
...
(assert (forall ((?v0 A_tree$) (?v1 A$)) (=> (and (consistent$ ?v0) (and (member$ ?v1 (alphabet$ ?v0)) (not (= (sibling$ ?v0 ?v1) ?v1)))) (= (freq$ (mergeSibling$ ?v0 ?v1)) (uu$ ?v0 ?v1))) ))
...
(assert (forall ((?v0 A_tree$) (?v1 A$) (?v2 A$) (?v3 A$) (?v4 A$)) (=> (and (consistent$ ?v0) (and (fun_app$ (fun_app$c (minima$ ?v0) ?v1) ?v2) (and (member$ ?v3 (alphabet$ ?v0)) (and (member$ ?v4 (alphabet$ ?v0)) (and (= (depth$ ?v0 ?v3) (height$ ?v0)) (and (= (depth$ ?v0 ?v4) (height$ ?v0)) (not (= ?v3 ?v4)))))))) (fun_app$d (less_eq$ (cost$ (swapFourSyms$ ?v0 ?v1 ?v2 ?v3 ?v4))) (cost$ ?v0))) ))
(assert (fun_app$d (less$ zero$) (height$ u$)))
(assert (forall ((?v0 A_tree$) (?v1 A$) (?v2 A$)) (=> (and (consistent$ ?v0) (and (member$ ?v1 (alphabet$ ?v0)) (and (member$ ?v2 (alphabet$ ?v0)) (and (fun_app$d (less_eq$ (fun_app$a (freq$ ?v0) ?v1)) (fun_app$a (freq$ ?v0) ?v2)) (fun_app$d (less_eq$ (depth$ ?v0 ?v1)) (depth$ ?v0 ?v2)))))) (fun_app$d (less_eq$ (cost$ (fun_app$e (swapSyms$ ?v0 ?v1) ?v2))) (cost$ ?v0))) ))
(assert (forall ((?v0 Nat$)) (fun_app$d (less_eq$ ?v0) ?v0) ))
