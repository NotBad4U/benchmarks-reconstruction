...
(declare-fun fun_app$v (A_llist_llist_a_llist_a_llist_prod_llist_bool_fun_fun$ A_llist_llist$) A_llist_a_llist_prod_llist_bool_fun$)
(declare-fun fun_app$w (A_llist_a_llist_a_llist_prod_bool_fun_fun$ A_llist$) A_llist_a_llist_prod_bool_fun$)
(declare-fun fun_app$x (A_llist_a_llist_prod_llist_a_llist_llist_bool_fun_fun$ A_llist_a_llist_prod_llist$) A_llist_llist_bool_fun$)
(declare-fun fun_app$y (A_llist_a_llist_prod_a_llist_bool_fun_fun$ A_llist_a_llist_prod$) A_llist_bool_fun$)
(declare-fun fun_app$z (A_llist_a_llist_prod_llist_a_llist_a_llist_prod_llist_bool_fun_fun$ A_llist_a_llist_prod_llist$) A_llist_a_llist_prod_llist_bool_fun$)
...
(declare-fun fun_app$aa (A_llist_llist_a_llist_bool_fun_fun$ A_llist_llist$) A_llist_bool_fun$)
(declare-fun fun_app$ab (A_llist_a_bool_fun_fun$ A_llist$) A_bool_fun$)
(declare-fun fun_app$ac (A_llist_a_llist_prod_llist_a_llist_bool_fun_fun$ A_llist_a_llist_prod_llist$) A_llist_bool_fun$)
(declare-fun fun_app$ad (A_llist_a_llist_prod_a_bool_fun_fun$ A_llist_a_llist_prod$) A_bool_fun$)
(declare-fun fun_app$ae (A_llist_a_llist_a_llist_prod_llist_bool_fun_fun$ A_llist$) A_llist_a_llist_prod_llist_bool_fun$)
(declare-fun fun_app$af (A_a_llist_a_llist_prod_bool_fun_fun$ A$) A_llist_a_llist_prod_bool_fun$)
(declare-fun fun_app$ag (A_set_a_set_a_set_fun_fun$ A_set$) A_set_a_set_fun$)
...
(assert (not thesis$))
(assert (forall ((?v0 A_llist$)) (=> (and (fun_app$b (fun_app$e lprefix$ ?v0) xs$) (and (lfinite$ ?v0) (forall ((?v1 A_llist$)) (=> (and (fun_app$b (fun_app$e lprefix$ ?v0) ?v1) (and (fun_app$b (fun_app$e lprefix$ ?v1) xs$) (lfinite$ ?v1))) (fun_app$b p$ ?v1)) ))) thesis$) ))
(assert (exists ((?v0 A_llist$)) (and (fun_app$b (fun_app$e lprefix$ ?v0) xs$) (and (lfinite$ ?v0) (forall ((?v1 A_llist$)) (=> (and (fun_app$b (fun_app$e lprefix$ ?v0) ?v1) (and (fun_app$b (fun_app$e lprefix$ ?v1) xs$) (lfinite$ ?v1))) (fun_app$b p$ ?v1)) ))) ))
...
(assert (forall ((?v0 A_llist$) (?v1 A_llist$) (?v2 A_llist$)) (=> (and (fun_app$b (fun_app$e lprefix$ ?v0) ?v1) (fun_app$b (fun_app$e lprefix$ ?v1) ?v2)) (fun_app$b (fun_app$e lprefix$ ?v0) ?v2)) ))
(assert (forall ((?v0 A_llist_a_llist_prod_llist$) (?v1 A_llist_a_llist_prod_llist$)) (! (=> (not (lfinite$a ?v0)) (= (fun_app$h (lprefix$a ?v0) ?v1) (= ?v0 ?v1))) :pattern ((fun_app$h (lprefix$a ?v0) ?v1)))))
(assert (forall ((?v0 A_llist_llist$) (?v1 A_llist_llist$)) (! (=> (not (lfinite$b ?v0)) (= (fun_app$i (lprefix$b ?v0) ?v1) (= ?v0 ?v1))) :pattern ((fun_app$i (lprefix$b ?v0) ?v1)))))
...
(assert (forall ((?v0 A_llist_a_llist_prod_llist$) (?v1 A_llist_a_llist_prod_llist$) (?v2 A_llist_a_llist_prod_llist$)) (= (fun_app$h (lprefix$a (fun_app$j (lappend$ ?v0) ?v1)) (fun_app$j (lappend$ ?v0) ?v2)) (=> (lfinite$a ?v0) (fun_app$h (lprefix$a ?v1) ?v2))) ))
(assert (forall ((?v0 A_llist_llist$) (?v1 A_llist_llist$) (?v2 A_llist_llist$)) (= (fun_app$i (lprefix$b (fun_app$k (lappend$a ?v0) ?v1)) (fun_app$k (lappend$a ?v0) ?v2)) (=> (lfinite$b ?v0) (fun_app$i (lprefix$b ?v1) ?v2))) ))
...
(assert (forall ((?v0 A_llist_llist$) (?v1 A_llist_llist$)) (= (lfinite$b (fun_app$k (lappend$a ?v0) ?v1)) (and (lfinite$b ?v0) (lfinite$b ?v1))) ))
...
(assert (forall ((?v0 A_llist_llist$) (?v1 A_llist_llist$)) (! (=> (not (lfinite$b ?v0)) (= (fun_app$k (lappend$a ?v0) ?v1) ?v0)) :pattern ((fun_app$k (lappend$a ?v0) ?v1)))))
...
(assert (forall ((?v0 A_a_llist_fun$) (?v1 A_llist$) (?v2 A_llist$)) (= (lmap$e ?v0 (fun_app$ (lappend$b ?v1) ?v2)) (fun_app$k (lappend$a (lmap$e ?v0 ?v1)) (lmap$e ?v0 ?v2))) ))
(assert (forall ((?v0 A_llist_a_llist_prod_a_fun$) (?v1 A_llist_a_llist_prod_llist$) (?v2 A_llist_a_llist_prod_llist$)) (= (lmap$ ?v0 (fun_app$j (lappend$ ?v1) ?v2)) (fun_app$ (lappend$b (lmap$ ?v0 ?v1)) (lmap$ ?v0 ?v2))) ))
(assert (forall ((?v0 A_llist_a_llist_prod_a_llist_a_llist_prod_fun$) (?v1 A_llist_a_llist_prod_llist$) (?v2 A_llist_a_llist_prod_llist$)) (= (lmap$c ?v0 (fun_app$j (lappend$ ?v1) ?v2)) (fun_app$j (lappend$ (lmap$c ?v0 ?v1)) (lmap$c ?v0 ?v2))) ))
(assert (forall ((?v0 A_llist_a_llist_prod_a_llist_fun$) (?v1 A_llist_a_llist_prod_llist$) (?v2 A_llist_a_llist_prod_llist$)) (= (lmap$f ?v0 (fun_app$j (lappend$ ?v1) ?v2)) (fun_app$k (lappend$a (lmap$f ?v0 ?v1)) (lmap$f ?v0 ?v2))) ))
(assert (forall ((?v0 A_llist_a_fun$) (?v1 A_llist_llist$) (?v2 A_llist_llist$)) (= (lmap$a ?v0 (fun_app$k (lappend$a ?v1) ?v2)) (fun_app$ (lappend$b (lmap$a ?v0 ?v1)) (lmap$a ?v0 ?v2))) ))
(assert (forall ((?v0 A_llist_a_llist_a_llist_prod_fun$) (?v1 A_llist_llist$) (?v2 A_llist_llist$)) (= (lmap$d ?v0 (fun_app$k (lappend$a ?v1) ?v2)) (fun_app$j (lappend$ (lmap$d ?v0 ?v1)) (lmap$d ?v0 ?v2))) ))
(assert (forall ((?v0 A_llist_a_llist_fun$) (?v1 A_llist_llist$) (?v2 A_llist_llist$)) (= (lmap$g ?v0 (fun_app$k (lappend$a ?v1) ?v2)) (fun_app$k (lappend$a (lmap$g ?v0 ?v1)) (lmap$g ?v0 ?v2))) ))
...
(assert (forall ((?v0 A_a_fun$) (?v1 A$) (?v2 A_llist$)) (! (= (fun_app$ (lmap$h ?v0) (lCons$ ?v1 ?v2)) (lCons$ (fun_app$l ?v0 ?v1) (fun_app$ (lmap$h ?v0) ?v2))) :pattern ((fun_app$ (lmap$h ?v0) (lCons$ ?v1 ?v2))))))
(assert (forall ((?v0 A_a_fun$) (?v1 A_llist$) (?v2 A$) (?v3 A_llist$)) (= (= (fun_app$ (lmap$h ?v0) ?v1) (lCons$ ?v2 ?v3)) (exists ((?v4 A$) (?v5 A_llist$)) (and (= ?v1 (lCons$ ?v4 ?v5)) (and (= ?v2 (fun_app$l ?v0 ?v4)) (= ?v3 (fun_app$ (lmap$h ?v0) ?v5)))) )) ))
...
(assert (forall ((?v0 A_llist$) (?v1 A_llist_llist$)) (=> (member$ ?v0 (lset$ ?v1)) (exists ((?v2 A_llist_llist$) (?v3 A_llist_llist$)) (and (= ?v1 (fun_app$k (lappend$a ?v2) (lCons$b ?v0 ?v3))) (lfinite$b ?v2)) )) ))
...
(assert (forall ((?v0 A_llist$) (?v1 A_llist_llist$)) (=> (member$ ?v0 (lset$ ?v1)) (exists ((?v2 A_llist_llist$) (?v3 A_llist_llist$)) (and (= ?v1 (fun_app$k (lappend$a ?v2) (lCons$b ?v0 ?v3))) (and (lfinite$b ?v2) (not (member$ ?v0 (lset$ ?v2))))) )) ))
...
(assert (forall ((?v0 A_llist_set$)) (= (fun_app$b lnull$ (fun_app$n lSup$ ?v0)) (forall ((?v1 A_llist$)) (=> (member$ ?v1 ?v0) (fun_app$b lnull$ ?v1)) )) ))
...
(assert (forall ((?v0 A_llist$) (?v1 A_a_fun$)) (=> (not (fun_app$b lnull$ ?v0)) (= (lhd$ (fun_app$ (lmap$h ?v1) ?v0)) (fun_app$l ?v1 (lhd$ ?v0)))) ))
...
(assert (forall ((?v0 A_llist_set$)) (= (not (fun_app$b lnull$ (fun_app$n lSup$ ?v0))) (not (forall ((?v1 A_llist$)) (=> (member$ ?v1 ?v0) (fun_app$b lnull$ ?v1)) ))) ))
(assert (forall ((?v0 A_llist_set$)) (=> (forall ((?v1 A_llist$)) (=> (member$ ?v1 ?v0) (fun_app$b lnull$ ?v1)) ) (fun_app$b lnull$ (fun_app$n lSup$ ?v0))) ))
(assert (forall ((?v0 A_llist_set$)) (=> (not (forall ((?v1 A_llist$)) (=> (member$ ?v1 ?v0) (fun_app$b lnull$ ?v1)) )) (not (fun_app$b lnull$ (fun_app$n lSup$ ?v0)))) ))
...
(assert (forall ((?v0 A_llist$) (?v1 A_llist_llist$) (?v2 A_llist_a_llist_llist_bool_fun_fun$)) (=> (and (member$ ?v0 (lset$ ?v1)) (and (forall ((?v3 A_llist$) (?v4 A_llist_llist$)) (fun_app$i (fun_app$o ?v2 ?v3) (lCons$b ?v3 ?v4)) ) (forall ((?v3 A_llist$) (?v4 A_llist_llist$) (?v5 A_llist$)) (=> (and (member$ ?v5 (lset$ ?v4)) (fun_app$i (fun_app$o ?v2 ?v5) ?v4)) (fun_app$i (fun_app$o ?v2 ?v5) (lCons$b ?v3 ?v4))) ))) (fun_app$i (fun_app$o ?v2 ?v0) ?v1)) ))
(assert (forall ((?v0 A_llist_a_llist_prod$) (?v1 A_llist_a_llist_prod_llist$) (?v2 A_llist_a_llist_prod_a_llist_a_llist_prod_llist_bool_fun_fun$)) (=> (and (member$a ?v0 (lset$a ?v1)) (and (forall ((?v3 A_llist_a_llist_prod$) (?v4 A_llist_a_llist_prod_llist$)) (fun_app$h (fun_app$p ?v2 ?v3) (lCons$a ?v3 ?v4)) ) (forall ((?v3 A_llist_a_llist_prod$) (?v4 A_llist_a_llist_prod_llist$) (?v5 A_llist_a_llist_prod$)) (=> (and (member$a ?v5 (lset$a ?v4)) (fun_app$h (fun_app$p ?v2 ?v5) ?v4)) (fun_app$h (fun_app$p ?v2 ?v5) (lCons$a ?v3 ?v4))) ))) (fun_app$h (fun_app$p ?v2 ?v0) ?v1)) ))
(assert (forall ((?v0 A$) (?v1 A_llist$) (?v2 A_a_llist_bool_fun_fun$)) (=> (and (member$b ?v0 (lset$b ?v1)) (and (forall ((?v3 A$) (?v4 A_llist$)) (fun_app$b (fun_app$q ?v2 ?v3) (lCons$ ?v3 ?v4)) ) (forall ((?v3 A$) (?v4 A_llist$) (?v5 A$)) (=> (and (member$b ?v5 (lset$b ?v4)) (fun_app$b (fun_app$q ?v2 ?v5) ?v4)) (fun_app$b (fun_app$q ?v2 ?v5) (lCons$ ?v3 ?v4))) ))) (fun_app$b (fun_app$q ?v2 ?v0) ?v1)) ))
...
(assert (forall ((?v0 A_llist$) (?v1 A_llist$) (?v2 A_a_fun$) (?v3 A_a_fun$)) (=> (and (forall ((?v4 A$) (?v5 A$)) (=> (and (member$b ?v4 (lset$b ?v0)) (and (member$b ?v5 (lset$b ?v1)) (= (fun_app$l ?v2 ?v4) (fun_app$l ?v3 ?v5)))) (= ?v4 ?v5)) ) (= (fun_app$ (lmap$h ?v2) ?v0) (fun_app$ (lmap$h ?v3) ?v1))) (= ?v0 ?v1)) ))
(assert (forall ((?v0 A_llist$) (?v1 A_a_fun$) (?v2 A_a_fun$)) (=> (forall ((?v3 A$)) (=> (member$b ?v3 (lset$b ?v0)) (= (fun_app$l ?v1 ?v3) (fun_app$l ?v2 ?v3))) ) (= (fun_app$ (lmap$h ?v1) ?v0) (fun_app$ (lmap$h ?v2) ?v0))) ))
(assert (forall ((?v0 A_llist$) (?v1 A_llist$) (?v2 A_a_fun$) (?v3 A_a_fun$)) (=> (and (= ?v0 ?v1) (forall ((?v4 A$)) (=> (member$b ?v4 (lset$b ?v1)) (= (fun_app$l ?v2 ?v4) (fun_app$l ?v3 ?v4))) )) (= (fun_app$ (lmap$h ?v2) ?v0) (fun_app$ (lmap$h ?v3) ?v1))) ))
...
(assert (forall ((?v0 A_llist_set$)) (! (=> (forall ((?v1 A_llist$)) (=> (member$ ?v1 ?v0) (fun_app$b lnull$ ?v1)) ) (= (fun_app$n lSup$ ?v0) lNil$)) :pattern ((fun_app$n lSup$ ?v0)))))
...
(assert (forall ((?v0 A_llist$) (?v1 A_llist_llist$) (?v2 A_llist_llist$)) (= (member$ ?v0 (lset$ (fun_app$k (lappend$a ?v1) ?v2))) (or (member$ ?v0 (lset$ ?v1)) (and (lfinite$b ?v1) (member$ ?v0 (lset$ ?v2))))) ))
...
(assert (forall ((?v0 A_llist$)) (= (fun_app$ (fun_app$r (fun_app$s (unfold_llist$ lnull$) uud$) uue$) ?v0) ?v0) ))
(assert (forall ((?v0 A_llist$) (?v1 A_llist$)) (=> (lfinite$ ?v0) (= (lset$b (fun_app$ (lappend$b ?v0) ?v1)) (fun_app$t (sup$ (lset$b ?v0)) (lset$b ?v1)))) ))
(assert (forall ((?v0 A_llist_set$) (?v1 A_llist$)) (=> (and (chain$ lprefix$ ?v0) (and (member$ ?v1 ?v0) (not (fun_app$b lnull$ ?v1)))) (= (lhd$ (fun_app$n lSup$ ?v0)) (lhd$ ?v1))) ))
(assert (forall ((?v0 A_llist$) (?v1 A_llist$)) (= (lset$b (fun_app$ (lappend$b ?v0) ?v1)) (ite (lfinite$ ?v0) (fun_app$t (sup$ (lset$b ?v0)) (lset$b ?v1)) (lset$b ?v0))) ))
...
(assert (forall ((?v0 A_llist_a_llist_bool_fun_fun$) (?v1 A_llist_llist$) (?v2 A_llist_llist$) (?v3 A_llist_a_llist_bool_fun_fun$)) (=> (and (fun_app$i (fun_app$u (llist_all2$a ?v0) ?v1) ?v2) (forall ((?v4 A_llist$) (?v5 A_llist$)) (=> (and (member$ ?v4 (lset$ ?v1)) (and (member$ ?v5 (lset$ ?v2)) (fun_app$b (fun_app$e ?v0 ?v4) ?v5))) (fun_app$b (fun_app$e ?v3 ?v4) ?v5)) )) (fun_app$i (fun_app$u (llist_all2$a ?v3) ?v1) ?v2)) ))
(assert (forall ((?v0 A_llist_a_llist_a_llist_prod_bool_fun_fun$) (?v1 A_llist_llist$) (?v2 A_llist_a_llist_prod_llist$) (?v3 A_llist_a_llist_a_llist_prod_bool_fun_fun$)) (=> (and (fun_app$h (fun_app$v (llist_all2$b ?v0) ?v1) ?v2) (forall ((?v4 A_llist$) (?v5 A_llist_a_llist_prod$)) (=> (and (member$ ?v4 (lset$ ?v1)) (and (member$a ?v5 (lset$a ?v2)) (fun_app$c (fun_app$w ?v0 ?v4) ?v5))) (fun_app$c (fun_app$w ?v3 ?v4) ?v5)) )) (fun_app$h (fun_app$v (llist_all2$b ?v3) ?v1) ?v2)) ))
(assert (forall ((?v0 A_llist_a_llist_prod_a_llist_bool_fun_fun$) (?v1 A_llist_a_llist_prod_llist$) (?v2 A_llist_llist$) (?v3 A_llist_a_llist_prod_a_llist_bool_fun_fun$)) (=> (and (fun_app$i (fun_app$x (llist_all2$c ?v0) ?v1) ?v2) (forall ((?v4 A_llist_a_llist_prod$) (?v5 A_llist$)) (=> (and (member$a ?v4 (lset$a ?v1)) (and (member$ ?v5 (lset$ ?v2)) (fun_app$b (fun_app$y ?v0 ?v4) ?v5))) (fun_app$b (fun_app$y ?v3 ?v4) ?v5)) )) (fun_app$i (fun_app$x (llist_all2$c ?v3) ?v1) ?v2)) ))
(assert (forall ((?v0 A_llist_a_llist_prod_a_llist_a_llist_prod_bool_fun_fun$) (?v1 A_llist_a_llist_prod_llist$) (?v2 A_llist_a_llist_prod_llist$) (?v3 A_llist_a_llist_prod_a_llist_a_llist_prod_bool_fun_fun$)) (=> (and (fun_app$h (fun_app$z (llist_all2$d ?v0) ?v1) ?v2) (forall ((?v4 A_llist_a_llist_prod$) (?v5 A_llist_a_llist_prod$)) (=> (and (member$a ?v4 (lset$a ?v1)) (and (member$a ?v5 (lset$a ?v2)) (fun_app$c (fun_app$f ?v0 ?v4) ?v5))) (fun_app$c (fun_app$f ?v3 ?v4) ?v5)) )) (fun_app$h (fun_app$z (llist_all2$d ?v3) ?v1) ?v2)) ))
(assert (forall ((?v0 A_llist_a_bool_fun_fun$) (?v1 A_llist_llist$) (?v2 A_llist$) (?v3 A_llist_a_bool_fun_fun$)) (=> (and (fun_app$b (fun_app$aa (llist_all2$e ?v0) ?v1) ?v2) (forall ((?v4 A_llist$) (?v5 A$)) (=> (and (member$ ?v4 (lset$ ?v1)) (and (member$b ?v5 (lset$b ?v2)) (fun_app$d (fun_app$ab ?v0 ?v4) ?v5))) (fun_app$d (fun_app$ab ?v3 ?v4) ?v5)) )) (fun_app$b (fun_app$aa (llist_all2$e ?v3) ?v1) ?v2)) ))
(assert (forall ((?v0 A_llist_a_llist_prod_a_bool_fun_fun$) (?v1 A_llist_a_llist_prod_llist$) (?v2 A_llist$) (?v3 A_llist_a_llist_prod_a_bool_fun_fun$)) (=> (and (fun_app$b (fun_app$ac (llist_all2$f ?v0) ?v1) ?v2) (forall ((?v4 A_llist_a_llist_prod$) (?v5 A$)) (=> (and (member$a ?v4 (lset$a ?v1)) (and (member$b ?v5 (lset$b ?v2)) (fun_app$d (fun_app$ad ?v0 ?v4) ?v5))) (fun_app$d (fun_app$ad ?v3 ?v4) ?v5)) )) (fun_app$b (fun_app$ac (llist_all2$f ?v3) ?v1) ?v2)) ))
(assert (forall ((?v0 A_a_llist_bool_fun_fun$) (?v1 A_llist$) (?v2 A_llist_llist$) (?v3 A_a_llist_bool_fun_fun$)) (=> (and (fun_app$i (fun_app$o (llist_all2$g ?v0) ?v1) ?v2) (forall ((?v4 A$) (?v5 A_llist$)) (=> (and (member$b ?v4 (lset$b ?v1)) (and (member$ ?v5 (lset$ ?v2)) (fun_app$b (fun_app$q ?v0 ?v4) ?v5))) (fun_app$b (fun_app$q ?v3 ?v4) ?v5)) )) (fun_app$i (fun_app$o (llist_all2$g ?v3) ?v1) ?v2)) ))
(assert (forall ((?v0 A_a_llist_a_llist_prod_bool_fun_fun$) (?v1 A_llist$) (?v2 A_llist_a_llist_prod_llist$) (?v3 A_a_llist_a_llist_prod_bool_fun_fun$)) (=> (and (fun_app$h (fun_app$ae (llist_all2$h ?v0) ?v1) ?v2) (forall ((?v4 A$) (?v5 A_llist_a_llist_prod$)) (=> (and (member$b ?v4 (lset$b ?v1)) (and (member$a ?v5 (lset$a ?v2)) (fun_app$c (fun_app$af ?v0 ?v4) ?v5))) (fun_app$c (fun_app$af ?v3 ?v4) ?v5)) )) (fun_app$h (fun_app$ae (llist_all2$h ?v3) ?v1) ?v2)) ))
...
(assert (forall ((?v0 A_llist_set$) (?v1 A_llist$)) (=> (and (chain$ lprefix$ ?v0) (forall ((?v2 A_llist$)) (=> (member$ ?v2 ?v0) (fun_app$b (fun_app$e lprefix$ ?v2) ?v1)) )) (fun_app$b (fun_app$e lprefix$ (fun_app$n lSup$ ?v0)) ?v1)) ))
(assert (forall ((?v0 A_llist_set$) (?v1 A_llist$)) (=> (and (chain$ lprefix$ ?v0) (forall ((?v2 A_llist$)) (=> (member$ ?v2 ?v0) (fun_app$b (fun_app$e lprefix$ ?v2) ?v1)) )) (fun_app$b (fun_app$e lprefix$ (fun_app$n lSup$ ?v0)) ?v1)) ))
(assert (forall ((?v0 A_llist_set$) (?v1 A_llist$)) (=> (and (chain$ lprefix$ ?v0) (member$ ?v1 ?v0)) (fun_app$b (fun_app$e lprefix$ ?v1) (fun_app$n lSup$ ?v0))) ))
(assert (forall ((?v0 A_llist_set$) (?v1 A_llist$)) (=> (and (chain$ lprefix$ ?v0) (member$ ?v1 ?v0)) (fun_app$b (fun_app$e lprefix$ ?v1) (fun_app$n lSup$ ?v0))) ))
...
(assert (forall ((?v0 A_set$) (?v1 A_llist$)) (! (= (fun_app$m (gen_lset$ ?v0) ?v1) (fun_app$t (sup$ ?v0) (lset$b ?v1))) :pattern ((fun_app$m (gen_lset$ ?v0) ?v1)))))
...
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_bool_fun$)) (= (exists ((?v3 A$)) (and (member$b ?v3 (fun_app$t (sup$ ?v0) ?v1)) (fun_app$d ?v2 ?v3)) ) (or (exists ((?v3 A$)) (and (member$b ?v3 ?v0) (fun_app$d ?v2 ?v3)) ) (exists ((?v3 A$)) (and (member$b ?v3 ?v1) (fun_app$d ?v2 ?v3)) ))) ))
...
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_bool_fun$)) (= (forall ((?v3 A$)) (=> (member$b ?v3 (fun_app$t (sup$ ?v0) ?v1)) (fun_app$d ?v2 ?v3)) ) (and (forall ((?v3 A$)) (=> (member$b ?v3 ?v0) (fun_app$d ?v2 ?v3)) ) (forall ((?v3 A$)) (=> (member$b ?v3 ?v1) (fun_app$d ?v2 ?v3)) ))) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$)) (= (fun_app$t (sup$ (fun_app$t (sup$ ?v0) ?v1)) ?v2) (fun_app$t (sup$ ?v0) (fun_app$t (sup$ ?v1) ?v2))) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$)) (= (fun_app$t (sup$ ?v0) (fun_app$t (sup$ ?v1) ?v2)) (fun_app$t (sup$ ?v1) (fun_app$t (sup$ ?v0) ?v2))) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (= (fun_app$t (sup$ ?v0) (fun_app$t (sup$ ?v0) ?v1)) (fun_app$t (sup$ ?v0) ?v1)) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (= (fun_app$t (sup$ ?v0) ?v1) (fun_app$t (sup$ ?v1) ?v0)) ))
...
(assert (forall ((?v0 A_llist$) (?v1 A_llist$)) (less_eq$ (lset$b (fun_app$ (lappend$b ?v0) ?v1)) (fun_app$t (sup$ (lset$b ?v0)) (lset$b ?v1))) ))
...
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$)) (= (less_eq$ (fun_app$t (sup$ ?v0) ?v1) ?v2) (and (less_eq$ ?v0 ?v2) (less_eq$ ?v1 ?v2))) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$)) (= (less_eq$ (fun_app$t (sup$ ?v0) ?v1) ?v2) (and (less_eq$ ?v0 ?v2) (less_eq$ ?v1 ?v2))) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$)) (= (less_eq$ (fun_app$t (sup$ ?v0) ?v1) ?v2) (and (less_eq$ ?v0 ?v2) (less_eq$ ?v1 ?v2))) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (less_eq$ ?v0 (fun_app$t (sup$ ?v1) ?v0)) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (less_eq$ ?v0 (fun_app$t (sup$ ?v0) ?v1)) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (less_eq$ ?v0 (fun_app$t (sup$ ?v0) ?v1)) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (less_eq$ ?v0 (fun_app$t (sup$ ?v1) ?v0)) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (less_eq$ ?v0 (fun_app$t (sup$ ?v0) ?v1)) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (less_eq$ ?v0 (fun_app$t (sup$ ?v1) ?v0)) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (less_eq$ ?v0 (fun_app$t (sup$ ?v0) ?v1)) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (less_eq$ ?v0 (fun_app$t (sup$ ?v1) ?v0)) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$)) (=> (less_eq$ ?v0 ?v1) (less_eq$ ?v0 (fun_app$t (sup$ ?v1) ?v2))) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$)) (=> (less_eq$ ?v0 ?v1) (less_eq$ ?v0 (fun_app$t (sup$ ?v2) ?v1))) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$)) (=> (less_eq$ ?v0 ?v1) (less_eq$ ?v0 (fun_app$t (sup$ ?v1) ?v2))) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$)) (=> (less_eq$ ?v0 ?v1) (less_eq$ ?v0 (fun_app$t (sup$ ?v2) ?v1))) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (! (=> (less_eq$ ?v0 ?v1) (= (fun_app$t (sup$ ?v0) ?v1) ?v1)) :pattern ((fun_app$t (sup$ ?v0) ?v1)))))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (! (=> (less_eq$ ?v0 ?v1) (= (fun_app$t (sup$ ?v1) ?v0) ?v1)) :pattern ((fun_app$t (sup$ ?v1) ?v0)))))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (! (=> (less_eq$ ?v0 ?v1) (= (fun_app$t (sup$ ?v1) ?v0) ?v1)) :pattern ((fun_app$t (sup$ ?v1) ?v0)))))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (! (=> (less_eq$ ?v0 ?v1) (= (fun_app$t (sup$ ?v0) ?v1) ?v1)) :pattern ((fun_app$t (sup$ ?v0) ?v1)))))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (! (=> (less_eq$ ?v0 ?v1) (= (fun_app$t (sup$ ?v1) ?v0) ?v1)) :pattern ((fun_app$t (sup$ ?v1) ?v0)))))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (! (=> (less_eq$ ?v0 ?v1) (= (fun_app$t (sup$ ?v0) ?v1) ?v1)) :pattern ((fun_app$t (sup$ ?v0) ?v1)))))
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$)) (=> (and (less_eq$ ?v0 ?v1) (less_eq$ ?v2 ?v1)) (less_eq$ (fun_app$t (sup$ ?v0) ?v2) ?v1)) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$)) (=> (and (less_eq$ ?v0 ?v1) (less_eq$ ?v2 ?v1)) (less_eq$ (fun_app$t (sup$ ?v0) ?v2) ?v1)) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$)) (=> (and (less_eq$ ?v0 ?v1) (less_eq$ ?v2 ?v1)) (less_eq$ (fun_app$t (sup$ ?v0) ?v2) ?v1)) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$)) (=> (and (less_eq$ ?v0 ?v1) (less_eq$ ?v2 ?v1)) (less_eq$ (fun_app$t (sup$ ?v0) ?v2) ?v1)) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$) (?v3 A_set$)) (=> (and (less_eq$ ?v0 ?v1) (less_eq$ ?v2 ?v3)) (less_eq$ (fun_app$t (sup$ ?v0) ?v2) (fun_app$t (sup$ ?v1) ?v3))) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$) (?v3 A_set$)) (=> (and (less_eq$ ?v0 ?v1) (less_eq$ ?v2 ?v3)) (less_eq$ (fun_app$t (sup$ ?v0) ?v2) (fun_app$t (sup$ ?v1) ?v3))) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$) (?v3 A_set$)) (=> (and (less_eq$ ?v0 ?v1) (less_eq$ ?v2 ?v3)) (less_eq$ (fun_app$t (sup$ ?v0) ?v2) (fun_app$t (sup$ ?v1) ?v3))) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (=> (and (less_eq$ ?v0 ?v1) (=> (= ?v1 (fun_app$t (sup$ ?v1) ?v0)) false)) false) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$)) (=> (and (less_eq$ (fun_app$t (sup$ ?v0) ?v1) ?v2) (=> (and (less_eq$ ?v0 ?v2) (less_eq$ ?v1 ?v2)) false)) false) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_set$)) (=> (and (less_eq$ (fun_app$t (sup$ ?v0) ?v1) ?v2) (=> (and (less_eq$ ?v0 ?v2) (less_eq$ ?v1 ?v2)) false)) false) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (=> (= ?v0 (fun_app$t (sup$ ?v0) ?v1)) (less_eq$ ?v1 ?v0)) ))
(assert (forall ((?v0 A_set_a_set_a_set_fun_fun$) (?v1 A_set$) (?v2 A_set$)) (=> (and (forall ((?v3 A_set$) (?v4 A_set$)) (less_eq$ ?v3 (fun_app$t (fun_app$ag ?v0 ?v3) ?v4)) ) (and (forall ((?v3 A_set$) (?v4 A_set$)) (less_eq$ ?v4 (fun_app$t (fun_app$ag ?v0 ?v3) ?v4)) ) (forall ((?v3 A_set$) (?v4 A_set$) (?v5 A_set$)) (=> (and (less_eq$ ?v4 ?v3) (less_eq$ ?v5 ?v3)) (less_eq$ (fun_app$t (fun_app$ag ?v0 ?v4) ?v5) ?v3)) ))) (= (fun_app$t (sup$ ?v1) ?v2) (fun_app$t (fun_app$ag ?v0 ?v1) ?v2))) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (! (= (less_eq$ ?v0 ?v1) (= ?v1 (fun_app$t (sup$ ?v1) ?v0))) :pattern ((less_eq$ ?v0 ?v1)))))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (! (= (less_eq$ ?v0 ?v1) (= (fun_app$t (sup$ ?v0) ?v1) ?v1)) :pattern ((less_eq$ ?v0 ?v1)))))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (! (= (less_eq$ ?v0 ?v1) (= (fun_app$t (sup$ ?v0) ?v1) ?v1)) :pattern ((less_eq$ ?v0 ?v1)))))
(check-sat)
(exit)
