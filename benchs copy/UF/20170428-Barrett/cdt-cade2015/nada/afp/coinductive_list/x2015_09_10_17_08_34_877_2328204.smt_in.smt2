...
(assert (not (fun_app$b (fun_app$e (llexord$ r$) xs$) zs$)))
(assert (forall ((?v0 A$) (?v1 A$) (?v2 A$)) (=> (and (fun_app$d (fun_app$f r$ ?v0) ?v1) (fun_app$d (fun_app$f r$ ?v1) ?v2)) (fun_app$d (fun_app$f r$ ?v0) ?v2)) ))
(assert (exists ((?v0 A_llist$)) (and (fun_app$b (fun_app$e (llexord$ r$) xs$) ?v0) (fun_app$b (fun_app$e (llexord$ r$) ?v0) zs$)) ))
...
(assert (fun_app$b (fun_app$e (llexord$ r$) ys$) zs$))
