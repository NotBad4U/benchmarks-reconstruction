...
(assert (not (and (fun_app$b (lsorted$ less_eq$) xs$) (forall ((?v0 A$)) (=> (member$ ?v0 (lset$ xs$)) (fun_app$a (fun_app$c less_eq$ x$) ?v0)) ))))
...
(assert (forall ((?v0 A$)) (=> (member$ ?v0 (lset$ xs$)) (fun_app$a (fun_app$c less_eq$ x$) ?v0)) ))
(assert (fun_app$b (lsorted$ less_eq$) (lCons$ x$ xs$)))
