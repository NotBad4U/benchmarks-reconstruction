...
(assert (not (= (lappend$ (lappend$ xs$ (ldrop$ (llength$ ys$) xs$)) xs$a) (lappend$ ys$ zs$))))
(assert (= (ltake$ (llength$ ys$) xs$) xs$))
(assert (= (lappend$ xs$ xs$a) (lappend$ ys$ zs$)))
(assert (= (lappend$ (ltake$ (llength$ ys$) xs$) (lappend$ (ldrop$ (llength$ ys$) xs$) xs$a)) (lappend$ ys$ zs$)))
(assert (=> (forall ((?v0 A_llist$)) (=> (= (lappend$ xs$ ?v0) (lappend$ ys$ zs$)) false) ) false))
(assert (not (fun_app$ (less_eq$ (llength$ ys$)) (llength$ xs$))))
...
(assert (fun_app$ (less$ (llength$ xs$)) (llength$ ys$)))
