...
(declare-fun uue$ (A_set$) A_a_bool_fun_fun_a_a_bool_fun_fun_fun$)
(declare-fun uuf$ (A$) A_bool_fun$)
(declare-fun uug$ (A$) A_bool_fun$)
(declare-fun uuh$ () A_bool_fun$)
(declare-fun uui$ (A$) A_bool_fun_a_bool_fun_fun$)
(declare-fun uuj$ (A$) A_set_a_bool_fun_fun$)
(declare-fun uuk$ (A_set$) A_set_a_bool_fun_fun$)
...
(assert (forall ((?v0 A$) (?v1 A$)) (! (= (fun_app$ (uug$ ?v0) ?v1) (= ?v0 ?v1)) :pattern ((fun_app$ (uug$ ?v0) ?v1)))))
(assert (forall ((?v0 A$) (?v1 A$)) (! (= (fun_app$ (uuf$ ?v0) ?v1) (= ?v1 ?v0)) :pattern ((fun_app$ (uuf$ ?v0) ?v1)))))
...
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A$)) (! (= (fun_app$ (fun_app$c (uuk$ ?v0) ?v1) ?v2) (or (fun_app$b (member$ ?v2) ?v0) (fun_app$b (member$ ?v2) ?v1))) :pattern ((fun_app$ (fun_app$c (uuk$ ?v0) ?v1) ?v2)))))
(assert (forall ((?v0 A$) (?v1 A_set$) (?v2 A$)) (! (= (fun_app$ (fun_app$c (uuj$ ?v0) ?v1) ?v2) (or (= ?v2 ?v0) (fun_app$b (member$ ?v2) ?v1))) :pattern ((fun_app$ (fun_app$c (uuj$ ?v0) ?v1) ?v2)))))
(assert (forall ((?v0 A$) (?v1 A_bool_fun$) (?v2 A$)) (! (= (fun_app$ (fun_app$d (uul$ ?v0) ?v1) ?v2) (and (= ?v0 ?v2) (fun_app$ ?v1 ?v2))) :pattern ((fun_app$ (fun_app$d (uul$ ?v0) ?v1) ?v2)))))
(assert (forall ((?v0 A$) (?v1 A_bool_fun$) (?v2 A$)) (! (= (fun_app$ (fun_app$d (uum$ ?v0) ?v1) ?v2) (and (= ?v2 ?v0) (fun_app$ ?v1 ?v2))) :pattern ((fun_app$ (fun_app$d (uum$ ?v0) ?v1) ?v2)))))
...
(assert (forall ((?v0 A_bool_fun$) (?v1 A_bool_fun$) (?v2 A$)) (! (= (fun_app$ (fun_app$d (uuc$ ?v0) ?v1) ?v2) (and (fun_app$ ?v0 ?v2) (fun_app$ ?v1 ?v2))) :pattern ((fun_app$ (fun_app$d (uuc$ ?v0) ?v1) ?v2)))))
(assert (forall ((?v0 A$) (?v1 A_bool_fun$) (?v2 A$)) (! (= (fun_app$ (fun_app$d (uui$ ?v0) ?v1) ?v2) (=> (not (= ?v2 ?v0)) (fun_app$ ?v1 ?v2))) :pattern ((fun_app$ (fun_app$d (uui$ ?v0) ?v1) ?v2)))))
(assert (forall ((?v0 A_set$) (?v1 A_a_bool_fun_fun$) (?v2 A$) (?v3 A$)) (! (= (fun_app$ (fun_app$a (fun_app$e (uue$ ?v0) ?v1) ?v2) ?v3) (and (fun_app$b (member$ ?v3) ?v0) (fun_app$ (fun_app$a ?v1 ?v3) ?v2))) :pattern ((fun_app$ (fun_app$a (fun_app$e (uue$ ?v0) ?v1) ?v2) ?v3)))))
(assert (forall ((?v0 A$)) (! (= (fun_app$ uuh$ ?v0) false) :pattern ((fun_app$ uuh$ ?v0)))))
(assert (not (fun_app$f (rbt_less$ less$ k$) t1$)))
...
(assert (=> (fun_app$f (rbt_sorted$ less$) t1$) (= (map_of$ (entries$ t1$)) (rbt_lookup$ less$ t1$))))
(assert (=> (fun_app$f (rbt_sorted$ less$) t2$) (= (map_of$ (entries$ t2$)) (rbt_lookup$ less$ t2$))))
(assert (= (entries$ empty$) nil$b))
(assert (forall ((?v0 A_b_rbt$)) (=> (fun_app$f (rbt_sorted$ less$) ?v0) (= (dom$ (rbt_lookup$ less$ ?v0)) (set$ (keys$ ?v0)))) ))
(assert (forall ((?v0 A$)) (! (= (fun_app$y (rbt_lookup$ less$ empty$) ?v0) none$) :pattern ((fun_app$y (rbt_lookup$ less$ empty$) ?v0)))))
(assert (forall ((?v0 A$)) (! (= (fun_app$y (rbt_lookup$ less$ empty$) ?v0) none$) :pattern ((fun_app$y (rbt_lookup$ less$ empty$) ?v0)))))
(assert (forall ((?v0 A$) (?v1 A_b_rbt$)) (! (=> (fun_app$f (rbt_greater$ less$ ?v0) ?v1) (= (fun_app$y (rbt_lookup$ less$ ?v1) ?v0) none$)) :pattern ((fun_app$y (rbt_lookup$ less$ ?v1) ?v0)))))
(assert (forall ((?v0 A$) (?v1 A_b_rbt$)) (! (=> (fun_app$f (rbt_less$ less$ ?v0) ?v1) (= (fun_app$y (rbt_lookup$ less$ ?v1) ?v0) none$)) :pattern ((fun_app$y (rbt_lookup$ less$ ?v1) ?v0)))))
(assert (forall ((?v0 A_a_bool_fun_fun$) (?v1 A$)) (! (= (fun_app$y (rbt_lookup$ ?v0 empty$) ?v1) none$) :pattern ((fun_app$y (rbt_lookup$ ?v0 empty$) ?v1)))))
(assert (forall ((?v0 A_a_bool_fun_fun$) (?v1 A$)) (! (= (fun_app$y (rbt_lookup$ ?v0 empty$) ?v1) none$) :pattern ((fun_app$y (rbt_lookup$ ?v0 empty$) ?v1)))))
(assert (forall ((?v0 A_a_bool_fun_fun$) (?v1 A$) (?v2 A_b_rbt$)) (! (=> (fun_app$f (rbt_less$ ?v0 ?v1) ?v2) (= (fun_app$y (rbt_lookup$ ?v0 ?v2) ?v1) none$)) :pattern ((fun_app$y (rbt_lookup$ ?v0 ?v2) ?v1)))))
(assert (forall ((?v0 A_a_bool_fun_fun$) (?v1 A$) (?v2 A_b_rbt$)) (! (=> (fun_app$f (rbt_greater$ ?v0 ?v1) ?v2) (= (fun_app$y (rbt_lookup$ ?v0 ?v2) ?v1) none$)) :pattern ((fun_app$y (rbt_lookup$ ?v0 ?v2) ?v1)))))
...
(assert (forall ((?v0 Color$) (?v1 A_b_rbt$) (?v2 A$) (?v3 B$) (?v4 A_b_rbt$)) (=> (fun_app$f (rbt_sorted$ less$) (branch$ ?v0 ?v1 ?v2 ?v3 ?v4)) (= (dom$ (rbt_lookup$ less$ (branch$ ?v0 ?v1 ?v2 ?v3 ?v4))) (insert$ ?v2 (sup$ (dom$ (rbt_lookup$ less$ ?v1)) (dom$ (rbt_lookup$ less$ ?v4)))))) ))
...
(assert (forall ((?v0 A_bool_fun$) (?v1 A_bool_fun$)) (=> (or (finite$ (collect$ ?v0)) (finite$ (collect$ ?v1))) (finite$ (collect$ (fun_app$d (uuc$ ?v0) ?v1)))) ))
...
(assert (forall ((?v0 A_set$) (?v1 A_set$) (?v2 A_a_bool_fun_fun$)) (=> (and (not (finite$ ?v0)) (and (finite$ ?v1) (forall ((?v3 A$)) (=> (fun_app$b (member$ ?v3) ?v0) (exists ((?v4 A$)) (and (fun_app$b (member$ ?v4) ?v1) (fun_app$ (fun_app$a ?v2 ?v3) ?v4)) )) ))) (exists ((?v3 A$)) (and (fun_app$b (member$ ?v3) ?v1) (not (finite$ (collect$ (fun_app$a (fun_app$e (uue$ ?v0) ?v2) ?v3))))) )) ))
...
(assert (= bot$ (set$ nil$)))
(assert (forall ((?v0 A$)) (= (collect$ (uuf$ ?v0)) (insert$ ?v0 bot$)) ))
(assert (forall ((?v0 A$)) (= (collect$ (uug$ ?v0)) (insert$ ?v0 bot$)) ))
(assert (= bot$ (collect$ uuh$)))
(assert (forall ((?v0 A$) (?v1 A_bool_fun$)) (= (insert$ ?v0 (collect$ ?v1)) (collect$ (fun_app$d (uui$ ?v0) ?v1))) ))
(assert (forall ((?v0 A$) (?v1 A_set$)) (= (insert$ ?v0 ?v1) (collect$ (fun_app$c (uuj$ ?v0) ?v1))) ))
(assert (forall ((?v0 A_bool_fun$) (?v1 A_bool_fun$)) (= (collect$ (fun_app$d (uud$ ?v0) ?v1)) (sup$ (collect$ ?v0) (collect$ ?v1))) ))
(assert (forall ((?v0 A_set$) (?v1 A_set$)) (= (sup$ ?v0 ?v1) (collect$ (fun_app$c (uuk$ ?v0) ?v1))) ))
(assert (forall ((?v0 A$) (?v1 A_bool_fun$)) (= (collect$ (fun_app$d (uul$ ?v0) ?v1)) (ite (fun_app$ ?v1 ?v0) (insert$ ?v0 bot$) bot$)) ))
(assert (forall ((?v0 A$) (?v1 A_bool_fun$)) (= (collect$ (fun_app$d (uum$ ?v0) ?v1)) (ite (fun_app$ ?v1 ?v0) (insert$ ?v0 bot$) bot$)) ))
(check-sat)
(exit)
