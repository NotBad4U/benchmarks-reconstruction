...
(assert (not (fun_app$ (less$ (fun_app$a (times$ (fun_app$a (plus$ (fun_app$a (plus$ (fun_app$a (times$ a$) aa$)) (fun_app$a (times$ ba$) (fun_app$a (plus$ aa$) bb$)))) (fun_app$a (plus$ (fun_app$a (times$ a$) baa$)) (fun_app$a (times$ ba$) (fun_app$a (plus$ baa$) ca$))))) (fun_app$a (plus$ b$) c$))) (fun_app$a (times$ (fun_app$a (plus$ a$) ba$)) (fun_app$a (plus$ (fun_app$a (plus$ (fun_app$a (times$ b$) aa$)) (fun_app$a (times$ c$) (fun_app$a (plus$ aa$) bb$)))) (fun_app$a (plus$ (fun_app$a (times$ b$) baa$)) (fun_app$a (times$ c$) (fun_app$a (plus$ baa$) ca$))))))))
...
(assert (fun_app$ (less$ (fun_app$a (times$ (fun_app$a (times$ b$) ba$)) (fun_app$a (plus$ bb$) ca$))) (fun_app$a (times$ (fun_app$a (times$ a$) c$)) (fun_app$a (plus$ bb$) ca$))))
