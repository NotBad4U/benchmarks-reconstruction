...
(assert (not (and (or (fun_app$ (less$ zero$) aa$) (fun_app$ (less$ zero$) baa$)) (fun_app$ (less$ (fun_app$a (times$ b$) ba$)) (fun_app$a (times$ a$) c$)))))
(assert (or (and (fun_app$ (less$ zero$) b$) (fun_app$ (less$ zero$) aa$)) (or (and (fun_app$ (less$ zero$) b$) (fun_app$ (less$ zero$) bb$)) (or (and (fun_app$ (less$ zero$) b$) (fun_app$ (less$ zero$) baa$)) (or (and (fun_app$ (less$ zero$) b$) (fun_app$ (less$ zero$) ca$)) (or (and (fun_app$ (less$ zero$) c$) (fun_app$ (less$ zero$) bb$)) (and (fun_app$ (less$ zero$) c$) (fun_app$ (less$ zero$) ca$))))))))
(assert (= (fun_app$a (minus$ (fun_app$a (times$ a$) c$)) (fun_app$a (times$ b$) ba$)) (suc$ zero$)))
(assert (= (fun_app$a (minus$ (fun_app$a (times$ aa$) ca$)) (fun_app$a (times$ bb$) baa$)) (suc$ zero$)))
