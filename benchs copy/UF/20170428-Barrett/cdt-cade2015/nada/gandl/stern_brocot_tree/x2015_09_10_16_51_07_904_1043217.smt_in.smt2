...
(assert (not (fun_app$ (less$ (fun_app$a (plus$ (fun_app$a (times$ b$) (fun_app$a (times$ ba$) aa$))) (fun_app$a (times$ b$) (fun_app$a (times$ ba$) baa$)))) (fun_app$a (plus$ (fun_app$a (times$ a$) (fun_app$a (times$ c$) aa$))) (fun_app$a (times$ a$) (fun_app$a (times$ c$) baa$))))))
