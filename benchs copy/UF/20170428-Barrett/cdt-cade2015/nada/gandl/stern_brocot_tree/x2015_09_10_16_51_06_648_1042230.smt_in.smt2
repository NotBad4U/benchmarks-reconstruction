...
(assert (not (fun_app$ (less$ (fun_app$a (times$ (fst$ (mediant$ (pair$a (pair$ a$ b$) (pair$ ba$ c$))))) (snd$ (mediant$ (mulmat$ (pair$a (pair$ a$ b$) (pair$ ba$ c$)) (mulmat$ uRmat$ (pair$a (pair$ aa$ bb$) (pair$ baa$ ca$)))))))) (fun_app$a (times$ (fst$ (mediant$ (mulmat$ (pair$a (pair$ a$ b$) (pair$ ba$ c$)) (mulmat$ uRmat$ (pair$a (pair$ aa$ bb$) (pair$ baa$ ca$))))))) (snd$ (mediant$ (pair$a (pair$ a$ b$) (pair$ ba$ c$))))))))
(assert (fun_app$ (less$ zero$) (snd$ (mediant$ (mulmat$ (pair$a (pair$ a$ b$) (pair$ ba$ c$)) (mulmat$ uRmat$ (pair$a (pair$ aa$ bb$) (pair$ baa$ ca$))))))))
(assert (= (det$ (pair$a (pair$ a$ b$) (pair$ ba$ c$))) (suc$ zero$)))
(assert (= (det$ (pair$a (pair$ aa$ bb$) (pair$ baa$ ca$))) (suc$ zero$)))
(assert (fun_app$ (less$ zero$) (snd$ (mediant$ (pair$a (pair$ a$ b$) (pair$ ba$ c$))))))
...
(assert (= (det$ x$) one$))
(assert (fun_app$ (less$ zero$) (snd$ (mediant$ (mulmat$ (mulmat$ x$ uRmat$) y$)))))
(assert (= (det$ y$) one$))
