...
(declare-fun fst$d (A_tree_a_tree_prod$) A_tree$)
(declare-fun snd$d (A_tree_a_tree_prod$) A_tree$)
...
(declare-fun root$c (B_b_prod_tree$) B_b_prod$)
(declare-fun left$c (B_b_prod_tree$) B_b_prod_tree$)
(declare-fun right$c (B_b_prod_tree$) B_b_prod_tree$)
...
(declare-sort B_b_tree_prod$ 0)
(declare-sort B_tree_b_prod$ 0)
...
(declare-fun projl$b (A_b_tree_sum$) A$)
(declare-fun inl$c (A$) A_b_tree_sum$)
(declare-fun projr$b (A_b_tree_sum$) B_tree$)
(declare-fun inr$c (B_tree$) A_b_tree_sum$)
(declare-fun projl$c (A_b_sum$) A$)
(declare-fun inl$d (A$) A_b_sum$)
(declare-fun projr$c (A_b_sum$) B$)
(declare-fun inr$d (B$) A_b_sum$)
(declare-fun fst$h (B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod_b_prod$) B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod$)
(declare-fun snd$h (B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod_b_prod$) B$)
(declare-fun pair$h (B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod$ B$) B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod_b_prod$)
(declare-fun fst$i (B_b_tree_prod$) B$)
(declare-fun snd$i (B_b_tree_prod$) B_tree$)
(declare-fun pair$i (B$ B_tree$) B_b_tree_prod$)
(declare-fun fst$j (B_tree_b_prod$) B_tree$)
(declare-fun snd$j (B_tree_b_prod$) B$)
(declare-fun pair$j (B_tree$ B$) B_tree_b_prod$)
...
(declare-fun fst$m (B_tree_b_b_prod_prod$) B_tree$)
(declare-fun snd$m (B_tree_b_b_prod_prod$) B_b_prod$)
(declare-fun pair$m (B_tree$ B_b_prod$) B_tree_b_b_prod_prod$)
(declare-fun fst$n (B_tree_b_tree_b_tree_prod_prod$) B_tree$)
(declare-fun snd$n (B_tree_b_tree_b_tree_prod_prod$) B_tree_b_tree_prod$)
(declare-fun pair$n (B_tree$ B_tree_b_tree_prod$) B_tree_b_tree_b_tree_prod_prod$)
(declare-fun fst$o (A_b_b_prod_prod$) A$)
(declare-fun snd$o (A_b_b_prod_prod$) B_b_prod$)
(declare-fun pair$o (A$ B_b_prod$) A_b_b_prod_prod$)
(declare-fun fst$p (A_b_tree_b_tree_prod_prod$) A$)
(declare-fun snd$p (A_b_tree_b_tree_prod_prod$) B_tree_b_tree_prod$)
(declare-fun pair$p (A$ B_tree_b_tree_prod$) A_b_tree_b_tree_prod_prod$)
(declare-fun projl$d (A_tree_b_sum$) A_tree$)
(declare-fun inl$e (A_tree$) A_tree_b_sum$)
(declare-fun projr$d (A_tree_b_sum$) B$)
(declare-fun inr$e (B$) A_tree_b_sum$)
(declare-fun fst$q (A_tree_b_sum_a_tree_b_sum_prod$) A_tree_b_sum$)
(declare-fun snd$q (A_tree_b_sum_a_tree_b_sum_prod$) A_tree_b_sum$)
(declare-fun pair$q (A_tree_b_sum$ A_tree_b_sum$) A_tree_b_sum_a_tree_b_sum_prod$)
(declare-fun fst$r (A_a_tree_b_sum_a_tree_b_sum_prod_prod$) A$)
(declare-fun snd$r (A_a_tree_b_sum_a_tree_b_sum_prod_prod$) A_tree_b_sum_a_tree_b_sum_prod$)
(declare-fun pair$r (A$ A_tree_b_sum_a_tree_b_sum_prod$) A_a_tree_b_sum_a_tree_b_sum_prod_prod$)
(declare-fun projl$e (B_tree_b_sum$) B_tree$)
(declare-fun inl$f (B_tree$) B_tree_b_sum$)
(declare-fun projr$e (B_tree_b_sum$) B$)
(declare-fun inr$f (B$) B_tree_b_sum$)
(declare-fun fst$s (B_tree_b_sum_b_tree_b_sum_prod$) B_tree_b_sum$)
(declare-fun snd$s (B_tree_b_sum_b_tree_b_sum_prod$) B_tree_b_sum$)
(declare-fun pair$s (B_tree_b_sum$ B_tree_b_sum$) B_tree_b_sum_b_tree_b_sum_prod$)
(declare-fun fst$t (B_b_tree_b_sum_b_tree_b_sum_prod_prod$) B$)
(declare-fun snd$t (B_b_tree_b_sum_b_tree_b_sum_prod_prod$) B_tree_b_sum_b_tree_b_sum_prod$)
(declare-fun pair$t (B$ B_tree_b_sum_b_tree_b_sum_prod$) B_b_tree_b_sum_b_tree_b_sum_prod_prod$)
(declare-fun projl$f (A_tree_b_tree_sum$) A_tree$)
(declare-fun inl$g (A_tree$) A_tree_b_tree_sum$)
(declare-fun projr$f (A_tree_b_tree_sum$) B_tree$)
(declare-fun inr$g (B_tree$) A_tree_b_tree_sum$)
(declare-fun fst$u (A_tree_b_tree_sum_a_tree_b_tree_sum_prod$) A_tree_b_tree_sum$)
(declare-fun snd$u (A_tree_b_tree_sum_a_tree_b_tree_sum_prod$) A_tree_b_tree_sum$)
(declare-fun pair$u (A_tree_b_tree_sum$ A_tree_b_tree_sum$) A_tree_b_tree_sum_a_tree_b_tree_sum_prod$)
(declare-fun fst$v (A_a_tree_b_tree_sum_a_tree_b_tree_sum_prod_prod$) A$)
(declare-fun snd$v (A_a_tree_b_tree_sum_a_tree_b_tree_sum_prod_prod$) A_tree_b_tree_sum_a_tree_b_tree_sum_prod$)
(declare-fun pair$v (A$ A_tree_b_tree_sum_a_tree_b_tree_sum_prod$) A_a_tree_b_tree_sum_a_tree_b_tree_sum_prod_prod$)
(declare-fun projl$g (B_tree_b_tree_sum$) B_tree$)
(declare-fun inl$h (B_tree$) B_tree_b_tree_sum$)
(declare-fun projr$g (B_tree_b_tree_sum$) B_tree$)
(declare-fun inr$h (B_tree$) B_tree_b_tree_sum$)
(declare-fun fst$w (B_tree_b_tree_sum_b_tree_b_tree_sum_prod$) B_tree_b_tree_sum$)
(declare-fun snd$w (B_tree_b_tree_sum_b_tree_b_tree_sum_prod$) B_tree_b_tree_sum$)
(declare-fun pair$w (B_tree_b_tree_sum$ B_tree_b_tree_sum$) B_tree_b_tree_sum_b_tree_b_tree_sum_prod$)
(declare-fun fst$x (B_b_tree_b_tree_sum_b_tree_b_tree_sum_prod_prod$) B$)
(declare-fun snd$x (B_b_tree_b_tree_sum_b_tree_b_tree_sum_prod_prod$) B_tree_b_tree_sum_b_tree_b_tree_sum_prod$)
(declare-fun pair$x (B$ B_tree_b_tree_sum_b_tree_b_tree_sum_prod$) B_b_tree_b_tree_sum_b_tree_b_tree_sum_prod_prod$)
(declare-fun projl$h (B_b_tree_sum$) B$)
(declare-fun inl$i (B$) B_b_tree_sum$)
(declare-fun projr$h (B_b_tree_sum$) B_tree$)
(declare-fun inr$i (B_tree$) B_b_tree_sum$)
...
(declare-fun fun_app$bd (A_tree_a_tree_fun$ A_tree$) A_tree$)
(declare-fun fun_app$be (A_tree_a_a_tree_a_tree_prod_prod_fun$ A_tree$) A_a_tree_a_tree_prod_prod$)
(declare-fun fun_app$bf (B_tree_a_tree_fun$ B_tree$) A_tree$)
(declare-fun fun_app$bg (B_a_fun$ B$) A$)
(declare-fun fun_app$bh (B_tree_tree_b_tree_tree_fun$ B_tree_tree$) B_tree_tree$)
(declare-fun fun_app$bi (A_b_fun_a_a_fun_fun$ A_b_fun$) A_a_fun$)
(declare-fun fun_app$bj (A_a_fun_a_a_fun_fun$ A_a_fun$) A_a_fun$)
(declare-fun fun_app$bk (B_a_fun_b_b_fun_fun$ B_a_fun$) B_b_fun$)
(declare-fun fun_app$bl (B_a_fun_b_a_fun_fun$ B_a_fun$) B_a_fun$)
(declare-fun fun_app$bm (B_b_fun_b_a_fun_fun$ B_b_fun$) B_a_fun$)
(declare-fun fun_app$bn (A_tree_b_b_prod_tree_fun$ A_tree$) B_b_prod_tree$)
(declare-fun fun_app$bo (A_a_fun_a_b_b_prod_fun_fun$ A_a_fun$) A_b_b_prod_fun$)
(declare-fun fun_app$bp (A_a_sum_tree_a_tree_fun$ A_a_sum_tree$) A_tree$)
(declare-fun fun_app$bq (A_a_sum_tree_b_tree_fun$ A_a_sum_tree$) B_tree$)
(declare-fun fun_app$br (A_tree_b_tree_fun_a_tree_b_tree_fun_fun$ A_tree_b_tree_fun$) A_tree_b_tree_fun$)
(declare-fun fun_app$bs (A_tree_a_tree_fun_a_tree_b_tree_fun_fun$ A_tree_a_tree_fun$) A_tree_b_tree_fun$)
(declare-fun fun_app$bt (A_tree_b_tree_fun_a_tree_a_tree_fun_fun$ A_tree_b_tree_fun$) A_tree_a_tree_fun$)
(declare-fun fun_app$bu (A_tree_a_tree_fun_a_tree_a_tree_fun_fun$ A_tree_a_tree_fun$) A_tree_a_tree_fun$)
(declare-fun fun_app$bv (B_tree_a_tree_fun_b_tree_b_tree_fun_fun$ B_tree_a_tree_fun$) B_tree_b_tree_fun$)
(declare-fun fun_app$bw (B_b_sum_tree_b_b_sum_tree_fun$ B_b_sum_tree$) B_b_sum_tree$)
(declare-fun fun_app$bx (B_tree_b_tree_fun_tree_b_tree_b_tree_fun_tree_fun$ B_tree_b_tree_fun_tree$) B_tree_b_tree_fun_tree$)
(declare-fun fun_app$by (B_b_fun_tree_b_b_fun_tree_fun$ B_b_fun_tree$) B_b_fun_tree$)
(declare-fun fun_app$bz (A_b_fun_tree_a_b_fun_tree_fun$ A_b_fun_tree$) A_b_fun_tree$)
(declare-fun fun_app$ca (B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_fun_b_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod_b_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod_fun_fun$ B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_fun$) B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod_b_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod_fun$)
(declare-fun fun_app$cb (B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_fun$ B_tree_a_b_fun_sum$) B_tree_a_b_fun_sum$)
(declare-fun fun_app$cc (B_b_tree_a_b_fun_sum_fun$ B$) B_tree_a_b_fun_sum$)
(declare-fun fun_app$cd (B_tree_a_b_fun_sum_b_fun$ B_tree_a_b_fun_sum$) B$)
(declare-fun fun_app$ce (B_b_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod_prod_b_b_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod_prod_fun$ B_b_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod_prod$) B_b_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod_prod$)
(declare-fun fun_app$cf (B_b_prod_b_b_prod_fun$ B_b_prod$) B_b_prod$)
(declare-fun fun_app$cg (A_a_prod_b_b_prod_fun$ A_a_prod$) B_b_prod$)
(declare-fun fun_app$ch (A_a_prod_a_a_prod_fun$ A_a_prod$) A_a_prod$)
(declare-fun fun_app$ci (A_tree_b_fun$ A_tree$) B$)
(declare-fun fun_app$cj (B_b_sum_b_fun$ B_b_sum$) B$)
(declare-fun fun_app$ck (A_a_sum_b_fun$ A_a_sum$) B$)
(declare-fun fun_app$cl (A_a_sum_a_fun$ A_a_sum$) A$)
(declare-fun fun_app$cm (A_a_fun_a_a_sum_a_fun_fun$ A_a_fun$) A_a_sum_a_fun$)
(declare-fun fun_app$cn (B_b_tree_b_tree_prod_prod_b_b_tree_b_tree_prod_prod_fun$ B_b_tree_b_tree_prod_prod$) B_b_tree_b_tree_prod_prod$)
(declare-fun fun_app$co (B_b_sum_b_b_sum_fun$ B_b_sum$) B_b_sum$)
...
(declare-fun map_tree$e (A_b_b_prod_fun$) A_tree_b_b_prod_tree_fun$)
(declare-fun map_tree$f (A_a_sum_a_fun$) A_a_sum_tree_a_tree_fun$)
(declare-fun map_tree$g (A_a_sum_b_fun$) A_a_sum_tree_b_tree_fun$)
...
(assert (not (forall ((?v0 A_b_fun$)) (= (id_bnf$a (fun_app$az (map_prod$ id$ (fun_app$ba (map_prod$a (fun_app$bb (case_sum$ id$a) uu$)) (fun_app$bb (case_sum$ id$a) uu$))) (id_bnf$ (id_bnf$ (pair$c (fun_app$ac ?v0 x$) (pair$b (inr$ (fun_app$v (comp$b ?v0) l$)) (inr$ (fun_app$v (comp$b ?v0) r$)))))))) (fun_app$bc dtor_tree$ (fun_app$d (map_tree$ ?v0) (node$a x$ (fun_app$bd (map_tree$a l$) t$) (fun_app$bd (map_tree$a r$) t$))))) )))
...
(assert (= t$ (node$a x$ (fun_app$bd (map_tree$a l$) t$) (fun_app$bd (map_tree$a r$) t$))))
(assert (forall ((?v0 A_tree$) (?v1 A_tree$)) (= (= (fun_app$be dtor_tree$a ?v0) (fun_app$be dtor_tree$a ?v1)) (= ?v0 ?v1)) ))
(assert (forall ((?v0 B_tree$) (?v1 B_tree$)) (= (= (fun_app$bc dtor_tree$ ?v0) (fun_app$bc dtor_tree$ ?v1)) (= ?v0 ?v1)) ))
(assert (forall ((?v0 B_a_fun$) (?v1 B$) (?v2 B_tree$) (?v3 B_tree$)) (! (= (fun_app$bf (map_tree$b ?v0) (node$ ?v1 ?v2 ?v3)) (node$a (fun_app$bg ?v0 ?v1) (fun_app$bf (map_tree$b ?v0) ?v2) (fun_app$bf (map_tree$b ?v0) ?v3))) :pattern ((fun_app$bf (map_tree$b ?v0) (node$ ?v1 ?v2 ?v3))))))
(assert (forall ((?v0 B_b_fun$) (?v1 B$) (?v2 B_tree$) (?v3 B_tree$)) (! (= (fun_app$x (map_tree$c ?v0) (node$ ?v1 ?v2 ?v3)) (node$ (fun_app$aa ?v0 ?v1) (fun_app$x (map_tree$c ?v0) ?v2) (fun_app$x (map_tree$c ?v0) ?v3))) :pattern ((fun_app$x (map_tree$c ?v0) (node$ ?v1 ?v2 ?v3))))))
(assert (forall ((?v0 B_tree_b_tree_fun$) (?v1 B_tree$) (?v2 B_tree_tree$) (?v3 B_tree_tree$)) (! (= (fun_app$bh (map_tree$d ?v0) (node$b ?v1 ?v2 ?v3)) (node$b (fun_app$x ?v0 ?v1) (fun_app$bh (map_tree$d ?v0) ?v2) (fun_app$bh (map_tree$d ?v0) ?v3))) :pattern ((fun_app$bh (map_tree$d ?v0) (node$b ?v1 ?v2 ?v3))))))
...
(assert (forall ((?v0 A_a_fun$) (?v1 A$) (?v2 A_tree$) (?v3 A_tree$)) (! (= (fun_app$bd (map_tree$a ?v0) (node$a ?v1 ?v2 ?v3)) (node$a (fun_app$aw ?v0 ?v1) (fun_app$bd (map_tree$a ?v0) ?v2) (fun_app$bd (map_tree$a ?v0) ?v3))) :pattern ((fun_app$bd (map_tree$a ?v0) (node$a ?v1 ?v2 ?v3))))))
(assert (forall ((?v0 B_b_fun$) (?v1 A_b_fun$) (?v2 A_tree$)) (= (fun_app$x (map_tree$c ?v0) (fun_app$d (map_tree$ ?v1) ?v2)) (fun_app$d (map_tree$ (fun_app$u (comp$c ?v0) ?v1)) ?v2)) ))
(assert (forall ((?v0 B_a_fun$) (?v1 A_b_fun$) (?v2 A_tree$)) (= (fun_app$bf (map_tree$b ?v0) (fun_app$d (map_tree$ ?v1) ?v2)) (fun_app$bd (map_tree$a (fun_app$bi (comp$d ?v0) ?v1)) ?v2)) ))
(assert (forall ((?v0 A_b_fun$) (?v1 A_a_fun$) (?v2 A_tree$)) (= (fun_app$d (map_tree$ ?v0) (fun_app$bd (map_tree$a ?v1) ?v2)) (fun_app$d (map_tree$ (fun_app$v (comp$b ?v0) ?v1)) ?v2)) ))
(assert (forall ((?v0 A_a_fun$) (?v1 A_a_fun$) (?v2 A_tree$)) (= (fun_app$bd (map_tree$a ?v0) (fun_app$bd (map_tree$a ?v1) ?v2)) (fun_app$bd (map_tree$a (fun_app$bj (comp$e ?v0) ?v1)) ?v2)) ))
(assert (forall ((?v0 A_b_fun$) (?v1 B_a_fun$) (?v2 B_tree$)) (= (fun_app$d (map_tree$ ?v0) (fun_app$bf (map_tree$b ?v1) ?v2)) (fun_app$x (map_tree$c (fun_app$bk (comp$f ?v0) ?v1)) ?v2)) ))
(assert (forall ((?v0 A_a_fun$) (?v1 B_a_fun$) (?v2 B_tree$)) (= (fun_app$bd (map_tree$a ?v0) (fun_app$bf (map_tree$b ?v1) ?v2)) (fun_app$bf (map_tree$b (fun_app$bl (comp$g ?v0) ?v1)) ?v2)) ))
(assert (forall ((?v0 B_a_fun$) (?v1 B_b_fun$) (?v2 B_tree$)) (= (fun_app$bf (map_tree$b ?v0) (fun_app$x (map_tree$c ?v1) ?v2)) (fun_app$bf (map_tree$b (fun_app$bm (comp$h ?v0) ?v1)) ?v2)) ))
(assert (forall ((?v0 B_b_fun$) (?v1 B_b_fun$) (?v2 B_tree$)) (= (fun_app$x (map_tree$c ?v0) (fun_app$x (map_tree$c ?v1) ?v2)) (fun_app$x (map_tree$c (fun_app$t (comp$a ?v0) ?v1)) ?v2)) ))
(assert (forall ((?v0 A_b_b_prod_fun$) (?v1 A_a_fun$) (?v2 A_tree$)) (= (fun_app$bn (map_tree$e ?v0) (fun_app$bd (map_tree$a ?v1) ?v2)) (fun_app$bn (map_tree$e (fun_app$bo (comp$i ?v0) ?v1)) ?v2)) ))
(assert (forall ((?v0 A_b_fun$) (?v1 A_a_sum_a_fun$) (?v2 A_a_sum_tree$)) (= (fun_app$d (map_tree$ ?v0) (fun_app$bp (map_tree$f ?v1) ?v2)) (fun_app$bq (map_tree$g (comp$j ?v0 ?v1)) ?v2)) ))
(assert (forall ((?v0 B_b_fun$) (?v1 A_b_fun$)) (= (map_tree$ (fun_app$u (comp$c ?v0) ?v1)) (fun_app$br (comp$k (map_tree$c ?v0)) (map_tree$ ?v1))) ))
(assert (forall ((?v0 A_b_fun$) (?v1 A_a_fun$)) (= (map_tree$ (fun_app$v (comp$b ?v0) ?v1)) (fun_app$bs (comp$l (map_tree$ ?v0)) (map_tree$a ?v1))) ))
(assert (forall ((?v0 B_a_fun$) (?v1 A_b_fun$)) (= (map_tree$a (fun_app$bi (comp$d ?v0) ?v1)) (fun_app$bt (comp$m (map_tree$b ?v0)) (map_tree$ ?v1))) ))
(assert (forall ((?v0 A_a_fun$) (?v1 A_a_fun$)) (= (map_tree$a (fun_app$bj (comp$e ?v0) ?v1)) (fun_app$bu (comp$n (map_tree$a ?v0)) (map_tree$a ?v1))) ))
(assert (forall ((?v0 A_a_fun$) (?v1 B_a_fun$)) (= (map_tree$b (fun_app$bl (comp$g ?v0) ?v1)) (comp$o (map_tree$a ?v0) (map_tree$b ?v1))) ))
(assert (forall ((?v0 B_a_fun$) (?v1 B_b_fun$)) (= (map_tree$b (fun_app$bm (comp$h ?v0) ?v1)) (comp$p (map_tree$b ?v0) (map_tree$c ?v1))) ))
(assert (forall ((?v0 A_b_fun$) (?v1 B_a_fun$)) (= (map_tree$c (fun_app$bk (comp$f ?v0) ?v1)) (fun_app$bv (comp$q (map_tree$ ?v0)) (map_tree$b ?v1))) ))
(assert (forall ((?v0 B_b_fun$) (?v1 B_b_fun$)) (= (map_tree$c (fun_app$t (comp$a ?v0) ?v1)) (fun_app$s (comp$ (map_tree$c ?v0)) (map_tree$c ?v1))) ))
(assert (forall ((?v0 A_b_b_prod_fun$) (?v1 A_a_fun$)) (= (map_tree$e (fun_app$bo (comp$i ?v0) ?v1)) (comp$r (map_tree$e ?v0) (map_tree$a ?v1))) ))
(assert (forall ((?v0 A_b_fun$) (?v1 A_a_sum_a_fun$)) (= (map_tree$g (comp$j ?v0 ?v1)) (comp$s (map_tree$ ?v0) (map_tree$f ?v1))) ))
(assert (forall ((?v0 B_tree$)) (= (fun_app$x (map_tree$c uua$) ?v0) ?v0) ))
(assert (forall ((?v0 B_tree_tree$)) (= (fun_app$bh (map_tree$d uub$) ?v0) ?v0) ))
(assert (forall ((?v0 A_tree$)) (= (fun_app$bd (map_tree$a uuc$) ?v0) ?v0) ))
(assert (forall ((?v0 B_b_sum_tree$)) (= (fun_app$bw (map_tree$h id$b) ?v0) ?v0) ))
(assert (forall ((?v0 B_tree_b_tree_fun_tree$)) (= (fun_app$bx (map_tree$i id$c) ?v0) ?v0) ))
(assert (forall ((?v0 B_b_fun_tree$)) (= (fun_app$by (map_tree$j id$d) ?v0) ?v0) ))
(assert (forall ((?v0 A_b_fun_tree$)) (= (fun_app$bz (map_tree$k id$e) ?v0) ?v0) ))
(assert (forall ((?v0 B_tree$)) (= (fun_app$x (map_tree$c id$) ?v0) ?v0) ))
(assert (forall ((?v0 B_tree_tree$)) (= (fun_app$bh (map_tree$d id$a) ?v0) ?v0) ))
(assert (forall ((?v0 A_tree$)) (= (fun_app$bd (map_tree$a id$f) ?v0) ?v0) ))
(assert (= (map_tree$h id$b) id$g))
(assert (= (map_tree$i id$c) id$h))
(assert (= (map_tree$j id$d) id$i))
(assert (= (map_tree$k id$e) id$j))
(assert (= (map_tree$c id$) id$a))
(assert (= (map_tree$d id$a) id$k))
(assert (= (map_tree$a id$f) id$l))
(assert (forall ((?v0 A_a_tree_a_tree_prod_prod$)) (=> (forall ((?v1 A_tree$)) (=> (= ?v0 (fun_app$be dtor_tree$a ?v1)) false) ) false) ))
...
(assert (forall ((?v0 B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_fun$) (?v1 B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_fun$) (?v2 B_tree_a_b_fun_sum$) (?v3 B_tree_a_b_fun_sum$)) (! (= (fun_app$ay (fun_app$ca (map_prod$b ?v0) ?v1) (pair$b ?v2 ?v3)) (pair$b (fun_app$cb ?v0 ?v2) (fun_app$cb ?v1 ?v3))) :pattern ((fun_app$ay (fun_app$ca (map_prod$b ?v0) ?v1) (pair$b ?v2 ?v3))))))
(assert (forall ((?v0 B_b_tree_a_b_fun_sum_fun$) (?v1 B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod_b_tree_a_b_fun_sum_fun$) (?v2 B$) (?v3 B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod$)) (! (= (map_prod$c ?v0 ?v1 (pair$c ?v2 ?v3)) (pair$b (fun_app$cc ?v0 ?v2) (fun_app$f ?v1 ?v3))) :pattern ((map_prod$c ?v0 ?v1 (pair$c ?v2 ?v3))))))
(assert (forall ((?v0 B_tree_a_b_fun_sum_b_fun$) (?v1 B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod_fun$) (?v2 B_tree_a_b_fun_sum$) (?v3 B_tree_a_b_fun_sum$)) (! (= (map_prod$d ?v0 ?v1 (pair$b ?v2 ?v3)) (pair$c (fun_app$cd ?v0 ?v2) (fun_app$a ?v1 ?v3))) :pattern ((map_prod$d ?v0 ?v1 (pair$b ?v2 ?v3))))))
(assert (forall ((?v0 B_b_fun$) (?v1 B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod_b_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod_fun$) (?v2 B$) (?v3 B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod$)) (! (= (fun_app$ce (map_prod$e ?v0 ?v1) (pair$c ?v2 ?v3)) (pair$c (fun_app$aa ?v0 ?v2) (fun_app$ay ?v1 ?v3))) :pattern ((fun_app$ce (map_prod$e ?v0 ?v1) (pair$c ?v2 ?v3))))))
(assert (forall ((?v0 B_b_fun$) (?v1 B_b_fun$) (?v2 B$) (?v3 B$)) (! (= (fun_app$cf (map_prod$f ?v0 ?v1) (pair$f ?v2 ?v3)) (pair$f (fun_app$aa ?v0 ?v2) (fun_app$aa ?v1 ?v3))) :pattern ((fun_app$cf (map_prod$f ?v0 ?v1) (pair$f ?v2 ?v3))))))
(assert (forall ((?v0 A_b_fun$) (?v1 A_b_fun$) (?v2 A$) (?v3 A$)) (! (= (fun_app$cg (map_prod$g ?v0 ?v1) (pair$g ?v2 ?v3)) (pair$f (fun_app$ac ?v0 ?v2) (fun_app$ac ?v1 ?v3))) :pattern ((fun_app$cg (map_prod$g ?v0 ?v1) (pair$g ?v2 ?v3))))))
(assert (forall ((?v0 A_a_fun$) (?v1 A_a_fun$) (?v2 A$) (?v3 A$)) (! (= (fun_app$ch (map_prod$h ?v0 ?v1) (pair$g ?v2 ?v3)) (pair$g (fun_app$aw ?v0 ?v2) (fun_app$aw ?v1 ?v3))) :pattern ((fun_app$ch (map_prod$h ?v0 ?v1) (pair$g ?v2 ?v3))))))
(assert (forall ((?v0 A_tree_b_fun$) (?v1 A_tree_b_fun$) (?v2 A_tree$) (?v3 A_tree$)) (! (= (map_prod$i ?v0 ?v1 (pair$d ?v2 ?v3)) (pair$f (fun_app$ci ?v0 ?v2) (fun_app$ci ?v1 ?v3))) :pattern ((map_prod$i ?v0 ?v1 (pair$d ?v2 ?v3))))))
(assert (forall ((?v0 A_b_b_prod_fun$)) (= (fun_app$bo (comp$i ?v0) id$f) ?v0) ))
(assert (forall ((?v0 A_a_fun$)) (= (fun_app$bj (comp$e ?v0) id$f) ?v0) ))
(assert (forall ((?v0 A_b_fun$)) (= (fun_app$v (comp$b ?v0) id$f) ?v0) ))
(assert (forall ((?v0 A_b_fun$)) (= (fun_app$u (comp$c id$) ?v0) ?v0) ))
(assert (forall ((?v0 A_a_fun$)) (= (fun_app$bj (comp$e id$f) ?v0) ?v0) ))
(assert (forall ((?v0 A_b_fun$)) (= (fun_app$u (comp$c id$) ?v0) ?v0) ))
(assert (forall ((?v0 A_a_fun$)) (= (fun_app$bj (comp$e id$f) ?v0) ?v0) ))
(assert (forall ((?v0 B$) (?v1 B_b_sum$)) (= (fun_app$cj (case_sum$a (uud$ ?v0) (uud$ ?v0)) ?v1) ?v0) ))
...
(assert (forall ((?v0 B$) (?v1 A_a_sum$)) (= (fun_app$ck (case_sum$d (uue$ ?v0) (uue$ ?v0)) ?v1) ?v0) ))
(assert (forall ((?v0 A$) (?v1 A_a_sum$)) (= (fun_app$cl (fun_app$cm (case_sum$e (uug$ ?v0)) (uug$ ?v0)) ?v1) ?v0) ))
(assert (forall ((?v0 B_tree$) (?v1 B_tree_a_b_fun_sum$)) (= (fun_app$w (fun_app$bb (case_sum$ (uuh$ ?v0)) (uui$ ?v0)) ?v1) ?v0) ))
(assert (forall ((?v0 B_b_tree_b_tree_prod_prod$)) (= (fun_app$cn (map_prod$j uua$ uuj$) ?v0) ?v0) ))
(assert (forall ((?v0 B_b_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod_prod$)) (= (fun_app$ce (map_prod$e uua$ uuk$) ?v0) ?v0) ))
(assert (forall ((?v0 B_b_prod$)) (= (fun_app$cf (map_prod$f uua$ uua$) ?v0) ?v0) ))
(assert (forall ((?v0 A_a_prod$)) (= (fun_app$ch (map_prod$h uuc$ uuc$) ?v0) ?v0) ))
(assert (forall ((?v0 A_b_fun$) (?v1 A_b_fun$)) (= (= (inr$ ?v0) (inr$ ?v1)) (= ?v0 ?v1)) ))
(assert (forall ((?v0 A_b_fun$) (?v1 A_b_fun$)) (= (= (inr$ ?v0) (inr$ ?v1)) (= ?v0 ?v1)) ))
(assert (forall ((?v0 B_b_sum$)) (! (= (fun_app$co id$b ?v0) ?v0) :pattern ((fun_app$co id$b ?v0)))))
...
(assert (forall ((?v0 B_a_fun$) (?v1 A_b_fun$) (?v2 A$)) (! (= (fun_app$aw (fun_app$bi (comp$d ?v0) ?v1) ?v2) (fun_app$bg ?v0 (fun_app$ac ?v1 ?v2))) :pattern ((fun_app$aw (fun_app$bi (comp$d ?v0) ?v1) ?v2)))))
(assert (forall ((?v0 A_b_b_prod_fun$) (?v1 A_a_fun$) (?v2 A$)) (! (= (fun_app$cp (fun_app$bo (comp$i ?v0) ?v1) ?v2) (fun_app$cp ?v0 (fun_app$aw ?v1 ?v2))) :pattern ((fun_app$cp (fun_app$bo (comp$i ?v0) ?v1) ?v2)))))
(assert (forall ((?v0 A_b_fun$) (?v1 A_a_sum_a_fun$) (?v2 A_a_sum$)) (! (= (fun_app$ck (comp$j ?v0 ?v1) ?v2) (fun_app$ac ?v0 (fun_app$cl ?v1 ?v2))) :pattern ((fun_app$ck (comp$j ?v0 ?v1) ?v2)))))
(assert (forall ((?v0 A_a_fun$) (?v1 A_a_fun$) (?v2 A$)) (! (= (fun_app$aw (fun_app$bj (comp$e ?v0) ?v1) ?v2) (fun_app$aw ?v0 (fun_app$aw ?v1 ?v2))) :pattern ((fun_app$aw (fun_app$bj (comp$e ?v0) ?v1) ?v2)))))
...
(assert (forall ((?v0 A_b_fun$) (?v1 A_a_fun$) (?v2 A_a_fun$)) (= (fun_app$v (comp$b (fun_app$v (comp$b ?v0) ?v1)) ?v2) (fun_app$v (comp$b ?v0) (fun_app$bj (comp$e ?v1) ?v2))) ))
...
(assert (forall ((?v0 A_b_fun$) (?v1 A_a_fun$) (?v2 A_a_fun$)) (= (fun_app$v (comp$b ?v0) (fun_app$bj (comp$e ?v1) ?v2)) (fun_app$v (comp$b (fun_app$v (comp$b ?v0) ?v1)) ?v2)) ))
(assert (forall ((?v0 B$)) (! (= (fun_app$aa id$ ?v0) ?v0) :pattern ((fun_app$aa id$ ?v0)))))
(assert (forall ((?v0 B_tree$)) (! (= (fun_app$x id$a ?v0) ?v0) :pattern ((fun_app$x id$a ?v0)))))
(assert (forall ((?v0 A_b_fun$) (?v1 A_b_fun$)) (=> (= (inr$ ?v0) (inr$ ?v1)) (= ?v0 ?v1)) ))
...
(assert (forall ((?v0 B_tree_a_b_fun_sum_b_tree_fun$) (?v1 B_tree_a_b_fun_sum_b_tree_fun$) (?v2 B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_fun$) (?v3 B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_fun$)) (= (fun_app$cu (comp$y (fun_app$ba (map_prod$a ?v0) ?v1)) (fun_app$ca (map_prod$b ?v2) ?v3)) (fun_app$ba (map_prod$a (fun_app$cv (comp$z ?v0) ?v2)) (fun_app$cv (comp$z ?v1) ?v3))) ))
...
(assert (forall ((?v0 B_b_prod$)) (= (fun_app$cf (map_prod$f id$ id$) ?v0) ?v0) ))
...
(assert (forall ((?v0 A_b_fun$) (?v1 A_a_fun$) (?v2 A_a_fun$)) (= (comp$j ?v0 (fun_app$cm (case_sum$e ?v1) ?v2)) (case_sum$d (fun_app$v (comp$b ?v0) ?v1) (fun_app$v (comp$b ?v0) ?v2))) ))
...
(assert (forall ((?v0 B_b_fun$) (?v1 A$) (?v2 A_a_fun$) (?v3 A_a_fun$) (?v4 A_b_fun$)) (= (fun_app$x (map_tree$c ?v0) (fun_app$c (fun_app$dh (fun_app$di (unfold_tree$ (uuo$ ?v1)) (uup$ ?v2)) (uup$ ?v3)) ?v4)) (fun_app$c (fun_app$dh (fun_app$di (unfold_tree$ (uuo$ ?v1)) (uup$ ?v2)) (uup$ ?v3)) (fun_app$u (comp$c ?v0) ?v4))) ))
...
(assert (forall ((?v0 A_a_fun$) (?v1 A_a_fun$) (?v2 A_a_fun$) (?v3 A_a_fun$) (?v4 A_b_fun$) (?v5 A_b_fun$)) (=> (and (= (fun_app$bj (comp$e ?v0) ?v1) (fun_app$bj (comp$e ?v2) ?v3)) (= (fun_app$v (comp$b ?v4) ?v2) ?v5)) (= (fun_app$v (comp$b (fun_app$v (comp$b ?v4) ?v0)) ?v1) (fun_app$v (comp$b ?v5) ?v3))) ))
...
(assert (forall ((?v0 B_b_fun$) (?v1 A_b_fun$) (?v2 A_b_fun$) (?v3 A_a_fun$) (?v4 A_a_fun$) (?v5 A_a_fun$)) (=> (and (= (fun_app$u (comp$c ?v0) ?v1) (fun_app$v (comp$b ?v2) ?v3)) (= (fun_app$bj (comp$e ?v3) ?v4) ?v5)) (= (fun_app$u (comp$c ?v0) (fun_app$v (comp$b ?v1) ?v4)) (fun_app$v (comp$b ?v2) ?v5))) ))
(assert (forall ((?v0 A_b_fun$) (?v1 A_a_fun$) (?v2 B_b_fun$) (?v3 A_b_fun$) (?v4 A_a_fun$) (?v5 A_b_fun$)) (=> (and (= (fun_app$v (comp$b ?v0) ?v1) (fun_app$u (comp$c ?v2) ?v3)) (= (fun_app$v (comp$b ?v3) ?v4) ?v5)) (= (fun_app$v (comp$b ?v0) (fun_app$bj (comp$e ?v1) ?v4)) (fun_app$u (comp$c ?v2) ?v5))) ))
(assert (forall ((?v0 A_b_fun$) (?v1 A_a_fun$) (?v2 A_b_fun$) (?v3 A_a_fun$) (?v4 A_a_fun$) (?v5 A_a_fun$)) (=> (and (= (fun_app$v (comp$b ?v0) ?v1) (fun_app$v (comp$b ?v2) ?v3)) (= (fun_app$bj (comp$e ?v3) ?v4) ?v5)) (= (fun_app$v (comp$b ?v0) (fun_app$bj (comp$e ?v1) ?v4)) (fun_app$v (comp$b ?v2) ?v5))) ))
(assert (forall ((?v0 A_a_fun$) (?v1 A_a_fun$) (?v2 A_a_fun$) (?v3 A_b_fun$)) (=> (= (fun_app$bj (comp$e ?v0) ?v1) ?v2) (= (fun_app$v (comp$b (fun_app$v (comp$b ?v3) ?v0)) ?v1) (fun_app$v (comp$b ?v3) ?v2))) ))
...
(assert (forall ((?v0 A_b_fun$) (?v1 A_a_fun$) (?v2 A_b_fun$) (?v3 A_a_fun$)) (=> (= (fun_app$v (comp$b ?v0) ?v1) ?v2) (= (fun_app$v (comp$b ?v0) (fun_app$bj (comp$e ?v1) ?v3)) (fun_app$v (comp$b ?v2) ?v3))) ))
...
(assert (forall ((?v0 B_b_tree_b_tree_prod_prod$)) (= (fun_app$cn (map_pre_tree$d id$ id$a) ?v0) ?v0) ))
...
(assert (forall ((?v0 A_b_fun$) (?v1 B_tree_a_b_tree_b_tree_prod_prod_fun$)) (= (fun_app$bv (comp$q (map_tree$ ?v0)) (dtor_unfold_tree$b ?v1)) (dtor_unfold_tree$c (comp$aj (map_pre_tree$h ?v0 id$a) ?v1))) ))
(assert (forall ((?v0 A_a_fun$) (?v1 B_a_b_b_prod_prod_fun$)) (= (comp$ak (map_tree$a ?v0) (dtor_unfold_tree$ ?v1)) (dtor_unfold_tree$ (fun_app$dx (comp$al (map_pre_tree$i ?v0 id$)) ?v1))) ))
(assert (forall ((?v0 A_a_fun$) (?v1 B_tree_a_b_tree_b_tree_prod_prod_fun$)) (= (comp$o (map_tree$a ?v0) (dtor_unfold_tree$b ?v1)) (dtor_unfold_tree$b (fun_app$dy (comp$am (map_pre_tree$j ?v0 id$a)) ?v1))) ))
...
(assert (forall ((?v0 A_a_fun$) (?v1 A_tree$)) (= (fun_app$be dtor_tree$a (fun_app$bd (map_tree$a ?v0) ?v1)) (fun_app$ef (map_pre_tree$k ?v0 (map_tree$a ?v0)) (fun_app$be dtor_tree$a ?v1))) ))
(assert (forall ((?v0 A_b_fun$) (?v1 A_tree$)) (= (fun_app$bc dtor_tree$ (fun_app$d (map_tree$ ?v0) ?v1)) (fun_app$eg (map_pre_tree$l ?v0 (map_tree$ ?v0)) (fun_app$be dtor_tree$a ?v1))) ))
(assert (forall ((?v0 B_b_fun$) (?v1 B_tree$)) (= (fun_app$bc dtor_tree$ (fun_app$x (map_tree$c ?v0) ?v1)) (fun_app$cn (map_pre_tree$d ?v0 (map_tree$c ?v0)) (fun_app$bc dtor_tree$ ?v1))) ))
(assert (forall ((?v0 A_tree_a_tree_fun$) (?v1 A_a_fun$)) (=> (= (comp$ax dtor_tree$a ?v0) (comp$ay (map_pre_tree$k ?v1 ?v0) dtor_tree$a)) (= ?v0 (map_tree$a ?v1))) ))
...
(assert (forall ((?v0 B_tree_b_tree_fun$) (?v1 B_b_fun$)) (=> (= (comp$bb dtor_tree$ ?v0) (comp$bc (map_pre_tree$d ?v1 ?v0) dtor_tree$)) (= ?v0 (map_tree$c ?v1))) ))
(assert (forall ((?v0 A_b_fun$) (?v1 A_b_fun$) (?v2 A_a_fun$)) (= (fun_app$bo (comp$i (fun_app$eh (convol$h ?v0) ?v1)) ?v2) (fun_app$eh (convol$h (fun_app$v (comp$b ?v0) ?v2)) (fun_app$v (comp$b ?v1) ?v2))) ))
(assert (forall ((?v0 A_a_fun$) (?v1 A_a_fun$) (?v2 A$)) (! (= (fun_app$dp (fun_app$cz (tree_recurse$b ?v0) ?v1) ?v2) (node$a ?v2 (fun_app$bd (map_tree$a ?v0) (fun_app$dp (fun_app$cz (tree_recurse$b ?v0) ?v1) ?v2)) (fun_app$bd (map_tree$a ?v1) (fun_app$dp (fun_app$cz (tree_recurse$b ?v0) ?v1) ?v2)))) :pattern ((fun_app$dp (fun_app$cz (tree_recurse$b ?v0) ?v1) ?v2)))))
...
(assert (forall ((?v0 A_b_fun$) (?v1 B_tree_a_a_tree_b_tree_sum_a_tree_b_tree_sum_prod_prod_fun$)) (= (fun_app$bv (comp$q (map_tree$ ?v0)) (dtor_corec_tree$c ?v1)) (dtor_corec_tree$d (comp$bf (map_pre_tree$n ?v0 (map_sum$a (map_tree$ ?v0) id$a)) ?v1))) ))
(assert (forall ((?v0 A_a_fun$) (?v1 B_a_a_tree_b_sum_a_tree_b_sum_prod_prod_fun$)) (= (comp$ak (map_tree$a ?v0) (dtor_corec_tree$a ?v1)) (dtor_corec_tree$a (fun_app$ej (comp$bg (map_pre_tree$o ?v0 (map_sum$b (map_tree$a ?v0) id$))) ?v1))) ))
(assert (forall ((?v0 A_a_fun$) (?v1 B_tree_a_a_tree_b_tree_sum_a_tree_b_tree_sum_prod_prod_fun$)) (= (comp$o (map_tree$a ?v0) (dtor_corec_tree$c ?v1)) (dtor_corec_tree$c (fun_app$ek (comp$bh (map_pre_tree$p ?v0 (map_sum$c (map_tree$a ?v0) id$a))) ?v1))) ))
...
(assert (forall ((?v0 B_b_sum$)) (= (fun_app$co (map_sum$f id$ id$) ?v0) ?v0) ))
...
(assert (forall ((?v0 B_tree_b_tree_fun$) (?v1 A_b_fun_a_b_fun_fun$) (?v2 Bool) (?v3 A_b_fun$) (?v4 B_tree_a_b_fun_sum$)) (= (fun_app$cb (fun_app$eq (map_sum$j ?v0) ?v1) (ite ?v2 (inr$ ?v3) ?v4)) (ite ?v2 (inr$ (fun_app$u ?v1 ?v3)) (fun_app$cb (fun_app$eq (map_sum$j ?v0) ?v1) ?v4))) ))
(assert (forall ((?v0 B_tree_b_tree_fun$) (?v1 A_b_fun_a_b_fun_fun$) (?v2 Bool) (?v3 B_tree_a_b_fun_sum$) (?v4 A_b_fun$)) (= (fun_app$cb (fun_app$eq (map_sum$j ?v0) ?v1) (ite ?v2 ?v3 (inr$ ?v4))) (ite ?v2 (fun_app$cb (fun_app$eq (map_sum$j ?v0) ?v1) ?v3) (inr$ (fun_app$u ?v1 ?v4)))) ))
(assert (forall ((?v0 B_tree_b_tree_fun$) (?v1 A_b_fun_a_b_fun_fun$)) (= (comp$bj (fun_app$eq (map_sum$j ?v0) ?v1) uun$) (comp$bk uun$ ?v1)) ))
(assert (forall ((?v0 B_tree_b_tree_fun$) (?v1 A_b_fun_a_b_fun_fun$) (?v2 A_b_fun$)) (! (= (fun_app$cb (fun_app$eq (map_sum$j ?v0) ?v1) (inr$ ?v2)) (inr$ (fun_app$u ?v1 ?v2))) :pattern ((fun_app$cb (fun_app$eq (map_sum$j ?v0) ?v1) (inr$ ?v2))))))
...
(assert (forall ((?v0 A_b_fun$) (?v1 A_b_fun$) (?v2 A_a_fun$) (?v3 A_a_fun$) (?v4 A_a_sum$)) (= (fun_app$ck (case_sum$d ?v0 ?v1) (fun_app$em (map_sum$e ?v2 ?v3) ?v4)) (fun_app$ck (case_sum$d (fun_app$v (comp$b ?v0) ?v2) (fun_app$v (comp$b ?v1) ?v3)) ?v4)) ))
(assert (forall ((?v0 B_tree_b_tree_fun$) (?v1 A_b_fun_b_tree_fun$) (?v2 B_tree_b_tree_fun$) (?v3 A_b_fun_a_b_fun_fun$) (?v4 B_tree_a_b_fun_sum$)) (= (fun_app$w (fun_app$bb (case_sum$ ?v0) ?v1) (fun_app$cb (fun_app$eq (map_sum$j ?v2) ?v3) ?v4)) (fun_app$w (fun_app$bb (case_sum$ (fun_app$s (comp$ ?v0) ?v2)) (fun_app$dh (comp$bm ?v1) ?v3)) ?v4)) ))
(assert (forall ((?v0 B_b_fun$) (?v1 B_b_fun$) (?v2 B_b_sum$)) (= (comp$bn (case_sum$a id$ ?v0) (map_sum$f ?v1 id$) ?v2) (fun_app$cj (case_sum$a (fun_app$t (comp$a ?v1) id$) ?v0) ?v2)) ))
...
(assert (forall ((?v0 B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_fun$) (?v1 B_tree_a_b_fun_sum$) (?v2 B_tree_a_b_fun_sum$)) (! (= (fun_app$ay (apfst$a ?v0) (pair$b ?v1 ?v2)) (pair$b (fun_app$cb ?v0 ?v1) ?v2)) :pattern ((fun_app$ay (apfst$a ?v0) (pair$b ?v1 ?v2))))))
...
(assert (forall ((?v0 B_tree_a_b_fun_sum_b_tree_a_b_fun_sum_fun$) (?v1 B_tree_a_b_fun_sum$) (?v2 B_tree_a_b_fun_sum$)) (! (= (fun_app$ay (apsnd$a ?v0) (pair$b ?v1 ?v2)) (pair$b ?v1 (fun_app$cb ?v0 ?v2))) :pattern ((fun_app$ay (apsnd$a ?v0) (pair$b ?v1 ?v2))))))
...
(assert (forall ((?v0 B_tree_a_b_fun_sum$)) (= (fun_app$cb (fun_app$fi (comp$ch uvh$) uvl$) ?v0) (id$z ?v0)) ))
...
(assert (forall ((?v0 B_tree_a_b_fun_sum$)) (= (fun_app$cb (fun_app$fi (comp$ch uvd$) uvl$) ?v0) (id$z ?v0)) ))
...
(assert (forall ((?v0 A_b_fun$) (?v1 A_a_fun$)) (= (fun_app$v (comp$b (ctor_rec$ ?v0)) ?v1) (ctor_rec$ (fun_app$v (comp$b ?v0) (fun_app$bj (comp$e (fun_app$bj (comp$e id_bnf$c) ?v1)) id_bnf$c)))) ))
...
(assert (forall ((?v0 B_b_tree_a_b_fun_sum_b_tree_a_b_fun_sum_prod_prod$)) (! (= (fun_app$ce (uncurry$b uvp$) ?v0) ?v0) :pattern ((fun_app$ce (uncurry$b uvp$) ?v0)))))
