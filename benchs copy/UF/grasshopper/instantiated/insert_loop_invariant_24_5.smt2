...
(set-info :source |
  ...
  tests/spl/sl/sl_insert.spl:24:5-6:An invariant might not be maintained by a loop in procedure insert
  tests/spl/sl/sl_insert.spl:20:16-69:Related location: This is the loop invariant that might not be maintained
  |)
...
(assert (or (Btwn$0 next$0 curr_5$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_84$0 next$0 curr_5$0 null$0))))

(assert (or (Btwn$0 next$0 lst_2$0 curr_5$0 curr_5$0)
    (not (lseg_struct$0 sk_?X_86$0 next$0 lst_2$0 curr_5$0))))
...
(assert (lseg_struct$0 sk_?X_82$0 next$0 lst_init$0 curr_init$0))
...
(assert (or (Btwn$0 next$0 curr_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_80$0 next$0 curr_init$0 null$0))))

(assert (or (Btwn$0 next$0 lst_init$0 curr_init$0 curr_init$0)
    (not (lseg_struct$0 sk_?X_82$0 next$0 lst_init$0 curr_init$0))))
...
(assert (= sk_?X_80$0 (lseg_domain$0 next$0 curr_init$0 null$0)))

(assert (= sk_?X_82$0 (lseg_domain$0 next$0 lst_init$0 curr_init$0)))

(assert (lseg_struct$0 sk_?X_80$0 next$0 curr_init$0 null$0))

(assert (not (= curr_init$0 null$0)))

(assert (= sk_?X_84$0 (lseg_domain$0 next$0 curr_5$0 null$0)))

(assert (= sk_?X_86$0 (lseg_domain$0 next$0 lst_2$0 curr_5$0)))

(assert (or (= curr_5$0 null$0)
    (in$0 sk_?e_3$0 (intersection$0 sk_?X_85$0 sk_?X_84$0))
