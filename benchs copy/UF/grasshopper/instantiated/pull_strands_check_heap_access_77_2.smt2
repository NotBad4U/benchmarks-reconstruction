...
(assert (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_149$0 next$0 lst$0 null$0))))

(assert (= curr_2$0 rest_3$0))

(assert (= rest_3$0 (read$0 next$0 lst$0)))

(assert (= sorted_tail_2$0 sorted_4$0))

(assert (= emptyset$0 emptyset$0))

(assert (= sk_?X_148$0 FP$0))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (not (= lst$0 null$0)))

(assert (not (in$0 sorted_tail_2$0 FP$0)))

(assert (= FP_Caller_3$0 (setminus$0 FP_Caller$0 FP$0)))

(assert (= prv_2$0 null$0))

(assert (= sorted_4$0 lst$0))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X_148$0 sk_?X_149$0))

(assert (= sk_?X_149$0 (lseg_domain$0 next$0 lst$0 null$0)))

(assert (lseg_struct$0 sk_?X_149$0 next$0 lst$0 null$0))
