...
(assert (forall ((?y Loc))
        (or (not (Btwn$0 next$0 res_3$0 ?y ?y)) (= res_3$0 ?y)
            (Btwn$0 next$0 res_3$0 (read$0 next$0 res_3$0) ?y))))
...
(assert (forall ((?y Loc))
        (or (not (Btwn$0 next_2$0 res_3$0 ?y ?y)) (= res_3$0 ?y)
            (Btwn$0 next_2$0 res_3$0 (read$0 next_2$0 res_3$0) ?y))))
...
(assert (forall ((?y Loc))
        (or (not (= (read$0 next$0 res_3$0) res_3$0))
            (not (Btwn$0 next$0 res_3$0 ?y ?y)) (= res_3$0 ?y))))
...
(assert (forall ((?y Loc))
        (or (not (= (read$0 next_2$0 res_3$0) res_3$0))
            (not (Btwn$0 next_2$0 res_3$0 ?y ?y)) (= res_3$0 ?y))))

(assert (Btwn$0 next$0 null$0 (read$0 next$0 null$0) (read$0 next$0 null$0)))

(assert (Btwn$0 next$0 res_3$0 (read$0 next$0 res_3$0) (read$0 next$0 res_3$0)))

(assert (Btwn$0 next_2$0 null$0 (read$0 next_2$0 null$0) (read$0 next_2$0 null$0)))

(assert (Btwn$0 next_2$0 res_3$0 (read$0 next_2$0 res_3$0) (read$0 next_2$0 res_3$0)))
...
(assert (or (not Axiom_5$0)
    (or (= (read$0 next$0 res_3$0) (read$0 next_2$0 res_3$0))
        (not (in$0 res_3$0 (setminus$0 Alloc$0 FP_4$0))))))
...
(assert (or (not Axiom_4$0)
    (forall ((?y Loc) (?z Loc))
            (or
                (and (Btwn$0 next$0 n1_3$0 ?z ?y)
                     (Btwn$0 next_2$0 n1_3$0 ?z ?y))
                (and (not (Btwn$0 next$0 n1_3$0 ?z ?y))
                     (not (Btwn$0 next_2$0 n1_3$0 ?z ?y)))
                (not
                     (or
                         (Btwn$0 next$0 n1_3$0 ?y
                           (ep$0 next$0 FP_4$0 n1_3$0))
                         (and (Btwn$0 next$0 n1_3$0 ?y ?y)
                              (not
                                   (Btwn$0 next$0 n1_3$0
                                     (ep$0 next$0 FP_4$0 n1_3$0)
                                     (ep$0 next$0 FP_4$0 n1_3$0))))))))))
    ...
    (forall ((?y Loc) (?z Loc))
            (or
                (and (Btwn$0 next$0 n2_2$0 ?z ?y)
                     (Btwn$0 next_2$0 n2_2$0 ?z ?y))
                (and (not (Btwn$0 next$0 n2_2$0 ?z ?y))
                     (not (Btwn$0 next_2$0 n2_2$0 ?z ?y)))
                (not
                     (or
                         (Btwn$0 next$0 n2_2$0 ?y
                           (ep$0 next$0 FP_4$0 n2_2$0))
    ...
    (forall ((?y Loc) (?z Loc))
            (or
                (and (Btwn$0 next$0 res_3$0 ?z ?y)
                     (Btwn$0 next_2$0 res_3$0 ?z ?y))
                (and (not (Btwn$0 next$0 res_3$0 ?z ?y))
                     (not (Btwn$0 next_2$0 res_3$0 ?z ?y)))
                (not
                     (or
                         (Btwn$0 next$0 res_3$0 ?y
                           (ep$0 next$0 FP_4$0 res_3$0))
...
(assert (or (not Axiom_3$0)
    (forall ((?y Loc) (?z Loc))
            (or (in$0 n1_3$0 FP_4$0)
                (and (Btwn$0 next$0 n1_3$0 ?z ?y)
                     (Btwn$0 next_2$0 n1_3$0 ?z ?y))
                (and (not (Btwn$0 next$0 n1_3$0 ?z ?y))
                     (not (Btwn$0 next_2$0 n1_3$0 ?z ?y)))
                (not (= n1_3$0 (ep$0 next$0 FP_4$0 n1_3$0)))))))

(assert (or (not Axiom_3$0)
    (forall ((?y Loc) (?z Loc))
            (or (in$0 n2_2$0 FP_4$0)
                (and (Btwn$0 next$0 n2_2$0 ?z ?y)
                     (Btwn$0 next_2$0 n2_2$0 ?z ?y))
                (and (not (Btwn$0 next$0 n2_2$0 ?z ?y))
                     (not (Btwn$0 next_2$0 n2_2$0 ?z ?y)))
                (not (= n2_2$0 (ep$0 next$0 FP_4$0 n2_2$0)))))))

(assert (or (not Axiom_3$0)
    (forall ((?y Loc) (?z Loc))
            (or (in$0 res_3$0 FP_4$0)
                (and (Btwn$0 next$0 res_3$0 ?z ?y)
                     (Btwn$0 next_2$0 res_3$0 ?z ?y))
                (and (not (Btwn$0 next$0 res_3$0 ?z ?y))
                     (not (Btwn$0 next_2$0 res_3$0 ?z ?y)))
                (not (= res_3$0 (ep$0 next$0 FP_4$0 res_3$0)))))))

(assert (or (not Axiom_3$0)
    (forall ((?y Loc) (?z Loc))
            (or (in$0 sk_?e_2$0 FP_4$0)
                (and (Btwn$0 next$0 sk_?e_2$0 ?z ?y)
                     (Btwn$0 next_2$0 sk_?e_2$0 ?z ?y))
                (and (not (Btwn$0 next$0 sk_?e_2$0 ?z ?y))
                     (not (Btwn$0 next_2$0 sk_?e_2$0 ?z ?y)))
                (not (= sk_?e_2$0 (ep$0 next$0 FP_4$0 sk_?e_2$0)))))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 null$0 (ep$0 next$0 FP_4$0 null$0) ?y)
            (not (Btwn$0 next$0 null$0 ?y ?y)) (not (in$0 ?y FP_4$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 n1_3$0 (ep$0 next$0 FP_4$0 n1_3$0) ?y)
            (not (Btwn$0 next$0 n1_3$0 ?y ?y)) (not (in$0 ?y FP_4$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 n2_2$0 (ep$0 next$0 FP_4$0 n2_2$0) ?y)
            (not (Btwn$0 next$0 n2_2$0 ?y ?y)) (not (in$0 ?y FP_4$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 res_3$0 (ep$0 next$0 FP_4$0 res_3$0) ?y)
            (not (Btwn$0 next$0 res_3$0 ?y ?y)) (not (in$0 ?y FP_4$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 sk_?e_2$0 (ep$0 next$0 FP_4$0 sk_?e_2$0) ?y)
            (not (Btwn$0 next$0 sk_?e_2$0 ?y ?y)) (not (in$0 ?y FP_4$0)))))

(assert (Btwn$0 next$0 null$0 (ep$0 next$0 FP_4$0 null$0)
  (ep$0 next$0 FP_4$0 null$0)))

(assert (Btwn$0 next$0 n1_3$0 (ep$0 next$0 FP_4$0 n1_3$0)
  (ep$0 next$0 FP_4$0 n1_3$0)))

(assert (Btwn$0 next$0 n2_2$0 (ep$0 next$0 FP_4$0 n2_2$0)
  (ep$0 next$0 FP_4$0 n2_2$0)))

(assert (Btwn$0 next$0 res_3$0 (ep$0 next$0 FP_4$0 res_3$0)
  (ep$0 next$0 FP_4$0 res_3$0)))

(assert (Btwn$0 next$0 sk_?e_2$0 (ep$0 next$0 FP_4$0 sk_?e_2$0)
  (ep$0 next$0 FP_4$0 sk_?e_2$0)))

(assert (or (in$0 (ep$0 next$0 FP_4$0 null$0) FP_4$0)
    (= null$0 (ep$0 next$0 FP_4$0 null$0))))

(assert (or (in$0 (ep$0 next$0 FP_4$0 n1_3$0) FP_4$0)
    (= n1_3$0 (ep$0 next$0 FP_4$0 n1_3$0))))

(assert (or (in$0 (ep$0 next$0 FP_4$0 n2_2$0) FP_4$0)
    (= n2_2$0 (ep$0 next$0 FP_4$0 n2_2$0))))

(assert (or (in$0 (ep$0 next$0 FP_4$0 res_3$0) FP_4$0)
    (= res_3$0 (ep$0 next$0 FP_4$0 res_3$0))))

(assert (or (in$0 (ep$0 next$0 FP_4$0 sk_?e_2$0) FP_4$0)
    (= sk_?e_2$0 (ep$0 next$0 FP_4$0 sk_?e_2$0))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 FP_4$0 FP$0))
                 (or (in$0 x FP_4$0) (in$0 x FP$0)))
            (and (not (in$0 x FP_4$0)) (not (in$0 x FP$0))
                 (not (in$0 x (union$0 FP_4$0 FP$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 (setminus$0 FP$0 FP_4$0) sk_?X_8$0))
                 (or (in$0 x (setminus$0 FP$0 FP_4$0)) (in$0 x sk_?X_8$0)))
            (and (not (in$0 x (setminus$0 FP$0 FP_4$0)))
                 (not (in$0 x sk_?X_8$0))
                 (not (in$0 x (union$0 (setminus$0 FP$0 FP_4$0) sk_?X_8$0)))))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 FP_Caller_1$0 FP_5$0))
                 (or (in$0 x FP_Caller_1$0) (in$0 x FP_5$0)))
            (and (not (in$0 x FP_Caller_1$0)) (not (in$0 x FP_5$0))
                 (not (in$0 x (union$0 FP_Caller_1$0 FP_5$0)))))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x Alloc$0) (in$0 x (setminus$0 Alloc$0 FP_4$0))
                 (not (in$0 x FP_4$0)))
            (and (or (in$0 x FP_4$0) (not (in$0 x Alloc$0)))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x FP$0) (in$0 x (setminus$0 FP$0 FP_4$0))
                 (not (in$0 x FP_4$0)))
            (and (or (in$0 x FP_4$0) (not (in$0 x FP$0)))
                 (not (in$0 x (setminus$0 FP$0 FP_4$0)))))))
...
(assert (= (read$0 (write$0 next_2$0 res_3$0 n2_2$0) res_3$0) n2_2$0))

(assert (or (= null$0 res_3$0)
    (= (read$0 next_2$0 null$0)
      (read$0 (write$0 next_2$0 res_3$0 n2_2$0) null$0))))

(assert (or (= res_3$0 res_3$0)
    (= (read$0 next_2$0 res_3$0)
      (read$0 (write$0 next_2$0 res_3$0 n2_2$0) res_3$0))))
