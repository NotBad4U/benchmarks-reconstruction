...
(set-info :source |
  ...
  tests/spl/sl/rec_copy.spl:29:9-36:A precondition for this call of rec_reverse_loop might not hold
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 FP$0 sk_?X_74$0))
                 (or (in$0 x FP$0) (in$0 x sk_?X_74$0)))
            (and (not (in$0 x FP$0)) (not (in$0 x sk_?X_74$0))
                 (not (in$0 x (union$0 FP$0 sk_?X_74$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x FP$0) (in$0 x sk_?X_74$0)
                 (in$0 x (intersection$0 FP$0 sk_?X_74$0)))
            (and (or (not (in$0 x FP$0)) (not (in$0 x sk_?X_74$0)))
                 (not (in$0 x (intersection$0 FP$0 sk_?X_74$0)))))))
...
(assert (or (Btwn$0 next$0 lst_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_72$0 next$0 lst_1$0 null$0))))

(assert (= FP_Caller_3$0 (setminus$0 FP_Caller$0 FP$0)))

(assert (= sk_?X_72$0 FP$0))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (= sk_?X_73$0 (union$0 sk_?X_75$0 sk_?X_74$0)))

(assert (= sk_?X_75$0 (lseg_domain$0 next$0 lst_1$0 null$0)))

(assert (or (in$0 sk_?e_6$0 (intersection$0 sk_?X_75$0 sk_?X_74$0))
    (and (in$0 sk_?e_6$0 sk_FP_3$0) (not (in$0 sk_?e_6$0 FP$0)))
...
(assert (or (Btwn$0 next$0 null$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_74$0 next$0 null$0 null$0))))

(assert (or (Btwn$0 next$0 lst_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_75$0 next$0 lst_1$0 null$0))))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X_72$0 (lseg_domain$0 next$0 lst_1$0 null$0)))

(assert (lseg_struct$0 sk_?X_72$0 next$0 lst_1$0 null$0))

(assert (= sk_?X_74$0 (lseg_domain$0 next$0 null$0 null$0)))

(assert (= sk_FP_3$0 sk_?X_73$0))
