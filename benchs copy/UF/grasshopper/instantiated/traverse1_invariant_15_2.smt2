...
(assert (= sk_?X_2$0 (lseg_domain$0 next$0 curr_3$0 null$0)))
...
(assert (or (Btwn$0 next$0 curr_3$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_2$0 next$0 curr_3$0 null$0))))

(assert (or (Btwn$0 next$0 lst$0 curr_3$0 curr_3$0)
    (not (lseg_struct$0 sk_?X_3$0 next$0 lst$0 curr_3$0))))
...
(assert (= sk_?X_3$0 (lseg_domain$0 next$0 lst$0 curr_3$0)))
...
(assert (or (in$0 sk_?e$0 (intersection$0 sk_?X_3$0 sk_?X_2$0))
    ...
    (not (Btwn$0 next$0 lst$0 curr_3$0 curr_3$0))))
