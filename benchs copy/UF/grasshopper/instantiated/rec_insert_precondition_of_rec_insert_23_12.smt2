...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_21$0)) (not (in$0 x sk_?X_19$0))
                 (not (in$0 x (union$0 sk_?X_21$0 sk_?X_19$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_25$0)) (not (in$0 x sk_?X_19$0))
                 (not (in$0 x (union$0 sk_?X_25$0 sk_?X_19$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_21$0)) (not (in$0 x sk_?X_19$0)))
                 (not (in$0 x (intersection$0 sk_?X_21$0 sk_?X_19$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_25$0)) (not (in$0 x sk_?X_19$0)))
                 (not (in$0 x (intersection$0 sk_?X_25$0 sk_?X_19$0)))))))
...
(assert (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_21$0 next$0 lst$0 null$0))))
...
(assert (= sk_?X_18$0 (union$0 sk_?X_21$0 sk_?X_19$0)))

(assert (= sk_?X_19$0 sk_?X_20$0))

(assert (= sk_?X_21$0 (lseg_domain$0 next$0 lst$0 null$0)))

(assert (lseg_struct$0 sk_?X_21$0 next$0 lst$0 null$0))

(assert (= sk_?X_23$0 sk_?X_24$0))

(assert (= sk_?X_25$0 (lseg_domain$0 next$0 n1_2$0 null$0)))
...
(assert (or (in$0 sk_?e_2$0 (intersection$0 sk_?X_25$0 sk_?X_23$0))
    ...
    (not (Btwn$0 next$0 n1_2$0 null$0 null$0))))
...
(assert (or (Btwn$0 next$0 n1_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_25$0 next$0 n1_2$0 null$0))))

(assert (= n1_2$0 (read$0 next$0 lst$0)))

(assert (= (read$0 next$0 elt$0) null$0))

(assert (= emptyset$0 (intersection$0 sk_?X_21$0 sk_?X_19$0)))

(assert (= sk_?X_18$0 FP$0))

(assert (= sk_?X_20$0 (setenum$0 elt$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (= sk_?X_22$0 (union$0 sk_?X_25$0 sk_?X_23$0)))

(assert (= sk_?X_24$0 (setenum$0 elt$0)))

(assert (= sk_FP$0 sk_?X_22$0))
