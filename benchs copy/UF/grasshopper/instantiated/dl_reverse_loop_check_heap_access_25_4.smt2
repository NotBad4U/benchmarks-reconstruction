...
(assert (or (not Axiom_15$0)
    (or (= (read$0 prev$0 null$0) end_2$0)
        ...
        (not (in$0 end_2$0 sk_?X_17$0)) (not (in$0 null$0 sk_?X_17$0)))))

(assert (or (not Axiom_15$0)
    (or (= (read$0 prev$0 null$0) start_init$0)
        (not (= (read$0 next$0 start_init$0) null$0))
        (not (in$0 start_init$0 sk_?X_17$0)) (not (in$0 null$0 sk_?X_17$0)))))
...
(assert (or (not Axiom_15$0)
    (or (= (read$0 prev$0 curr_init$0) end_2$0)
        ...
        (not (in$0 end_2$0 sk_?X_17$0)) (not (in$0 curr_init$0 sk_?X_17$0)))))
...
(assert (or (not Axiom_15$0)
    (or (= (read$0 prev$0 prv_init$0) null$0)
        ...
        (not (in$0 null$0 sk_?X_17$0)) (not (in$0 prv_init$0 sk_?X_17$0)))))

(assert (or (not Axiom_15$0)
    (or (= (read$0 prev$0 prv_init$0) end_2$0)
        (not (= (read$0 next$0 end_2$0) prv_init$0))
        (not (in$0 end_2$0 sk_?X_17$0)) (not (in$0 prv_init$0 sk_?X_17$0)))))
...
(assert (or (not Axiom_16$0)
    (or (= (read$0 prev$0 null$0) end_2$0)
        (not (= (read$0 next$0 end_2$0) null$0))
        (not (in$0 end_2$0 sk_?X_16$0)) (not (in$0 null$0 sk_?X_16$0)))))

(assert (or (not Axiom_16$0)
    (or (= (read$0 prev$0 null$0) start_init$0)
        (not (= (read$0 next$0 start_init$0) null$0))
        (not (in$0 start_init$0 sk_?X_16$0)) (not (in$0 null$0 sk_?X_16$0)))))
...
(assert (or (not Axiom_16$0)
    (or (= (read$0 prev$0 curr_init$0) end_2$0)
        (not (= (read$0 next$0 end_2$0) curr_init$0))
        (not (in$0 end_2$0 sk_?X_16$0)) (not (in$0 curr_init$0 sk_?X_16$0)))))
...
(assert (or (not Axiom_16$0)
    (or (= (read$0 prev$0 prv_init$0) null$0)
        (not (= (read$0 next$0 null$0) prv_init$0))
        (not (in$0 null$0 sk_?X_16$0)) (not (in$0 prv_init$0 sk_?X_16$0)))))

(assert (or (not Axiom_16$0)
    (or (= (read$0 prev$0 prv_init$0) end_2$0)
        (not (= (read$0 next$0 end_2$0) prv_init$0))
        (not (in$0 end_2$0 sk_?X_16$0)) (not (in$0 prv_init$0 sk_?X_16$0)))))
