...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_97$0)) (not (in$0 x sk_?X_96$0))
                 (not (in$0 x (union$0 sk_?X_97$0 sk_?X_96$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_97$0)) (not (in$0 x sk_?X_96$0)))
                 (not (in$0 x (intersection$0 sk_?X_97$0 sk_?X_96$0)))))))
...
(assert (or (Btwn$0 next$0 lst_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_97$0 next$0 lst_2$0 null$0))))
...
(assert (= sk_?X_96$0 (lseg_domain$0 next$0 acc$0 null$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_97$0 next$0 lst_2$0 null$0))
...
(assert (or (Btwn$0 next$0 acc$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_96$0 next$0 acc$0 null$0))))
...
(assert (= sk_?X_97$0 (lseg_domain$0 next$0 lst_2$0 null$0)))

(assert (lseg_struct$0 sk_?X_96$0 next$0 acc$0 null$0))

(assert (not (= lst_2$0 null$0)))

(assert (not (in$0 old_lst_2$0 FP$0)))
