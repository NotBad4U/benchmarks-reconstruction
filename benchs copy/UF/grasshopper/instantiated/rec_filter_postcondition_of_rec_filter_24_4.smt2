...
(set-info :source |
  ...
  tests/spl/sl/rec_filter.spl:24:4-26:A postcondition of procedure rec_filter might not hold at this return point
...
(assert (forall ((?y Loc))
        (or (not (Btwn$0 next_1$0 x$0 ?y ?y)) (= x$0 ?y)
            (Btwn$0 next_1$0 x$0 (read$0 next_1$0 x$0) ?y))))
...
(assert (forall ((?y Loc))
        (or (not (= (read$0 next_1$0 x$0) x$0))
            (not (Btwn$0 next_1$0 x$0 ?y ?y)) (= x$0 ?y))))
...
(assert (Btwn$0 next_1$0 x$0 (read$0 next_1$0 x$0) (read$0 next_1$0 x$0)))

(assert (or (not Axiom_8$0)
    (or (= (read$0 next$0 null$0) (read$0 next_1$0 null$0))
        (not (in$0 null$0 (setminus$0 Alloc_1$0 FP_2$0))))))

(assert (or (not Axiom_8$0)
    (or (= (read$0 next$0 x$0) (read$0 next_1$0 x$0))
        (not (in$0 x$0 (setminus$0 Alloc_1$0 FP_2$0))))))
    ...
    (forall ((?y Loc) (?z Loc))
            (or
                (and (Btwn$0 next$0 sk_?e_4$0 ?z ?y)
                     (Btwn$0 next_1$0 sk_?e_4$0 ?z ?y))
                (and (not (Btwn$0 next$0 sk_?e_4$0 ?z ?y))
                     (not (Btwn$0 next_1$0 sk_?e_4$0 ?z ?y)))
                (not
                     (or
                         (Btwn$0 next$0 sk_?e_4$0 ?y
                           (ep$0 next$0 FP_2$0 sk_?e_4$0))
...
(assert (or (not Axiom_7$0)
    (forall ((?y Loc) (?z Loc))
            (or (and (Btwn$0 next$0 x$0 ?z ?y) (Btwn$0 next_1$0 x$0 ?z ?y))
                (and (not (Btwn$0 next$0 x$0 ?z ?y))
                     (not (Btwn$0 next_1$0 x$0 ?z ?y)))
                (not
...
(assert (or (not Axiom_6$0)
    (forall ((?y Loc) (?z Loc))
            (or (in$0 n1_2$0 FP_2$0)
                (and (Btwn$0 next$0 n1_2$0 ?z ?y)
                     (Btwn$0 next_1$0 n1_2$0 ?z ?y))
                (and (not (Btwn$0 next$0 n1_2$0 ?z ?y))
                     (not (Btwn$0 next_1$0 n1_2$0 ?z ?y)))
                (not (= n1_2$0 (ep$0 next$0 FP_2$0 n1_2$0)))))))

(assert (or (not Axiom_6$0)
    (forall ((?y Loc) (?z Loc))
            (or (in$0 res_2$0 FP_2$0)
                (and (Btwn$0 next$0 res_2$0 ?z ?y)
                     (Btwn$0 next_1$0 res_2$0 ?z ?y))
                (and (not (Btwn$0 next$0 res_2$0 ?z ?y))
                     (not (Btwn$0 next_1$0 res_2$0 ?z ?y)))
                (not (= res_2$0 (ep$0 next$0 FP_2$0 res_2$0)))))))

(assert (or (not Axiom_6$0)
    (forall ((?y Loc) (?z Loc))
            (or (in$0 sk_?e_4$0 FP_2$0)
                (and (Btwn$0 next$0 sk_?e_4$0 ?z ?y)
                     (Btwn$0 next_1$0 sk_?e_4$0 ?z ?y))
                (and (not (Btwn$0 next$0 sk_?e_4$0 ?z ?y))
                     (not (Btwn$0 next_1$0 sk_?e_4$0 ?z ?y)))
                (not (= sk_?e_4$0 (ep$0 next$0 FP_2$0 sk_?e_4$0)))))))

(assert (or (not Axiom_6$0)
    (forall ((?y Loc) (?z Loc))
            (or (in$0 x$0 FP_2$0)
                (and (Btwn$0 next$0 x$0 ?z ?y) (Btwn$0 next_1$0 x$0 ?z ?y))
                (and (not (Btwn$0 next$0 x$0 ?z ?y))
                     (not (Btwn$0 next_1$0 x$0 ?z ?y)))
...
(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 null$0 (ep$0 next$0 sk_?X_17$0 null$0) ?y)
            (not (Btwn$0 next$0 null$0 ?y ?y)) (not (in$0 ?y sk_?X_17$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 n1_2$0 (ep$0 next$0 sk_?X_17$0 n1_2$0) ?y)
            (not (Btwn$0 next$0 n1_2$0 ?y ?y)) (not (in$0 ?y sk_?X_17$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 res_2$0 (ep$0 next$0 sk_?X_17$0 res_2$0) ?y)
            (not (Btwn$0 next$0 res_2$0 ?y ?y)) (not (in$0 ?y sk_?X_17$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 sk_?e_4$0 (ep$0 next$0 sk_?X_17$0 sk_?e_4$0) ?y)
            (not (Btwn$0 next$0 sk_?e_4$0 ?y ?y)) (not (in$0 ?y sk_?X_17$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 x$0 (ep$0 next$0 sk_?X_17$0 x$0) ?y)
            (not (Btwn$0 next$0 x$0 ?y ?y)) (not (in$0 ?y sk_?X_17$0)))))

(assert (or (in$0 (ep$0 next$0 sk_?X_17$0 null$0) sk_?X_17$0)
    (= null$0 (ep$0 next$0 sk_?X_17$0 null$0))))

(assert (or (in$0 (ep$0 next$0 sk_?X_17$0 n1_2$0) sk_?X_17$0)
    (= n1_2$0 (ep$0 next$0 sk_?X_17$0 n1_2$0))))

(assert (or (in$0 (ep$0 next$0 sk_?X_17$0 res_2$0) sk_?X_17$0)
    (= res_2$0 (ep$0 next$0 sk_?X_17$0 res_2$0))))

(assert (or (in$0 (ep$0 next$0 sk_?X_17$0 sk_?e_4$0) sk_?X_17$0)
    (= sk_?e_4$0 (ep$0 next$0 sk_?X_17$0 sk_?e_4$0))))

(assert (or (in$0 (ep$0 next$0 sk_?X_17$0 x$0) sk_?X_17$0)
    (= x$0 (ep$0 next$0 sk_?X_17$0 x$0))))

(assert (Btwn$0 next$0 null$0 (ep$0 next$0 sk_?X_17$0 null$0)
  (ep$0 next$0 sk_?X_17$0 null$0)))

(assert (Btwn$0 next$0 n1_2$0 (ep$0 next$0 sk_?X_17$0 n1_2$0)
  (ep$0 next$0 sk_?X_17$0 n1_2$0)))

(assert (Btwn$0 next$0 res_2$0 (ep$0 next$0 sk_?X_17$0 res_2$0)
  (ep$0 next$0 sk_?X_17$0 res_2$0)))

(assert (Btwn$0 next$0 sk_?e_4$0 (ep$0 next$0 sk_?X_17$0 sk_?e_4$0)
  (ep$0 next$0 sk_?X_17$0 sk_?e_4$0)))

(assert (Btwn$0 next$0 x$0 (ep$0 next$0 sk_?X_17$0 x$0) (ep$0 next$0 sk_?X_17$0 x$0)))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x FP_3$0)) (not (in$0 x Alloc_2$0))
                 (not (in$0 x (union$0 FP_3$0 Alloc_2$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 sk_?X_17$0 FP_1$0))
                 (or (in$0 x sk_?X_17$0) (in$0 x FP_1$0)))
            (and (not (in$0 x sk_?X_17$0)) (not (in$0 x FP_1$0))
                 (not (in$0 x (union$0 sk_?X_17$0 FP_1$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 (setminus$0 FP_1$0 FP_2$0) sk_?X_16$0))
                 (or (in$0 x (setminus$0 FP_1$0 FP_2$0)) (in$0 x sk_?X_16$0)))
            (and (not (in$0 x (setminus$0 FP_1$0 FP_2$0)))
                 (not (in$0 x sk_?X_16$0))
                 (not
                      (in$0 x
                        (union$0 (setminus$0 FP_1$0 FP_2$0) sk_?X_16$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x Alloc_2$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (intersection$0 Alloc_2$0 FP$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x Alloc_2$0) (in$0 x sk_?X_17$0)
                 (in$0 x (intersection$0 Alloc_2$0 sk_?X_17$0)))
            (and (or (not (in$0 x Alloc_2$0)) (not (in$0 x sk_?X_17$0)))
                 (not (in$0 x (intersection$0 Alloc_2$0 sk_?X_17$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x Alloc_1$0)
                 (in$0 x (setminus$0 Alloc_1$0 sk_?X_17$0))
                 (not (in$0 x sk_?X_17$0)))
            (and (or (in$0 x sk_?X_17$0) (not (in$0 x Alloc_1$0)))
                 (not (in$0 x (setminus$0 Alloc_1$0 sk_?X_17$0)))))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x FP_1$0) (in$0 x (setminus$0 FP_1$0 sk_?X_17$0))
                 (not (in$0 x sk_?X_17$0)))
            (and (or (in$0 x sk_?X_17$0) (not (in$0 x FP_1$0)))
                 (not (in$0 x (setminus$0 FP_1$0 sk_?X_17$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x (setenum$0 x$0)) (not (in$0 x Alloc$0)))
                 (not (in$0 x (setminus$0 Alloc$0 (setenum$0 x$0))))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x (setenum$0 x$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (setminus$0 FP$0 (setenum$0 x$0))))))))
...
(assert (or (Btwn$0 next$0 x$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_18$0 next$0 x$0 null$0))))

(assert (or (Btwn$0 next_1$0 res_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_19$0 next_1$0 res_2$0 null$0))))

(assert (= FP_1$0 (setminus$0 FP$0 (setenum$0 x$0))))

(assert (= FP_Caller_1$0 (setminus$0 FP_Caller$0 FP$0)))

(assert (= n1_2$0 (read$0 next$0 x$0)))

(assert (Frame$0 FP_2$0 Alloc_1$0 next$0 next_1$0))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X_16$0 (lseg_domain$0 next_1$0 res_1$0 null$0)))

(assert (= sk_?X_17$0 FP_2$0))

(assert (= FP_1$0 (union$0 FP_2$0 FP_1$0)))
...
(assert (= sk_?X_19$0
  (union$0 (intersection$0 Alloc_2$0 FP$0) (setminus$0 Alloc_2$0 Alloc$0))))

(assert (not (= x$0 null$0)))

(assert (not (in$0 null$0 Alloc_2$0)))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next_1$0 res_1$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next_1$0 res_1$0 null$0)))))))

(assert (or (and Axiom_8$0 Axiom_7$0 Axiom_6$0)
    (not (Frame$0 FP_2$0 Alloc_1$0 next$0 next_1$0))))

(assert (or (Btwn$0 next$0 n1_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_17$0 next$0 n1_2$0 null$0))))

(assert (or (Btwn$0 next_1$0 res_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_16$0 next_1$0 res_1$0 null$0))))

(assert (= Alloc_1$0 (setminus$0 Alloc$0 (setenum$0 x$0))))
...
(assert (= res_2$0 res_1$0))

(assert (= Alloc_2$0 (union$0 FP_3$0 Alloc_2$0)))

(assert (= sk_?X_16$0
  (union$0 (intersection$0 Alloc_2$0 FP_2$0)
    (setminus$0 Alloc_2$0 Alloc_1$0))))

(assert (lseg_struct$0 sk_?X_16$0 next_1$0 res_1$0 null$0))

(assert (= sk_?X_17$0 (lseg_domain$0 next$0 n1_2$0 null$0)))

(assert (lseg_struct$0 sk_?X_17$0 next$0 n1_2$0 null$0))

(assert (= sk_?X_18$0 (lseg_domain$0 next$0 x$0 null$0)))

(assert (lseg_struct$0 sk_?X_18$0 next$0 x$0 null$0))

(assert (or
    (and (in$0 sk_?e_4$0 (lseg_domain$0 next_1$0 res_2$0 null$0))
         (not (in$0 sk_?e_4$0 sk_?X_19$0)))
    (and (in$0 sk_?e_4$0 sk_?X_19$0)
         (not (in$0 sk_?e_4$0 (lseg_domain$0 next_1$0 res_2$0 null$0))))
