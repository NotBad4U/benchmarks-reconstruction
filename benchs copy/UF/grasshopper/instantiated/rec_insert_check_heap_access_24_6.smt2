...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_34$0)) (not (in$0 x sk_?X_29$0))
                 (not (in$0 x (union$0 sk_?X_34$0 sk_?X_29$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_30$0)) (not (in$0 x sk_?X_29$0))
                 (not (in$0 x (union$0 sk_?X_30$0 sk_?X_29$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x (setminus$0 FP$0 FP_1$0)))
                 ...
                 (not (in$0 x (union$0 (setminus$0 FP$0 FP_1$0) sk_?X_26$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_34$0)) (not (in$0 x sk_?X_29$0)))
                 (not (in$0 x (intersection$0 sk_?X_34$0 sk_?X_29$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_30$0)) (not (in$0 x sk_?X_29$0)))
                 (not (in$0 x (intersection$0 sk_?X_30$0 sk_?X_29$0)))))))
...
(assert (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_34$0 next$0 lst$0 null$0))))

(assert (or (Btwn$0 next_1$0 n2_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_26$0 next_1$0 n2_2$0 null$0))))
...
(assert (= sk_?X_27$0 (union$0 sk_?X_30$0 sk_?X_28$0)))

(assert (= sk_?X_28$0 sk_?X_29$0))

(assert (= sk_?X_30$0 (lseg_domain$0 next$0 n1_2$0 null$0)))

(assert (lseg_struct$0 sk_?X_30$0 next$0 n1_2$0 null$0))

(assert (= emptyset$0 emptyset$0))

(assert (= sk_?X_31$0 (union$0 sk_?X_34$0 sk_?X_32$0)))

(assert (= sk_?X_32$0 sk_?X_33$0))

(assert (= sk_?X_34$0 (lseg_domain$0 next$0 lst$0 null$0)))

(assert (lseg_struct$0 sk_?X_34$0 next$0 lst$0 null$0))

(assert (= sk_?X_26$0 (lseg_domain$0 next_1$0 n2_2$0 null$0)))
...
(assert (or (Btwn$0 next$0 n1_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_30$0 next$0 n1_2$0 null$0))))
...
(assert (= emptyset$0 (intersection$0 sk_?X_30$0 sk_?X_28$0)))

(assert (= sk_?X_27$0 FP_1$0))

(assert (= sk_?X_29$0 (setenum$0 elt$0)))

(assert (= FP$0 (union$0 FP_1$0 FP$0)))

(assert (= (read$0 next$0 elt$0) null$0))

(assert (= emptyset$0 (intersection$0 sk_?X_34$0 sk_?X_32$0)))

(assert (= sk_?X_31$0 FP$0))

(assert (= sk_?X_33$0 (setenum$0 elt$0)))
...
(assert (lseg_struct$0 sk_?X_26$0 next_1$0 n2_2$0 null$0))
