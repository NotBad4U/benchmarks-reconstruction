...
(assert (or
    ...
    (not (Btwn$0 next$0 res_3$0 null$0 null$0))))
...
(assert (or (Btwn$0 next$0 res_3$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_4$0 next$0 res_3$0 null$0))))

(assert (= FP_Caller_final_3$0 (union$0 FP_Caller_1$0 FP$0)))

(assert (= res_3$0 elt$0))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 res_3$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 res_3$0 null$0)))))))
