...
(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 a$0) b$0) (not (= (read$0 next$0 b$0) a$0))
        (not (in$0 b$0 sk_?X_1$0)) (not (in$0 a$0 sk_?X_1$0)))))

(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 a$0) sk_l1$0) (not (= (read$0 next$0 sk_l1$0) a$0))
        (not (in$0 sk_l1$0 sk_?X_1$0)) (not (in$0 a$0 sk_?X_1$0)))))

(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 a$0) prv_2$0) (not (= (read$0 next$0 prv_2$0) a$0))
        (not (in$0 prv_2$0 sk_?X_1$0)) (not (in$0 a$0 sk_?X_1$0)))))

(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 sk_l2$0) b$0) (not (= (read$0 next$0 b$0) sk_l2$0))
        (not (in$0 b$0 sk_?X_1$0)) (not (in$0 sk_l2$0 sk_?X_1$0)))))
...
(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 sk_l2$0) prv_2$0)
        ...
        (not (in$0 prv_2$0 sk_?X_1$0)) (not (in$0 sk_l2$0 sk_?X_1$0)))))

(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 prv_2$0) b$0) (not (= (read$0 next$0 b$0) prv_2$0))
        (not (in$0 b$0 sk_?X_1$0)) (not (in$0 prv_2$0 sk_?X_1$0)))))

(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 prv_2$0) sk_l1$0)
        (not (= (read$0 next$0 sk_l1$0) prv_2$0))
        (not (in$0 sk_l1$0 sk_?X_1$0)) (not (in$0 prv_2$0 sk_?X_1$0)))))

(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 prv_2$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) prv_2$0))
        (not (in$0 prv_2$0 sk_?X_1$0)) (not (in$0 prv_2$0 sk_?X_1$0)))))

(assert (or (not Axiom$0)
    (or (= (read$0 prev$0 a$0) b$0) (not (= (read$0 next$0 b$0) a$0))
        (not (in$0 b$0 sk_?X$0)) (not (in$0 a$0 sk_?X$0)))))

(assert (or (not Axiom$0)
    (or (= (read$0 prev$0 a$0) sk_l1$0) (not (= (read$0 next$0 sk_l1$0) a$0))
        (not (in$0 sk_l1$0 sk_?X$0)) (not (in$0 a$0 sk_?X$0)))))

(assert (or (not Axiom$0)
    (or (= (read$0 prev$0 a$0) prv_2$0) (not (= (read$0 next$0 prv_2$0) a$0))
        (not (in$0 prv_2$0 sk_?X$0)) (not (in$0 a$0 sk_?X$0)))))
...
(assert (or (not Axiom$0)
    (or (= (read$0 prev$0 prv_2$0) b$0) (not (= (read$0 next$0 b$0) prv_2$0))
        (not (in$0 b$0 sk_?X$0)) (not (in$0 prv_2$0 sk_?X$0)))))
...
(assert (or
    (and (Btwn$0 next$0 a$0 null$0 null$0)
         ...
         Axiom_1$0)
    (not (dlseg_struct$0 sk_?X_1$0 next$0 prev$0 a$0 prv_2$0 null$0 b$0))))
...
(assert (= sk_?X_1$0 (dlseg_domain$0 next$0 prev$0 a$0 prv_2$0 null$0 b$0)))
...
(assert (or
    ...
    (not (Btwn$0 next$0 a$0 null$0 null$0))))
