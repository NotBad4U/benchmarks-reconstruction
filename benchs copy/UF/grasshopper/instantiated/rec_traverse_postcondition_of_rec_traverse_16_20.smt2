...
(set-info :source |
  ...
  tests/spl/sl/rec_traverse.spl:16:20-21:A postcondition of procedure rec_traverse might not hold at this return point
  tests/spl/sl/rec_traverse.spl:11:10-25:Related location: This is the postcondition that might not hold
  |)
...
(assert (or (in$0 (ep$0 next$0 FP_1$0 n_2$0) FP_1$0)
    (= n_2$0 (ep$0 next$0 FP_1$0 n_2$0))))
...
(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 n_2$0 (ep$0 next$0 FP_1$0 n_2$0) ?y)
            (not (Btwn$0 next$0 n_2$0 ?y ?y)) (not (in$0 ?y FP_1$0)))))
...
(assert (Btwn$0 next$0 n_2$0 (ep$0 next$0 FP_1$0 n_2$0) (ep$0 next$0 FP_1$0 n_2$0)))
...
(assert (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_4$0 next$0 lst$0 null$0))))

(assert (or (Btwn$0 next$0 n_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_6$0 next$0 n_2$0 null$0))))

(assert (= FP_Caller_1$0 (setminus$0 FP_Caller$0 FP$0)))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X_3$0 (lseg_domain$0 next$0 lst$0 null$0)))

(assert (lseg_struct$0 sk_?X_3$0 next$0 lst$0 null$0))

(assert (or
    (and (in$0 sk_?e_1$0 (lseg_domain$0 next$0 lst$0 null$0))
         (not (in$0 sk_?e_1$0 sk_?X_4$0)))
    (and (in$0 sk_?e_1$0 sk_?X_4$0)
...
(assert (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_3$0 next$0 lst$0 null$0))))

(assert (or (Btwn$0 next$0 n_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_5$0 next$0 n_2$0 null$0))))
...
(assert (or
    (and
         ...
         (Frame$0 FP_1$0 Alloc$0 next$0 next$0)
         (= Alloc$0 (union$0 FP_2$0 Alloc$0))
         (and
              (= sk_?X_5$0
                (union$0 (intersection$0 Alloc$0 FP_1$0)
                  (setminus$0 Alloc$0 Alloc$0)))
         ...
         (and (= sk_?X_6$0 FP_1$0)
              (= sk_?X_6$0 (lseg_domain$0 next$0 n_2$0 null$0))
              (= FP$0 (union$0 FP_1$0 FP$0))
              (lseg_struct$0 sk_?X_6$0 next$0 n_2$0 null$0))
         (not (= lst$0 null$0)) (not (in$0 null$0 Alloc$0)))
    (and (= FP_2$0 FP$0) (= lst$0 null$0) (= n_2$0 n$0))))

(assert (= FP_Caller_final_1$0 (union$0 FP_Caller_1$0 FP_2$0)))

(assert (= sk_?X_3$0 FP$0))
