...
(assert (or (Btwn$0 next$0 lst_init$0 curr_init$0 curr_init$0)
    (not (lseg_struct$0 sk_?X_14$0 next$0 lst_init$0 curr_init$0))))
...
(assert (= sk_?X_13$0 (lseg_domain$0 next$0 curr_init$0 null$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_14$0 next$0 lst_init$0 curr_init$0))
...
(assert (or (Btwn$0 next$0 curr_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_13$0 next$0 curr_init$0 null$0))))
...
(assert (= sk_?X_14$0 (lseg_domain$0 next$0 lst_init$0 curr_init$0)))

(assert (lseg_struct$0 sk_?X_13$0 next$0 curr_init$0 null$0))
