...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_49$0)) (not (in$0 x FP$0))
                 (not (in$0 x (union$0 sk_?X_49$0 FP$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x (setminus$0 FP$0 FP_1$0)))
                 ...
                 (not (in$0 x (union$0 (setminus$0 FP$0 FP_1$0) sk_?X_46$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_43$0)) (not (in$0 x sk_?X_45$0))
                 (not (in$0 x (union$0 sk_?X_43$0 sk_?X_45$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_49$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (intersection$0 sk_?X_49$0 FP$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_43$0)) (not (in$0 x sk_?X_45$0)))
                 (not (in$0 x (intersection$0 sk_?X_43$0 sk_?X_45$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x (setenum$0 tmp_2$0)) (not (in$0 x Alloc$0)))
                 (not (in$0 x (setminus$0 Alloc$0 (setenum$0 tmp_2$0))))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x (setenum$0 tmp_2$0)) (not (in$0 x FP_2$0)))
                 (not (in$0 x (setminus$0 FP_2$0 (setenum$0 tmp_2$0))))))))
...
(assert (or (Btwn$0 next$0 curr_3$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_45$0 next$0 curr_3$0 null$0))))

(assert (or (Btwn$0 next$0 lst$0 curr_2$0 curr_2$0)
    (not (lseg_struct$0 sk_?X_50$0 next$0 lst$0 curr_2$0))))

(assert (or (Btwn$0 next_1$0 res_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_52$0 next_1$0 res_1$0 null$0))))
...
(assert (= sk_?X_43$0 (lseg_domain$0 next$0 lst_1$0 curr_3$0)))

(assert (= sk_?X_45$0 (lseg_domain$0 next$0 curr_3$0 null$0)))

(assert (= sk_?X_46$0 (union$0 sk_?X_44$0 sk_?X_45$0)))

(assert (lseg_struct$0 sk_?X_45$0 next$0 curr_3$0 null$0))

(assert (= emptyset$0 emptyset$0))

(assert (= sk_?X_47$0 (union$0 sk_?X_49$0 sk_?X_48$0)))

(assert (= sk_?X_48$0 (lseg_domain$0 next$0 curr_2$0 null$0)))

(assert (= sk_?X_50$0 (lseg_domain$0 next$0 lst$0 curr_2$0)))

(assert (lseg_struct$0 sk_?X_48$0 next$0 curr_2$0 null$0))

(assert (not (= curr_2$0 null$0)))

(assert (= sk_?X_51$0 (lseg_domain$0 next$0 lst$0 null$0)))

(assert (lseg_struct$0 sk_?X_51$0 next$0 lst$0 null$0))
...
(assert (or (Btwn$0 next$0 curr_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_48$0 next$0 curr_2$0 null$0))))

(assert (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_51$0 next$0 lst$0 null$0))))

(assert (or (Btwn$0 next$0 lst_1$0 curr_3$0 curr_3$0)
    (not (lseg_struct$0 sk_?X_43$0 next$0 lst_1$0 curr_3$0))))
...
(assert (or
    (and (= Alloc_1$0 (setminus$0 Alloc$0 (setenum$0 tmp_2$0)))
         ...
         (not (= tmp_2$0 null$0)))
    (and (= Alloc_1$0 Alloc$0) (= next_1$0 next$0) (= tmp_2$0 null$0))))
...
(assert (= emptyset$0 (intersection$0 sk_?X_44$0 sk_?X_45$0)))
...
(assert (lseg_struct$0 sk_?X_43$0 next$0 lst_1$0 curr_3$0))

(assert (not (= curr_3$0 null$0)))

(assert (= emptyset$0 (intersection$0 sk_?X_49$0 sk_?X_48$0)))

(assert (= sk_?X_47$0 FP_1$0))

(assert (= sk_?X_49$0 sk_?X_50$0))

(assert (= FP$0 (union$0 FP_1$0 FP$0)))

(assert (lseg_struct$0 sk_?X_50$0 next$0 lst$0 curr_2$0))

(assert (= sk_?X_51$0 FP$0))
