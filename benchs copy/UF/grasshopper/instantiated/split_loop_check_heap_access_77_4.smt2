...
(set-info :source |
  ...
  tests/spl/sls/sls_merge_sort.spl:77:4-22:Possible heap access through null or dangling reference
  |)
...
(declare-fun sk_?X_271$0 () SetLoc)
(declare-fun sk_?X_272$0 () SetLoc)
(declare-fun sk_?X_273$0 () SetLoc)
(declare-fun sk_?X_274$0 () SetLoc)
(declare-fun sk_?X_275$0 () SetLoc)
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 sk_?X_273$0 sk_?X_272$0))
                 (or (in$0 x sk_?X_273$0) (in$0 x sk_?X_272$0)))
            (and (not (in$0 x sk_?X_273$0)) (not (in$0 x sk_?X_272$0))
                 (not (in$0 x (union$0 sk_?X_273$0 sk_?X_272$0)))))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 sk_?X_275$0 sk_?X_274$0))
                 (or (in$0 x sk_?X_275$0) (in$0 x sk_?X_274$0)))
            (and (not (in$0 x sk_?X_275$0)) (not (in$0 x sk_?X_274$0))
                 (not (in$0 x (union$0 sk_?X_275$0 sk_?X_274$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x sk_?X_275$0) (in$0 x sk_?X_274$0)
                 (in$0 x (intersection$0 sk_?X_275$0 sk_?X_274$0)))
            (and (or (not (in$0 x sk_?X_275$0)) (not (in$0 x sk_?X_274$0)))
                 (not (in$0 x (intersection$0 sk_?X_275$0 sk_?X_274$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x sk_?X_273$0) (in$0 x sk_?X_272$0)
                 (in$0 x (intersection$0 sk_?X_273$0 sk_?X_272$0)))
            (and (or (not (in$0 x sk_?X_273$0)) (not (in$0 x sk_?X_272$0)))
                 (not (in$0 x (intersection$0 sk_?X_273$0 sk_?X_272$0)))))))
...
(assert (or (Btwn$0 next$0 y_init$0 z_init$0 z_init$0)
    (not (lseg_struct$0 sk_?X_275$0 next$0 y_init$0 z_init$0))))
...
(assert (= emptyset$0 (intersection$0 sk_?X_273$0 sk_?X_272$0)))

(assert (= sk_?X_271$0 (union$0 sk_?X_273$0 sk_?X_272$0)))

(assert (= sk_?X_272$0 (lseg_domain$0 next$0 curr_init$0 null$0)))

(assert (= sk_?X_274$0 (lseg_domain$0 next$0 z_init$0 curr_init$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_274$0 next$0 z_init$0 curr_init$0))
...
(assert (or (Btwn$0 next$0 curr_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_272$0 next$0 curr_init$0 null$0))))

(assert (or (Btwn$0 next$0 z_init$0 curr_init$0 curr_init$0)
    (not (lseg_struct$0 sk_?X_274$0 next$0 z_init$0 curr_init$0))))
...
(assert (= emptyset$0 (intersection$0 sk_?X_275$0 sk_?X_274$0)))

(assert (= sk_?X_271$0 FP$0))

(assert (= sk_?X_273$0 (union$0 sk_?X_275$0 sk_?X_274$0)))

(assert (= sk_?X_275$0 (lseg_domain$0 next$0 y_init$0 z_init$0)))

(assert (lseg_struct$0 sk_?X_272$0 next$0 curr_init$0 null$0))

(assert (lseg_struct$0 sk_?X_275$0 next$0 y_init$0 z_init$0))
