...
(assert (= Alloc_2$0 (setminus$0 Alloc$0 (setenum$0 lst$0))))
...
(assert (or (Btwn$0 next$0 res_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_5$0 next$0 res_2$0 null$0))))

(assert (= FP_3$0 (setminus$0 FP$0 (setenum$0 lst$0))))

(assert (= FP_Caller_final_2$0 (union$0 FP_Caller_1$0 FP_3$0)))

(assert (= res_2$0 n_2$0))
...
(assert (or
    ...
    (not (Btwn$0 next$0 res_2$0 null$0 null$0))))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 res_2$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 res_2$0 null$0)))))))
