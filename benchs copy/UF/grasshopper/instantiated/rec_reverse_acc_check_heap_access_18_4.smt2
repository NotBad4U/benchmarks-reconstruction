...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_25$0)) (not (in$0 x sk_?X_24$0))
                 (not (in$0 x (union$0 sk_?X_25$0 sk_?X_24$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_25$0)) (not (in$0 x sk_?X_24$0)))
                 (not (in$0 x (intersection$0 sk_?X_25$0 sk_?X_24$0)))))))
...
(assert (or (Btwn$0 next$0 curr$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_24$0 next$0 curr$0 null$0))))
...
(assert (= sk_?X_24$0 (lseg_domain$0 next$0 curr$0 null$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_25$0 next$0 rev$0 null$0))
...
(assert (or (Btwn$0 next$0 rev$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_25$0 next$0 rev$0 null$0))))

(assert (= tmp_2$0 (read$0 next$0 curr$0)))

(assert (= emptyset$0 (intersection$0 sk_?X_25$0 sk_?X_24$0)))

(assert (= sk_?X_23$0 FP$0))

(assert (= sk_?X_25$0 (lseg_domain$0 next$0 rev$0 null$0)))

(assert (lseg_struct$0 sk_?X_24$0 next$0 curr$0 null$0))
