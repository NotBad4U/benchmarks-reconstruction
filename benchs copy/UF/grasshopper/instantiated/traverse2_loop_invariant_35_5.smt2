...
(assert (forall ((?y Loc))
        (or (not (Btwn$0 next$0 curr_init_1$0 ?y ?y)) (= curr_init_1$0 ?y)
            (Btwn$0 next$0 curr_init_1$0 (read$0 next$0 curr_init_1$0) ?y))))
...
(assert (forall ((?y Loc))
        (or (not (= (read$0 next$0 curr_init_1$0) curr_init_1$0))
            (not (Btwn$0 next$0 curr_init_1$0 ?y ?y)) (= curr_init_1$0 ?y))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_41$0)) (not (in$0 x sk_?X_40$0))
                 (not (in$0 x (union$0 sk_?X_41$0 sk_?X_40$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_41$0)) (not (in$0 x sk_?X_40$0)))
                 (not (in$0 x (intersection$0 sk_?X_41$0 sk_?X_40$0)))))))
...
(assert (or (Btwn$0 next$0 curr_12$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_40$0 next$0 curr_12$0 null$0))))

(assert (or (Btwn$0 next$0 lst_6$0 curr_12$0 curr_12$0)
    (not (lseg_struct$0 sk_?X_41$0 next$0 lst_6$0 curr_12$0))))

(assert (= FP_Caller_4$0 (setminus$0 FP_Caller$0 FP$0)))

(assert (= curr_12$0 (read$0 next$0 curr_11$0)))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X_36$0 (union$0 sk_?X_38$0 sk_?X_37$0)))

(assert (= sk_?X_37$0 (lseg_domain$0 next$0 curr_init_1$0 null$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_38$0 next$0 lst_init_1$0 curr_init_1$0))

(assert (= sk_?X_40$0 (lseg_domain$0 next$0 curr_12$0 null$0)))

(assert (= sk_FP_3$0 sk_?X_39$0))

(assert (not (= (read$0 next$0 curr_11$0) null$0)))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 curr_12$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 curr_12$0 null$0)))))))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and
                 ...
                 (not (in$0 l1 (lseg_domain$0 next$0 lst_6$0 curr_12$0)))))))

(assert (or (Btwn$0 next$0 curr_init_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_37$0 next$0 curr_init_1$0 null$0))))

(assert (or (Btwn$0 next$0 lst_init_1$0 curr_init_1$0 curr_init_1$0)
    (not (lseg_struct$0 sk_?X_38$0 next$0 lst_init_1$0 curr_init_1$0))))

(assert (= curr_11$0 curr_init_1$0))

(assert (= lst_6$0 lst_init_1$0))

(assert (= emptyset$0 (intersection$0 sk_?X_38$0 sk_?X_37$0)))

(assert (= sk_?X_36$0 FP$0))

(assert (= sk_?X_38$0 (lseg_domain$0 next$0 lst_init_1$0 curr_init_1$0)))

(assert (lseg_struct$0 sk_?X_37$0 next$0 curr_init_1$0 null$0))

(assert (= sk_?X_39$0 (union$0 sk_?X_41$0 sk_?X_40$0)))

(assert (= sk_?X_41$0 (lseg_domain$0 next$0 lst_6$0 curr_12$0)))
...
(assert (or (in$0 sk_?e_5$0 (intersection$0 sk_?X_41$0 sk_?X_40$0))
    ...
    (not (Btwn$0 next$0 lst_6$0 curr_12$0 curr_12$0))))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and
                 ...
                 (not (in$0 l1 (lseg_domain$0 next$0 curr_init_1$0 null$0)))))))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and
                 ...
                 (not
                      (in$0 l1
                        (lseg_domain$0 next$0 lst_init_1$0 curr_init_1$0)))))))
