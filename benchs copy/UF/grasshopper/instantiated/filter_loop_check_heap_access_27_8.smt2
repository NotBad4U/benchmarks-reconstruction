...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_39$0)) (not (in$0 x sk_?X_37$0))
                 (not (in$0 x (union$0 sk_?X_39$0 sk_?X_37$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_39$0)) (not (in$0 x sk_?X_37$0)))
                 (not (in$0 x (intersection$0 sk_?X_39$0 sk_?X_37$0)))))))
...
(assert (= sk_?X_35$0 (union$0 sk_?X_39$0 sk_?X_37$0)))

(assert (= sk_?X_37$0 (lseg_domain$0 next$0 curr_init$0 null$0)))

(assert (= sk_?X_39$0 (union$0 sk_?X_42$0 sk_?X_40$0)))

(assert (= sk_?X_41$0 (setenum$0 prv_init$0)))
...
(assert (or (Btwn$0 next$0 res_init$0 prv_init$0 prv_init$0)
    (not (lseg_struct$0 sk_?X_42$0 next$0 res_init$0 prv_init$0))))
...
(assert (= sk_?X_38$0 emptyset$0))

(assert (= sk_?X_40$0 sk_?X_41$0))

(assert (= sk_?X_42$0 (lseg_domain$0 next$0 res_init$0 prv_init$0)))
