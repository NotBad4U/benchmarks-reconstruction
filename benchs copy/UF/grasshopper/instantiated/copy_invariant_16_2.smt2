...
(assert (forall ((?y Loc))
        (or (not (Btwn$0 next$0 cp_2$0 ?y ?y)) (= cp_2$0 ?y)
            (Btwn$0 next$0 cp_2$0 (read$0 next$0 cp_2$0) ?y))))

(assert (forall ((?y Loc))
        (or (not (= (read$0 next$0 cp_2$0) cp_2$0))
            (not (Btwn$0 next$0 cp_2$0 ?y ?y)) (= cp_2$0 ?y))))

(assert (Btwn$0 next$0 cp_2$0 (read$0 next$0 cp_2$0) (read$0 next$0 cp_2$0)))
...
(assert (or (Btwn$0 next$0 cp_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_2$0 next$0 cp_2$0 null$0))))
...
(assert (= sk_?X_5$0 (lseg_domain$0 next$0 lst$0 curr_2$0)))
...
(assert (or (Btwn$0 next$0 lst$0 curr_2$0 curr_2$0)
    (not (lseg_struct$0 sk_?X_5$0 next$0 lst$0 curr_2$0))))
...
(assert (= sk_?X_2$0 (lseg_domain$0 next$0 cp_2$0 null$0)))
