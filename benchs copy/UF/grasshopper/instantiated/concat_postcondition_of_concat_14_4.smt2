...
(assert (or (Btwn$0 next$0 a$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_2$0 next$0 a$0 null$0))))

(assert (or (Btwn$0 next$0 res_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_3$0 next$0 res_2$0 null$0))))
...
(assert (= sk_?X_2$0 (lseg_domain$0 next$0 a$0 null$0)))

(assert (lseg_struct$0 sk_?X_1$0 next$0 b$0 null$0))
...
(assert (or (Btwn$0 next$0 b$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_1$0 next$0 b$0 null$0))))
...
(assert (= sk_?X_1$0 (lseg_domain$0 next$0 b$0 null$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_2$0 next$0 a$0 null$0))
