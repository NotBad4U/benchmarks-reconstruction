...
(assert (forall ((?y Loc))
        (or (not (Btwn$0 next$0 end_3$0 ?y ?y)) (= end_3$0 ?y)
            (Btwn$0 next$0 end_3$0 (read$0 next$0 end_3$0) ?y))))

(assert (forall ((?y Loc))
        (or (not (Btwn$0 next$0 end2$0 ?y ?y)) (= end2$0 ?y)
            (Btwn$0 next$0 end2$0 (read$0 next$0 end2$0) ?y))))
...
(assert (forall ((?y Loc))
        (or (not (Btwn$0 next$0 start2$0 ?y ?y)) (= start2$0 ?y)
            (Btwn$0 next$0 start2$0 (read$0 next$0 start2$0) ?y))))

(assert (forall ((?y Loc))
        (or (not (= (read$0 next$0 end_3$0) end_3$0))
            (not (Btwn$0 next$0 end_3$0 ?y ?y)) (= end_3$0 ?y))))

(assert (forall ((?y Loc))
        (or (not (= (read$0 next$0 end2$0) end2$0))
            (not (Btwn$0 next$0 end2$0 ?y ?y)) (= end2$0 ?y))))
...
(assert (forall ((?y Loc))
        (or (not (= (read$0 next$0 start2$0) start2$0))
            (not (Btwn$0 next$0 start2$0 ?y ?y)) (= start2$0 ?y))))

(assert (Btwn$0 next$0 end_3$0 (read$0 next$0 end_3$0) (read$0 next$0 end_3$0)))

(assert (Btwn$0 next$0 end2$0 (read$0 next$0 end2$0) (read$0 next$0 end2$0)))

(assert (Btwn$0 next$0 sk_l1$0 (read$0 next$0 sk_l1$0) (read$0 next$0 sk_l1$0)))

(assert (Btwn$0 next$0 start2$0 (read$0 next$0 start2$0) (read$0 next$0 start2$0)))

(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 sk_l2$0) end_3$0)
        (not (= (read$0 next$0 end_3$0) sk_l2$0))
        (not (in$0 end_3$0 sk_?X_2$0)) (not (in$0 sk_l2$0 sk_?X_2$0)))))

(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 sk_l2$0) end2$0)
        (not (= (read$0 next$0 end2$0) sk_l2$0))
        (not (in$0 end2$0 sk_?X_2$0)) (not (in$0 sk_l2$0 sk_?X_2$0)))))
...
(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 sk_l2$0) start2$0)
        ...
        (not (in$0 start2$0 sk_?X_2$0)) (not (in$0 sk_l2$0 sk_?X_2$0)))))

(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 start1$0) end_3$0)
        (not (= (read$0 next$0 end_3$0) start1$0))
        (not (in$0 end_3$0 sk_?X_2$0)) (not (in$0 start1$0 sk_?X_2$0)))))

(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 start1$0) end2$0)
        (not (= (read$0 next$0 end2$0) start1$0))
        (not (in$0 end2$0 sk_?X_2$0)) (not (in$0 start1$0 sk_?X_2$0)))))

(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 start1$0) sk_l1$0)
        (not (= (read$0 next$0 sk_l1$0) start1$0))
        (not (in$0 sk_l1$0 sk_?X_2$0)) (not (in$0 start1$0 sk_?X_2$0)))))

(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 start1$0) start2$0)
        (not (= (read$0 next$0 start2$0) start1$0))
        (not (in$0 start2$0 sk_?X_2$0)) (not (in$0 start1$0 sk_?X_2$0)))))

(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 start2$0) end_3$0)
        (not (= (read$0 next$0 end_3$0) start2$0))
        (not (in$0 end_3$0 sk_?X_2$0)) (not (in$0 start2$0 sk_?X_2$0)))))

(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 start2$0) end2$0)
        (not (= (read$0 next$0 end2$0) start2$0))
        (not (in$0 end2$0 sk_?X_2$0)) (not (in$0 start2$0 sk_?X_2$0)))))

(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 start2$0) sk_l1$0)
        (not (= (read$0 next$0 sk_l1$0) start2$0))
        (not (in$0 sk_l1$0 sk_?X_2$0)) (not (in$0 start2$0 sk_?X_2$0)))))

(assert (or (not Axiom_1$0)
    (or (= (read$0 prev$0 start2$0) start2$0)
        (not (= (read$0 next$0 start2$0) start2$0))
        (not (in$0 start2$0 sk_?X_2$0)) (not (in$0 start2$0 sk_?X_2$0)))))

(assert (or (not Axiom_2$0)
    (or (= (read$0 prev$0 sk_l2$0) end_3$0)
        (not (= (read$0 next$0 end_3$0) sk_l2$0))
        (not (in$0 end_3$0 sk_?X_1$0)) (not (in$0 sk_l2$0 sk_?X_1$0)))))

(assert (or (not Axiom_2$0)
    (or (= (read$0 prev$0 sk_l2$0) end2$0)
        (not (= (read$0 next$0 end2$0) sk_l2$0))
        (not (in$0 end2$0 sk_?X_1$0)) (not (in$0 sk_l2$0 sk_?X_1$0)))))
...
(assert (or (not Axiom_2$0)
    (or (= (read$0 prev$0 sk_l2$0) start2$0)
        (not (= (read$0 next$0 start2$0) sk_l2$0))
        (not (in$0 start2$0 sk_?X_1$0)) (not (in$0 sk_l2$0 sk_?X_1$0)))))

(assert (or (not Axiom_2$0)
    (or (= (read$0 prev$0 start1$0) end_3$0)
        (not (= (read$0 next$0 end_3$0) start1$0))
        (not (in$0 end_3$0 sk_?X_1$0)) (not (in$0 start1$0 sk_?X_1$0)))))

(assert (or (not Axiom_2$0)
    (or (= (read$0 prev$0 start1$0) end2$0)
        (not (= (read$0 next$0 end2$0) start1$0))
        (not (in$0 end2$0 sk_?X_1$0)) (not (in$0 start1$0 sk_?X_1$0)))))

(assert (or (not Axiom_2$0)
    (or (= (read$0 prev$0 start1$0) sk_l1$0)
        (not (= (read$0 next$0 sk_l1$0) start1$0))
        (not (in$0 sk_l1$0 sk_?X_1$0)) (not (in$0 start1$0 sk_?X_1$0)))))

(assert (or (not Axiom_2$0)
    (or (= (read$0 prev$0 start1$0) start2$0)
        (not (= (read$0 next$0 start2$0) start1$0))
        (not (in$0 start2$0 sk_?X_1$0)) (not (in$0 start1$0 sk_?X_1$0)))))

(assert (or (not Axiom_2$0)
    (or (= (read$0 prev$0 start2$0) end_3$0)
        (not (= (read$0 next$0 end_3$0) start2$0))
        (not (in$0 end_3$0 sk_?X_1$0)) (not (in$0 start2$0 sk_?X_1$0)))))

(assert (or (not Axiom_2$0)
    (or (= (read$0 prev$0 start2$0) end2$0)
        (not (= (read$0 next$0 end2$0) start2$0))
        (not (in$0 end2$0 sk_?X_1$0)) (not (in$0 start2$0 sk_?X_1$0)))))

(assert (or (not Axiom_2$0)
    (or (= (read$0 prev$0 start2$0) sk_l1$0)
        (not (= (read$0 next$0 sk_l1$0) start2$0))
        (not (in$0 sk_l1$0 sk_?X_1$0)) (not (in$0 start2$0 sk_?X_1$0)))))

(assert (or (not Axiom_2$0)
    (or (= (read$0 prev$0 start2$0) start2$0)
        (not (= (read$0 next$0 start2$0) start2$0))
        (not (in$0 start2$0 sk_?X_1$0)) (not (in$0 start2$0 sk_?X_1$0)))))

(assert (or (not Axiom$0)
    (or (= (read$0 prev$0 sk_l2$0) end_3$0)
        (not (= (read$0 next$0 end_3$0) sk_l2$0))
        (not (in$0 end_3$0 sk_?X_3$0)) (not (in$0 sk_l2$0 sk_?X_3$0)))))

(assert (or (not Axiom$0)
    (or (= (read$0 prev$0 sk_l2$0) end2$0)
        (not (= (read$0 next$0 end2$0) sk_l2$0))
        (not (in$0 end2$0 sk_?X_3$0)) (not (in$0 sk_l2$0 sk_?X_3$0)))))

(assert (or (not Axiom$0)
    (or (= (read$0 prev$0 sk_l2$0) sk_l1$0)
        (not (= (read$0 next$0 sk_l1$0) sk_l2$0))
        (not (in$0 sk_l1$0 sk_?X_3$0)) (not (in$0 sk_l2$0 sk_?X_3$0)))))

(assert (or (not Axiom$0)
    (or (= (read$0 prev$0 sk_l2$0) start2$0)
        (not (= (read$0 next$0 start2$0) sk_l2$0))
        (not (in$0 start2$0 sk_?X_3$0)) (not (in$0 sk_l2$0 sk_?X_3$0)))))

(assert (or (not Axiom$0)
    (or (= (read$0 prev$0 start1$0) end_3$0)
        (not (= (read$0 next$0 end_3$0) start1$0))
        (not (in$0 end_3$0 sk_?X_3$0)) (not (in$0 start1$0 sk_?X_3$0)))))

(assert (or (not Axiom$0)
    (or (= (read$0 prev$0 start1$0) end2$0)
        (not (= (read$0 next$0 end2$0) start1$0))
        (not (in$0 end2$0 sk_?X_3$0)) (not (in$0 start1$0 sk_?X_3$0)))))

(assert (or (not Axiom$0)
    (or (= (read$0 prev$0 start1$0) sk_l1$0)
        (not (= (read$0 next$0 sk_l1$0) start1$0))
        (not (in$0 sk_l1$0 sk_?X_3$0)) (not (in$0 start1$0 sk_?X_3$0)))))

(assert (or (not Axiom$0)
    (or (= (read$0 prev$0 start1$0) start2$0)
        (not (= (read$0 next$0 start2$0) start1$0))
        (not (in$0 start2$0 sk_?X_3$0)) (not (in$0 start1$0 sk_?X_3$0)))))

(assert (or (not Axiom$0)
    (or (= (read$0 prev$0 start2$0) end_3$0)
        (not (= (read$0 next$0 end_3$0) start2$0))
        (not (in$0 end_3$0 sk_?X_3$0)) (not (in$0 start2$0 sk_?X_3$0)))))

(assert (or (not Axiom$0)
    (or (= (read$0 prev$0 start2$0) end2$0)
        (not (= (read$0 next$0 end2$0) start2$0))
        (not (in$0 end2$0 sk_?X_3$0)) (not (in$0 start2$0 sk_?X_3$0)))))

(assert (or (not Axiom$0)
    (or (= (read$0 prev$0 start2$0) sk_l1$0)
        (not (= (read$0 next$0 sk_l1$0) start2$0))
        (not (in$0 sk_l1$0 sk_?X_3$0)) (not (in$0 start2$0 sk_?X_3$0)))))

(assert (or (not Axiom$0)
    (or (= (read$0 prev$0 start2$0) start2$0)
        (not (= (read$0 next$0 start2$0) start2$0))
        (not (in$0 start2$0 sk_?X_3$0)) (not (in$0 start2$0 sk_?X_3$0)))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_2$0)) (not (in$0 x sk_?X_1$0))
                 (not (in$0 x (union$0 sk_?X_2$0 sk_?X_1$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_2$0)) (not (in$0 x sk_?X_1$0)))
                 (not (in$0 x (intersection$0 sk_?X_2$0 sk_?X_1$0)))))))
...
(assert (= end_3$0 end1$0))

(assert (= start2$0 null$0))

(assert (= emptyset$0 (intersection$0 sk_?X_2$0 sk_?X_1$0)))

(assert (= sk_?X$0 FP$0))

(assert (= sk_?X_2$0 (dlseg_domain$0 next$0 prev$0 start1$0 null$0 null$0 end1$0)))

(assert (dlseg_struct$0 sk_?X_1$0 next$0 prev$0 start2$0 null$0 null$0 end2$0))
...
(assert (= start_3$0 start1$0))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X$0 (union$0 sk_?X_2$0 sk_?X_1$0)))

(assert (= sk_?X_1$0 (dlseg_domain$0 next$0 prev$0 start2$0 null$0 null$0 end2$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (dlseg_struct$0 sk_?X_2$0 next$0 prev$0 start1$0 null$0 null$0 end1$0))
...
(assert (or
    ...
    (not (Btwn$0 next$0 start_3$0 null$0 null$0))))
