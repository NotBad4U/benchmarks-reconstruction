...
(assert (or (not Axiom_7$0)
    (or (= (read$0 prev$0 start1$0) null$0)
        (not (= (read$0 next$0 null$0) start1$0))
        (not (in$0 null$0 sk_?X_9$0)) (not (in$0 start1$0 sk_?X_9$0)))))

(assert (or (not Axiom_7$0)
    (or (= (read$0 prev$0 start1$0) end1$0)
        (not (= (read$0 next$0 end1$0) start1$0))
        (not (in$0 end1$0 sk_?X_9$0)) (not (in$0 start1$0 sk_?X_9$0)))))

(assert (or (not Axiom_7$0)
    (or (= (read$0 prev$0 start1$0) end2$0)
        (not (= (read$0 next$0 end2$0) start1$0))
        (not (in$0 end2$0 sk_?X_9$0)) (not (in$0 start1$0 sk_?X_9$0)))))

(assert (or (not Axiom_7$0)
    (or (= (read$0 prev$0 start2$0) null$0)
        (not (= (read$0 next$0 null$0) start2$0))
        (not (in$0 null$0 sk_?X_9$0)) (not (in$0 start2$0 sk_?X_9$0)))))

(assert (or (not Axiom_7$0)
    (or (= (read$0 prev$0 start2$0) end1$0)
        (not (= (read$0 next$0 end1$0) start2$0))
        (not (in$0 end1$0 sk_?X_9$0)) (not (in$0 start2$0 sk_?X_9$0)))))

(assert (or (not Axiom_7$0)
    (or (= (read$0 prev$0 start2$0) end2$0)
        (not (= (read$0 next$0 end2$0) start2$0))
        (not (in$0 end2$0 sk_?X_9$0)) (not (in$0 start2$0 sk_?X_9$0)))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_10$0)) (not (in$0 x sk_?X_9$0))
                 (not (in$0 x (union$0 sk_?X_10$0 sk_?X_9$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_10$0)) (not (in$0 x sk_?X_9$0)))
                 (not (in$0 x (intersection$0 sk_?X_10$0 sk_?X_9$0)))))))
...
(assert (= emptyset$0 (intersection$0 sk_?X_10$0 sk_?X_9$0)))

(assert (= sk_?X_8$0 FP$0))

(assert (= sk_?X_10$0 (dlseg_domain$0 next$0 prev$0 start1$0 null$0 null$0 end1$0)))

(assert (dlseg_struct$0 sk_?X_9$0 next$0 prev$0 start2$0 null$0 null$0 end2$0))
...
(assert (= sk_?X_8$0 (union$0 sk_?X_10$0 sk_?X_9$0)))

(assert (= sk_?X_9$0 (dlseg_domain$0 next$0 prev$0 start2$0 null$0 null$0 end2$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (dlseg_struct$0 sk_?X_10$0 next$0 prev$0 start1$0 null$0 null$0 end1$0))

(assert (not (= start2$0 null$0)))

(assert (not (in$0 end1$0 FP$0)))
