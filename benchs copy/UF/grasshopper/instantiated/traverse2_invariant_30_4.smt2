...
(set-info :source |
  ...
  tests/spl/sl/sl_traverse.spl:30:4:An invariant might not hold before entering a loop in procedure traverse2
  tests/spl/sl/sl_traverse.spl:31:16:Related location: This is the loop invariant that might not hold initially
  |)
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x sk_?X_24$0) (in$0 x FP$0)
                 (in$0 x (intersection$0 sk_?X_24$0 FP$0)))
            (and (or (not (in$0 x sk_?X_24$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (intersection$0 sk_?X_24$0 FP$0)))))))
...
(assert (or (Btwn$0 next$0 curr_9$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_23$0 next$0 curr_9$0 null$0))))

(assert (or (Btwn$0 next$0 lst_1$0 curr_9$0 curr_9$0)
    (not (lseg_struct$0 sk_?X_24$0 next$0 lst_1$0 curr_9$0))))

(assert (= curr_9$0 lst_1$0))
...
(assert (= sk_?X_24$0 (lseg_domain$0 next$0 lst_1$0 curr_9$0)))

(assert (or (in$0 sk_?e_3$0 (intersection$0 sk_?X_24$0 sk_?X_23$0))
    (and (in$0 sk_?e_3$0 sk_FP_2$0) (not (in$0 sk_?e_3$0 FP$0)))
    (not (Btwn$0 next$0 curr_9$0 null$0 null$0))
    (not (Btwn$0 next$0 lst_1$0 curr_9$0 curr_9$0))))
...
(assert (or (Btwn$0 next$0 lst_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_21$0 next$0 lst_1$0 null$0))))

(assert (= FP_Caller_3$0 (setminus$0 FP_Caller$0 FP$0)))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X_21$0 (lseg_domain$0 next$0 lst_1$0 null$0)))

(assert (lseg_struct$0 sk_?X_21$0 next$0 lst_1$0 null$0))

(assert (= sk_?X_23$0 (lseg_domain$0 next$0 curr_9$0 null$0)))

(assert (= sk_FP_2$0 sk_?X_22$0))

(assert (not (= lst_1$0 null$0)))
