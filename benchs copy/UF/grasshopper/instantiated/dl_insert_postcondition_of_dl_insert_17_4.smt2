...
(assert (forall ((?y Loc))
        (or (not (Btwn$0 next$0 c_5$0 ?y ?y)) (= c_5$0 ?y)
            (Btwn$0 next$0 c_5$0 (read$0 next$0 c_5$0) ?y))))
...
(assert (forall ((?y Loc))
        (or (not (= (read$0 next$0 c_5$0) c_5$0))
            (not (Btwn$0 next$0 c_5$0 ?y ?y)) (= c_5$0 ?y))))
...
(assert (Btwn$0 next$0 c_5$0 (read$0 next$0 c_5$0) (read$0 next$0 c_5$0)))
...
(assert (or (not Axiom_2$0)
    (or (= (read$0 prev_3$0 null$0) b$0) (not (= (read$0 next$0 b$0) null$0))
        (not (in$0 b$0 sk_?X_8$0)) (not (in$0 null$0 sk_?X_8$0)))))

(assert (or (not Axiom_2$0)
    (or (= (read$0 prev_3$0 null$0) sk_l1$0)
        (not (= (read$0 next$0 sk_l1$0) null$0))
        (not (in$0 sk_l1$0 sk_?X_8$0)) (not (in$0 null$0 sk_?X_8$0)))))

(assert (or (not Axiom_2$0)
    (or (= (read$0 prev_3$0 c_5$0) c_5$0)
        (not (= (read$0 next$0 c_5$0) c_5$0)) (not (in$0 c_5$0 sk_?X_8$0))
        (not (in$0 c_5$0 sk_?X_8$0)))))
...
(assert (or (not Axiom_2$0)
    (or (= (read$0 prev_3$0 c_5$0) b$0) (not (= (read$0 next$0 b$0) c_5$0))
        (not (in$0 b$0 sk_?X_8$0)) (not (in$0 c_5$0 sk_?X_8$0)))))

(assert (or (not Axiom_2$0)
    (or (= (read$0 prev_3$0 c_5$0) sk_l1$0)
        (not (= (read$0 next$0 sk_l1$0) c_5$0))
        (not (in$0 sk_l1$0 sk_?X_8$0)) (not (in$0 c_5$0 sk_?X_8$0)))))
...
(assert (or (not Axiom_2$0)
    (or (= (read$0 prev_3$0 sk_l2$0) null$0)
        (not (= (read$0 next$0 null$0) sk_l2$0))
        (not (in$0 null$0 sk_?X_8$0)) (not (in$0 sk_l2$0 sk_?X_8$0)))))
...
(assert (or (not Axiom_2$0)
    (or (= (read$0 prev_3$0 sk_l2$0) sk_l1$0)
        (not (= (read$0 next$0 sk_l1$0) sk_l2$0))
        (not (in$0 sk_l1$0 sk_?X_8$0)) (not (in$0 sk_l2$0 sk_?X_8$0)))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_7$0)) (not (in$0 x sk_?X_6$0))
                 (not (in$0 x (union$0 sk_?X_7$0 sk_?X_6$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_7$0)) (not (in$0 x sk_?X_6$0)))
                 (not (in$0 x (intersection$0 sk_?X_7$0 sk_?X_6$0)))))))
...
(assert (= (read$0 (write$0 prev$0 c_5$0 null$0) c_5$0) null$0))

(assert (or (= null$0 c_5$0)
    (= (read$0 prev$0 null$0) (read$0 (write$0 prev$0 c_5$0 null$0) null$0))))

(assert (or (= c_5$0 c_5$0)
    (= (read$0 prev$0 c_5$0) (read$0 (write$0 prev$0 c_5$0 null$0) c_5$0))))

(assert (or (= sk_l2$0 c_5$0)
    (= (read$0 prev$0 sk_l2$0)
      (read$0 (write$0 prev$0 c_5$0 null$0) sk_l2$0))))

(assert (= (read$0 next$0 null$0) null$0))

(assert (= (read$0 prev$0 null$0) null$0))

(assert (= (read$0 prev_3$0 null$0) null$0))
...
(assert (or
    (and (Btwn$0 next$0 a$0 null$0 null$0)
         ...
         Axiom_1$0)
    (not (dlseg_struct$0 sk_?X_7$0 next$0 prev$0 a$0 null$0 null$0 b$0))))
...
(assert (= sk_?X_4$0 (union$0 sk_?X_7$0 sk_?X_5$0)))

(assert (= sk_?X_5$0 sk_?X_6$0))

(assert (= sk_?X_7$0 (dlseg_domain$0 next$0 prev$0 a$0 null$0 null$0 b$0)))

(assert (dlseg_struct$0 sk_?X_7$0 next$0 prev$0 a$0 null$0 null$0 b$0))
...
(assert (or
    ...
    (not (Btwn$0 next$0 c_5$0 null$0 null$0))))
...
(assert (or
    (and (Btwn$0 next$0 c_5$0 null$0 null$0)
         ...
         Axiom_2$0)
    (not
         (dlseg_struct$0 sk_?X_8$0 next$0 prev_3$0 c_5$0 null$0 null$0 d_4$0))))

(assert (= FP_Caller_final_2$0 (union$0 FP_Caller_1$0 FP$0)))

(assert (= c_5$0 elt$0))

(assert (= prev_3$0 (write$0 prev$0 elt$0 null$0)))

(assert (= (read$0 next$0 elt$0) null$0))

(assert (= emptyset$0 (intersection$0 sk_?X_7$0 sk_?X_5$0)))

(assert (= sk_?X_4$0 FP$0))

(assert (= sk_?X_6$0 (setenum$0 elt$0)))
