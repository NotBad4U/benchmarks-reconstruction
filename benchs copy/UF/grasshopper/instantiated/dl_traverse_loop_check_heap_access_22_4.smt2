...
(assert (or (not Axiom_10$0)
    (or (= (read$0 prev$0 null$0) b_init$0)
        ...
        (not (in$0 b_init$0 sk_?X_14$0)) (not (in$0 null$0 sk_?X_14$0)))))

(assert (or (not Axiom_10$0)
    (or (= (read$0 prev$0 null$0) prv_init$0)
        (not (= (read$0 next$0 prv_init$0) null$0))
        (not (in$0 prv_init$0 sk_?X_14$0)) (not (in$0 null$0 sk_?X_14$0)))))
...
(assert (or (not Axiom_10$0)
    (or (= (read$0 prev$0 curr_init$0) b_init$0)
        ...
        (not (in$0 b_init$0 sk_?X_14$0)) (not (in$0 curr_init$0 sk_?X_14$0)))))
...
(assert (or (not Axiom_10$0)
    (or (= (read$0 prev$0 lst_2$0) null$0)
        ...
        (not (in$0 null$0 sk_?X_14$0)) (not (in$0 lst_2$0 sk_?X_14$0)))))

(assert (or (not Axiom_10$0)
    (or (= (read$0 prev$0 lst_2$0) b_init$0)
        (not (= (read$0 next$0 b_init$0) lst_2$0))
        (not (in$0 b_init$0 sk_?X_14$0)) (not (in$0 lst_2$0 sk_?X_14$0)))))

(assert (or (not Axiom_10$0)
    (or (= (read$0 prev$0 lst_2$0) prv_init$0)
        (not (= (read$0 next$0 prv_init$0) lst_2$0))
        (not (in$0 prv_init$0 sk_?X_14$0)) (not (in$0 lst_2$0 sk_?X_14$0)))))
...
(assert (or (not Axiom_9$0)
    (or (= (read$0 prev$0 null$0) b_init$0)
        (not (= (read$0 next$0 b_init$0) null$0))
        (not (in$0 b_init$0 sk_?X_13$0)) (not (in$0 null$0 sk_?X_13$0)))))

(assert (or (not Axiom_9$0)
    (or (= (read$0 prev$0 null$0) prv_init$0)
        (not (= (read$0 next$0 prv_init$0) null$0))
        (not (in$0 prv_init$0 sk_?X_13$0)) (not (in$0 null$0 sk_?X_13$0)))))
...
(assert (or (not Axiom_9$0)
    (or (= (read$0 prev$0 curr_init$0) b_init$0)
        (not (= (read$0 next$0 b_init$0) curr_init$0))
        (not (in$0 b_init$0 sk_?X_13$0)) (not (in$0 curr_init$0 sk_?X_13$0)))))
...
(assert (or (not Axiom_9$0)
    (or (= (read$0 prev$0 lst_2$0) null$0)
        (not (= (read$0 next$0 null$0) lst_2$0))
        (not (in$0 null$0 sk_?X_13$0)) (not (in$0 lst_2$0 sk_?X_13$0)))))

(assert (or (not Axiom_9$0)
    (or (= (read$0 prev$0 lst_2$0) b_init$0)
        (not (= (read$0 next$0 b_init$0) lst_2$0))
        (not (in$0 b_init$0 sk_?X_13$0)) (not (in$0 lst_2$0 sk_?X_13$0)))))

(assert (or (not Axiom_9$0)
    (or (= (read$0 prev$0 lst_2$0) prv_init$0)
        (not (= (read$0 next$0 prv_init$0) lst_2$0))
        (not (in$0 prv_init$0 sk_?X_13$0)) (not (in$0 lst_2$0 sk_?X_13$0)))))
