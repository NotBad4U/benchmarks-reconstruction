...
(set-info :source |
  ...
  tests/spl/sl/sl_remove.spl:24:6-24:Possible heap access through null or dangling reference
  |)
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_66$0)) (not (in$0 x sk_?X_64$0))
                 (not (in$0 x (union$0 sk_?X_66$0 sk_?X_64$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_66$0)) (not (in$0 x sk_?X_64$0)))
                 (not (in$0 x (intersection$0 sk_?X_66$0 sk_?X_64$0)))))))
...
(assert (or (Btwn$0 next$0 curr_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_64$0 next$0 curr_init$0 null$0))))
...
(assert (= sk_?X_63$0 (union$0 sk_?X_65$0 sk_?X_64$0)))

(assert (= sk_?X_64$0 (lseg_domain$0 next$0 curr_init$0 null$0)))

(assert (= sk_?X_66$0 (lseg_domain$0 next$0 lst_init$0 curr_init$0)))

(assert (lseg_struct$0 sk_?X_64$0 next$0 curr_init$0 null$0))
...
(assert (or (Btwn$0 next$0 lst_init$0 curr_init$0 curr_init$0)
    (not (lseg_struct$0 sk_?X_66$0 next$0 lst_init$0 curr_init$0))))
...
(assert (= emptyset$0 (intersection$0 sk_?X_65$0 sk_?X_64$0)))
...
(assert (lseg_struct$0 sk_?X_66$0 next$0 lst_init$0 curr_init$0))
