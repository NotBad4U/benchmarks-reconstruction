...
(set-info :source |
  ...
  tests/spl/sl/sl_reverse.spl:22:4-22:Possible heap access through null or dangling reference
  |)
...
(assert (or (Btwn$0 next$0 rev_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_14$0 next$0 rev_init$0 null$0))))
...
(assert (lseg_struct$0 sk_?X_14$0 next$0 rev_init$0 null$0))
...
(assert (= sk_?X_14$0 (lseg_domain$0 next$0 rev_init$0 null$0)))
