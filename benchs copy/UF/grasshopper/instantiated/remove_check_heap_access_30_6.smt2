...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_22$0)) (not (in$0 x FP$0))
                 (not (in$0 x (union$0 sk_?X_22$0 FP$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x (setminus$0 FP$0 FP_1$0)))
                 ...
                 (not (in$0 x (union$0 (setminus$0 FP$0 FP_1$0) sk_?X_19$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_17$0)) (not (in$0 x sk_?X_18$0))
                 (not (in$0 x (union$0 sk_?X_17$0 sk_?X_18$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_22$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (intersection$0 sk_?X_22$0 FP$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_17$0)) (not (in$0 x sk_?X_18$0)))
                 (not (in$0 x (intersection$0 sk_?X_17$0 sk_?X_18$0)))))))
...
(assert (or (Btwn$0 next$0 curr_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_21$0 next$0 curr_2$0 null$0))))
...
(assert (or (Btwn$0 next$0 lst_1$0 curr_3$0 curr_3$0)
    (not (lseg_struct$0 sk_?X_16$0 next$0 lst_1$0 curr_3$0))))
...
(assert (= emptyset$0 (intersection$0 sk_?X_17$0 sk_?X_18$0)))

(assert (= sk_?X_17$0 sk_?X_16$0))

(assert (= sk_?X_19$0
  (union$0 (intersection$0 Alloc$0 FP_1$0) (setminus$0 Alloc$0 Alloc$0))))

(assert (lseg_struct$0 sk_?X_16$0 next$0 lst_1$0 curr_3$0))

(assert (not (= curr_3$0 null$0)))

(assert (= emptyset$0 (intersection$0 sk_?X_22$0 sk_?X_21$0)))

(assert (= sk_?X_20$0 FP_1$0))

(assert (= sk_?X_22$0 sk_?X_23$0))

(assert (= FP$0 (union$0 FP_1$0 FP$0)))

(assert (lseg_struct$0 sk_?X_23$0 next$0 lst$0 curr_2$0))
...
(assert (or (Btwn$0 next$0 curr_3$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_18$0 next$0 curr_3$0 null$0))))

(assert (or (Btwn$0 next$0 lst$0 curr_2$0 curr_2$0)
    (not (lseg_struct$0 sk_?X_23$0 next$0 lst$0 curr_2$0))))
...
(assert (= sk_?X_16$0 (lseg_domain$0 next$0 lst_1$0 curr_3$0)))

(assert (= sk_?X_18$0 (lseg_domain$0 next$0 curr_3$0 null$0)))

(assert (= sk_?X_19$0 (union$0 sk_?X_17$0 sk_?X_18$0)))

(assert (lseg_struct$0 sk_?X_18$0 next$0 curr_3$0 null$0))

(assert (= emptyset$0 emptyset$0))

(assert (= sk_?X_20$0 (union$0 sk_?X_22$0 sk_?X_21$0)))

(assert (= sk_?X_21$0 (lseg_domain$0 next$0 curr_2$0 null$0)))

(assert (= sk_?X_23$0 (lseg_domain$0 next$0 lst$0 curr_2$0)))

(assert (lseg_struct$0 sk_?X_21$0 next$0 curr_2$0 null$0))
