...
(set-info :source |
  ...
  tests/spl/sl/sl_filter.spl:17:2:An invariant might not hold before entering a loop in procedure filter
  tests/spl/sl/sl_filter.spl:18:14:Related location: This is the loop invariant that might not hold initially
  |)
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 emptyset$0 FP$0))
                 (or (in$0 x emptyset$0) (in$0 x FP$0)))
            (and (not (in$0 x emptyset$0)) (not (in$0 x FP$0))
                 (not (in$0 x (union$0 emptyset$0 FP$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 FP$0 sk_?X_6$0))
                 (or (in$0 x FP$0) (in$0 x sk_?X_6$0)))
            (and (not (in$0 x FP$0)) (not (in$0 x sk_?X_6$0))
                 (not (in$0 x (union$0 FP$0 sk_?X_6$0)))))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x emptyset$0) (in$0 x FP$0)
                 (in$0 x (intersection$0 emptyset$0 FP$0)))
            (and (or (not (in$0 x emptyset$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (intersection$0 emptyset$0 FP$0)))))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x FP$0) (in$0 x sk_?X_6$0)
                 (in$0 x (intersection$0 FP$0 sk_?X_6$0)))
            (and (or (not (in$0 x FP$0)) (not (in$0 x sk_?X_6$0)))
                 (not (in$0 x (intersection$0 FP$0 sk_?X_6$0)))))))
...
(assert (or (Btwn$0 next$0 curr_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_3$0 next$0 curr_2$0 null$0))))

(assert (or (Btwn$0 next$0 x$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X$0 next$0 x$0 null$0))))
...
(assert (= sk_?X_1$0 (union$0 sk_?X_5$0 sk_?X_3$0)))

(assert (= sk_?X_3$0 (lseg_domain$0 next$0 curr_2$0 null$0)))

(assert (= sk_?X_5$0 (union$0 sk_?X_8$0 sk_?X_6$0)))

(assert (= sk_?X_7$0 (setenum$0 prv_2$0)))

(assert (= sk_FP$0 sk_?X_2$0))

(assert (or (in$0 sk_?e$0 (intersection$0 sk_?X_5$0 sk_?X_3$0))
    (in$0 sk_?e$0 (intersection$0 sk_?X_8$0 sk_?X_6$0))
    (and (in$0 sk_?e$0 sk_FP_1$0) (not (in$0 sk_?e$0 FP$0)))
    (not (= (read$0 next$0 prv_2$0) curr_2$0))
    (not (Btwn$0 next$0 curr_2$0 null$0 null$0))
    (not (Btwn$0 next$0 res_1$0 prv_2$0 prv_2$0))))
...
(assert (or (Btwn$0 next$0 res_1$0 prv_2$0 prv_2$0)
    (not (lseg_struct$0 sk_?X_8$0 next$0 res_1$0 prv_2$0))))
...
(assert (= sk_?X$0 (lseg_domain$0 next$0 x$0 null$0)))

(assert (lseg_struct$0 sk_?X$0 next$0 x$0 null$0))

(assert (= sk_?X_2$0 (union$0 sk_?X_4$0 sk_?X_3$0)))

(assert (= sk_?X_4$0 emptyset$0))

(assert (= sk_?X_6$0 sk_?X_7$0))

(assert (= sk_?X_8$0 (lseg_domain$0 next$0 res_1$0 prv_2$0)))

(assert (= sk_FP_1$0 sk_?X_1$0))

(assert (or (in$0 sk_?e_1$0 (intersection$0 sk_?X_4$0 sk_?X_3$0))
    (and (in$0 sk_?e_1$0 sk_FP$0) (not (in$0 sk_?e_1$0 FP$0)))
    (not (= prv_2$0 null$0)) (not (= res_1$0 curr_2$0))
    (not (Btwn$0 next$0 curr_2$0 null$0 null$0))))
