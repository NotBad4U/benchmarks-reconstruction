...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_34$0)) (not (in$0 x sk_?X_32$0))
                 (not (in$0 x (union$0 sk_?X_34$0 sk_?X_32$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_34$0)) (not (in$0 x sk_?X_32$0)))
                 (not (in$0 x (intersection$0 sk_?X_34$0 sk_?X_32$0)))))))
...
(assert (or (Btwn$0 next$0 res_init$0 prv_init$0 prv_init$0)
    (not (lseg_struct$0 sk_?X_34$0 next$0 res_init$0 prv_init$0))))
...
(assert (= sk_?X_28$0 (union$0 sk_?X_30$0 sk_?X_29$0)))

(assert (= sk_?X_30$0 emptyset$0))

(assert (= sk_?X_32$0 sk_?X_33$0))

(assert (= sk_?X_34$0 (lseg_domain$0 next$0 res_init$0 prv_init$0)))
...
(assert (or (Btwn$0 next$0 curr_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_29$0 next$0 curr_init$0 null$0))))
...
(assert (= sk_?X_27$0 (union$0 sk_?X_31$0 sk_?X_29$0)))

(assert (= sk_?X_29$0 (lseg_domain$0 next$0 curr_init$0 null$0)))

(assert (= sk_?X_31$0 (union$0 sk_?X_34$0 sk_?X_32$0)))

(assert (= sk_?X_33$0 (setenum$0 prv_init$0)))
