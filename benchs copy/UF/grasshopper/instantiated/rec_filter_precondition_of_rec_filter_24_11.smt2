...
(assert (or (Btwn$0 next$0 x$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_14$0 next$0 x$0 null$0))))
...
(assert (= sk_?X_15$0 (lseg_domain$0 next$0 n1_2$0 null$0)))
...
(assert (or (Btwn$0 next$0 n1_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_15$0 next$0 n1_2$0 null$0))))
...
(assert (= sk_?X_14$0 (lseg_domain$0 next$0 x$0 null$0)))

(assert (lseg_struct$0 sk_?X_14$0 next$0 x$0 null$0))

(assert (= sk_FP_1$0 sk_?X_15$0))
