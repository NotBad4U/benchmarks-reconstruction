...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_227$0)) (not (in$0 x FP$0))
                 (not (in$0 x (union$0 sk_?X_227$0 FP$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_229$0)) (not (in$0 x sk_?X_229$0))
                 (not (in$0 x (union$0 sk_?X_229$0 sk_?X_229$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_227$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (intersection$0 sk_?X_227$0 FP$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_229$0)) (not (in$0 x sk_?X_229$0)))
                 (not (in$0 x (intersection$0 sk_?X_229$0 sk_?X_229$0)))))))
...
(assert (or (Btwn$0 next$0 x_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_224$0 next$0 x_1$0 null$0))))

(assert (or (Btwn$0 next$0 z_1$0 curr_2$0 curr_2$0)
    (not (lseg_struct$0 sk_?X_228$0 next$0 z_1$0 curr_2$0))))

(assert (= curr_2$0 x_1$0))

(assert (= z_1$0 x_1$0))

(assert (= sk_?X_224$0 FP$0))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (= sk_?X_225$0 (union$0 sk_?X_227$0 sk_?X_226$0)))

(assert (= sk_?X_227$0 (union$0 sk_?X_229$0 sk_?X_228$0)))

(assert (= sk_?X_229$0 (lseg_domain$0 next$0 y_6$0 z_1$0)))
...
(assert (or (in$0 sk_?e_3$0 (intersection$0 sk_?X_227$0 sk_?X_226$0))
    ...
    (not (Btwn$0 next$0 z_1$0 curr_2$0 curr_2$0))))
...
(assert (or (Btwn$0 next$0 curr_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_226$0 next$0 curr_2$0 null$0))))

(assert (or (Btwn$0 next$0 y_6$0 z_1$0 z_1$0)
    (not (lseg_struct$0 sk_?X_229$0 next$0 y_6$0 z_1$0))))
...
(assert (= sk_?X_224$0 (lseg_domain$0 next$0 x_1$0 null$0)))

(assert (lseg_struct$0 sk_?X_224$0 next$0 x_1$0 null$0))

(assert (= sk_?X_226$0 (lseg_domain$0 next$0 curr_2$0 null$0)))

(assert (= sk_?X_228$0 (lseg_domain$0 next$0 z_1$0 curr_2$0)))

(assert (= sk_FP_8$0 sk_?X_225$0))
