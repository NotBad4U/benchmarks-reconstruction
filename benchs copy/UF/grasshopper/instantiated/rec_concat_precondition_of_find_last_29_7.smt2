...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_FP_1$0)) (not (in$0 x sk_?X_37$0))
                 (not (in$0 x (union$0 sk_FP_1$0 sk_?X_37$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_FP_1$0)) (not (in$0 x sk_?X_37$0)))
                 (not (in$0 x (intersection$0 sk_FP_1$0 sk_?X_37$0)))))))
...
(assert (or (Btwn$0 next$0 a_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_41$0 next$0 a_1$0 null$0))))
...
(assert (= sk_?X_37$0 (lseg_domain$0 next$0 b$0 null$0)))

(assert (= sk_?X_39$0 (lseg_domain$0 next$0 a_1$0 null$0)))

(assert (lseg_struct$0 sk_?X_37$0 next$0 b$0 null$0))

(assert (not (= a_1$0 null$0)))

(assert (= sk_?X_41$0 (lseg_domain$0 next$0 a_1$0 null$0)))

(assert (or (= a_1$0 null$0)
    (and (in$0 sk_?e_3$0 sk_FP_1$0) (not (in$0 sk_?e_3$0 FP$0)))
    (not (Btwn$0 next$0 a_1$0 null$0 null$0))))
...
(assert (or (Btwn$0 next$0 a_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_39$0 next$0 a_1$0 null$0))))

(assert (or (Btwn$0 next$0 b$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_37$0 next$0 b$0 null$0))))
...
(assert (lseg_struct$0 sk_?X_39$0 next$0 a_1$0 null$0))

(assert (= sk_?X_40$0 sk_?X_41$0))

(assert (= sk_FP_1$0 sk_?X_40$0))
