...
(set-info :source |
  ...
  tests/spl/sl/rec_remove.spl:26:4-15:A postcondition of procedure rec_remove might not hold at this return point
...
(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 null$0 (ep$0 next$0 FP_1$0 null$0) ?y)
            (not (Btwn$0 next$0 null$0 ?y ?y)) (not (in$0 ?y FP_1$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 lst$0 (ep$0 next$0 FP_1$0 lst$0) ?y)
            (not (Btwn$0 next$0 lst$0 ?y ?y)) (not (in$0 ?y FP_1$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 n1_2$0 (ep$0 next$0 FP_1$0 n1_2$0) ?y)
            (not (Btwn$0 next$0 n1_2$0 ?y ?y)) (not (in$0 ?y FP_1$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 n2_2$0 (ep$0 next$0 FP_1$0 n2_2$0) ?y)
            (not (Btwn$0 next$0 n2_2$0 ?y ?y)) (not (in$0 ?y FP_1$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 sk_?e_3$0 (ep$0 next$0 FP_1$0 sk_?e_3$0) ?y)
            (not (Btwn$0 next$0 sk_?e_3$0 ?y ?y)) (not (in$0 ?y FP_1$0)))))

(assert (Btwn$0 next$0 null$0 (ep$0 next$0 FP_1$0 null$0)
  (ep$0 next$0 FP_1$0 null$0)))

(assert (Btwn$0 next$0 lst$0 (ep$0 next$0 FP_1$0 lst$0) (ep$0 next$0 FP_1$0 lst$0)))
...
(assert (Btwn$0 next$0 sk_?e_3$0 (ep$0 next$0 FP_1$0 sk_?e_3$0)
  (ep$0 next$0 FP_1$0 sk_?e_3$0)))

(assert (or (in$0 (ep$0 next$0 FP_1$0 null$0) FP_1$0)
    (= null$0 (ep$0 next$0 FP_1$0 null$0))))

(assert (or (in$0 (ep$0 next$0 FP_1$0 lst$0) FP_1$0)
    (= lst$0 (ep$0 next$0 FP_1$0 lst$0))))

(assert (or (in$0 (ep$0 next$0 FP_1$0 n1_2$0) FP_1$0)
    (= n1_2$0 (ep$0 next$0 FP_1$0 n1_2$0))))

(assert (or (in$0 (ep$0 next$0 FP_1$0 n2_2$0) FP_1$0)
    (= n2_2$0 (ep$0 next$0 FP_1$0 n2_2$0))))

(assert (or (in$0 (ep$0 next$0 FP_1$0 sk_?e_3$0) FP_1$0)
    (= sk_?e_3$0 (ep$0 next$0 FP_1$0 sk_?e_3$0))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 (setminus$0 FP$0 FP_1$0) sk_?X_12$0))
                 (or (in$0 x (setminus$0 FP$0 FP_1$0)) (in$0 x sk_?X_12$0)))
            (and (not (in$0 x (setminus$0 FP$0 FP_1$0)))
                 (not (in$0 x sk_?X_12$0))
                 (not (in$0 x (union$0 (setminus$0 FP$0 FP_1$0) sk_?X_12$0)))))))
...
(assert (or (Btwn$0 next$0 n1_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_13$0 next$0 n1_2$0 null$0))))

(assert (or (Btwn$0 next_2$0 res_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_15$0 next_2$0 res_1$0 null$0))))
...
(assert (lseg_struct$0 sk_?X_12$0 next_1$0 n2_2$0 null$0))

(assert (= sk_?X_13$0 (lseg_domain$0 next$0 n1_2$0 null$0)))

(assert (lseg_struct$0 sk_?X_13$0 next$0 n1_2$0 null$0))

(assert (= sk_?X_14$0 (lseg_domain$0 next$0 lst$0 null$0)))

(assert (lseg_struct$0 sk_?X_14$0 next$0 lst$0 null$0))

(assert (or
    (and (in$0 sk_?e_3$0 (lseg_domain$0 next_2$0 res_1$0 null$0))
         (not (in$0 sk_?e_3$0 sk_?X_15$0)))
    (and (in$0 sk_?e_3$0 sk_?X_15$0)
...
(assert (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_14$0 next$0 lst$0 null$0))))

(assert (or (Btwn$0 next_1$0 n2_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_12$0 next_1$0 n2_2$0 null$0))))
...
(assert (= sk_?X_12$0 (lseg_domain$0 next_1$0 n2_2$0 null$0)))

(assert (= sk_?X_13$0 FP_1$0))
