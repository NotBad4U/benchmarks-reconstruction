...
(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 c_1$0 (ep$0 next$0 sk_?X_41$0 c_1$0) ?y)
            (not (Btwn$0 next$0 c_1$0 ?y ?y)) (not (in$0 ?y sk_?X_41$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 d_1$0 (ep$0 next$0 sk_?X_41$0 d_1$0) ?y)
            (not (Btwn$0 next$0 d_1$0 ?y ?y)) (not (in$0 ?y sk_?X_41$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 curr_3$0 (ep$0 next$0 sk_?X_41$0 curr_3$0) ?y)
            (not (Btwn$0 next$0 curr_3$0 ?y ?y)) (not (in$0 ?y sk_?X_41$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 prv_2$0 (ep$0 next$0 sk_?X_41$0 prv_2$0) ?y)
            (not (Btwn$0 next$0 prv_2$0 ?y ?y)) (not (in$0 ?y sk_?X_41$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 prv_3$0 (ep$0 next$0 sk_?X_41$0 prv_3$0) ?y)
            (not (Btwn$0 next$0 prv_3$0 ?y ?y)) (not (in$0 ?y sk_?X_41$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 tmp_2$0 (ep$0 next$0 sk_?X_41$0 tmp_2$0) ?y)
            (not (Btwn$0 next$0 tmp_2$0 ?y ?y)) (not (in$0 ?y sk_?X_41$0)))))

(assert (Btwn$0 next$0 c_1$0 (ep$0 next$0 sk_?X_41$0 c_1$0)
  (ep$0 next$0 sk_?X_41$0 c_1$0)))

(assert (Btwn$0 next$0 d_1$0 (ep$0 next$0 sk_?X_41$0 d_1$0)
  (ep$0 next$0 sk_?X_41$0 d_1$0)))

(assert (Btwn$0 next$0 curr_3$0 (ep$0 next$0 sk_?X_41$0 curr_3$0)
  (ep$0 next$0 sk_?X_41$0 curr_3$0)))

(assert (Btwn$0 next$0 prv_2$0 (ep$0 next$0 sk_?X_41$0 prv_2$0)
  (ep$0 next$0 sk_?X_41$0 prv_2$0)))

(assert (Btwn$0 next$0 prv_3$0 (ep$0 next$0 sk_?X_41$0 prv_3$0)
  (ep$0 next$0 sk_?X_41$0 prv_3$0)))

(assert (Btwn$0 next$0 tmp_2$0 (ep$0 next$0 sk_?X_41$0 tmp_2$0)
  (ep$0 next$0 sk_?X_41$0 tmp_2$0)))

(assert (or (not Axiom_26$0)
    (or (= (read$0 prev$0 c_1$0) d_1$0) (not (= (read$0 next$0 d_1$0) c_1$0))
        (not (in$0 d_1$0 sk_?X_42$0)) (not (in$0 c_1$0 sk_?X_42$0)))))

(assert (or (not Axiom_26$0)
    (or (= (read$0 prev$0 c_1$0) prv_3$0)
        (not (= (read$0 next$0 prv_3$0) c_1$0))
        (not (in$0 prv_3$0 sk_?X_42$0)) (not (in$0 c_1$0 sk_?X_42$0)))))

(assert (or (not Axiom_26$0)
    (or (= (read$0 prev$0 c_1$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) c_1$0))
        (not (in$0 prv_2$0 sk_?X_42$0)) (not (in$0 c_1$0 sk_?X_42$0)))))

(assert (or (not Axiom_26$0)
    (or (= (read$0 prev$0 c_1$0) curr_3$0)
        (not (= (read$0 next$0 curr_3$0) c_1$0))
        (not (in$0 curr_3$0 sk_?X_42$0)) (not (in$0 c_1$0 sk_?X_42$0)))))

(assert (or (not Axiom_26$0)
    (or (= (read$0 prev$0 curr_3$0) d_1$0)
        (not (= (read$0 next$0 d_1$0) curr_3$0))
        (not (in$0 d_1$0 sk_?X_42$0)) (not (in$0 curr_3$0 sk_?X_42$0)))))

(assert (or (not Axiom_26$0)
    (or (= (read$0 prev$0 curr_3$0) prv_3$0)
        (not (= (read$0 next$0 prv_3$0) curr_3$0))
        (not (in$0 prv_3$0 sk_?X_42$0)) (not (in$0 curr_3$0 sk_?X_42$0)))))

(assert (or (not Axiom_26$0)
    (or (= (read$0 prev$0 curr_3$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) curr_3$0))
        (not (in$0 prv_2$0 sk_?X_42$0)) (not (in$0 curr_3$0 sk_?X_42$0)))))

(assert (or (not Axiom_26$0)
    (or (= (read$0 prev$0 curr_3$0) curr_3$0)
        (not (= (read$0 next$0 curr_3$0) curr_3$0))
        (not (in$0 curr_3$0 sk_?X_42$0)) (not (in$0 curr_3$0 sk_?X_42$0)))))

(assert (or (not Axiom_26$0)
    (or (= (read$0 prev$0 prv_2$0) d_1$0)
        (not (= (read$0 next$0 d_1$0) prv_2$0)) (not (in$0 d_1$0 sk_?X_42$0))
        (not (in$0 prv_2$0 sk_?X_42$0)))))

(assert (or (not Axiom_26$0)
    (or (= (read$0 prev$0 prv_2$0) prv_3$0)
        (not (= (read$0 next$0 prv_3$0) prv_2$0))
        (not (in$0 prv_3$0 sk_?X_42$0)) (not (in$0 prv_2$0 sk_?X_42$0)))))

(assert (or (not Axiom_26$0)
    (or (= (read$0 prev$0 prv_2$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) prv_2$0))
        (not (in$0 prv_2$0 sk_?X_42$0)) (not (in$0 prv_2$0 sk_?X_42$0)))))

(assert (or (not Axiom_26$0)
    (or (= (read$0 prev$0 prv_2$0) curr_3$0)
        (not (= (read$0 next$0 curr_3$0) prv_2$0))
        (not (in$0 curr_3$0 sk_?X_42$0)) (not (in$0 prv_2$0 sk_?X_42$0)))))

(assert (or (not Axiom_24$0)
    (or (= (read$0 prev$0 c_1$0) d_1$0) (not (= (read$0 next$0 d_1$0) c_1$0))
        (not (in$0 d_1$0 sk_?X_44$0)) (not (in$0 c_1$0 sk_?X_44$0)))))

(assert (or (not Axiom_24$0)
    (or (= (read$0 prev$0 c_1$0) prv_3$0)
        (not (= (read$0 next$0 prv_3$0) c_1$0))
        (not (in$0 prv_3$0 sk_?X_44$0)) (not (in$0 c_1$0 sk_?X_44$0)))))

(assert (or (not Axiom_24$0)
    (or (= (read$0 prev$0 c_1$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) c_1$0))
        (not (in$0 prv_2$0 sk_?X_44$0)) (not (in$0 c_1$0 sk_?X_44$0)))))

(assert (or (not Axiom_24$0)
    (or (= (read$0 prev$0 c_1$0) curr_3$0)
        (not (= (read$0 next$0 curr_3$0) c_1$0))
        (not (in$0 curr_3$0 sk_?X_44$0)) (not (in$0 c_1$0 sk_?X_44$0)))))

(assert (or (not Axiom_24$0)
    (or (= (read$0 prev$0 curr_3$0) d_1$0)
        (not (= (read$0 next$0 d_1$0) curr_3$0))
        (not (in$0 d_1$0 sk_?X_44$0)) (not (in$0 curr_3$0 sk_?X_44$0)))))

(assert (or (not Axiom_24$0)
    (or (= (read$0 prev$0 curr_3$0) prv_3$0)
        (not (= (read$0 next$0 prv_3$0) curr_3$0))
        (not (in$0 prv_3$0 sk_?X_44$0)) (not (in$0 curr_3$0 sk_?X_44$0)))))

(assert (or (not Axiom_24$0)
    (or (= (read$0 prev$0 curr_3$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) curr_3$0))
        (not (in$0 prv_2$0 sk_?X_44$0)) (not (in$0 curr_3$0 sk_?X_44$0)))))

(assert (or (not Axiom_24$0)
    (or (= (read$0 prev$0 curr_3$0) curr_3$0)
        (not (= (read$0 next$0 curr_3$0) curr_3$0))
        (not (in$0 curr_3$0 sk_?X_44$0)) (not (in$0 curr_3$0 sk_?X_44$0)))))

(assert (or (not Axiom_24$0)
    (or (= (read$0 prev$0 prv_2$0) d_1$0)
        (not (= (read$0 next$0 d_1$0) prv_2$0)) (not (in$0 d_1$0 sk_?X_44$0))
        (not (in$0 prv_2$0 sk_?X_44$0)))))

(assert (or (not Axiom_24$0)
    (or (= (read$0 prev$0 prv_2$0) prv_3$0)
        (not (= (read$0 next$0 prv_3$0) prv_2$0))
        (not (in$0 prv_3$0 sk_?X_44$0)) (not (in$0 prv_2$0 sk_?X_44$0)))))

(assert (or (not Axiom_24$0)
    (or (= (read$0 prev$0 prv_2$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) prv_2$0))
        (not (in$0 prv_2$0 sk_?X_44$0)) (not (in$0 prv_2$0 sk_?X_44$0)))))

(assert (or (not Axiom_24$0)
    (or (= (read$0 prev$0 prv_2$0) curr_3$0)
        (not (= (read$0 next$0 curr_3$0) prv_2$0))
        (not (in$0 curr_3$0 sk_?X_44$0)) (not (in$0 prv_2$0 sk_?X_44$0)))))

(assert (or (in$0 (ep$0 next$0 sk_?X_41$0 c_1$0) sk_?X_41$0)
    (= c_1$0 (ep$0 next$0 sk_?X_41$0 c_1$0))))

(assert (or (in$0 (ep$0 next$0 sk_?X_41$0 d_1$0) sk_?X_41$0)
    (= d_1$0 (ep$0 next$0 sk_?X_41$0 d_1$0))))

(assert (or (in$0 (ep$0 next$0 sk_?X_41$0 curr_3$0) sk_?X_41$0)
    (= curr_3$0 (ep$0 next$0 sk_?X_41$0 curr_3$0))))

(assert (or (in$0 (ep$0 next$0 sk_?X_41$0 prv_2$0) sk_?X_41$0)
    (= prv_2$0 (ep$0 next$0 sk_?X_41$0 prv_2$0))))

(assert (or (in$0 (ep$0 next$0 sk_?X_41$0 prv_3$0) sk_?X_41$0)
    (= prv_3$0 (ep$0 next$0 sk_?X_41$0 prv_3$0))))

(assert (or (in$0 (ep$0 next$0 sk_?X_41$0 tmp_2$0) sk_?X_41$0)
    (= tmp_2$0 (ep$0 next$0 sk_?X_41$0 tmp_2$0))))

(assert (or (not Axiom_27$0)
    (or (= (read$0 prev$0 c_1$0) d_1$0) (not (= (read$0 next$0 d_1$0) c_1$0))
        (not (in$0 d_1$0 sk_?X_39$0)) (not (in$0 c_1$0 sk_?X_39$0)))))

(assert (or (not Axiom_27$0)
    (or (= (read$0 prev$0 c_1$0) prv_3$0)
        (not (= (read$0 next$0 prv_3$0) c_1$0))
        (not (in$0 prv_3$0 sk_?X_39$0)) (not (in$0 c_1$0 sk_?X_39$0)))))

(assert (or (not Axiom_27$0)
    (or (= (read$0 prev$0 c_1$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) c_1$0))
        (not (in$0 prv_2$0 sk_?X_39$0)) (not (in$0 c_1$0 sk_?X_39$0)))))

(assert (or (not Axiom_27$0)
    (or (= (read$0 prev$0 c_1$0) curr_3$0)
        (not (= (read$0 next$0 curr_3$0) c_1$0))
        (not (in$0 curr_3$0 sk_?X_39$0)) (not (in$0 c_1$0 sk_?X_39$0)))))

(assert (or (not Axiom_27$0)
    (or (= (read$0 prev$0 curr_3$0) d_1$0)
        (not (= (read$0 next$0 d_1$0) curr_3$0))
        (not (in$0 d_1$0 sk_?X_39$0)) (not (in$0 curr_3$0 sk_?X_39$0)))))

(assert (or (not Axiom_27$0)
    (or (= (read$0 prev$0 curr_3$0) prv_3$0)
        (not (= (read$0 next$0 prv_3$0) curr_3$0))
        (not (in$0 prv_3$0 sk_?X_39$0)) (not (in$0 curr_3$0 sk_?X_39$0)))))

(assert (or (not Axiom_27$0)
    (or (= (read$0 prev$0 curr_3$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) curr_3$0))
        (not (in$0 prv_2$0 sk_?X_39$0)) (not (in$0 curr_3$0 sk_?X_39$0)))))

(assert (or (not Axiom_27$0)
    (or (= (read$0 prev$0 curr_3$0) curr_3$0)
        (not (= (read$0 next$0 curr_3$0) curr_3$0))
        (not (in$0 curr_3$0 sk_?X_39$0)) (not (in$0 curr_3$0 sk_?X_39$0)))))

(assert (or (not Axiom_27$0)
    (or (= (read$0 prev$0 prv_2$0) d_1$0)
        (not (= (read$0 next$0 d_1$0) prv_2$0)) (not (in$0 d_1$0 sk_?X_39$0))
        (not (in$0 prv_2$0 sk_?X_39$0)))))

(assert (or (not Axiom_27$0)
    (or (= (read$0 prev$0 prv_2$0) prv_3$0)
        (not (= (read$0 next$0 prv_3$0) prv_2$0))
        (not (in$0 prv_3$0 sk_?X_39$0)) (not (in$0 prv_2$0 sk_?X_39$0)))))

(assert (or (not Axiom_27$0)
    (or (= (read$0 prev$0 prv_2$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) prv_2$0))
        (not (in$0 prv_2$0 sk_?X_39$0)) (not (in$0 prv_2$0 sk_?X_39$0)))))

(assert (or (not Axiom_27$0)
    (or (= (read$0 prev$0 prv_2$0) curr_3$0)
        (not (= (read$0 next$0 curr_3$0) prv_2$0))
        (not (in$0 curr_3$0 sk_?X_39$0)) (not (in$0 prv_2$0 sk_?X_39$0)))))

(assert (or (not Axiom_25$0)
    (or (= (read$0 prev$0 c_1$0) d_1$0) (not (= (read$0 next$0 d_1$0) c_1$0))
        (not (in$0 d_1$0 sk_?X_37$0)) (not (in$0 c_1$0 sk_?X_37$0)))))

(assert (or (not Axiom_25$0)
    (or (= (read$0 prev$0 c_1$0) prv_3$0)
        (not (= (read$0 next$0 prv_3$0) c_1$0))
        (not (in$0 prv_3$0 sk_?X_37$0)) (not (in$0 c_1$0 sk_?X_37$0)))))

(assert (or (not Axiom_25$0)
    (or (= (read$0 prev$0 c_1$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) c_1$0))
        (not (in$0 prv_2$0 sk_?X_37$0)) (not (in$0 c_1$0 sk_?X_37$0)))))

(assert (or (not Axiom_25$0)
    (or (= (read$0 prev$0 c_1$0) curr_3$0)
        (not (= (read$0 next$0 curr_3$0) c_1$0))
        (not (in$0 curr_3$0 sk_?X_37$0)) (not (in$0 c_1$0 sk_?X_37$0)))))

(assert (or (not Axiom_25$0)
    (or (= (read$0 prev$0 curr_3$0) d_1$0)
        (not (= (read$0 next$0 d_1$0) curr_3$0))
        (not (in$0 d_1$0 sk_?X_37$0)) (not (in$0 curr_3$0 sk_?X_37$0)))))

(assert (or (not Axiom_25$0)
    (or (= (read$0 prev$0 curr_3$0) prv_3$0)
        (not (= (read$0 next$0 prv_3$0) curr_3$0))
        (not (in$0 prv_3$0 sk_?X_37$0)) (not (in$0 curr_3$0 sk_?X_37$0)))))

(assert (or (not Axiom_25$0)
    (or (= (read$0 prev$0 curr_3$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) curr_3$0))
        (not (in$0 prv_2$0 sk_?X_37$0)) (not (in$0 curr_3$0 sk_?X_37$0)))))

(assert (or (not Axiom_25$0)
    (or (= (read$0 prev$0 curr_3$0) curr_3$0)
        (not (= (read$0 next$0 curr_3$0) curr_3$0))
        (not (in$0 curr_3$0 sk_?X_37$0)) (not (in$0 curr_3$0 sk_?X_37$0)))))

(assert (or (not Axiom_25$0)
    (or (= (read$0 prev$0 prv_2$0) d_1$0)
        (not (= (read$0 next$0 d_1$0) prv_2$0)) (not (in$0 d_1$0 sk_?X_37$0))
        (not (in$0 prv_2$0 sk_?X_37$0)))))

(assert (or (not Axiom_25$0)
    (or (= (read$0 prev$0 prv_2$0) prv_3$0)
        (not (= (read$0 next$0 prv_3$0) prv_2$0))
        (not (in$0 prv_3$0 sk_?X_37$0)) (not (in$0 prv_2$0 sk_?X_37$0)))))

(assert (or (not Axiom_25$0)
    (or (= (read$0 prev$0 prv_2$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) prv_2$0))
        (not (in$0 prv_2$0 sk_?X_37$0)) (not (in$0 prv_2$0 sk_?X_37$0)))))

(assert (or (not Axiom_25$0)
    (or (= (read$0 prev$0 prv_2$0) curr_3$0)
        (not (= (read$0 next$0 curr_3$0) prv_2$0))
        (not (in$0 curr_3$0 sk_?X_37$0)) (not (in$0 prv_2$0 sk_?X_37$0)))))

(assert (or (not Axiom_23$0)
    (or (= (read$0 prev$0 c_1$0) d_1$0) (not (= (read$0 next$0 d_1$0) c_1$0))
        (not (in$0 d_1$0 sk_?X_45$0)) (not (in$0 c_1$0 sk_?X_45$0)))))

(assert (or (not Axiom_23$0)
    (or (= (read$0 prev$0 c_1$0) prv_3$0)
        (not (= (read$0 next$0 prv_3$0) c_1$0))
        (not (in$0 prv_3$0 sk_?X_45$0)) (not (in$0 c_1$0 sk_?X_45$0)))))

(assert (or (not Axiom_23$0)
    (or (= (read$0 prev$0 c_1$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) c_1$0))
        (not (in$0 prv_2$0 sk_?X_45$0)) (not (in$0 c_1$0 sk_?X_45$0)))))

(assert (or (not Axiom_23$0)
    (or (= (read$0 prev$0 c_1$0) curr_3$0)
        (not (= (read$0 next$0 curr_3$0) c_1$0))
        (not (in$0 curr_3$0 sk_?X_45$0)) (not (in$0 c_1$0 sk_?X_45$0)))))

(assert (or (not Axiom_23$0)
    (or (= (read$0 prev$0 curr_3$0) d_1$0)
        (not (= (read$0 next$0 d_1$0) curr_3$0))
        (not (in$0 d_1$0 sk_?X_45$0)) (not (in$0 curr_3$0 sk_?X_45$0)))))

(assert (or (not Axiom_23$0)
    (or (= (read$0 prev$0 curr_3$0) prv_3$0)
        (not (= (read$0 next$0 prv_3$0) curr_3$0))
        (not (in$0 prv_3$0 sk_?X_45$0)) (not (in$0 curr_3$0 sk_?X_45$0)))))

(assert (or (not Axiom_23$0)
    (or (= (read$0 prev$0 curr_3$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) curr_3$0))
        (not (in$0 prv_2$0 sk_?X_45$0)) (not (in$0 curr_3$0 sk_?X_45$0)))))

(assert (or (not Axiom_23$0)
    (or (= (read$0 prev$0 curr_3$0) curr_3$0)
        (not (= (read$0 next$0 curr_3$0) curr_3$0))
        (not (in$0 curr_3$0 sk_?X_45$0)) (not (in$0 curr_3$0 sk_?X_45$0)))))

(assert (or (not Axiom_23$0)
    (or (= (read$0 prev$0 prv_2$0) d_1$0)
        (not (= (read$0 next$0 d_1$0) prv_2$0)) (not (in$0 d_1$0 sk_?X_45$0))
        (not (in$0 prv_2$0 sk_?X_45$0)))))

(assert (or (not Axiom_23$0)
    (or (= (read$0 prev$0 prv_2$0) prv_3$0)
        (not (= (read$0 next$0 prv_3$0) prv_2$0))
        (not (in$0 prv_3$0 sk_?X_45$0)) (not (in$0 prv_2$0 sk_?X_45$0)))))

(assert (or (not Axiom_23$0)
    (or (= (read$0 prev$0 prv_2$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) prv_2$0))
        (not (in$0 prv_2$0 sk_?X_45$0)) (not (in$0 prv_2$0 sk_?X_45$0)))))

(assert (or (not Axiom_23$0)
    (or (= (read$0 prev$0 prv_2$0) curr_3$0)
        (not (= (read$0 next$0 curr_3$0) prv_2$0))
        (not (in$0 curr_3$0 sk_?X_45$0)) (not (in$0 prv_2$0 sk_?X_45$0)))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_41$0)) (not (in$0 x FP$0))
                 (not (in$0 x (union$0 sk_?X_41$0 FP$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x (setminus$0 FP$0 FP_1$0)))
                 ...
                 (not (in$0 x (union$0 (setminus$0 FP$0 FP_1$0) sk_?X_40$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_37$0)) (not (in$0 x sk_?X_39$0))
                 (not (in$0 x (union$0 sk_?X_37$0 sk_?X_39$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_43$0)) (not (in$0 x FP$0))
                 (not (in$0 x (union$0 sk_?X_43$0 FP$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_43$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (intersection$0 sk_?X_43$0 FP$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_37$0)) (not (in$0 x sk_?X_39$0)))
                 (not (in$0 x (intersection$0 sk_?X_37$0 sk_?X_39$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x Alloc$0)) (not (in$0 x sk_?X_41$0)))
                 (not (in$0 x (intersection$0 Alloc$0 sk_?X_41$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x sk_?X_41$0) (not (in$0 x FP$0)))
                 (not (in$0 x (setminus$0 FP$0 sk_?X_41$0)))))))
...
(assert (= sk_?X_37$0 (dlseg_domain$0 next$0 prev$0 c_2$0 null$0 curr_3$0 prv_3$0)))

(assert (= sk_?X_39$0 (dlseg_domain$0 next$0 prev$0 curr_3$0 prv_3$0 null$0 d_2$0)))

(assert (= sk_?X_40$0 (union$0 sk_?X_38$0 sk_?X_39$0)))

(assert (dlseg_struct$0 sk_?X_39$0 next$0 prev$0 curr_3$0 prv_3$0 null$0 d_2$0))

(assert (= emptyset$0 emptyset$0))

(assert (= sk_?X_41$0 (union$0 sk_?X_43$0 sk_?X_42$0)))

(assert (= sk_?X_42$0 (dlseg_domain$0 next$0 prev$0 curr_2$0 prv_2$0 null$0 d_1$0)))

(assert (= sk_?X_44$0 (dlseg_domain$0 next$0 prev$0 c_1$0 null$0 curr_2$0 prv_2$0)))

(assert (dlseg_struct$0 sk_?X_42$0 next$0 prev$0 curr_2$0 prv_2$0 null$0 d_1$0))

(assert (not (= curr_2$0 null$0)))

(assert (= sk_?X_45$0 (dlseg_domain$0 next$0 prev$0 a$0 null$0 null$0 b$0)))

(assert (dlseg_struct$0 sk_?X_45$0 next$0 prev$0 a$0 null$0 null$0 b$0))

(assert (not (= a$0 b$0)))

(assert (not (in$0 null$0 Alloc$0)))

(assert (not (in$0 tmp_2$0 FP_2$0)))
...
(assert (or
    (and (Btwn$0 next$0 a$0 null$0 null$0)
         ...
         Axiom_23$0)
    (not (dlseg_struct$0 sk_?X_45$0 next$0 prev$0 a$0 null$0 null$0 b$0))))
...
(assert (= emptyset$0 (intersection$0 sk_?X_38$0 sk_?X_39$0)))

(assert (= sk_?X_38$0 sk_?X_37$0))

(assert (= sk_?X_40$0
  (union$0 (intersection$0 Alloc$0 FP_1$0) (setminus$0 Alloc$0 Alloc$0))))

(assert (dlseg_struct$0 sk_?X_37$0 next$0 prev$0 c_2$0 null$0 curr_3$0 prv_3$0))

(assert (not (= curr_3$0 null$0)))

(assert (= emptyset$0 (intersection$0 sk_?X_43$0 sk_?X_42$0)))

(assert (= sk_?X_41$0 FP_1$0))

(assert (= sk_?X_43$0 sk_?X_44$0))

(assert (= FP$0 (union$0 FP_1$0 FP$0)))

(assert (dlseg_struct$0 sk_?X_44$0 next$0 prev$0 c_1$0 null$0 curr_2$0 prv_2$0))

(assert (= sk_?X_45$0 FP$0))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (not (= a$0 null$0)))

(assert (not (= tmp_2$0 null$0)))
