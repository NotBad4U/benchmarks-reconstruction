...
(set-info :source |
  ...
  tests/spl/sl/rec_copy.spl:15:4-15:A postcondition of procedure rec_reverse_loop might not hold at this return point
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 sk_?X_90$0 sk_?X_89$0))
                 (or (in$0 x sk_?X_90$0) (in$0 x sk_?X_89$0)))
            (and (not (in$0 x sk_?X_90$0)) (not (in$0 x sk_?X_89$0))
                 (not (in$0 x (union$0 sk_?X_90$0 sk_?X_89$0)))))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 FP_Caller_4$0 FP$0))
                 (or (in$0 x FP_Caller_4$0) (in$0 x FP$0)))
            (and (not (in$0 x FP_Caller_4$0)) (not (in$0 x FP$0))
                 (not (in$0 x (union$0 FP_Caller_4$0 FP$0)))))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x sk_?X_90$0) (in$0 x sk_?X_89$0)
                 (in$0 x (intersection$0 sk_?X_90$0 sk_?X_89$0)))
            (and (or (not (in$0 x sk_?X_90$0)) (not (in$0 x sk_?X_89$0)))
                 (not (in$0 x (intersection$0 sk_?X_90$0 sk_?X_89$0)))))))
...
(assert (or (Btwn$0 next$0 acc$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_89$0 next$0 acc$0 null$0))))

(assert (or (Btwn$0 next$0 res_14$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_91$0 next$0 res_14$0 null$0))))

(assert (= FP_Caller_final_9$0 (union$0 FP_Caller_4$0 FP$0)))

(assert (= res_14$0 acc$0))

(assert (= emptyset$0 (intersection$0 sk_?X_90$0 sk_?X_89$0)))

(assert (= sk_?X_88$0 FP$0))

(assert (= sk_?X_90$0 (lseg_domain$0 next$0 lst_2$0 null$0)))

(assert (lseg_struct$0 sk_?X_89$0 next$0 acc$0 null$0))
...
(assert (or (Btwn$0 next$0 lst_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_90$0 next$0 lst_2$0 null$0))))

(assert (= FP_Caller_4$0 (setminus$0 FP_Caller$0 FP$0)))

(assert (= lst_2$0 null$0))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X_88$0 (union$0 sk_?X_90$0 sk_?X_89$0)))

(assert (= sk_?X_89$0 (lseg_domain$0 next$0 acc$0 null$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_90$0 next$0 lst_2$0 null$0))

(assert (or
    (and (in$0 sk_?e_8$0 (lseg_domain$0 next$0 res_14$0 null$0))
         (not (in$0 sk_?e_8$0 sk_?X_91$0)))
    (and (in$0 sk_?e_8$0 sk_?X_91$0)
         (not (in$0 sk_?e_8$0 (lseg_domain$0 next$0 res_14$0 null$0))))
    (not (Btwn$0 next$0 res_14$0 null$0 null$0))))
...
(assert (forall ((l1 Loc))
        (or
            (and (Btwn$0 next$0 res_14$0 l1 null$0)
                 (in$0 l1 (lseg_domain$0 next$0 res_14$0 null$0))
                 (not (= l1 null$0)))
            (and (or (= l1 null$0) (not (Btwn$0 next$0 res_14$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 res_14$0 null$0)))))))
