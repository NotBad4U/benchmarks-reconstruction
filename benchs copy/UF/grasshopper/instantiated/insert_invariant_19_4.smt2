...
(set-info :source |
  ...
  tests/spl/sl/sl_insert.spl:19:4:An invariant might not hold before entering a loop in procedure insert
  tests/spl/sl/sl_insert.spl:20:16-69:Related location: This is the loop invariant that might not hold initially
  |)
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 sk_?X_8$0 sk_?X_6$0))
                 (or (in$0 x sk_?X_8$0) (in$0 x sk_?X_6$0)))
            (and (not (in$0 x sk_?X_8$0)) (not (in$0 x sk_?X_6$0))
                 (not (in$0 x (union$0 sk_?X_8$0 sk_?X_6$0)))))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 sk_?X_11$0 sk_?X_8$0))
                 (or (in$0 x sk_?X_11$0) (in$0 x sk_?X_8$0)))
            (and (not (in$0 x sk_?X_11$0)) (not (in$0 x sk_?X_8$0))
                 (not (in$0 x (union$0 sk_?X_11$0 sk_?X_8$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x sk_?X_8$0) (in$0 x sk_?X_6$0)
                 (in$0 x (intersection$0 sk_?X_8$0 sk_?X_6$0)))
            (and (or (not (in$0 x sk_?X_8$0)) (not (in$0 x sk_?X_6$0)))
                 (not (in$0 x (intersection$0 sk_?X_8$0 sk_?X_6$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x sk_?X_11$0) (in$0 x sk_?X_8$0)
                 (in$0 x (intersection$0 sk_?X_11$0 sk_?X_8$0)))
            (and (or (not (in$0 x sk_?X_11$0)) (not (in$0 x sk_?X_8$0)))
                 (not (in$0 x (intersection$0 sk_?X_11$0 sk_?X_8$0)))))))
...
(assert (= sk_?X_10$0 (lseg_domain$0 next$0 curr_2$0 null$0)))

(assert (= sk_?X_12$0 (lseg_domain$0 next$0 lst$0 curr_2$0)))

(assert (or (= curr_2$0 null$0)
    (in$0 sk_?e_1$0 (intersection$0 sk_?X_11$0 sk_?X_10$0))
...
(assert (or (Btwn$0 next$0 curr_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_10$0 next$0 curr_2$0 null$0))))

(assert (or (Btwn$0 next$0 lst$0 curr_2$0 curr_2$0)
    (not (lseg_struct$0 sk_?X_12$0 next$0 lst$0 curr_2$0))))

(assert (= curr_2$0 lst$0))

(assert (= (read$0 next$0 elt$0) null$0))

(assert (= emptyset$0 (intersection$0 sk_?X_8$0 sk_?X_6$0)))

(assert (= sk_?X_5$0 FP$0))

(assert (= sk_?X_7$0 (setenum$0 elt$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (= sk_?X_9$0 (union$0 sk_?X_11$0 sk_?X_10$0)))

(assert (= sk_?X_11$0 sk_?X_12$0))

(assert (= sk_FP$0 sk_?X_9$0))
