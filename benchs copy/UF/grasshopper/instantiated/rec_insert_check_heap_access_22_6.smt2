...
(set-info :source |
  ...
  tests/spl/sl/rec_insert.spl:22:6-21:Possible heap access through null or dangling reference
  |)
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 sk_?X_17$0 sk_?X_15$0))
                 (or (in$0 x sk_?X_17$0) (in$0 x sk_?X_15$0)))
            (and (not (in$0 x sk_?X_17$0)) (not (in$0 x sk_?X_15$0))
                 (not (in$0 x (union$0 sk_?X_17$0 sk_?X_15$0)))))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x sk_?X_17$0) (in$0 x sk_?X_15$0)
                 (in$0 x (intersection$0 sk_?X_17$0 sk_?X_15$0)))
            (and (or (not (in$0 x sk_?X_17$0)) (not (in$0 x sk_?X_15$0)))
                 (not (in$0 x (intersection$0 sk_?X_17$0 sk_?X_15$0)))))))
...
(assert (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_17$0 next$0 lst$0 null$0))))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= emptyset$0 emptyset$0))

(assert (= sk_?X_14$0 (union$0 sk_?X_17$0 sk_?X_15$0)))

(assert (= sk_?X_15$0 sk_?X_16$0))

(assert (= sk_?X_17$0 (lseg_domain$0 next$0 lst$0 null$0)))

(assert (lseg_struct$0 sk_?X_17$0 next$0 lst$0 null$0))
...
(assert (= emptyset$0 (intersection$0 sk_?X_17$0 sk_?X_15$0)))

(assert (= sk_?X_14$0 FP$0))

(assert (= sk_?X_16$0 (setenum$0 elt$0)))
