...
(assert (or (not Axiom$0)
    (forall ((?y Loc) (?z Loc))
            (or (in$0 res_5$0 FP_1$0)
                ...
                (and (not (Btwn$0 next$0 res_5$0 ?z ?y))
                     (not (Btwn$0 next_1$0 res_5$0 ?z ?y)))
                (not (= res_5$0 (ep$0 next$0 FP_1$0 res_5$0)))))))
...
(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 res_5$0 (ep$0 next$0 FP_1$0 res_5$0) ?y)
            (not (Btwn$0 next$0 res_5$0 ?y ?y)) (not (in$0 ?y FP_1$0)))))
...
(assert (or (in$0 (ep$0 next$0 FP_1$0 res_5$0) FP_1$0)
    (= res_5$0 (ep$0 next$0 FP_1$0 res_5$0))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_12$0)) (not (in$0 x sk_?X_11$0))
                 (not (in$0 x (union$0 sk_?X_12$0 sk_?X_11$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_11$0)) (not (in$0 x sk_?X_12$0))
                 (not (in$0 x (union$0 sk_?X_11$0 sk_?X_12$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_12$0)) (not (in$0 x sk_?X_11$0)))
                 (not (in$0 x (intersection$0 sk_?X_12$0 sk_?X_11$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_11$0)) (not (in$0 x sk_?X_12$0)))
                 (not (in$0 x (intersection$0 sk_?X_11$0 sk_?X_12$0)))))))
...
(assert (or (Btwn$0 next$0 null$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_9$0 next$0 null$0 null$0))))
...
(assert (or (Btwn$0 next_1$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_11$0 next_1$0 lst$0 null$0))))

(assert (or (Btwn$0 next_1$0 res_5$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_12$0 next_1$0 res_5$0 null$0))))
...
(assert (= sk_?X_5$0 (lseg_domain$0 next_1$0 lst$0 null$0)))

(assert (= sk_?X_6$0 (union$0 sk_?X_4$0 sk_?X_5$0)))

(assert (lseg_struct$0 sk_?X_5$0 next_1$0 lst$0 null$0))

(assert (= sk_?X_7$0 (union$0 sk_?X_9$0 sk_?X_8$0)))

(assert (= sk_?X_8$0 (lseg_domain$0 next$0 lst$0 null$0)))

(assert (= FP$0 (union$0 FP_1$0 FP$0)))

(assert (lseg_struct$0 sk_?X_9$0 next$0 null$0 null$0))

(assert (= sk_?X_10$0 (lseg_domain$0 next$0 lst$0 null$0)))

(assert (lseg_struct$0 sk_?X_10$0 next$0 lst$0 null$0))

(assert (= sk_?X_12$0 (lseg_domain$0 next_1$0 res_5$0 null$0)))
...
(assert (or (in$0 sk_?e_1$0 (intersection$0 sk_?X_11$0 sk_?X_12$0))
    ...
    (not (Btwn$0 next_1$0 res_5$0 null$0 null$0))))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next_1$0 res_4$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next_1$0 res_4$0 null$0)))))))

(assert (or (and Axiom_2$0 Axiom_1$0 Axiom$0)
    (not (Frame$0 FP_1$0 Alloc$0 next$0 next_1$0))))

(assert (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_8$0 next$0 lst$0 null$0))))

(assert (or (Btwn$0 next_1$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_5$0 next_1$0 lst$0 null$0))))

(assert (or (Btwn$0 next_1$0 res_4$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_4$0 next_1$0 res_4$0 null$0))))
...
(assert (= sk_?X_4$0 (lseg_domain$0 next_1$0 res_4$0 null$0)))

(assert (= sk_?X_6$0
  (union$0 (intersection$0 Alloc_1$0 FP_1$0) (setminus$0 Alloc_1$0 Alloc$0))))

(assert (lseg_struct$0 sk_?X_4$0 next_1$0 res_4$0 null$0))

(assert (= emptyset$0 (intersection$0 sk_?X_9$0 sk_?X_8$0)))

(assert (= sk_?X_7$0 FP_1$0))

(assert (= sk_?X_9$0 (lseg_domain$0 next$0 null$0 null$0)))

(assert (lseg_struct$0 sk_?X_8$0 next$0 lst$0 null$0))

(assert (= sk_?X_10$0 FP$0))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (= sk_?X_11$0 (lseg_domain$0 next_1$0 lst$0 null$0)))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next_1$0 res_5$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next_1$0 res_5$0 null$0)))))))
