...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_49$0)) (not (in$0 x sk_?X_47$0))
                 (not (in$0 x (union$0 sk_?X_49$0 sk_?X_47$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_49$0)) (not (in$0 x sk_?X_47$0)))
                 (not (in$0 x (intersection$0 sk_?X_49$0 sk_?X_47$0)))))))
...
(assert (or (Btwn$0 next$0 a_init$0 curr_init$0 curr_init$0)
    (not (lseg_struct$0 sk_?X_49$0 next$0 a_init$0 curr_init$0))))
...
(assert (= sk_?X_49$0 (lseg_domain$0 next$0 a_init$0 curr_init$0)))
...
(assert (= sk_?X_46$0 FP$0))

(assert (= sk_?X_48$0 sk_?X_49$0))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_49$0 next$0 a_init$0 curr_init$0))
