...
(set-info :source |
  ...
  tests/spl/sl/rec_filter.spl:17:4-17:Possible heap access through null or dangling reference
  |)
...
(assert (or (Btwn$0 next$0 x$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_2$0 next$0 x$0 null$0))))
...
(assert (= sk_?X_2$0 (lseg_domain$0 next$0 x$0 null$0)))

(assert (lseg_struct$0 sk_?X_2$0 next$0 x$0 null$0))
