...
(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 lst$0 (ep$0 next$0 sk_?X_10$0 lst$0) ?y)
            (not (Btwn$0 next$0 lst$0 ?y ?y)) (not (in$0 ?y sk_?X_10$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 n1_2$0 (ep$0 next$0 sk_?X_10$0 n1_2$0) ?y)
            (not (Btwn$0 next$0 n1_2$0 ?y ?y)) (not (in$0 ?y sk_?X_10$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 n2_2$0 (ep$0 next$0 sk_?X_10$0 n2_2$0) ?y)
            (not (Btwn$0 next$0 n2_2$0 ?y ?y)) (not (in$0 ?y sk_?X_10$0)))))

(assert (or (in$0 (ep$0 next$0 sk_?X_10$0 null$0) sk_?X_10$0)
    (= null$0 (ep$0 next$0 sk_?X_10$0 null$0))))

(assert (or (in$0 (ep$0 next$0 sk_?X_10$0 lst$0) sk_?X_10$0)
    (= lst$0 (ep$0 next$0 sk_?X_10$0 lst$0))))

(assert (or (in$0 (ep$0 next$0 sk_?X_10$0 n1_2$0) sk_?X_10$0)
    (= n1_2$0 (ep$0 next$0 sk_?X_10$0 n1_2$0))))

(assert (or (in$0 (ep$0 next$0 sk_?X_10$0 n2_2$0) sk_?X_10$0)
    (= n2_2$0 (ep$0 next$0 sk_?X_10$0 n2_2$0))))

(assert (Btwn$0 next$0 null$0 (ep$0 next$0 sk_?X_10$0 null$0)
  (ep$0 next$0 sk_?X_10$0 null$0)))

(assert (Btwn$0 next$0 lst$0 (ep$0 next$0 sk_?X_10$0 lst$0)
  (ep$0 next$0 sk_?X_10$0 lst$0)))

(assert (Btwn$0 next$0 n1_2$0 (ep$0 next$0 sk_?X_10$0 n1_2$0)
  (ep$0 next$0 sk_?X_10$0 n1_2$0)))

(assert (Btwn$0 next$0 n2_2$0 (ep$0 next$0 sk_?X_10$0 n2_2$0)
  (ep$0 next$0 sk_?X_10$0 n2_2$0)))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x Alloc$0) (in$0 x (setminus$0 Alloc$0 sk_?X_10$0))
                 (not (in$0 x sk_?X_10$0)))
            (and (or (in$0 x sk_?X_10$0) (not (in$0 x Alloc$0)))
                 (not (in$0 x (setminus$0 Alloc$0 sk_?X_10$0)))))))
