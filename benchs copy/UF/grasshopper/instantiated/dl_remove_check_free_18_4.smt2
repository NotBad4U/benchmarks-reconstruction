...
(assert (or (not Axiom_2$0)
    (or (= (read$0 prev$0 b$0) null$0) (not (= (read$0 next$0 null$0) b$0))
        (not (in$0 null$0 sk_?X_2$0)) (not (in$0 b$0 sk_?X_2$0)))))

(assert (or (not Axiom_2$0)
    (or (= (read$0 prev$0 b$0) b$0) (not (= (read$0 next$0 b$0) b$0))
        (not (in$0 b$0 sk_?X_2$0)) (not (in$0 b$0 sk_?X_2$0)))))
...
(assert (or
    (and (Btwn$0 next$0 a$0 null$0 null$0)
         ...
         Axiom_2$0)
    (not (dlseg_struct$0 sk_?X_2$0 next$0 prev$0 a$0 null$0 null$0 b$0))))
...
(assert (not (in$0 a$0 FP$0)))

(assert (= FP_Caller_1$0 (setminus$0 FP_Caller$0 FP$0)))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X_2$0 (dlseg_domain$0 next$0 prev$0 a$0 null$0 null$0 b$0)))

(assert (dlseg_struct$0 sk_?X_2$0 next$0 prev$0 a$0 null$0 null$0 b$0))
