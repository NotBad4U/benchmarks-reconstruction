...
(set-info :source |
  ...
  tests/spl/sl/sl_remove.spl:25:5-6:An invariant might not be maintained by a loop in procedure remove
  tests/spl/sl/sl_remove.spl:19:16:Related location: This is the loop invariant that might not be maintained
  |)
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 sk_?X_70$0 sk_?X_68$0))
                 (or (in$0 x sk_?X_70$0) (in$0 x sk_?X_68$0)))
            (and (not (in$0 x sk_?X_70$0)) (not (in$0 x sk_?X_68$0))
                 (not (in$0 x (union$0 sk_?X_70$0 sk_?X_68$0)))))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 sk_?X_73$0 sk_?X_72$0))
                 (or (in$0 x sk_?X_73$0) (in$0 x sk_?X_72$0)))
            (and (not (in$0 x sk_?X_73$0)) (not (in$0 x sk_?X_72$0))
                 (not (in$0 x (union$0 sk_?X_73$0 sk_?X_72$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x sk_?X_70$0) (in$0 x sk_?X_68$0)
                 (in$0 x (intersection$0 sk_?X_70$0 sk_?X_68$0)))
            (and (or (not (in$0 x sk_?X_70$0)) (not (in$0 x sk_?X_68$0)))
                 (not (in$0 x (intersection$0 sk_?X_70$0 sk_?X_68$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x sk_?X_73$0) (in$0 x sk_?X_72$0)
                 (in$0 x (intersection$0 sk_?X_73$0 sk_?X_72$0)))
            (and (or (not (in$0 x sk_?X_73$0)) (not (in$0 x sk_?X_72$0)))
                 (not (in$0 x (intersection$0 sk_?X_73$0 sk_?X_72$0)))))))
...
(assert (or (Btwn$0 next$0 curr_5$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_72$0 next$0 curr_5$0 null$0))))

(assert (or (Btwn$0 next$0 lst_2$0 curr_5$0 curr_5$0)
    (not (lseg_struct$0 sk_?X_74$0 next$0 lst_2$0 curr_5$0))))
...
(assert (= emptyset$0 (intersection$0 sk_?X_69$0 sk_?X_68$0)))

(assert (= sk_?X_67$0 FP$0))

(assert (= sk_?X_69$0 sk_?X_70$0))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_70$0 next$0 lst_init$0 curr_init$0))

(assert (= sk_?X_71$0 (union$0 sk_?X_73$0 sk_?X_72$0)))

(assert (= sk_?X_73$0 sk_?X_74$0))

(assert (= sk_FP_1$0 sk_?X_71$0))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 curr_5$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 curr_5$0 null$0)))))))

(assert (forall ((l1 Loc))
        (or
            (and (Btwn$0 next$0 lst_2$0 l1 curr_5$0)
                 (in$0 l1 (lseg_domain$0 next$0 lst_2$0 curr_5$0))
                 (not (= l1 curr_5$0)))
            (and
                 (or (= l1 curr_5$0)
                     (not (Btwn$0 next$0 lst_2$0 l1 curr_5$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 lst_2$0 curr_5$0)))))))

(assert (or (Btwn$0 next$0 curr_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_68$0 next$0 curr_init$0 null$0))))

(assert (or (Btwn$0 next$0 lst_init$0 curr_init$0 curr_init$0)
    (not (lseg_struct$0 sk_?X_70$0 next$0 lst_init$0 curr_init$0))))
...
(assert (= sk_?X_68$0 (lseg_domain$0 next$0 curr_init$0 null$0)))

(assert (= sk_?X_70$0 (lseg_domain$0 next$0 lst_init$0 curr_init$0)))

(assert (lseg_struct$0 sk_?X_68$0 next$0 curr_init$0 null$0))

(assert (not (= curr_init$0 null$0)))

(assert (= sk_?X_72$0 (lseg_domain$0 next$0 curr_5$0 null$0)))

(assert (= sk_?X_74$0 (lseg_domain$0 next$0 lst_2$0 curr_5$0)))

(assert (or (= curr_5$0 null$0)
    (in$0 sk_?e_3$0 (intersection$0 sk_?X_73$0 sk_?X_72$0))
