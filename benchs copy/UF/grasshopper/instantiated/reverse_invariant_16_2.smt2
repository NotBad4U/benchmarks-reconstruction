...
(set-info :source |
  ...
  tests/spl/sl/sl_reverse.spl:16:2:An invariant might not hold before entering a loop in procedure reverse
  tests/spl/sl/sl_reverse.spl:17:14:Related location: This is the loop invariant that might not hold initially
  |)
...
(assert (or (Btwn$0 next$0 curr_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_2$0 next$0 curr_2$0 null$0))))

(assert (or (Btwn$0 next$0 rev_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_3$0 next$0 rev_1$0 null$0))))
...
(assert (= sk_?X_2$0 (lseg_domain$0 next$0 curr_2$0 null$0)))
...
(assert (= sk_?X_3$0 (lseg_domain$0 next$0 rev_1$0 null$0)))
...
(assert (or (in$0 sk_?e$0 (intersection$0 sk_?X_3$0 sk_?X_2$0))
    ...
    (not (Btwn$0 next$0 rev_1$0 null$0 null$0))))
