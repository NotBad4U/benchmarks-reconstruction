...
(set-info :source |
  ...
  tests/spl/sl/sl_remove.spl:18:4:An invariant might not hold before entering a loop in procedure remove
  tests/spl/sl/sl_remove.spl:19:16:Related location: This is the loop invariant that might not hold initially
  |)
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x sk_?X_6$0) (in$0 x FP$0)
                 (in$0 x (intersection$0 sk_?X_6$0 FP$0)))
            (and (or (not (in$0 x sk_?X_6$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (intersection$0 sk_?X_6$0 FP$0)))))))
...
(assert (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_2$0 next$0 lst$0 null$0))))

(assert (= FP_Caller_1$0 (setminus$0 FP_Caller$0 FP$0)))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X_2$0 (lseg_domain$0 next$0 lst$0 null$0)))

(assert (lseg_struct$0 sk_?X_2$0 next$0 lst$0 null$0))

(assert (= sk_?X_4$0 (lseg_domain$0 next$0 curr_2$0 null$0)))

(assert (= sk_?X_6$0 (lseg_domain$0 next$0 lst$0 curr_2$0)))

(assert (or (= curr_2$0 null$0) (in$0 sk_?e_1$0 (intersection$0 sk_?X_5$0 sk_?X_4$0))
...
(assert (or (Btwn$0 next$0 curr_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_4$0 next$0 curr_2$0 null$0))))

(assert (or (Btwn$0 next$0 lst$0 curr_2$0 curr_2$0)
    (not (lseg_struct$0 sk_?X_6$0 next$0 lst$0 curr_2$0))))
