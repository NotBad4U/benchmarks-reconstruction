...
(set-info :source |
  ...
  tests/spl/sl/rec_concat.spl:17:10-22:A precondition for this call of find_last might not hold
...
(assert (or (Btwn$0 next$0 a$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_3$0 next$0 a$0 null$0))))

(assert (= FP_Caller_1$0 (setminus$0 FP_Caller$0 FP$0)))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X_2$0 sk_?X_3$0))

(assert (= sk_?X_3$0 (lseg_domain$0 next$0 a$0 null$0)))

(assert (lseg_struct$0 sk_?X_3$0 next$0 a$0 null$0))

(assert (= sk_?X_4$0 sk_?X_5$0))

(assert (= sk_FP$0 sk_?X_4$0))
...
(assert (= sk_?X_5$0 (lseg_domain$0 next$0 n_2$0 null$0)))

(assert (or (= n_2$0 null$0) (and (in$0 sk_?e$0 sk_FP$0) (not (in$0 sk_?e$0 FP$0)))
