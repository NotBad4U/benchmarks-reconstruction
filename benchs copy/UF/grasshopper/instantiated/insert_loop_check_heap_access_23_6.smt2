...
(assert (or (Btwn$0 next$0 curr_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_76$0 next$0 curr_init$0 null$0))))
...
(assert (= sk_?X_76$0 (lseg_domain$0 next$0 curr_init$0 null$0)))

(assert (= sk_?X_78$0 (lseg_domain$0 next$0 lst_init$0 curr_init$0)))

(assert (lseg_struct$0 sk_?X_76$0 next$0 curr_init$0 null$0))
...
(assert (or (Btwn$0 next$0 lst_init$0 curr_init$0 curr_init$0)
    (not (lseg_struct$0 sk_?X_78$0 next$0 lst_init$0 curr_init$0))))
...
(assert (lseg_struct$0 sk_?X_78$0 next$0 lst_init$0 curr_init$0))
