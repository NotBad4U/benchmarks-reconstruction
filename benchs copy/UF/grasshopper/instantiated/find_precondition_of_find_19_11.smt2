...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_9$0)) (not (in$0 x sk_?X_8$0))
                 (not (in$0 x (union$0 sk_?X_9$0 sk_?X_8$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_13$0)) (not (in$0 x sk_?X_8$0))
                 (not (in$0 x (union$0 sk_?X_13$0 sk_?X_8$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_9$0)) (not (in$0 x sk_?X_8$0)))
                 (not (in$0 x (intersection$0 sk_?X_9$0 sk_?X_8$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_13$0)) (not (in$0 x sk_?X_8$0)))
                 (not (in$0 x (intersection$0 sk_?X_13$0 sk_?X_8$0)))))))
...
(assert (or (Btwn$0 next$0 x$0 root_x$0 root_x$0)
    (not (lseg_set_struct$0 sk_?X_9$0 next$0 x$0 root_x$0 X$0))))

(assert (= n_5$0 (read$0 next$0 x$0)))

(assert (= (read$0 next$0 root_x$0) null$0))

(assert (= emptyset$0 (intersection$0 sk_?X_9$0 sk_?X_7$0)))

(assert (= sk_?X_6$0 (union$0 sk_?X_9$0 sk_?X_7$0)))

(assert (= sk_?X_7$0 sk_?X_8$0))

(assert (= sk_?X_9$0 (lseg_set_domain$0 next$0 x$0 root_x$0)))

(assert (lseg_set_struct$0 sk_?X_9$0 next$0 x$0 root_x$0 X$0))

(assert (= sk_?X_11$0 sk_?X_12$0))

(assert (= sk_?X_13$0 (lseg_set_domain$0 next$0 n_5$0 root_x$0)))

(assert (= sk_X$0 (lseg_set_X$0 next$0 n_5$0 root_x$0)))
...
(assert (or (Btwn$0 next$0 n_5$0 root_x$0 root_x$0)
    (not (lseg_set_struct$0 sk_?X_13$0 next$0 n_5$0 root_x$0 sk_X$0))))
...
(assert (= sk_?X_6$0 FP$0))

(assert (= sk_?X_8$0 (setenum$0 root_x$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (= sk_?X_10$0 (union$0 sk_?X_13$0 sk_?X_11$0)))

(assert (= sk_?X_12$0 (setenum$0 root_x$0)))

(assert (= sk_FP$0 sk_?X_10$0))
...
(assert (or (in$0 sk_?e_1$0 (intersection$0 sk_?X_13$0 sk_?X_11$0))
    ...
    (not (Btwn$0 next$0 n_5$0 root_x$0 root_x$0))))
