...
(assert (forall ((?y Loc))
        (or (not (Btwn$0 next_4$0 curr$0 ?y ?y)) (= curr$0 ?y)
            (Btwn$0 next_4$0 curr$0 (read$0 next_4$0 curr$0) ?y))))
...
(assert (forall ((?y Loc))
        (or (not (= (read$0 next_4$0 curr$0) curr$0))
            (not (Btwn$0 next_4$0 curr$0 ?y ?y)) (= curr$0 ?y))))

(assert (Btwn$0 next$0 curr$0 (read$0 next$0 curr$0) (read$0 next$0 curr$0)))

(assert (Btwn$0 next_4$0 curr$0 (read$0 next_4$0 curr$0) (read$0 next_4$0 curr$0)))

(assert (or (not Axiom_5$0)
    (or (= (read$0 next$0 curr$0) (read$0 next_4$0 curr$0))
        (not (in$0 curr$0 (setminus$0 Alloc$0 FP_6$0))))))
...
(assert (or (not Axiom_3$0)
    (forall ((?y Loc) (?z Loc))
            (or (in$0 cp$0 FP_6$0)
                ...
                (and (not (Btwn$0 next$0 cp$0 ?z ?y))
                     (not (Btwn$0 next_4$0 cp$0 ?z ?y)))
                (not (= cp$0 (ep$0 next$0 FP_6$0 cp$0)))))))
...
(assert (or (not Axiom_3$0)
    (forall ((?y Loc) (?z Loc))
            (or (in$0 curr$0 FP_6$0)
                ...
                (and (not (Btwn$0 next$0 curr$0 ?z ?y))
                     (not (Btwn$0 next_4$0 curr$0 ?z ?y)))
                (not (= curr$0 (ep$0 next$0 FP_6$0 curr$0)))))))
...
(assert (or (not Axiom_3$0)
    (forall ((?y Loc) (?z Loc))
            (or (in$0 res_8$0 FP_6$0)
                ...
                (and (not (Btwn$0 next$0 res_8$0 ?z ?y))
                     (not (Btwn$0 next_4$0 res_8$0 ?z ?y)))
                (not (= res_8$0 (ep$0 next$0 FP_6$0 res_8$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_29$0)) (not (in$0 x FP$0))
                 (not (in$0 x (union$0 sk_?X_29$0 FP$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x (setminus$0 FP$0 FP_6$0)))
                 ...
                 (not (in$0 x (union$0 (setminus$0 FP$0 FP_6$0) sk_?X_33$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x FP_Caller_2$0)) (not (in$0 x FP_7$0))
                 (not (in$0 x (union$0 FP_Caller_2$0 FP_7$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_33$0)) (not (in$0 x sk_?X_34$0))
                 (not (in$0 x (union$0 sk_?X_33$0 sk_?X_34$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x Alloc$0)) (not (in$0 x sk_?X_29$0)))
                 (not (in$0 x (intersection$0 Alloc$0 sk_?X_29$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_33$0)) (not (in$0 x sk_?X_34$0)))
                 (not (in$0 x (intersection$0 sk_?X_33$0 sk_?X_34$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x sk_?X_29$0) (not (in$0 x Alloc$0)))
                 (not (in$0 x (setminus$0 Alloc$0 sk_?X_29$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x sk_?X_29$0) (not (in$0 x FP$0)))
                 (not (in$0 x (setminus$0 FP$0 sk_?X_29$0)))))))
...
(assert (or (Btwn$0 next$0 cp$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_29$0 next$0 cp$0 null$0))))

(assert (or (Btwn$0 next$0 curr$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_31$0 next$0 curr$0 null$0))))

(assert (or (Btwn$0 next_4$0 res_8$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_28$0 next_4$0 res_8$0 null$0))))

(assert (= FP_7$0
  (union$0 (setminus$0 FP$0 FP_6$0)
    (union$0 (intersection$0 Alloc$0 FP_6$0) (setminus$0 Alloc$0 Alloc$0)))))

(assert (= FP_Caller_final_4$0 (union$0 FP_Caller_2$0 FP_7$0)))

(assert (= res_9$0 res_8$0))
...
(assert (= sk_?X_32$0 (lseg_domain$0 next$0 cp$0 null$0)))

(assert (lseg_struct$0 sk_?X_31$0 next$0 curr$0 null$0))

(assert (= sk_?X_28$0
  (union$0 (intersection$0 Alloc$0 FP_6$0) (setminus$0 Alloc$0 Alloc$0))))

(assert (lseg_struct$0 sk_?X_28$0 next_4$0 res_8$0 null$0))

(assert (= sk_?X_29$0 (lseg_domain$0 next$0 cp$0 null$0)))

(assert (lseg_struct$0 sk_?X_29$0 next$0 cp$0 null$0))

(assert (= sk_?X_34$0 (lseg_domain$0 next_4$0 curr$0 null$0)))
...
(assert (or (in$0 sk_?e_3$0 (intersection$0 sk_?X_33$0 sk_?X_34$0))
    ...
    (not (Btwn$0 next_4$0 res_9$0 null$0 null$0))))
...
(assert (= sk_?X_31$0 (lseg_domain$0 next$0 curr$0 null$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_32$0 next$0 cp$0 null$0))

(assert (= sk_?X_28$0 (lseg_domain$0 next_4$0 res_8$0 null$0)))

(assert (= sk_?X_29$0 FP_6$0))

(assert (= FP$0 (union$0 FP_6$0 FP$0)))

(assert (= sk_?X_33$0 (lseg_domain$0 next_4$0 res_9$0 null$0)))

(assert (= sk_?X_35$0 (union$0 sk_?X_33$0 sk_?X_34$0)))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next_4$0 curr$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next_4$0 curr$0 null$0)))))))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next_4$0 res_9$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next_4$0 res_9$0 null$0)))))))
