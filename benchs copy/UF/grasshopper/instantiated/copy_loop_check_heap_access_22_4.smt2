...
(assert (or (Btwn$0 next$0 cp_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_35$0 next$0 cp_init$0 null$0))))

(assert (or (Btwn$0 next$0 lst_init$0 curr_init$0 curr_init$0)
    (not (lseg_struct$0 sk_?X_38$0 next$0 lst_init$0 curr_init$0))))
...
(assert (= emptyset$0 (intersection$0 sk_?X_36$0 sk_?X_35$0)))

(assert (= sk_?X_34$0 (union$0 sk_?X_36$0 sk_?X_35$0)))

(assert (= sk_?X_35$0 (lseg_domain$0 next$0 cp_init$0 null$0)))

(assert (= sk_?X_37$0 (lseg_domain$0 next$0 curr_init$0 null$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_37$0 next$0 curr_init$0 null$0))
...
(assert (or (Btwn$0 next$0 curr_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_37$0 next$0 curr_init$0 null$0))))
...
(assert (= sk_?X_34$0 FP$0))

(assert (= sk_?X_36$0 (union$0 sk_?X_38$0 sk_?X_37$0)))

(assert (= sk_?X_38$0 (lseg_domain$0 next$0 lst_init$0 curr_init$0)))

(assert (lseg_struct$0 sk_?X_35$0 next$0 cp_init$0 null$0))

(assert (lseg_struct$0 sk_?X_38$0 next$0 lst_init$0 curr_init$0))

(assert (not (= tmp_3$0 null$0)))

(assert (not (in$0 cp_5$0 FP_3$0)))
