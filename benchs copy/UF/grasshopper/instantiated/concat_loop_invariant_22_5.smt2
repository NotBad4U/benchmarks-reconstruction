...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_52$0)) (not (in$0 x sk_?X_51$0))
                 (not (in$0 x (union$0 sk_?X_52$0 sk_?X_51$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_57$0)) (not (in$0 x sk_?X_55$0))
                 (not (in$0 x (union$0 sk_?X_57$0 sk_?X_55$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_52$0)) (not (in$0 x sk_?X_51$0)))
                 (not (in$0 x (intersection$0 sk_?X_52$0 sk_?X_51$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_57$0)) (not (in$0 x sk_?X_55$0)))
                 (not (in$0 x (intersection$0 sk_?X_57$0 sk_?X_55$0)))))))
...
(assert (or (Btwn$0 next$0 a_2$0 curr_5$0 curr_5$0)
    (not (lseg_struct$0 sk_?X_57$0 next$0 a_2$0 curr_5$0))))

(assert (or (Btwn$0 next$0 curr_5$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_55$0 next$0 curr_5$0 null$0))))
...
(assert (= sk_?X_50$0 FP$0))

(assert (= sk_?X_52$0 sk_?X_53$0))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_53$0 next$0 a_init$0 curr_init$0))

(assert (= sk_?X_54$0 (union$0 sk_?X_56$0 sk_?X_55$0)))

(assert (= sk_?X_56$0 sk_?X_57$0))

(assert (= sk_FP_1$0 sk_?X_54$0))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 curr_5$0) (not (Btwn$0 next$0 a_2$0 l1 curr_5$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 a_2$0 curr_5$0)))))))
...
(assert (or (Btwn$0 next$0 a_init$0 curr_init$0 curr_init$0)
    (not (lseg_struct$0 sk_?X_53$0 next$0 a_init$0 curr_init$0))))

(assert (or (Btwn$0 next$0 curr_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_51$0 next$0 curr_init$0 null$0))))
...
(assert (= sk_?X_51$0 (lseg_domain$0 next$0 curr_init$0 null$0)))

(assert (= sk_?X_53$0 (lseg_domain$0 next$0 a_init$0 curr_init$0)))

(assert (lseg_struct$0 sk_?X_51$0 next$0 curr_init$0 null$0))

(assert (not (= curr_init$0 null$0)))

(assert (= sk_?X_55$0 (lseg_domain$0 next$0 curr_5$0 null$0)))

(assert (= sk_?X_57$0 (lseg_domain$0 next$0 a_2$0 curr_5$0)))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and
                 ...
                 (not (in$0 l1 (lseg_domain$0 next$0 a_init$0 curr_init$0)))))))
