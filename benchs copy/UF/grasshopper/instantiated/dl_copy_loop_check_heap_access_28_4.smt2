...
(assert (or (not Axiom_17$0)
    (or (= (read$0 prev$0 null$0) null$0)
        (not (= (read$0 next$0 null$0) null$0))
        (not (in$0 null$0 sk_?X_24$0)) (not (in$0 null$0 sk_?X_24$0)))))

(assert (or (not Axiom_17$0)
    (or (= (read$0 prev$0 null$0) b_init$0)
        (not (= (read$0 next$0 b_init$0) null$0))
        (not (in$0 b_init$0 sk_?X_24$0)) (not (in$0 null$0 sk_?X_24$0)))))

(assert (or (not Axiom_17$0)
    (or (= (read$0 prev$0 null$0) old_d_4$0)
        (not (= (read$0 next$0 old_d_4$0) null$0))
        (not (in$0 old_d_4$0 sk_?X_24$0)) (not (in$0 null$0 sk_?X_24$0)))))

(assert (or (not Axiom_17$0)
    (or (= (read$0 prev$0 null$0) old_curr_4$0)
        (not (= (read$0 next$0 old_curr_4$0) null$0))
        (not (in$0 old_curr_4$0 sk_?X_24$0)) (not (in$0 null$0 sk_?X_24$0)))))

(assert (or (not Axiom_17$0)
    (or (= (read$0 prev$0 a_2$0) null$0)
        (not (= (read$0 next$0 null$0) a_2$0)) (not (in$0 null$0 sk_?X_24$0))
        (not (in$0 a_2$0 sk_?X_24$0)))))

(assert (or (not Axiom_17$0)
    (or (= (read$0 prev$0 a_2$0) b_init$0)
        (not (= (read$0 next$0 b_init$0) a_2$0))
        (not (in$0 b_init$0 sk_?X_24$0)) (not (in$0 a_2$0 sk_?X_24$0)))))

(assert (or (not Axiom_17$0)
    (or (= (read$0 prev$0 a_2$0) old_d_4$0)
        (not (= (read$0 next$0 old_d_4$0) a_2$0))
        (not (in$0 old_d_4$0 sk_?X_24$0)) (not (in$0 a_2$0 sk_?X_24$0)))))

(assert (or (not Axiom_17$0)
    (or (= (read$0 prev$0 a_2$0) old_curr_4$0)
        (not (= (read$0 next$0 old_curr_4$0) a_2$0))
        (not (in$0 old_curr_4$0 sk_?X_24$0)) (not (in$0 a_2$0 sk_?X_24$0)))))

(assert (or (not Axiom_17$0)
    (or (= (read$0 prev$0 c_3$0) null$0)
        (not (= (read$0 next$0 null$0) c_3$0)) (not (in$0 null$0 sk_?X_24$0))
        (not (in$0 c_3$0 sk_?X_24$0)))))

(assert (or (not Axiom_17$0)
    (or (= (read$0 prev$0 c_3$0) b_init$0)
        (not (= (read$0 next$0 b_init$0) c_3$0))
        (not (in$0 b_init$0 sk_?X_24$0)) (not (in$0 c_3$0 sk_?X_24$0)))))

(assert (or (not Axiom_17$0)
    (or (= (read$0 prev$0 c_3$0) old_d_4$0)
        (not (= (read$0 next$0 old_d_4$0) c_3$0))
        (not (in$0 old_d_4$0 sk_?X_24$0)) (not (in$0 c_3$0 sk_?X_24$0)))))

(assert (or (not Axiom_17$0)
    (or (= (read$0 prev$0 c_3$0) old_curr_4$0)
        (not (= (read$0 next$0 old_curr_4$0) c_3$0))
        (not (in$0 old_curr_4$0 sk_?X_24$0)) (not (in$0 c_3$0 sk_?X_24$0)))))

(assert (or (not Axiom_17$0)
    (or (= (read$0 prev$0 curr_init$0) null$0)
        (not (= (read$0 next$0 null$0) curr_init$0))
        (not (in$0 null$0 sk_?X_24$0)) (not (in$0 curr_init$0 sk_?X_24$0)))))

(assert (or (not Axiom_17$0)
    (or (= (read$0 prev$0 curr_init$0) b_init$0)
        (not (= (read$0 next$0 b_init$0) curr_init$0))
        (not (in$0 b_init$0 sk_?X_24$0)) (not (in$0 curr_init$0 sk_?X_24$0)))))

(assert (or (not Axiom_17$0)
    (or (= (read$0 prev$0 curr_init$0) old_d_4$0)
        (not (= (read$0 next$0 old_d_4$0) curr_init$0))
        (not (in$0 old_d_4$0 sk_?X_24$0))
        (not (in$0 curr_init$0 sk_?X_24$0)))))
...
(assert (or (not Axiom_18$0)
    (or (= (read$0 prev$0 null$0) null$0)
        (not (= (read$0 next$0 null$0) null$0))
        (not (in$0 null$0 sk_?X_21$0)) (not (in$0 null$0 sk_?X_21$0)))))

(assert (or (not Axiom_18$0)
    (or (= (read$0 prev$0 null$0) b_init$0)
        (not (= (read$0 next$0 b_init$0) null$0))
        (not (in$0 b_init$0 sk_?X_21$0)) (not (in$0 null$0 sk_?X_21$0)))))

(assert (or (not Axiom_18$0)
    (or (= (read$0 prev$0 null$0) old_d_4$0)
        (not (= (read$0 next$0 old_d_4$0) null$0))
        (not (in$0 old_d_4$0 sk_?X_21$0)) (not (in$0 null$0 sk_?X_21$0)))))

(assert (or (not Axiom_18$0)
    (or (= (read$0 prev$0 null$0) old_curr_4$0)
        (not (= (read$0 next$0 old_curr_4$0) null$0))
        (not (in$0 old_curr_4$0 sk_?X_21$0)) (not (in$0 null$0 sk_?X_21$0)))))

(assert (or (not Axiom_18$0)
    (or (= (read$0 prev$0 a_2$0) null$0)
        (not (= (read$0 next$0 null$0) a_2$0)) (not (in$0 null$0 sk_?X_21$0))
        (not (in$0 a_2$0 sk_?X_21$0)))))

(assert (or (not Axiom_18$0)
    (or (= (read$0 prev$0 a_2$0) b_init$0)
        (not (= (read$0 next$0 b_init$0) a_2$0))
        (not (in$0 b_init$0 sk_?X_21$0)) (not (in$0 a_2$0 sk_?X_21$0)))))

(assert (or (not Axiom_18$0)
    (or (= (read$0 prev$0 a_2$0) old_d_4$0)
        (not (= (read$0 next$0 old_d_4$0) a_2$0))
        (not (in$0 old_d_4$0 sk_?X_21$0)) (not (in$0 a_2$0 sk_?X_21$0)))))

(assert (or (not Axiom_18$0)
    (or (= (read$0 prev$0 a_2$0) old_curr_4$0)
        (not (= (read$0 next$0 old_curr_4$0) a_2$0))
        (not (in$0 old_curr_4$0 sk_?X_21$0)) (not (in$0 a_2$0 sk_?X_21$0)))))

(assert (or (not Axiom_18$0)
    (or (= (read$0 prev$0 c_3$0) null$0)
        (not (= (read$0 next$0 null$0) c_3$0)) (not (in$0 null$0 sk_?X_21$0))
        (not (in$0 c_3$0 sk_?X_21$0)))))

(assert (or (not Axiom_18$0)
    (or (= (read$0 prev$0 c_3$0) b_init$0)
        (not (= (read$0 next$0 b_init$0) c_3$0))
        (not (in$0 b_init$0 sk_?X_21$0)) (not (in$0 c_3$0 sk_?X_21$0)))))

(assert (or (not Axiom_18$0)
    (or (= (read$0 prev$0 c_3$0) old_d_4$0)
        (not (= (read$0 next$0 old_d_4$0) c_3$0))
        (not (in$0 old_d_4$0 sk_?X_21$0)) (not (in$0 c_3$0 sk_?X_21$0)))))

(assert (or (not Axiom_18$0)
    (or (= (read$0 prev$0 c_3$0) old_curr_4$0)
        (not (= (read$0 next$0 old_curr_4$0) c_3$0))
        (not (in$0 old_curr_4$0 sk_?X_21$0)) (not (in$0 c_3$0 sk_?X_21$0)))))

(assert (or (not Axiom_18$0)
    (or (= (read$0 prev$0 curr_init$0) null$0)
        (not (= (read$0 next$0 null$0) curr_init$0))
        (not (in$0 null$0 sk_?X_21$0)) (not (in$0 curr_init$0 sk_?X_21$0)))))

(assert (or (not Axiom_18$0)
    (or (= (read$0 prev$0 curr_init$0) b_init$0)
        (not (= (read$0 next$0 b_init$0) curr_init$0))
        (not (in$0 b_init$0 sk_?X_21$0)) (not (in$0 curr_init$0 sk_?X_21$0)))))

(assert (or (not Axiom_18$0)
    (or (= (read$0 prev$0 curr_init$0) old_d_4$0)
        (not (= (read$0 next$0 old_d_4$0) curr_init$0))
        (not (in$0 old_d_4$0 sk_?X_21$0))
        (not (in$0 curr_init$0 sk_?X_21$0)))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_22$0)) (not (in$0 x sk_?X_21$0))
                 (not (in$0 x (union$0 sk_?X_22$0 sk_?X_21$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_24$0)) (not (in$0 x sk_?X_23$0))
                 (not (in$0 x (union$0 sk_?X_24$0 sk_?X_23$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_24$0)) (not (in$0 x sk_?X_23$0)))
                 (not (in$0 x (intersection$0 sk_?X_24$0 sk_?X_23$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_22$0)) (not (in$0 x sk_?X_21$0)))
                 (not (in$0 x (intersection$0 sk_?X_22$0 sk_?X_21$0)))))))
...
(assert (= emptyset$0 (intersection$0 sk_?X_22$0 sk_?X_21$0)))

(assert (= sk_?X_20$0 (union$0 sk_?X_22$0 sk_?X_21$0)))

(assert (= sk_?X_21$0 (dlseg_domain$0 next$0 prev$0 c_init$0 null$0 null$0 d_init$0)))
...
(assert (= emptyset$0 (intersection$0 sk_?X_24$0 sk_?X_23$0)))

(assert (= sk_?X_20$0 FP$0))

(assert (= sk_?X_22$0 (union$0 sk_?X_24$0 sk_?X_23$0)))

(assert (= sk_?X_24$0
  (dlseg_domain$0 next$0 prev$0 a_init$0 null$0 curr_init$0 old_curr_init$0)))

(assert (dlseg_struct$0 sk_?X_21$0 next$0 prev$0 c_init$0 null$0 null$0 d_init$0))
