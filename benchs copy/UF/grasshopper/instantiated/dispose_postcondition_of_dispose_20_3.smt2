...
(assert (forall ((?y Loc))
        (or (not (Btwn$0 next$0 lst_1$0 ?y ?y)) (= lst_1$0 ?y)
            (Btwn$0 next$0 lst_1$0 (read$0 next$0 lst_1$0) ?y))))

(assert (forall ((?y Loc))
        (or (not (= (read$0 next$0 lst_1$0) lst_1$0))
            (not (Btwn$0 next$0 lst_1$0 ?y ?y)) (= lst_1$0 ?y))))

(assert (Btwn$0 next$0 lst_1$0 (read$0 next$0 lst_1$0) (read$0 next$0 lst_1$0)))

(assert (or (in$0 (ep$0 next$0 FP$0 lst$0) FP$0) (= lst$0 (ep$0 next$0 FP$0 lst$0))))

(assert (or (in$0 (ep$0 next$0 FP$0 lst_1$0) FP$0)
    (= lst_1$0 (ep$0 next$0 FP$0 lst_1$0))))

(assert (or (in$0 (ep$0 next$0 FP$0 sk_?e_1$0) FP$0)
    (= sk_?e_1$0 (ep$0 next$0 FP$0 sk_?e_1$0))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 lst$0 (ep$0 next$0 FP$0 lst$0) ?y)
            (not (Btwn$0 next$0 lst$0 ?y ?y)) (not (in$0 ?y FP$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 lst_1$0 (ep$0 next$0 FP$0 lst_1$0) ?y)
            (not (Btwn$0 next$0 lst_1$0 ?y ?y)) (not (in$0 ?y FP$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 sk_?e_1$0 (ep$0 next$0 FP$0 sk_?e_1$0) ?y)
            (not (Btwn$0 next$0 sk_?e_1$0 ?y ?y)) (not (in$0 ?y FP$0)))))

(assert (Btwn$0 next$0 lst$0 (ep$0 next$0 FP$0 lst$0) (ep$0 next$0 FP$0 lst$0)))

(assert (Btwn$0 next$0 lst_1$0 (ep$0 next$0 FP$0 lst_1$0) (ep$0 next$0 FP$0 lst_1$0)))

(assert (Btwn$0 next$0 sk_?e_1$0 (ep$0 next$0 FP$0 sk_?e_1$0)
  (ep$0 next$0 FP$0 sk_?e_1$0)))
...
(assert (or (Btwn$0 next$0 lst_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_2$0 next$0 lst_1$0 null$0))))

(assert (= FP_Caller_1$0 (setminus$0 FP_Caller$0 FP$0)))

(assert (= lst_1$0 null$0))
...
(assert (lseg_struct$0 sk_?X_2$0 next$0 lst_1$0 null$0))
...
(assert (= sk_?X_2$0 (lseg_domain$0 next$0 lst_1$0 null$0)))
