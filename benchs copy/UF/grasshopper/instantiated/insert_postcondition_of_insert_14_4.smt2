...
(set-info :source |
  ...
  tests/spl/sl/sl_insert.spl:14:4-15:A postcondition of procedure insert might not hold at this return point
...
(assert (or (Btwn$0 next$0 res_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_4$0 next$0 res_2$0 null$0))))
