...
(set-info :source |
  ...
  tests/spl/sl/rec_copy.spl:45:11-31:A precondition for this call of rec_copy_loop might not hold
...
(assert (forall ((?y Loc))
        (or (not (Btwn$0 next$0 tmp_1$0 ?y ?y)) (= tmp_1$0 ?y)
            (Btwn$0 next$0 tmp_1$0 (read$0 next$0 tmp_1$0) ?y))))
...
(assert (forall ((?y Loc))
        (or (not (= (read$0 next$0 tmp_1$0) tmp_1$0))
            (not (Btwn$0 next$0 tmp_1$0 ?y ?y)) (= tmp_1$0 ?y))))
...
(assert (Btwn$0 next$0 tmp_1$0 (read$0 next$0 tmp_1$0) (read$0 next$0 tmp_1$0)))
...
(assert (= (read$0 (write$0 next$0 tmp_1$0 old_cp_2$0) tmp_1$0) old_cp_2$0))

(assert (or (= null$0 tmp_1$0)
    (= (read$0 next$0 null$0)
      (read$0 (write$0 next$0 tmp_1$0 old_cp_2$0) null$0))))

(assert (or (= tmp_1$0 tmp_1$0)
    (= (read$0 next$0 tmp_1$0)
      (read$0 (write$0 next$0 tmp_1$0 old_cp_2$0) tmp_1$0))))

(assert (or (= curr$0 tmp_1$0)
    (= (read$0 next$0 curr$0)
      (read$0 (write$0 next$0 tmp_1$0 old_cp_2$0) curr$0))))
...
(assert (or (Btwn$0 next$0 cp$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_44$0 next$0 cp$0 null$0))))

(assert (or (Btwn$0 next_2$0 cp_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_47$0 next_2$0 cp_1$0 null$0))))
...
(assert (= sk_?X_44$0 (lseg_domain$0 next$0 cp$0 null$0)))

(assert (lseg_struct$0 sk_?X_43$0 next$0 curr$0 null$0))

(assert (= sk_?X_45$0 (union$0 sk_?X_47$0 sk_?X_46$0)))

(assert (= sk_?X_47$0 (lseg_domain$0 next_2$0 cp_1$0 null$0)))

(assert (or (in$0 sk_?e_4$0 (intersection$0 sk_?X_47$0 sk_?X_46$0))
    (and (in$0 sk_?e_4$0 sk_FP_2$0) (not (in$0 sk_?e_4$0 FP_3$0)))
    (not (Btwn$0 next_2$0 cp_1$0 null$0 null$0))
    (not (Btwn$0 next_2$0 n_2$0 null$0 null$0))))
...
(assert (or (Btwn$0 next$0 curr$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_43$0 next$0 curr$0 null$0))))

(assert (or (Btwn$0 next_2$0 n_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_46$0 next_2$0 n_2$0 null$0))))
...
(assert (= sk_?X_43$0 (lseg_domain$0 next$0 curr$0 null$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_44$0 next$0 cp$0 null$0))

(assert (= sk_?X_46$0 (lseg_domain$0 next_2$0 n_2$0 null$0)))

(assert (= sk_FP_2$0 sk_?X_45$0))
