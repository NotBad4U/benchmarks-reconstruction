...
(set-info :source |
  ...
  tests/spl/sl/sl_concat.spl:24:4-13:A postcondition of procedure concat might not hold at this return point
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 sk_?X_29$0 sk_?X_32$0))
                 (or (in$0 x sk_?X_29$0) (in$0 x sk_?X_32$0)))
            (and (not (in$0 x sk_?X_29$0)) (not (in$0 x sk_?X_32$0))
                 (not (in$0 x (union$0 sk_?X_29$0 sk_?X_32$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 (setminus$0 FP$0 FP_1$0) sk_?X_25$0))
                 (or (in$0 x (setminus$0 FP$0 FP_1$0)) (in$0 x sk_?X_25$0)))
            (and (not (in$0 x (setminus$0 FP$0 FP_1$0)))
                 (not (in$0 x sk_?X_25$0))
                 (not (in$0 x (union$0 (setminus$0 FP$0 FP_1$0) sk_?X_25$0)))))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 sk_?X_22$0 sk_?X_24$0))
                 (or (in$0 x sk_?X_22$0) (in$0 x sk_?X_24$0)))
            (and (not (in$0 x sk_?X_22$0)) (not (in$0 x sk_?X_24$0))
                 (not (in$0 x (union$0 sk_?X_22$0 sk_?X_24$0)))))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x sk_?X_29$0) (in$0 x sk_?X_32$0)
                 (in$0 x (intersection$0 sk_?X_29$0 sk_?X_32$0)))
            (and (or (not (in$0 x sk_?X_29$0)) (not (in$0 x sk_?X_32$0)))
                 (not (in$0 x (intersection$0 sk_?X_29$0 sk_?X_32$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x sk_?X_22$0) (in$0 x sk_?X_24$0)
                 (in$0 x (intersection$0 sk_?X_22$0 sk_?X_24$0)))
            (and (or (not (in$0 x sk_?X_22$0)) (not (in$0 x sk_?X_24$0)))
                 (not (in$0 x (intersection$0 sk_?X_22$0 sk_?X_24$0)))))))
...
(assert (= (read$0 (write$0 next$0 curr_3$0 b$0) curr_3$0) b$0))

(assert (or (= curr_3$0 curr_3$0)
    (= (read$0 next$0 curr_3$0)
      (read$0 (write$0 next$0 curr_3$0 b$0) curr_3$0))))

(assert (or (= null$0 curr_3$0)
    (= (read$0 next$0 null$0) (read$0 (write$0 next$0 curr_3$0 b$0) null$0))))
...
(assert (or (Btwn$0 next$0 a$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_32$0 next$0 a$0 null$0))))

(assert (or (Btwn$0 next$0 a_1$0 curr_3$0 curr_3$0)
    (not (lseg_struct$0 sk_?X_22$0 next$0 a_1$0 curr_3$0))))

(assert (or (Btwn$0 next$0 curr_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_27$0 next$0 curr_2$0 null$0))))

(assert (or (Btwn$0 next_1$0 res_1$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_33$0 next_1$0 res_1$0 null$0))))
...
(assert (= res_1$0 a_1$0))

(assert (= Alloc$0 (union$0 FP_2$0 Alloc$0)))

(assert (= emptyset$0 emptyset$0))

(assert (= sk_?X_22$0 (lseg_domain$0 next$0 a_1$0 curr_3$0)))

(assert (= sk_?X_24$0 (lseg_domain$0 next$0 curr_3$0 null$0)))

(assert (= sk_?X_25$0 (union$0 sk_?X_23$0 sk_?X_24$0)))

(assert (lseg_struct$0 sk_?X_24$0 next$0 curr_3$0 null$0))

(assert (= emptyset$0 emptyset$0))

(assert (= sk_?X_26$0 (union$0 sk_?X_28$0 sk_?X_27$0)))

(assert (= sk_?X_27$0 (lseg_domain$0 next$0 curr_2$0 null$0)))

(assert (= sk_?X_29$0 (lseg_domain$0 next$0 a$0 curr_2$0)))

(assert (lseg_struct$0 sk_?X_27$0 next$0 curr_2$0 null$0))

(assert (not (= curr_2$0 null$0)))

(assert (= sk_?X_30$0 (union$0 sk_?X_32$0 sk_?X_31$0)))

(assert (= sk_?X_31$0 (lseg_domain$0 next$0 b$0 null$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_32$0 next$0 a$0 null$0))

(assert (or
    (and (in$0 sk_?e_2$0 (lseg_domain$0 next_1$0 res_1$0 null$0))
         (not (in$0 sk_?e_2$0 sk_?X_33$0)))
    (and (in$0 sk_?e_2$0 sk_?X_33$0)
         (not (in$0 sk_?e_2$0 (lseg_domain$0 next_1$0 res_1$0 null$0))))
    (not (Btwn$0 next_1$0 res_1$0 null$0 null$0))))
...
(assert (or (Btwn$0 next$0 a$0 curr_2$0 curr_2$0)
    (not (lseg_struct$0 sk_?X_29$0 next$0 a$0 curr_2$0))))

(assert (or (Btwn$0 next$0 b$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_31$0 next$0 b$0 null$0))))

(assert (or (Btwn$0 next$0 curr_3$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_24$0 next$0 curr_3$0 null$0))))
...
(assert (= next_1$0 (write$0 next$0 curr_3$0 b$0)))

(assert (Frame$0 FP_1$0 Alloc$0 next$0 next$0))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= emptyset$0 (intersection$0 sk_?X_23$0 sk_?X_24$0)))

(assert (= sk_?X_23$0 sk_?X_22$0))

(assert (= sk_?X_25$0
  (union$0 (intersection$0 Alloc$0 FP_1$0) (setminus$0 Alloc$0 Alloc$0))))

(assert (lseg_struct$0 sk_?X_22$0 next$0 a_1$0 curr_3$0))

(assert (not (= curr_3$0 null$0)))

(assert (= emptyset$0 (intersection$0 sk_?X_28$0 sk_?X_27$0)))

(assert (= sk_?X_26$0 FP_1$0))

(assert (= sk_?X_28$0 sk_?X_29$0))

(assert (= FP$0 (union$0 FP_1$0 FP$0)))

(assert (lseg_struct$0 sk_?X_29$0 next$0 a$0 curr_2$0))

(assert (= emptyset$0 (intersection$0 sk_?X_32$0 sk_?X_31$0)))

(assert (= sk_?X_30$0 FP$0))

(assert (= sk_?X_32$0 (lseg_domain$0 next$0 a$0 null$0)))

(assert (lseg_struct$0 sk_?X_31$0 next$0 b$0 null$0))
...
(assert (forall ((?u Loc) (?v Loc) (?z Loc))
        (and
             (or (Btwn$0 (write$0 next$0 curr_3$0 b$0) ?z ?u ?v)
                 (not
                      (or
                          ...
                          (and (not (= curr_3$0 ?v))
                               ...
                               (or (Btwn$0 next$0 b$0 ?v curr_3$0)
                                   (and (Btwn$0 next$0 b$0 ?v ?v)
                                        (not
                                             (Btwn$0 next$0 b$0 curr_3$0
                                               curr_3$0)))))
                          (and (not (= curr_3$0 ?v))
                               (or (Btwn$0 next$0 ?z curr_3$0 ?v)
                                   (and (Btwn$0 next$0 ?z curr_3$0 curr_3$0)
             ...
             (or
                 ...
                 (and (not (= curr_3$0 ?v))
                      ...
                      (or (Btwn$0 next$0 b$0 ?v curr_3$0)
                          (and (Btwn$0 next$0 b$0 ?v ?v)
                               (not (Btwn$0 next$0 b$0 curr_3$0 curr_3$0)))))
                 (and (not (= curr_3$0 ?v))
                      (or (Btwn$0 next$0 ?z curr_3$0 ?v)
                          (and (Btwn$0 next$0 ?z curr_3$0 curr_3$0)
                               (not (Btwn$0 next$0 ?z ?v ?v))))
                      ...
                      (or (Btwn$0 next$0 b$0 ?v curr_3$0)
                          (and (Btwn$0 next$0 b$0 ?v ?v)
                               (not (Btwn$0 next$0 b$0 curr_3$0 curr_3$0)))))
                 (not (Btwn$0 (write$0 next$0 curr_3$0 b$0) ?z ?u ?v))))))
