...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_268$0)) (not (in$0 x sk_?X_267$0))
                 (not (in$0 x (union$0 sk_?X_268$0 sk_?X_267$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_270$0)) (not (in$0 x sk_?X_269$0))
                 (not (in$0 x (union$0 sk_?X_270$0 sk_?X_269$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_270$0)) (not (in$0 x sk_?X_269$0)))
                 (not (in$0 x (intersection$0 sk_?X_270$0 sk_?X_269$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_268$0)) (not (in$0 x sk_?X_267$0)))
                 (not (in$0 x (intersection$0 sk_?X_268$0 sk_?X_267$0)))))))
...
(assert (or (Btwn$0 next$0 curr_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_267$0 next$0 curr_init$0 null$0))))

(assert (or (Btwn$0 next$0 z_init$0 curr_init$0 curr_init$0)
    (not (lseg_struct$0 sk_?X_269$0 next$0 z_init$0 curr_init$0))))

(assert (= curr_4$0 curr_init$0))

(assert (= z_4$0 z_init$0))

(assert (= emptyset$0 (intersection$0 sk_?X_268$0 sk_?X_267$0)))

(assert (= sk_?X_266$0 (union$0 sk_?X_268$0 sk_?X_267$0)))

(assert (= sk_?X_267$0 (lseg_domain$0 next$0 curr_init$0 null$0)))

(assert (= sk_?X_269$0 (lseg_domain$0 next$0 z_init$0 curr_init$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_269$0 next$0 z_init$0 curr_init$0))

(assert (not (= curr_4$0 null$0)))

(assert (not (in$0 z_4$0 FP$0)))
...
(assert (or (Btwn$0 next$0 y_init$0 z_init$0 z_init$0)
    (not (lseg_struct$0 sk_?X_270$0 next$0 y_init$0 z_init$0))))
...
(assert (= emptyset$0 (intersection$0 sk_?X_270$0 sk_?X_269$0)))

(assert (= sk_?X_266$0 FP$0))

(assert (= sk_?X_268$0 (union$0 sk_?X_270$0 sk_?X_269$0)))

(assert (= sk_?X_270$0 (lseg_domain$0 next$0 y_init$0 z_init$0)))

(assert (lseg_struct$0 sk_?X_267$0 next$0 curr_init$0 null$0))

(assert (lseg_struct$0 sk_?X_270$0 next$0 y_init$0 z_init$0))
