...
(assert (forall ((?y Loc))
        (or (not (Btwn$0 next$0 n2_2$0 ?y ?y)) (= n2_2$0 ?y)
            (Btwn$0 next$0 n2_2$0 (read$0 next$0 n2_2$0) ?y))))
...
(assert (forall ((?y Loc))
        (or (not (Btwn$0 next$0 a$0 ?y ?y)) (= a$0 ?y)
            (Btwn$0 next$0 a$0 (read$0 next$0 a$0) ?y))))

(assert (forall ((?y Loc))
        (or (not (= (read$0 next$0 n2_2$0) n2_2$0))
            (not (Btwn$0 next$0 n2_2$0 ?y ?y)) (= n2_2$0 ?y))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_10$0)) (not (in$0 x FP$0))
                 (not (in$0 x (union$0 sk_?X_10$0 FP$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x (setminus$0 FP$0 FP_1$0)))
                 ...
                 (not (in$0 x (union$0 (setminus$0 FP$0 FP_1$0) sk_?X_9$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_6$0)) (not (in$0 x sk_?X_8$0))
                 (not (in$0 x (union$0 sk_?X_6$0 sk_?X_8$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_14$0)) (not (in$0 x sk_?X_8$0))
                 (not (in$0 x (union$0 sk_?X_14$0 sk_?X_8$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_6$0)) (not (in$0 x sk_?X_8$0)))
                 (not (in$0 x (intersection$0 sk_?X_6$0 sk_?X_8$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_14$0)) (not (in$0 x sk_?X_8$0)))
                 (not (in$0 x (intersection$0 sk_?X_14$0 sk_?X_8$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x sk_?X_10$0) (not (in$0 x FP$0)))
                 (not (in$0 x (setminus$0 FP$0 sk_?X_10$0)))))))
...
(assert (or (Btwn$0 next$0 a$0 l_3$0 l_3$0)
    (not (lseg_struct$0 sk_?X_14$0 next$0 a$0 l_3$0))))

(assert (or (Btwn$0 next$0 n_2$0 n2_2$0 n2_2$0)
    (not (lseg_struct$0 sk_?X_6$0 next$0 n_2$0 n2_2$0))))
...
(assert (= sk_?X_6$0 (lseg_domain$0 next$0 n_2$0 n2_2$0)))

(assert (= sk_?X_8$0 sk_?X_7$0))

(assert (= sk_?X_9$0 (union$0 sk_?X_6$0 sk_?X_8$0)))
...
(assert (not (= n_2$0 null$0)))

(assert (= sk_?X_12$0 sk_?X_13$0))

(assert (= sk_?X_13$0 (lseg_domain$0 next$0 a$0 null$0)))

(assert (lseg_struct$0 sk_?X_13$0 next$0 a$0 null$0))

(assert (= sk_?X_14$0 (lseg_domain$0 next$0 a$0 l_3$0)))
...
(assert (or (in$0 sk_?e_1$0 (intersection$0 sk_?X_14$0 sk_?X_16$0))
    ...
    (not (Btwn$0 next$0 a$0 l_3$0 l_3$0))))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 n_2$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 n_2$0 null$0)))))))

(assert (or (Btwn$0 next$0 a$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_13$0 next$0 a$0 null$0))))

(assert (or (Btwn$0 next$0 n_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_11$0 next$0 n_2$0 null$0))))

(assert (= FP_2$0
  (union$0 (setminus$0 FP$0 FP_1$0)
    (union$0 (intersection$0 Alloc$0 FP_1$0) (setminus$0 Alloc$0 Alloc$0)))))

(assert (= FP_Caller_final_2$0 (union$0 FP_Caller_1$0 FP_2$0)))

(assert (= n_2$0 (read$0 next$0 a$0)))

(assert (= Alloc$0 (union$0 FP_2$0 Alloc$0)))

(assert (= (read$0 next$0 n2_2$0) null$0))

(assert (= emptyset$0 (intersection$0 sk_?X_6$0 sk_?X_8$0)))

(assert (= sk_?X_7$0 (setenum$0 n2_2$0)))

(assert (= sk_?X_9$0
  (union$0 (intersection$0 Alloc$0 FP_1$0) (setminus$0 Alloc$0 Alloc$0))))

(assert (lseg_struct$0 sk_?X_6$0 next$0 n_2$0 n2_2$0))

(assert (= sk_?X_10$0 sk_?X_11$0))

(assert (= sk_?X_11$0 (lseg_domain$0 next$0 n_2$0 null$0)))

(assert (lseg_struct$0 sk_?X_11$0 next$0 n_2$0 null$0))

(assert (= emptyset$0 emptyset$0))

(assert (= sk_?X_12$0 FP$0))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (not (= a$0 null$0)))

(assert (= sk_?X_15$0 (setenum$0 l_3$0)))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 l_3$0) (not (Btwn$0 next$0 a$0 l1 l_3$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 a$0 l_3$0)))))))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 n2_2$0) (not (Btwn$0 next$0 n_2$0 l1 n2_2$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 n_2$0 n2_2$0)))))))
