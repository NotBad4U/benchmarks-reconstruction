...
(assert (forall ((?y Loc))
        (or (not (Btwn$0 next$0 d_5$0 ?y ?y)) (= d_5$0 ?y)
            (Btwn$0 next$0 d_5$0 (read$0 next$0 d_5$0) ?y))))
...
(assert (forall ((?y Loc))
        (or (not (= (read$0 next$0 d_5$0) d_5$0))
            (not (Btwn$0 next$0 d_5$0 ?y ?y)) (= d_5$0 ?y))))
...
(assert (Btwn$0 next$0 d_5$0 (read$0 next$0 d_5$0) (read$0 next$0 d_5$0)))

(assert (or (not Axiom_3$0)
    (or (= (read$0 prev$0 b$0) b$0) (not (= (read$0 next$0 b$0) b$0))
        (not (in$0 b$0 sk_?X_3$0)) (not (in$0 b$0 sk_?X_3$0)))))

(assert (or (not Axiom_3$0)
    (or (= (read$0 prev$0 b$0) sk_l1_1$0)
        (not (= (read$0 next$0 sk_l1_1$0) b$0))
        (not (in$0 sk_l1_1$0 sk_?X_3$0)) (not (in$0 b$0 sk_?X_3$0)))))

(assert (or (not Axiom_3$0)
    (or (= (read$0 prev$0 b$0) d_5$0) (not (= (read$0 next$0 d_5$0) b$0))
        (not (in$0 d_5$0 sk_?X_3$0)) (not (in$0 b$0 sk_?X_3$0)))))

(assert (or (not Axiom_3$0)
    (or (= (read$0 prev$0 sk_l2_1$0) b$0)
        (not (= (read$0 next$0 b$0) sk_l2_1$0)) (not (in$0 b$0 sk_?X_3$0))
        (not (in$0 sk_l2_1$0 sk_?X_3$0)))))

(assert (or (not Axiom_3$0)
    (or (= (read$0 prev$0 sk_l2_1$0) sk_l1_1$0)
        (not (= (read$0 next$0 sk_l1_1$0) sk_l2_1$0))
        (not (in$0 sk_l1_1$0 sk_?X_3$0)) (not (in$0 sk_l2_1$0 sk_?X_3$0)))))

(assert (or (not Axiom_3$0)
    (or (= (read$0 prev$0 sk_l2_1$0) d_5$0)
        (not (= (read$0 next$0 d_5$0) sk_l2_1$0))
        (not (in$0 d_5$0 sk_?X_3$0)) (not (in$0 sk_l2_1$0 sk_?X_3$0)))))

(assert (or (not Axiom_3$0)
    (or (= (read$0 prev$0 d_5$0) b$0) (not (= (read$0 next$0 b$0) d_5$0))
        (not (in$0 b$0 sk_?X_3$0)) (not (in$0 d_5$0 sk_?X_3$0)))))

(assert (or (not Axiom_3$0)
    (or (= (read$0 prev$0 d_5$0) sk_l1_1$0)
        (not (= (read$0 next$0 sk_l1_1$0) d_5$0))
        (not (in$0 sk_l1_1$0 sk_?X_3$0)) (not (in$0 d_5$0 sk_?X_3$0)))))

(assert (or (not Axiom_3$0)
    (or (= (read$0 prev$0 d_5$0) d_5$0) (not (= (read$0 next$0 d_5$0) d_5$0))
        (not (in$0 d_5$0 sk_?X_3$0)) (not (in$0 d_5$0 sk_?X_3$0)))))

(assert (or (not Axiom_4$0)
    (or (= (read$0 prev$0 b$0) b$0) (not (= (read$0 next$0 b$0) b$0))
        (not (in$0 b$0 sk_?X_4$0)) (not (in$0 b$0 sk_?X_4$0)))))

(assert (or (not Axiom_4$0)
    (or (= (read$0 prev$0 b$0) sk_l1_1$0)
        (not (= (read$0 next$0 sk_l1_1$0) b$0))
        (not (in$0 sk_l1_1$0 sk_?X_4$0)) (not (in$0 b$0 sk_?X_4$0)))))

(assert (or (not Axiom_4$0)
    (or (= (read$0 prev$0 b$0) d_5$0) (not (= (read$0 next$0 d_5$0) b$0))
        (not (in$0 d_5$0 sk_?X_4$0)) (not (in$0 b$0 sk_?X_4$0)))))
...
(assert (or (not Axiom_4$0)
    (or (= (read$0 prev$0 sk_l2_1$0) d_5$0)
        (not (= (read$0 next$0 d_5$0) sk_l2_1$0))
        (not (in$0 d_5$0 sk_?X_4$0)) (not (in$0 sk_l2_1$0 sk_?X_4$0)))))

(assert (or (not Axiom_4$0)
    (or (= (read$0 prev$0 d_5$0) b$0) (not (= (read$0 next$0 b$0) d_5$0))
        (not (in$0 b$0 sk_?X_4$0)) (not (in$0 d_5$0 sk_?X_4$0)))))

(assert (or (not Axiom_4$0)
    (or (= (read$0 prev$0 d_5$0) sk_l1_1$0)
        (not (= (read$0 next$0 sk_l1_1$0) d_5$0))
        (not (in$0 sk_l1_1$0 sk_?X_4$0)) (not (in$0 d_5$0 sk_?X_4$0)))))

(assert (or (not Axiom_4$0)
    (or (= (read$0 prev$0 d_5$0) d_5$0) (not (= (read$0 next$0 d_5$0) d_5$0))
        (not (in$0 d_5$0 sk_?X_4$0)) (not (in$0 d_5$0 sk_?X_4$0)))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x FP_Caller_1$0)) (not (in$0 x FP_4$0))
                 (not (in$0 x (union$0 FP_Caller_1$0 FP_4$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x (setenum$0 a$0)) (not (in$0 x Alloc$0)))
                 (not (in$0 x (setminus$0 Alloc$0 (setenum$0 a$0))))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x (setenum$0 a$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (setminus$0 FP$0 (setenum$0 a$0))))))))
...
(assert (= Alloc_2$0 (setminus$0 Alloc$0 (setenum$0 a$0))))
...
(assert (or
    (and (Btwn$0 next$0 c_5$0 null$0 null$0)
         ...
         Axiom_4$0)
    (not (dlseg_struct$0 sk_?X_4$0 next$0 prev$0 c_5$0 null$0 null$0 d_5$0))))

(assert (= FP_4$0 (setminus$0 FP$0 (setenum$0 a$0))))

(assert (= FP_Caller_final_2$0 (union$0 FP_Caller_1$0 FP_4$0)))
