...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 sk_?X_46$0 sk_?X_45$0))
                 (or (in$0 x sk_?X_46$0) (in$0 x sk_?X_45$0)))
            (and (not (in$0 x sk_?X_46$0)) (not (in$0 x sk_?X_45$0))
                 (not (in$0 x (union$0 sk_?X_46$0 sk_?X_45$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 sk_?X_50$0 sk_?X_49$0))
                 (or (in$0 x sk_?X_50$0) (in$0 x sk_?X_49$0)))
            (and (not (in$0 x sk_?X_50$0)) (not (in$0 x sk_?X_49$0))
                 (not (in$0 x (union$0 sk_?X_50$0 sk_?X_49$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x sk_?X_46$0) (in$0 x sk_?X_45$0)
                 (in$0 x (intersection$0 sk_?X_46$0 sk_?X_45$0)))
            (and (or (not (in$0 x sk_?X_46$0)) (not (in$0 x sk_?X_45$0)))
                 (not (in$0 x (intersection$0 sk_?X_46$0 sk_?X_45$0)))))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x sk_?X_50$0) (in$0 x sk_?X_49$0)
                 (in$0 x (intersection$0 sk_?X_50$0 sk_?X_49$0)))
            (and (or (not (in$0 x sk_?X_50$0)) (not (in$0 x sk_?X_49$0)))
                 (not (in$0 x (intersection$0 sk_?X_50$0 sk_?X_49$0)))))))
...
(assert (or (Btwn$0 next$0 curr_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_45$0 next$0 curr_init$0 null$0))))
...
(assert (= sk_?X_43$0 (union$0 sk_?X_47$0 sk_?X_45$0)))

(assert (= sk_?X_45$0 (lseg_domain$0 next$0 curr_init$0 null$0)))

(assert (= sk_?X_47$0 (union$0 sk_?X_50$0 sk_?X_48$0)))

(assert (= sk_?X_49$0 (setenum$0 prv_init$0)))
...
(assert (or (Btwn$0 next$0 res_init$0 prv_init$0 prv_init$0)
    (not (lseg_struct$0 sk_?X_50$0 next$0 res_init$0 prv_init$0))))
...
(assert (= sk_?X_46$0 emptyset$0))

(assert (= sk_?X_48$0 sk_?X_49$0))

(assert (= sk_?X_50$0 (lseg_domain$0 next$0 res_init$0 prv_init$0)))

(assert (or
    (and (= (read$0 next$0 prv_init$0) curr_init$0) (= emptyset$0 emptyset$0)
         (= emptyset$0 (intersection$0 sk_?X_47$0 sk_?X_45$0))
         (= emptyset$0 (intersection$0 sk_?X_50$0 sk_?X_48$0))
         (= sk_?X_43$0 FP$0)
         (lseg_struct$0 sk_?X_45$0 next$0 curr_init$0 null$0)
         (lseg_struct$0 sk_?X_50$0 next$0 res_init$0 prv_init$0))
    (and (= emptyset$0 emptyset$0)
         (= emptyset$0 (intersection$0 sk_?X_46$0 sk_?X_45$0))
         (= prv_init$0 null$0) (= res_init$0 curr_init$0) (= sk_?X_44$0 FP$0)
         (lseg_struct$0 sk_?X_45$0 next$0 curr_init$0 null$0))))

(assert (not (= prv_4$0 null$0)))
