...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x (setenum$0 curr_4$0)) (not (in$0 x Alloc$0)))
                 (not (in$0 x (setminus$0 Alloc$0 (setenum$0 curr_4$0))))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x (setenum$0 curr_4$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (setminus$0 FP$0 (setenum$0 curr_4$0))))))))
...
(assert (or (Btwn$0 next$0 lst_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_7$0 next$0 lst_init$0 null$0))))

(assert (= FP_3$0 (setminus$0 FP$0 (setenum$0 curr_4$0))))

(assert (= curr_2$0 curr_init$0))

(assert (= lst_2$0 lst_init$0))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X_7$0 (lseg_domain$0 next$0 lst_init$0 null$0)))

(assert (lseg_struct$0 sk_?X_7$0 next$0 lst_init$0 null$0))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 lst_3$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 lst_3$0 null$0)))))))

(assert (or (Btwn$0 next$0 lst_3$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_8$0 next$0 lst_3$0 null$0))))

(assert (= Alloc_2$0 (setminus$0 Alloc$0 (setenum$0 curr_4$0))))

(assert (= FP_Caller_2$0 (setminus$0 FP_Caller$0 FP$0)))

(assert (= curr_4$0 lst_2$0))
...
(assert (= sk_?X_8$0 (lseg_domain$0 next$0 lst_3$0 null$0)))

(assert (or (and (in$0 sk_?e_2$0 sk_FP_1$0) (not (in$0 sk_?e_2$0 FP_3$0)))
    (not (Btwn$0 next$0 lst_3$0 null$0 null$0))))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and
                 ...
                 (not (in$0 l1 (lseg_domain$0 next$0 lst_init$0 null$0)))))))
