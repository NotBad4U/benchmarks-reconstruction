...
(set-info :source |
  ...
  tests/spl/sl/rec_reverse.spl:27:9-35:A precondition for this call of rec_reverse_acc might not hold
...
(assert (= sk_?X_3$0 (lseg_domain$0 next$0 null$0 null$0)))
...
(assert (or (Btwn$0 next$0 null$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_3$0 next$0 null$0 null$0))))
