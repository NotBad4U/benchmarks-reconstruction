...
(set-info :source |
  ...
  tests/spl/sl/rec_copy.spl:19:4-20:Possible heap access through null or dangling reference
  |)
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 sk_?X_94$0 sk_?X_93$0))
                 (or (in$0 x sk_?X_94$0) (in$0 x sk_?X_93$0)))
            (and (not (in$0 x sk_?X_94$0)) (not (in$0 x sk_?X_93$0))
                 (not (in$0 x (union$0 sk_?X_94$0 sk_?X_93$0)))))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x sk_?X_94$0) (in$0 x sk_?X_93$0)
                 (in$0 x (intersection$0 sk_?X_94$0 sk_?X_93$0)))
            (and (or (not (in$0 x sk_?X_94$0)) (not (in$0 x sk_?X_93$0)))
                 (not (in$0 x (intersection$0 sk_?X_94$0 sk_?X_93$0)))))))
...
(assert (or (Btwn$0 next$0 acc$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_93$0 next$0 acc$0 null$0))))

(assert (= FP_Caller_4$0 (setminus$0 FP_Caller$0 FP$0)))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X_92$0 (union$0 sk_?X_94$0 sk_?X_93$0)))

(assert (= sk_?X_93$0 (lseg_domain$0 next$0 acc$0 null$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_94$0 next$0 lst_2$0 null$0))
...
(assert (or (Btwn$0 next$0 lst_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_94$0 next$0 lst_2$0 null$0))))

(assert (= old_lst_2$0 lst_2$0))

(assert (= emptyset$0 (intersection$0 sk_?X_94$0 sk_?X_93$0)))

(assert (= sk_?X_92$0 FP$0))

(assert (= sk_?X_94$0 (lseg_domain$0 next$0 lst_2$0 null$0)))

(assert (lseg_struct$0 sk_?X_93$0 next$0 acc$0 null$0))

(assert (not (= lst_2$0 null$0)))

(assert (not (in$0 lst_2$0 FP$0)))
