...
(set-info :source |
  ...
  tests/spl/sl/sl_remove.spl:14:4-16:A postcondition of procedure remove might not hold at this return point
...
(assert (or (Btwn$0 next$0 res_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_1$0 next$0 res_2$0 null$0))))

(assert (= FP_Caller_final_2$0 (union$0 FP_Caller_1$0 FP$0)))

(assert (= res_2$0 null$0))
