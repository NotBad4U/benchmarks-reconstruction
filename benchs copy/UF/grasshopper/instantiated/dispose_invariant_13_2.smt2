...
(set-info :source |
  ...
  tests/spl/sl/sl_dispose.spl:13:2:An invariant might not hold before entering a loop in procedure dispose
  tests/spl/sl/sl_dispose.spl:14:14-29:Related location: This is the loop invariant that might not hold initially
  |)
