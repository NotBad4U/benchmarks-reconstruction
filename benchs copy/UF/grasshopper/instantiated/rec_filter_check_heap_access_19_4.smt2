...
(set-info :source |
  ...
  tests/spl/sl/rec_filter.spl:19:4-17:Possible heap access through null or dangling reference
  |)
...
(assert (or (not Axiom_2$0)
    (or (= (read$0 next$0 x$0) (read$0 next_2$0 x$0))
        (not (in$0 x$0 (setminus$0 Alloc$0 FP_4$0))))))
...
(assert (or (not Axiom_1$0)
    (forall ((?y Loc) (?z Loc))
            (or (and (Btwn$0 next$0 x$0 ?z ?y) (Btwn$0 next_2$0 x$0 ?z ?y))
                ...
                (not
                     (or (Btwn$0 next$0 x$0 ?y (ep$0 next$0 FP_4$0 x$0))
                         (and (Btwn$0 next$0 x$0 ?y ?y)
                              (not
                                   (Btwn$0 next$0 x$0
                                     (ep$0 next$0 FP_4$0 x$0)
                                     (ep$0 next$0 FP_4$0 x$0))))))))))
...
(assert (or (not Axiom$0)
    (forall ((?y Loc) (?z Loc))
            (or (in$0 x$0 FP_4$0)
                ...
                (and (not (Btwn$0 next$0 x$0 ?z ?y))
                     (not (Btwn$0 next_2$0 x$0 ?z ?y)))
                (not (= x$0 (ep$0 next$0 FP_4$0 x$0)))))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 null$0 (ep$0 next$0 sk_?X_6$0 null$0) ?y)
            (not (Btwn$0 next$0 null$0 ?y ?y)) (not (in$0 ?y sk_?X_6$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 n1_3$0 (ep$0 next$0 sk_?X_6$0 n1_3$0) ?y)
            (not (Btwn$0 next$0 n1_3$0 ?y ?y)) (not (in$0 ?y sk_?X_6$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 n2_2$0 (ep$0 next$0 sk_?X_6$0 n2_2$0) ?y)
            (not (Btwn$0 next$0 n2_2$0 ?y ?y)) (not (in$0 ?y sk_?X_6$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 x$0 (ep$0 next$0 sk_?X_6$0 x$0) ?y)
            (not (Btwn$0 next$0 x$0 ?y ?y)) (not (in$0 ?y sk_?X_6$0)))))

(assert (or (in$0 (ep$0 next$0 sk_?X_6$0 null$0) sk_?X_6$0)
    (= null$0 (ep$0 next$0 sk_?X_6$0 null$0))))

(assert (or (in$0 (ep$0 next$0 sk_?X_6$0 n1_3$0) sk_?X_6$0)
    (= n1_3$0 (ep$0 next$0 sk_?X_6$0 n1_3$0))))

(assert (or (in$0 (ep$0 next$0 sk_?X_6$0 n2_2$0) sk_?X_6$0)
    (= n2_2$0 (ep$0 next$0 sk_?X_6$0 n2_2$0))))

(assert (or (in$0 (ep$0 next$0 sk_?X_6$0 x$0) sk_?X_6$0)
    (= x$0 (ep$0 next$0 sk_?X_6$0 x$0))))

(assert (Btwn$0 next$0 null$0 (ep$0 next$0 sk_?X_6$0 null$0)
  (ep$0 next$0 sk_?X_6$0 null$0)))

(assert (Btwn$0 next$0 n1_3$0 (ep$0 next$0 sk_?X_6$0 n1_3$0)
  (ep$0 next$0 sk_?X_6$0 n1_3$0)))

(assert (Btwn$0 next$0 n2_2$0 (ep$0 next$0 sk_?X_6$0 n2_2$0)
  (ep$0 next$0 sk_?X_6$0 n2_2$0)))

(assert (Btwn$0 next$0 x$0 (ep$0 next$0 sk_?X_6$0 x$0) (ep$0 next$0 sk_?X_6$0 x$0)))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 sk_?X_6$0 FP$0))
                 (or (in$0 x sk_?X_6$0) (in$0 x FP$0)))
            (and (not (in$0 x sk_?X_6$0)) (not (in$0 x FP$0))
                 (not (in$0 x (union$0 sk_?X_6$0 FP$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x (union$0 (setminus$0 FP$0 FP_4$0) sk_?X_5$0))
                 (or (in$0 x (setminus$0 FP$0 FP_4$0)) (in$0 x sk_?X_5$0)))
            (and (not (in$0 x (setminus$0 FP$0 FP_4$0)))
                 (not (in$0 x sk_?X_5$0))
                 (not (in$0 x (union$0 (setminus$0 FP$0 FP_4$0) sk_?X_5$0)))))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x Alloc_3$0) (in$0 x sk_?X_6$0)
                 (in$0 x (intersection$0 Alloc_3$0 sk_?X_6$0)))
            (and (or (not (in$0 x Alloc_3$0)) (not (in$0 x sk_?X_6$0)))
                 (not (in$0 x (intersection$0 Alloc_3$0 sk_?X_6$0)))))))

(assert (forall ((x Loc))
        (or
            (and (in$0 x Alloc$0) (in$0 x (setminus$0 Alloc$0 sk_?X_6$0))
                 (not (in$0 x sk_?X_6$0)))
            (and (or (in$0 x sk_?X_6$0) (not (in$0 x Alloc$0)))
                 (not (in$0 x (setminus$0 Alloc$0 sk_?X_6$0)))))))
...
(assert (forall ((x Loc))
        (or
            (and (in$0 x FP$0) (in$0 x (setminus$0 FP$0 sk_?X_6$0))
                 (not (in$0 x sk_?X_6$0)))
            (and (or (in$0 x sk_?X_6$0) (not (in$0 x FP$0)))
                 (not (in$0 x (setminus$0 FP$0 sk_?X_6$0)))))))
...
(assert (or (Btwn$0 next$0 n1_3$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_6$0 next$0 n1_3$0 null$0))))

(assert (or (Btwn$0 next_2$0 n2_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_5$0 next_2$0 n2_2$0 null$0))))
...
(assert (lseg_struct$0 sk_?X_5$0 next_2$0 n2_2$0 null$0))

(assert (= sk_?X_6$0 (lseg_domain$0 next$0 n1_3$0 null$0)))

(assert (lseg_struct$0 sk_?X_6$0 next$0 n1_3$0 null$0))

(assert (= sk_?X_7$0 (lseg_domain$0 next$0 x$0 null$0)))

(assert (lseg_struct$0 sk_?X_7$0 next$0 x$0 null$0))

(assert (not (in$0 null$0 Alloc$0)))

(assert (not (in$0 x$0 FP_5$0)))
...
(assert (or (Btwn$0 next$0 x$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_7$0 next$0 x$0 null$0))))
...
(assert (= sk_?X_5$0 (lseg_domain$0 next_2$0 n2_2$0 null$0)))

(assert (= sk_?X_6$0 FP_4$0))

(assert (= FP$0 (union$0 FP_4$0 FP$0)))

(assert (= sk_?X_7$0 FP$0))
