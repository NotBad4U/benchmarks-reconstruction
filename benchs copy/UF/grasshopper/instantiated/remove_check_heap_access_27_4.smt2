...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_14$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (intersection$0 sk_?X_14$0 FP$0)))))))
...
(assert (or (Btwn$0 next$0 curr_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_12$0 next$0 curr_2$0 null$0))))

(assert (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_15$0 next$0 lst$0 null$0))))

(assert (or (Btwn$0 next$0 lst_1$0 curr_3$0 curr_3$0)
    (not (lseg_struct$0 sk_?X_7$0 next$0 lst_1$0 curr_3$0))))
...
(assert (= sk_?X_7$0 (lseg_domain$0 next$0 lst_1$0 curr_3$0)))

(assert (= sk_?X_9$0 (lseg_domain$0 next$0 curr_3$0 null$0)))

(assert (= sk_?X_10$0 (union$0 sk_?X_8$0 sk_?X_9$0)))

(assert (lseg_struct$0 sk_?X_9$0 next$0 curr_3$0 null$0))

(assert (= emptyset$0 emptyset$0))

(assert (= sk_?X_11$0 (union$0 sk_?X_13$0 sk_?X_12$0)))

(assert (= sk_?X_12$0 (lseg_domain$0 next$0 curr_2$0 null$0)))

(assert (= sk_?X_14$0 (lseg_domain$0 next$0 lst$0 curr_2$0)))

(assert (lseg_struct$0 sk_?X_12$0 next$0 curr_2$0 null$0))

(assert (not (= curr_2$0 null$0)))

(assert (= sk_?X_15$0 (lseg_domain$0 next$0 lst$0 null$0)))

(assert (lseg_struct$0 sk_?X_15$0 next$0 lst$0 null$0))
...
(assert (or (Btwn$0 next$0 curr_3$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_9$0 next$0 curr_3$0 null$0))))

(assert (or (Btwn$0 next$0 lst$0 curr_2$0 curr_2$0)
    (not (lseg_struct$0 sk_?X_14$0 next$0 lst$0 curr_2$0))))
...
(assert (lseg_struct$0 sk_?X_7$0 next$0 lst_1$0 curr_3$0))
...
(assert (= sk_?X_13$0 sk_?X_14$0))

(assert (= FP$0 (union$0 FP_1$0 FP$0)))

(assert (lseg_struct$0 sk_?X_14$0 next$0 lst$0 curr_2$0))
