...
(set-info :source |
  ...
  tests/spl/sls/sls_strand_sort.spl:72:2-19:Possible heap access through null or dangling reference
  |)
...
(assert (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_147$0 next$0 lst$0 null$0))))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X_146$0 sk_?X_147$0))

(assert (= sk_?X_147$0 (lseg_domain$0 next$0 lst$0 null$0)))

(assert (lseg_struct$0 sk_?X_147$0 next$0 lst$0 null$0))
