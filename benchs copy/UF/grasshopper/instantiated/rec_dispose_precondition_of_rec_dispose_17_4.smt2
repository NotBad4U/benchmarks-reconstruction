...
(set-info :source |
  ...
  tests/spl/sl/rec_dispose.spl:17:4-18:A precondition for this call of rec_dispose might not hold
  tests/spl/sl/rec_dispose.spl:10:11-26:Related location: This is the precondition that might not hold
  |)
...
(assert (= Alloc_1$0 (setminus$0 Alloc$0 (setenum$0 lst$0))))
...
(assert (or (Btwn$0 next$0 n_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_3$0 next$0 n_2$0 null$0))))

(assert (= FP_1$0 (setminus$0 FP$0 (setenum$0 lst$0))))

(assert (= n_2$0 (read$0 next$0 lst$0)))

(assert (= sk_?X_2$0 FP$0))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (= sk_?X_3$0 (lseg_domain$0 next$0 n_2$0 null$0)))

(assert (or (and (in$0 sk_?e$0 sk_FP$0) (not (in$0 sk_?e$0 FP_1$0)))
    (not (Btwn$0 next$0 n_2$0 null$0 null$0))))
