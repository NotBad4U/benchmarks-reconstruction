...
(set-info :source |
  ...
  tests/spl/sl/rec_traverse.spl:16:4-19:A precondition for this call of rec_traverse might not hold
  tests/spl/sl/rec_traverse.spl:10:11-26:Related location: This is the precondition that might not hold
  |)
...
(assert (or (Btwn$0 next$0 lst$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_1$0 next$0 lst$0 null$0))))

(assert (= FP_Caller_1$0 (setminus$0 FP_Caller$0 FP$0)))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X_1$0 (lseg_domain$0 next$0 lst$0 null$0)))

(assert (lseg_struct$0 sk_?X_1$0 next$0 lst$0 null$0))
...
(assert (or (Btwn$0 next$0 n_2$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_2$0 next$0 n_2$0 null$0))))

(assert (= n_2$0 (read$0 next$0 lst$0)))

(assert (= sk_?X_1$0 FP$0))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (= sk_?X_2$0 (lseg_domain$0 next$0 n_2$0 null$0)))

(assert (or (and (in$0 sk_?e$0 sk_FP$0) (not (in$0 sk_?e$0 FP$0)))
