...
(assert (or (not Axiom_8$0)
    (or (= (read$0 prev$0 null$0) null$0)
        ...
        (not (in$0 null$0 sk_?X_13$0)) (not (in$0 null$0 sk_?X_13$0)))))

(assert (or (not Axiom_8$0)
    (or (= (read$0 prev$0 null$0) end1$0)
        (not (= (read$0 next$0 end1$0) null$0))
        (not (in$0 end1$0 sk_?X_13$0)) (not (in$0 null$0 sk_?X_13$0)))))

(assert (or (not Axiom_8$0)
    (or (= (read$0 prev$0 null$0) end2$0)
        (not (= (read$0 next$0 end2$0) null$0))
        (not (in$0 end2$0 sk_?X_13$0)) (not (in$0 null$0 sk_?X_13$0)))))

(assert (or (not Axiom_8$0)
    (or (= (read$0 prev$0 start1$0) null$0)
        (not (= (read$0 next$0 null$0) start1$0))
        (not (in$0 null$0 sk_?X_13$0)) (not (in$0 start1$0 sk_?X_13$0)))))

(assert (or (not Axiom_8$0)
    (or (= (read$0 prev$0 start1$0) end1$0)
        (not (= (read$0 next$0 end1$0) start1$0))
        (not (in$0 end1$0 sk_?X_13$0)) (not (in$0 start1$0 sk_?X_13$0)))))

(assert (or (not Axiom_8$0)
    (or (= (read$0 prev$0 start1$0) end2$0)
        (not (= (read$0 next$0 end2$0) start1$0))
        (not (in$0 end2$0 sk_?X_13$0)) (not (in$0 start1$0 sk_?X_13$0)))))

(assert (or (not Axiom_8$0)
    (or (= (read$0 prev$0 start2$0) null$0)
        (not (= (read$0 next$0 null$0) start2$0))
        (not (in$0 null$0 sk_?X_13$0)) (not (in$0 start2$0 sk_?X_13$0)))))

(assert (or (not Axiom_8$0)
    (or (= (read$0 prev$0 start2$0) end1$0)
        (not (= (read$0 next$0 end1$0) start2$0))
        (not (in$0 end1$0 sk_?X_13$0)) (not (in$0 start2$0 sk_?X_13$0)))))

(assert (or (not Axiom_8$0)
    (or (= (read$0 prev$0 start2$0) end2$0)
        (not (= (read$0 next$0 end2$0) start2$0))
        (not (in$0 end2$0 sk_?X_13$0)) (not (in$0 start2$0 sk_?X_13$0)))))

(assert (or (not Axiom_9$0)
    (or (= (read$0 prev$0 null$0) null$0)
        (not (= (read$0 next$0 null$0) null$0))
        (not (in$0 null$0 sk_?X_12$0)) (not (in$0 null$0 sk_?X_12$0)))))

(assert (or (not Axiom_9$0)
    (or (= (read$0 prev$0 null$0) end1$0)
        (not (= (read$0 next$0 end1$0) null$0))
        (not (in$0 end1$0 sk_?X_12$0)) (not (in$0 null$0 sk_?X_12$0)))))

(assert (or (not Axiom_9$0)
    (or (= (read$0 prev$0 null$0) end2$0)
        (not (= (read$0 next$0 end2$0) null$0))
        (not (in$0 end2$0 sk_?X_12$0)) (not (in$0 null$0 sk_?X_12$0)))))

(assert (or (not Axiom_9$0)
    (or (= (read$0 prev$0 start1$0) null$0)
        (not (= (read$0 next$0 null$0) start1$0))
        (not (in$0 null$0 sk_?X_12$0)) (not (in$0 start1$0 sk_?X_12$0)))))

(assert (or (not Axiom_9$0)
    (or (= (read$0 prev$0 start1$0) end1$0)
        (not (= (read$0 next$0 end1$0) start1$0))
        (not (in$0 end1$0 sk_?X_12$0)) (not (in$0 start1$0 sk_?X_12$0)))))

(assert (or (not Axiom_9$0)
    (or (= (read$0 prev$0 start1$0) end2$0)
        (not (= (read$0 next$0 end2$0) start1$0))
        (not (in$0 end2$0 sk_?X_12$0)) (not (in$0 start1$0 sk_?X_12$0)))))

(assert (or (not Axiom_9$0)
    (or (= (read$0 prev$0 start2$0) null$0)
        (not (= (read$0 next$0 null$0) start2$0))
        (not (in$0 null$0 sk_?X_12$0)) (not (in$0 start2$0 sk_?X_12$0)))))

(assert (or (not Axiom_9$0)
    (or (= (read$0 prev$0 start2$0) end1$0)
        (not (= (read$0 next$0 end1$0) start2$0))
        (not (in$0 end1$0 sk_?X_12$0)) (not (in$0 start2$0 sk_?X_12$0)))))

(assert (or (not Axiom_9$0)
    (or (= (read$0 prev$0 start2$0) end2$0)
        (not (= (read$0 next$0 end2$0) start2$0))
        (not (in$0 end2$0 sk_?X_12$0)) (not (in$0 start2$0 sk_?X_12$0)))))
...
(assert (or (= end2$0 end1$0)
    (= (read$0 next$0 end2$0)
      (read$0 (write$0 next$0 end1$0 start2$0) end2$0))))
...
(assert (= sk_?X_12$0 (dlseg_domain$0 next$0 prev$0 start2$0 null$0 null$0 end2$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (dlseg_struct$0 sk_?X_13$0 next$0 prev$0 start1$0 null$0 null$0 end1$0))

(assert (not (= start2$0 null$0)))

(assert (not (in$0 start2$0 FP$0)))
...
(assert (= sk_?X_13$0 (dlseg_domain$0 next$0 prev$0 start1$0 null$0 null$0 end1$0)))

(assert (dlseg_struct$0 sk_?X_12$0 next$0 prev$0 start2$0 null$0 null$0 end2$0))
