...
(assert (forall ((?y Loc))
        (or (not (Btwn$0 next$0 n_3$0 ?y ?y)) (= n_3$0 ?y)
            (Btwn$0 next$0 n_3$0 (read$0 next$0 n_3$0) ?y))))
...
(assert (forall ((?y Loc))
        (or (not (= (read$0 next$0 n_3$0) n_3$0))
            (not (Btwn$0 next$0 n_3$0 ?y ?y)) (= n_3$0 ?y))))

(assert (Btwn$0 next$0 null$0 (read$0 next$0 null$0) (read$0 next$0 null$0)))

(assert (Btwn$0 next$0 n_3$0 (read$0 next$0 n_3$0) (read$0 next$0 n_3$0)))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x FP_Caller_1$0)) (not (in$0 x FP_1$0))
                 (not (in$0 x (union$0 FP_Caller_1$0 FP_1$0)))))))
...
(assert (= (read$0 (write$0 next$0 n_3$0 null$0) n_3$0) null$0))

(assert (or (= null$0 n_3$0)
    (= (read$0 next$0 null$0) (read$0 (write$0 next$0 n_3$0 null$0) null$0))))

(assert (or (= n_3$0 n_3$0)
    (= (read$0 next$0 n_3$0) (read$0 (write$0 next$0 n_3$0 null$0) n_3$0))))
...
(assert (= FP_Caller_final_1$0 (union$0 FP_Caller_1$0 FP_1$0)))

(assert (= next_1$0 (write$0 next$0 n_3$0 null$0)))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next_1$0 res_2$0 l1 null$0)))
                 (not (in$0 l1 (lseg_set_domain$0 next_1$0 res_2$0 null$0)))))))
...
(assert (forall ((l1 Loc))
        (or
            (and (Btwn$0 next_1$0 res_2$0 l1 null$0)
                 ...
                 (not (= l1 null$0)))
            (and (or (= l1 null$0) (not (Btwn$0 next_1$0 res_2$0 l1 null$0)))
                 (not (in$0 l1 (lseg_set_X$0 next_1$0 res_2$0 null$0)))))))
             ...
             (or
                 ...
                 (and (not (= n_3$0 ?v))
                      ...
                      (or (Btwn$0 next$0 null$0 ?v n_3$0)
                          (and (Btwn$0 next$0 null$0 ?v ?v)
                               (not (Btwn$0 next$0 null$0 n_3$0 n_3$0)))))
                 (not (Btwn$0 (write$0 next$0 n_3$0 null$0) ?z ?u ?v))))))
