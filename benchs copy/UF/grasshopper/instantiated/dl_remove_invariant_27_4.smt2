...
(assert (or (not Axiom_6$0)
    (or (= (read$0 prev$0 prv_2$0) sk_l1_2$0)
        ...
        (not (in$0 sk_l1_2$0 sk_?X_9$0)) (not (in$0 prv_2$0 sk_?X_9$0)))))

(assert (or (not Axiom_6$0)
    (or (= (read$0 prev$0 prv_2$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) prv_2$0))
        (not (in$0 prv_2$0 sk_?X_9$0)) (not (in$0 prv_2$0 sk_?X_9$0)))))

(assert (or (not Axiom_7$0)
    (or (= (read$0 prev$0 curr_2$0) d_1$0)
        (not (= (read$0 next$0 d_1$0) curr_2$0)) (not (in$0 d_1$0 sk_?X_7$0))
        (not (in$0 curr_2$0 sk_?X_7$0)))))

(assert (or (not Axiom_7$0)
    (or (= (read$0 prev$0 curr_2$0) sk_l1_2$0)
        (not (= (read$0 next$0 sk_l1_2$0) curr_2$0))
        (not (in$0 sk_l1_2$0 sk_?X_7$0)) (not (in$0 curr_2$0 sk_?X_7$0)))))

(assert (or (not Axiom_7$0)
    (or (= (read$0 prev$0 curr_2$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) curr_2$0))
        (not (in$0 prv_2$0 sk_?X_7$0)) (not (in$0 curr_2$0 sk_?X_7$0)))))

(assert (or (not Axiom_7$0)
    (or (= (read$0 prev$0 sk_l2_2$0) d_1$0)
        (not (= (read$0 next$0 d_1$0) sk_l2_2$0))
        (not (in$0 d_1$0 sk_?X_7$0)) (not (in$0 sk_l2_2$0 sk_?X_7$0)))))

(assert (or (not Axiom_7$0)
    (or (= (read$0 prev$0 sk_l2_2$0) sk_l1_2$0)
        (not (= (read$0 next$0 sk_l1_2$0) sk_l2_2$0))
        (not (in$0 sk_l1_2$0 sk_?X_7$0)) (not (in$0 sk_l2_2$0 sk_?X_7$0)))))

(assert (or (not Axiom_7$0)
    (or (= (read$0 prev$0 sk_l2_2$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) sk_l2_2$0))
        (not (in$0 prv_2$0 sk_?X_7$0)) (not (in$0 sk_l2_2$0 sk_?X_7$0)))))

(assert (or (not Axiom_7$0)
    (or (= (read$0 prev$0 prv_2$0) d_1$0)
        (not (= (read$0 next$0 d_1$0) prv_2$0)) (not (in$0 d_1$0 sk_?X_7$0))
        (not (in$0 prv_2$0 sk_?X_7$0)))))

(assert (or (not Axiom_7$0)
    (or (= (read$0 prev$0 prv_2$0) sk_l1_2$0)
        (not (= (read$0 next$0 sk_l1_2$0) prv_2$0))
        (not (in$0 sk_l1_2$0 sk_?X_7$0)) (not (in$0 prv_2$0 sk_?X_7$0)))))

(assert (or (not Axiom_7$0)
    (or (= (read$0 prev$0 prv_2$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) prv_2$0))
        (not (in$0 prv_2$0 sk_?X_7$0)) (not (in$0 prv_2$0 sk_?X_7$0)))))
...
(assert (or (not Axiom_5$0)
    (or (= (read$0 prev$0 curr_2$0) sk_l1_2$0)
        (not (= (read$0 next$0 sk_l1_2$0) curr_2$0))
        (not (in$0 sk_l1_2$0 sk_?X_5$0)) (not (in$0 curr_2$0 sk_?X_5$0)))))

(assert (or (not Axiom_5$0)
    (or (= (read$0 prev$0 curr_2$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) curr_2$0))
        (not (in$0 prv_2$0 sk_?X_5$0)) (not (in$0 curr_2$0 sk_?X_5$0)))))

(assert (or (not Axiom_5$0)
    (or (= (read$0 prev$0 sk_l2_2$0) d_1$0)
        (not (= (read$0 next$0 d_1$0) sk_l2_2$0))
        (not (in$0 d_1$0 sk_?X_5$0)) (not (in$0 sk_l2_2$0 sk_?X_5$0)))))

(assert (or (not Axiom_5$0)
    (or (= (read$0 prev$0 sk_l2_2$0) sk_l1_2$0)
        (not (= (read$0 next$0 sk_l1_2$0) sk_l2_2$0))
        (not (in$0 sk_l1_2$0 sk_?X_5$0)) (not (in$0 sk_l2_2$0 sk_?X_5$0)))))

(assert (or (not Axiom_5$0)
    (or (= (read$0 prev$0 sk_l2_2$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) sk_l2_2$0))
        (not (in$0 prv_2$0 sk_?X_5$0)) (not (in$0 sk_l2_2$0 sk_?X_5$0)))))

(assert (or (not Axiom_5$0)
    (or (= (read$0 prev$0 prv_2$0) d_1$0)
        (not (= (read$0 next$0 d_1$0) prv_2$0)) (not (in$0 d_1$0 sk_?X_5$0))
        (not (in$0 prv_2$0 sk_?X_5$0)))))

(assert (or (not Axiom_5$0)
    (or (= (read$0 prev$0 prv_2$0) sk_l1_2$0)
        (not (= (read$0 next$0 sk_l1_2$0) prv_2$0))
        (not (in$0 sk_l1_2$0 sk_?X_5$0)) (not (in$0 prv_2$0 sk_?X_5$0)))))

(assert (or (not Axiom_5$0)
    (or (= (read$0 prev$0 prv_2$0) prv_2$0)
        (not (= (read$0 next$0 prv_2$0) prv_2$0))
        (not (in$0 prv_2$0 sk_?X_5$0)) (not (in$0 prv_2$0 sk_?X_5$0)))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_8$0)) (not (in$0 x FP$0))
                 (not (in$0 x (union$0 sk_?X_8$0 FP$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_8$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (intersection$0 sk_?X_8$0 FP$0)))))))
...
(assert (= sk_?X_5$0 FP$0))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (= sk_?X_6$0 (union$0 sk_?X_8$0 sk_?X_7$0)))

(assert (= sk_?X_8$0 sk_?X_9$0))

(assert (= sk_FP$0 sk_?X_6$0))
...
(assert (or
    (and (Btwn$0 next$0 a$0 null$0 null$0)
         ...
         Axiom_5$0)
    (not (dlseg_struct$0 sk_?X_5$0 next$0 prev$0 a$0 null$0 null$0 b$0))))
...
(assert (= sk_?X_5$0 (dlseg_domain$0 next$0 prev$0 a$0 null$0 null$0 b$0)))

(assert (dlseg_struct$0 sk_?X_5$0 next$0 prev$0 a$0 null$0 null$0 b$0))

(assert (= sk_?X_7$0 (dlseg_domain$0 next$0 prev$0 curr_2$0 prv_2$0 null$0 d_1$0)))
