...
(set-info :source |
  ...
  tests/spl/sl/sl_dispose.spl:19:4-15:This deallocation might be unsafe
  |)
...
(assert (or (Btwn$0 next$0 lst_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_6$0 next$0 lst_init$0 null$0))))
...
(assert (= sk_?X_6$0 (lseg_domain$0 next$0 lst_init$0 null$0)))

(assert (lseg_struct$0 sk_?X_6$0 next$0 lst_init$0 null$0))
