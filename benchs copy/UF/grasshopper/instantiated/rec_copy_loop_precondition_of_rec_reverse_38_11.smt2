...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_FP_1$0)) (not (in$0 x sk_?X_25$0))
                 (not (in$0 x (union$0 sk_FP_1$0 sk_?X_25$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_FP_1$0)) (not (in$0 x sk_?X_25$0)))
                 (not (in$0 x (intersection$0 sk_FP_1$0 sk_?X_25$0)))))))
...
(assert (or (Btwn$0 next$0 cp$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_26$0 next$0 cp$0 null$0))))

(assert (or (Btwn$0 next$0 curr$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_25$0 next$0 curr$0 null$0))))
...
(assert (= sk_?X_26$0 (lseg_domain$0 next$0 cp$0 null$0)))

(assert (lseg_struct$0 sk_?X_25$0 next$0 curr$0 null$0))

(assert (= sk_?X_27$0 (lseg_domain$0 next$0 cp$0 null$0)))

(assert (or (and (in$0 sk_?e_2$0 sk_FP_1$0) (not (in$0 sk_?e_2$0 FP$0)))
    (not (Btwn$0 next$0 cp$0 null$0 null$0))))
...
(assert (or (Btwn$0 next$0 cp$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_27$0 next$0 cp$0 null$0))))
...
(assert (= sk_?X_25$0 (lseg_domain$0 next$0 curr$0 null$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_26$0 next$0 cp$0 null$0))
