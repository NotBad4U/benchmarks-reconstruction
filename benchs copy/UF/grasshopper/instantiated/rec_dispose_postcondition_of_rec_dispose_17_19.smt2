...
(assert (or (in$0 (ep$0 next$0 FP_2$0 lst$0) FP_2$0)
    (= lst$0 (ep$0 next$0 FP_2$0 lst$0))))

(assert (or (in$0 (ep$0 next$0 FP_2$0 n_2$0) FP_2$0)
    (= n_2$0 (ep$0 next$0 FP_2$0 n_2$0))))

(assert (or (in$0 (ep$0 next$0 FP_2$0 sk_?e_1$0) FP_2$0)
    (= sk_?e_1$0 (ep$0 next$0 FP_2$0 sk_?e_1$0))))
...
(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 lst$0 (ep$0 next$0 FP_2$0 lst$0) ?y)
            (not (Btwn$0 next$0 lst$0 ?y ?y)) (not (in$0 ?y FP_2$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 n_2$0 (ep$0 next$0 FP_2$0 n_2$0) ?y)
            (not (Btwn$0 next$0 n_2$0 ?y ?y)) (not (in$0 ?y FP_2$0)))))

(assert (forall ((?y Loc))
        (or (Btwn$0 next$0 sk_?e_1$0 (ep$0 next$0 FP_2$0 sk_?e_1$0) ?y)
            (not (Btwn$0 next$0 sk_?e_1$0 ?y ?y)) (not (in$0 ?y FP_2$0)))))

(assert (Btwn$0 next$0 null$0 (ep$0 next$0 FP_2$0 null$0)
  (ep$0 next$0 FP_2$0 null$0)))

(assert (Btwn$0 next$0 lst$0 (ep$0 next$0 FP_2$0 lst$0) (ep$0 next$0 FP_2$0 lst$0)))

(assert (Btwn$0 next$0 n_2$0 (ep$0 next$0 FP_2$0 n_2$0) (ep$0 next$0 FP_2$0 n_2$0)))

(assert (Btwn$0 next$0 sk_?e_1$0 (ep$0 next$0 FP_2$0 sk_?e_1$0)
  (ep$0 next$0 FP_2$0 sk_?e_1$0)))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x FP_2$0)) (not (in$0 x FP_1$0))
                 (not (in$0 x (union$0 FP_2$0 FP_1$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x Alloc_2$0)) (not (in$0 x FP_2$0)))
                 (not (in$0 x (intersection$0 Alloc_2$0 FP_2$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x (setenum$0 lst$0)) (not (in$0 x Alloc$0)))
                 (not (in$0 x (setminus$0 Alloc$0 (setenum$0 lst$0))))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x (setenum$0 lst$0)) (not (in$0 x FP$0)))
                 (not (in$0 x (setminus$0 FP$0 (setenum$0 lst$0))))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (in$0 x FP_2$0) (not (in$0 x FP_1$0)))
                 (not (in$0 x (setminus$0 FP_1$0 FP_2$0)))))))
...
(assert (= sk_?X_4$0 (lseg_domain$0 next$0 lst$0 null$0)))

(assert (lseg_struct$0 sk_?X_4$0 next$0 lst$0 null$0))
