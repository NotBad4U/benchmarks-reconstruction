...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x sk_?X_18$0)) (not (in$0 x sk_?X_17$0))
                 (not (in$0 x (union$0 sk_?X_18$0 sk_?X_17$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (not (in$0 x FP_Caller_2$0)) (not (in$0 x FP$0))
                 (not (in$0 x (union$0 FP_Caller_2$0 FP$0)))))))
...
(assert (forall ((x Loc))
        (or
            ...
            (and (or (not (in$0 x sk_?X_18$0)) (not (in$0 x sk_?X_17$0)))
                 (not (in$0 x (intersection$0 sk_?X_18$0 sk_?X_17$0)))))))
...
(assert (or (Btwn$0 next$0 curr$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_17$0 next$0 curr$0 null$0))))

(assert (or (Btwn$0 next$0 rev$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_18$0 next$0 rev$0 null$0))))

(assert (= FP_Caller_final_4$0 (union$0 FP_Caller_2$0 FP$0)))

(assert (= res_6$0 rev$0))

(assert (= emptyset$0 (intersection$0 sk_?X_18$0 sk_?X_17$0)))

(assert (= sk_?X_16$0 FP$0))

(assert (= sk_?X_18$0 (lseg_domain$0 next$0 rev$0 null$0)))

(assert (lseg_struct$0 sk_?X_17$0 next$0 curr$0 null$0))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and (or (= l1 null$0) (not (Btwn$0 next$0 res_6$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 res_6$0 null$0)))))))

(assert (or (Btwn$0 next$0 res_6$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_19$0 next$0 res_6$0 null$0))))
...
(assert (= sk_?X_16$0 (union$0 sk_?X_18$0 sk_?X_17$0)))

(assert (= sk_?X_17$0 (lseg_domain$0 next$0 curr$0 null$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_18$0 next$0 rev$0 null$0))
...
(assert (or
    ...
    (not (Btwn$0 next$0 res_6$0 null$0 null$0))))
