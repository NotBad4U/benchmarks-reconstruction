...
(set-info :source |
  ...
  tests/spl/sl/rec_reverse.spl:17:4-21:Possible heap access through null or dangling reference
  |)
...
(assert (or (Btwn$0 next$0 rev$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_22$0 next$0 rev$0 null$0))))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X_20$0 (union$0 sk_?X_22$0 sk_?X_21$0)))

(assert (= sk_?X_21$0 (lseg_domain$0 next$0 curr$0 null$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_22$0 next$0 rev$0 null$0))
...
(assert (or (Btwn$0 next$0 curr$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_21$0 next$0 curr$0 null$0))))
...
(assert (= sk_?X_22$0 (lseg_domain$0 next$0 rev$0 null$0)))

(assert (lseg_struct$0 sk_?X_21$0 next$0 curr$0 null$0))

(assert (not (= curr$0 null$0)))

(assert (not (in$0 curr$0 FP$0)))
