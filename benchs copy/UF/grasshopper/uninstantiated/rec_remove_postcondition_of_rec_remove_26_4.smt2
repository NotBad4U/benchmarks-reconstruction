...
(assert (= (ep$0 next$0 FP_1$0 sk_?e_3$0) t_12$0))

(assert (= (ep$0 next$0 FP_1$0 res_1$0) t_11$0))

(assert (= (ep$0 next$0 FP_1$0 n2_2$0) t_10$0))

(assert (= (ep$0 next$0 FP_1$0 n1_2$0) t_9$0))

(assert (= (ep$0 next$0 FP_1$0 lst$0) t_8$0))

(assert (= (ep$0 next$0 FP_1$0 null$0) t_7$0))

(assert (= (read$0 next_1$0 lst$0) t_6$0))

(assert (= (read$0 (write$0 next_1$0 lst$0 n2_2$0) lst$0) t_5$0))
