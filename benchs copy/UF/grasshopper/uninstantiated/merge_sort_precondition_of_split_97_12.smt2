...
(set-info :source |
  ...
  tests/spl/sls/sls_merge_sort.spl:97:12-20:A precondition for this call of split might not hold
  tests/spl/sls/sls_merge_sort.spl:66:11-24:Related location: This is the precondition that might not hold
  |)
...
(declare-fun sk_?X_168$0 () SetLoc)
(declare-fun sk_?X_169$0 () SetLoc)
...
(assert (or (Btwn$0 next$0 x$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_168$0 next$0 x$0 null$0))))

(assert (= FP_Caller_3$0 (setminus$0 FP_Caller$0 FP$0)))

(assert (= sk_?X_168$0 FP$0))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (= sk_?X_169$0 (lseg_domain$0 next$0 x$0 null$0)))

(assert (or (and (in$0 sk_?e$0 sk_FP_4$0) (not (in$0 sk_?e$0 FP$0)))
    (not (Btwn$0 next$0 x$0 null$0 null$0))))
...
(assert (or (Btwn$0 next$0 x$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_169$0 next$0 x$0 null$0))))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X_168$0 (lseg_domain$0 next$0 x$0 null$0)))

(assert (lseg_struct$0 sk_?X_168$0 next$0 x$0 null$0))

(assert (= sk_FP_4$0 sk_?X_169$0))
