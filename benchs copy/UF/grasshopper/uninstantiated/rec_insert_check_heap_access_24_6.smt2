...
(assert (= (ep$0 next$0 FP_1$0 n2_2$0) t_6$0))

(assert (= (ep$0 next$0 FP_1$0 n1_2$0) t_5$0))

(assert (= (ep$0 next$0 FP_1$0 lst$0) t_4$0))

(assert (= (ep$0 next$0 FP_1$0 null$0) t_3$0))

(assert (= (read$0 next_1$0 lst$0) t_2$0))

(assert (= (read$0 next_1$0 elt$0) t_1$0))
