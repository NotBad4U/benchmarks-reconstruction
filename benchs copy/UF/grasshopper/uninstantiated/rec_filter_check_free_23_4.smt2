...
(assert (or (Btwn$0 next$0 x$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_13$0 next$0 x$0 null$0))))

(assert (= n1_2$0 (read$0 next$0 x$0)))

(assert (= sk_?X_13$0 FP$0))
...
(assert (= sk_?X_13$0 (lseg_domain$0 next$0 x$0 null$0)))

(assert (lseg_struct$0 sk_?X_13$0 next$0 x$0 null$0))
