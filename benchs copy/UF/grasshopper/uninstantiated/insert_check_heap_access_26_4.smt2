...
(assert (= (ep$0 next$0 FP_1$0 lst_1$0) t_17$0))

(assert (= (ep$0 next$0 FP_1$0 lst$0) t_16$0))

(assert (= (ep$0 next$0 FP_1$0 curr_3$0) t_15$0))

(assert (= (ep$0 next$0 FP_1$0 curr_2$0) t_14$0))

(assert (= (ep$0 next$0 FP_1$0 null$0) t_13$0))

(assert (= (read$0 (write$0 next$0 elt$0 (read$0 next$0 curr_3$0)) elt$0) t_12$0))

(assert (= (read$0 (write$0 next$0 elt$0 (read$0 next$0 curr_3$0)) curr_3$0) t_11$0))

(assert (forall ((?d_5 Loc) (?x Loc) (?y Loc))
        (or (= ?y ?x)
            (= (read$0 next$0 ?y) (read$0 (write$0 next$0 ?x ?d_5) ?y)))))

(assert (forall ((?d_5 Loc) (?x Loc)) (= (read$0 (write$0 next$0 ?x ?d_5) ?x) ?d_5)))
