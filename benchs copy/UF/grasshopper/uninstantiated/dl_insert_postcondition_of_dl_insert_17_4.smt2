...
(assert (= (read$0 prev$0 sk_l2$0) t_6$0))

(assert (= (read$0 prev$0 elt$0) t_5$0))

(assert (= (read$0 prev$0 c_5$0) t_4$0))

(assert (= (read$0 (write$0 prev$0 elt$0 null$0) sk_l2$0) t_3$0))

(assert (= (read$0 (write$0 prev$0 elt$0 null$0) elt$0) t_2$0))

(assert (= (read$0 (write$0 prev$0 elt$0 null$0) c_5$0) t_1$0))

(assert (= (read$0 (write$0 prev$0 elt$0 null$0) a$0) t$0))

(assert (forall ((?d_2 Loc) (?x Loc) (?y Loc))
        (or (= ?y ?x)
            (= (read$0 prev$0 ?y) (read$0 (write$0 prev$0 ?x ?d_2) ?y)))))

(assert (forall ((?d_2 Loc) (?x Loc)) (= (read$0 (write$0 prev$0 ?x ?d_2) ?x) ?d_2)))
...
(assert (or (not Axiom_2$0)
    (forall ((l1 Loc) (l2 Loc))
            (or (= (read$0 prev_3$0 l2) l1) (not (= (read$0 next$0 l1) l2))
