...
(assert (= (ep$0 next$0 FP_1$0 sk_?e_2$0) t_14$0))

(assert (= (ep$0 next$0 FP_1$0 res_1$0) t_13$0))

(assert (= (ep$0 next$0 FP_1$0 curr_3$0) t_12$0))

(assert (= (ep$0 next$0 FP_1$0 curr_2$0) t_11$0))

(assert (= (ep$0 next$0 FP_1$0 b$0) t_10$0))

(assert (= (ep$0 next$0 FP_1$0 a_1$0) t_9$0))

(assert (= (ep$0 next$0 FP_1$0 a$0) t_8$0))

(assert (= (ep$0 next$0 FP_1$0 null$0) t_7$0))

(assert (= (read$0 (write$0 next$0 curr_3$0 b$0) curr_3$0) t_6$0))

(assert (forall ((?d_4 Loc) (?x Loc) (?y Loc))
        (or (= ?y ?x)
            (= (read$0 next$0 ?y) (read$0 (write$0 next$0 ?x ?d_4) ?y)))))

(assert (forall ((?d_4 Loc) (?x Loc)) (= (read$0 (write$0 next$0 ?x ?d_4) ?x) ?d_4)))
