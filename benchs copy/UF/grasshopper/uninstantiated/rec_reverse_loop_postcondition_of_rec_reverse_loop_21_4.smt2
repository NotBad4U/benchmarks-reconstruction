...
(assert (= (ep$0 next_6$0 FP_10$0 sk_?e_10$0) t_49$0))

(assert (= (ep$0 next_6$0 FP_10$0 res_13$0) t_48$0))

(assert (= (ep$0 next_6$0 FP_10$0 res_12$0) t_47$0))

(assert (= (ep$0 next_6$0 FP_10$0 old_lst_2$0) t_46$0))

(assert (= (ep$0 next_6$0 FP_10$0 lst_3$0) t_45$0))

(assert (= (ep$0 next_6$0 FP_10$0 lst_2$0) t_44$0))

(assert (= (ep$0 next_6$0 FP_10$0 acc$0) t_43$0))

(assert (= (ep$0 next_6$0 FP_10$0 null$0) t_42$0))

(assert (= (read$0 next$0 old_lst_2$0) t_41$0))

(assert (= (read$0 (write$0 next$0 old_lst_2$0 acc$0) old_lst_2$0) t_40$0))

(assert (= (read$0 (write$0 next$0 old_lst_2$0 acc$0) lst_2$0) t_39$0))

(assert (forall ((?d_19 Loc) (?x Loc) (?y Loc))
        (or (= ?y ?x)
            (= (read$0 next$0 ?y) (read$0 (write$0 next$0 ?x ?d_19) ?y)))))

(assert (forall ((?d_19 Loc) (?x Loc))
        (= (read$0 (write$0 next$0 ?x ?d_19) ?x) ?d_19)))
...
(assert (or (not Axiom_12$0)
    (forall ((?x Loc) (?y Loc) (?z Loc))
            (or (in$0 ?x FP_10$0)
                (and (Btwn$0 next_6$0 ?x ?z ?y) (Btwn$0 next_7$0 ?x ?z ?y))
                (and (not (Btwn$0 next_6$0 ?x ?z ?y))
                     (not (Btwn$0 next_7$0 ?x ?z ?y)))
                (not (= ?x (ep$0 next_6$0 FP_10$0 ?x)))))))

(assert (or (not Axiom_13$0)
    (forall ((?x Loc) (?y Loc) (?z Loc))
            (or (and (Btwn$0 next_6$0 ?x ?z ?y) (Btwn$0 next_7$0 ?x ?z ?y))
                (and (not (Btwn$0 next_6$0 ?x ?z ?y))
                     (not (Btwn$0 next_7$0 ?x ?z ?y)))
                (not
                     (or (Btwn$0 next_6$0 ?x ?y (ep$0 next_6$0 FP_10$0 ?x))
                         (and (Btwn$0 next_6$0 ?x ?y ?y)
                              (not
                                   (Btwn$0 next_6$0 ?x
                                     (ep$0 next_6$0 FP_10$0 ?x)
                                     (ep$0 next_6$0 FP_10$0 ?x))))))))))

(assert (or (not Axiom_14$0)
    (forall ((?x Loc))
            (or (= (read$0 next_6$0 ?x) (read$0 next_7$0 ?x))
                (not (in$0 ?x (setminus$0 Alloc$0 FP_10$0)))))))
