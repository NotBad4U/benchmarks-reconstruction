...
(assert (or (Btwn$0 next$0 n1_3$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_4$0 next$0 n1_3$0 null$0))))
...
(assert (= sk_?X_4$0 (lseg_domain$0 next$0 n1_3$0 null$0)))

(assert (or (and (in$0 sk_?e_1$0 sk_FP$0) (not (in$0 sk_?e_1$0 FP$0)))
    (not (Btwn$0 next$0 n1_3$0 null$0 null$0))))
...
(assert (or (Btwn$0 next$0 x$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_3$0 next$0 x$0 null$0))))

(assert (= n1_3$0 (read$0 next$0 x$0)))

(assert nondet_1$0)

(assert (= sk_?X_3$0 (lseg_domain$0 next$0 x$0 null$0)))

(assert (lseg_struct$0 sk_?X_3$0 next$0 x$0 null$0))
