...
(assert (= (read$0 next$0 prv_4$0) t_42$0))

(assert (= (read$0 (write$0 next$0 prv_4$0 curr_5$0) prv_init$0) t_41$0))

(assert (= (read$0 (write$0 next$0 prv_4$0 curr_5$0) prv_4$0) t_40$0))

(assert (= (read$0 (write$0 next$0 prv_4$0 curr_5$0) d_init$0) t_39$0))

(assert (= (read$0 (write$0 next$0 prv_4$0 curr_5$0) curr_4$0) t_38$0))
