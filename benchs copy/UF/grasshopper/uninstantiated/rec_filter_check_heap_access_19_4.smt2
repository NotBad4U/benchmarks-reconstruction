...
(assert (= (ep$0 next$0 FP_4$0 x$0) t_4$0))

(assert (= (ep$0 next$0 FP_4$0 n2_2$0) t_3$0))

(assert (= (ep$0 next$0 FP_4$0 n1_3$0) t_2$0))

(assert (= (ep$0 next$0 FP_4$0 null$0) t_1$0))

(assert (= (read$0 next_2$0 x$0) t$0))
