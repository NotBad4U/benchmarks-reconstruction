...
(assert (= (ep$0 next$0 FP_6$0 sk_?e_3$0) t_10$0))

(assert (= (ep$0 next$0 FP_6$0 res_9$0) t_9$0))

(assert (= (ep$0 next$0 FP_6$0 res_8$0) t_8$0))

(assert (= (ep$0 next$0 FP_6$0 curr$0) t_7$0))

(assert (= (ep$0 next$0 FP_6$0 cp$0) t_6$0))

(assert (= (ep$0 next$0 FP_6$0 null$0) t_5$0))
