...
(assert (= (ep$0 next$0 FP_1$0 sk_?e_1$0) t_5$0))

(assert (= (ep$0 next$0 FP_1$0 lst_2$0) t_4$0))

(assert (= (ep$0 next$0 FP_1$0 lst$0) t_3$0))

(assert (= (ep$0 next$0 FP_1$0 curr_4$0) t_2$0))

(assert (= (ep$0 next$0 FP_1$0 curr_3$0) t_1$0))
