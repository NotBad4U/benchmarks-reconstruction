...
(assert (= (read$0 prev$0 start_1$0) t_13$0))

(assert (= (read$0 prev$0 sk_l2_2$0) t_12$0))

(assert (= (read$0 next$0 sk_l1_2$0) t_11$0))

(assert (= (read$0 next$0 end_1$0) t_10$0))

(assert (= (read$0 (write$0 prev$0 start2$0 end1$0) start2$0) t_9$0))

(assert (= (read$0 (write$0 prev$0 start2$0 end1$0) start1$0) t_8$0))

(assert (= (read$0 (write$0 prev$0 start2$0 end1$0) start_1$0) t_7$0))

(assert (= (read$0 (write$0 prev$0 start2$0 end1$0) sk_l2_2$0) t_6$0))

(assert (= (read$0 (write$0 next$0 end1$0 start2$0) sk_l1_2$0) t_5$0))

(assert (= (read$0 (write$0 next$0 end1$0 start2$0) end2$0) t_4$0))

(assert (= (read$0 (write$0 next$0 end1$0 start2$0) end1$0) t_3$0))

(assert (= (read$0 (write$0 next$0 end1$0 start2$0) end_1$0) t_2$0))

(assert (forall ((?d_7 Loc) (?x Loc) (?y Loc))
        (or (= ?y ?x)
            (= (read$0 prev$0 ?y) (read$0 (write$0 prev$0 ?x ?d_7) ?y)))))

(assert (forall ((?d_7 Loc) (?x Loc)) (= (read$0 (write$0 prev$0 ?x ?d_7) ?x) ?d_7)))
