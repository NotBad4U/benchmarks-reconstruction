...
(set-info :source |
  ...
  tests/spl/sl/sl_dispose.spl:18:4-20:Possible heap access through null or dangling reference
  |)
...
(assert (= sk_?X_5$0 (lseg_domain$0 next$0 lst_init$0 null$0)))

(assert (lseg_struct$0 sk_?X_5$0 next$0 lst_init$0 null$0))
...
(assert (or (Btwn$0 next$0 lst_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_5$0 next$0 lst_init$0 null$0))))
