...
(assert (= (ep$0 prev$0 FP_1$0 prv_3$0) t_43$0))

(assert (= (ep$0 prev$0 FP_1$0 prv_2$0) t_42$0))

(assert (= (ep$0 prev$0 FP_1$0 d_2$0) t_41$0))

(assert (= (ep$0 prev$0 FP_1$0 d_1$0) t_40$0))

(assert (= (ep$0 prev$0 FP_1$0 curr_3$0) t_39$0))

(assert (= (ep$0 prev$0 FP_1$0 curr_2$0) t_38$0))

(assert (= (ep$0 prev$0 FP_1$0 c_2$0) t_37$0))

(assert (= (ep$0 prev$0 FP_1$0 c_1$0) t_36$0))

(assert (= (ep$0 prev$0 FP_1$0 b$0) t_35$0))

(assert (= (ep$0 prev$0 FP_1$0 a$0) t_34$0))

(assert (= (ep$0 prev$0 FP_1$0 null$0) t_33$0))

(assert (= (ep$0 next$0 FP_1$0 prv_3$0) t_32$0))

(assert (= (ep$0 next$0 FP_1$0 prv_2$0) t_31$0))

(assert (= (ep$0 next$0 FP_1$0 d_2$0) t_30$0))

(assert (= (ep$0 next$0 FP_1$0 d_1$0) t_29$0))

(assert (= (ep$0 next$0 FP_1$0 curr_3$0) t_28$0))

(assert (= (ep$0 next$0 FP_1$0 curr_2$0) t_27$0))

(assert (= (ep$0 next$0 FP_1$0 c_2$0) t_26$0))

(assert (= (ep$0 next$0 FP_1$0 c_1$0) t_25$0))

(assert (= (ep$0 next$0 FP_1$0 b$0) t_24$0))

(assert (= (ep$0 next$0 FP_1$0 a$0) t_23$0))
...
(assert (or (not Axiom_13$0)
    (forall ((l1 Loc) (l2 Loc))
            (or (= (read$0 prev$0 l2) l1) (not (= (read$0 next$0 l1) l2))
                (not (in$0 l1 sk_?X_27$0)) (not (in$0 l2 sk_?X_27$0))))))
...
(assert (or (not Axiom_17$0)
    (forall ((l1 Loc) (l2 Loc))
            (or (= (read$0 prev$0 l2) l1) (not (= (read$0 next$0 l1) l2))
                (not (in$0 l1 sk_?X_21$0)) (not (in$0 l2 sk_?X_21$0))))))
