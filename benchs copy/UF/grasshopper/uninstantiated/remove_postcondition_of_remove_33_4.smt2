...
(assert (= (ep$0 next$0 FP_1$0 sk_?e_2$0) t_32$0))

(assert (= (ep$0 next$0 FP_1$0 res_1$0) t_31$0))

(assert (= (ep$0 next$0 FP_1$0 lst_1$0) t_30$0))

(assert (= (ep$0 next$0 FP_1$0 lst$0) t_29$0))

(assert (= (ep$0 next$0 FP_1$0 curr_3$0) t_28$0))

(assert (= (ep$0 next$0 FP_1$0 curr_2$0) t_27$0))

(assert (= (ep$0 next$0 FP_1$0 null$0) t_26$0))

(assert (= (read$0 (write$0 next$0 curr_3$0 (read$0 next$0 tmp_2$0)) tmp_2$0) t_25$0))
