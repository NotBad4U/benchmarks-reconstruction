...
(assert (= (read$0 (write$0 next$0 elt$0 lst$0) elt$0) t$0))

(assert (forall ((?d_3 Loc) (?x Loc) (?y Loc))
        (or (= ?y ?x)
            (= (read$0 next$0 ?y) (read$0 (write$0 next$0 ?x ?d_3) ?y)))))

(assert (forall ((?d_3 Loc) (?x Loc)) (= (read$0 (write$0 next$0 ?x ?d_3) ?x) ?d_3)))
