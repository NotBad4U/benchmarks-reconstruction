...
(assert (= (read$0 next$0 n_3$0) t_4$0))

(assert (= (read$0 (write$0 next$0 n_3$0 null$0) n_3$0) t_3$0))

(assert (forall ((?d_1 Loc) (?x Loc) (?y Loc))
        (or (= ?y ?x)
            (= (read$0 next$0 ?y) (read$0 (write$0 next$0 ?x ?d_1) ?y)))))

(assert (forall ((?d_1 Loc) (?x Loc)) (= (read$0 (write$0 next$0 ?x ?d_1) ?x) ?d_1)))
