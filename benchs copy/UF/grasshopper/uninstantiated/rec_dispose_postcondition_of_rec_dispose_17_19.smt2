...
(assert (= (ep$0 next$0 FP_2$0 sk_?e_1$0) t_3$0))

(assert (= (ep$0 next$0 FP_2$0 n_2$0) t_2$0))

(assert (= (ep$0 next$0 FP_2$0 lst$0) t_1$0))

(assert (= (ep$0 next$0 FP_2$0 null$0) t$0))
