...
(assert (= (ep$0 prev$0 FP_1$0 tmp_2$0) t_95$0))

(assert (= (ep$0 prev$0 FP_1$0 prv_3$0) t_94$0))

(assert (= (ep$0 prev$0 FP_1$0 prv_2$0) t_93$0))

(assert (= (ep$0 prev$0 FP_1$0 d_2$0) t_92$0))

(assert (= (ep$0 prev$0 FP_1$0 d_1$0) t_91$0))

(assert (= (ep$0 prev$0 FP_1$0 curr_3$0) t_90$0))

(assert (= (ep$0 prev$0 FP_1$0 curr_2$0) t_89$0))

(assert (= (ep$0 prev$0 FP_1$0 c_2$0) t_88$0))

(assert (= (ep$0 prev$0 FP_1$0 c_1$0) t_87$0))

(assert (= (ep$0 prev$0 FP_1$0 b$0) t_86$0))

(assert (= (ep$0 prev$0 FP_1$0 a$0) t_85$0))

(assert (= (ep$0 prev$0 FP_1$0 null$0) t_84$0))

(assert (= (ep$0 next$0 FP_1$0 tmp_2$0) t_83$0))
...
(assert (= (read$0 (write$0 next$0 prv_3$0 (read$0 next$0 curr_3$0)) prv_3$0) t_71$0))

(assert (= (read$0 (write$0 next$0 prv_3$0 (read$0 next$0 curr_3$0)) prv_2$0) t_70$0))

(assert (= (read$0 (write$0 next$0 prv_3$0 (read$0 next$0 curr_3$0)) d_2$0) t_69$0))

(assert (= (read$0 (write$0 next$0 prv_3$0 (read$0 next$0 curr_3$0)) d_1$0) t_68$0))

(assert (= (read$0 (write$0 next$0 prv_3$0 (read$0 next$0 curr_3$0)) curr_3$0)
  t_67$0))

(assert (= (read$0 (write$0 next$0 prv_3$0 (read$0 next$0 curr_3$0)) b$0) t_66$0))
...
(assert (or (not Axiom_26$0)
    (forall ((l1 Loc) (l2 Loc))
            (or (= (read$0 prev$0 l2) l1) (not (= (read$0 next$0 l1) l2))
                (not (in$0 l1 sk_?X_42$0)) (not (in$0 l2 sk_?X_42$0))))))
...
(assert (or (not Axiom_23$0)
    (forall ((l1 Loc) (l2 Loc))
            (or (= (read$0 prev$0 l2) l1) (not (= (read$0 next$0 l1) l2))
                (not (in$0 l1 sk_?X_45$0)) (not (in$0 l2 sk_?X_45$0))))))
...
(assert (or (not Axiom_25$0)
    (forall ((l1 Loc) (l2 Loc))
            (or (= (read$0 prev$0 l2) l1) (not (= (read$0 next$0 l1) l2))
                (not (in$0 l1 sk_?X_37$0)) (not (in$0 l2 sk_?X_37$0))))))
