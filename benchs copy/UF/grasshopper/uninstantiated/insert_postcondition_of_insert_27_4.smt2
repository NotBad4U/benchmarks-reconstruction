...
(assert (= (ep$0 next$0 FP_1$0 sk_?e_2$0) t_28$0))

(assert (= (ep$0 next$0 FP_1$0 res_1$0) t_27$0))

(assert (= (ep$0 next$0 FP_1$0 lst_1$0) t_26$0))

(assert (= (ep$0 next$0 FP_1$0 lst$0) t_25$0))

(assert (= (ep$0 next$0 FP_1$0 curr_3$0) t_24$0))

(assert (= (ep$0 next$0 FP_1$0 curr_2$0) t_23$0))

(assert (= (ep$0 next$0 FP_1$0 null$0) t_22$0))

(assert (= (read$0 next_1$0 curr_3$0) t_21$0))

(assert (= (read$0 (write$0 next_1$0 curr_3$0 elt$0) curr_3$0) t_20$0))

(assert (= (read$0 (write$0 next$0 elt$0 (read$0 next$0 curr_3$0)) elt$0) t_19$0))

(assert (= (read$0 (write$0 next$0 elt$0 (read$0 next$0 curr_3$0)) curr_3$0) t_18$0))

(assert (forall ((?d_8 Loc) (?x Loc) (?y Loc))
        (or (= ?y ?x)
            (= (read$0 next_1$0 ?y) (read$0 (write$0 next_1$0 ?x ?d_8) ?y)))))

(assert (forall ((?d_8 Loc) (?x Loc))
        (= (read$0 (write$0 next_1$0 ?x ?d_8) ?x) ?d_8)))
