...
(assert (= (read$0 next$0 tmp_4$0) t_9$0))

(assert (= (read$0 (write$0 next$0 tmp_4$0 rev_3$0) tmp_4$0) t_8$0))

(assert (= (read$0 (write$0 next$0 tmp_4$0 rev_3$0) curr_4$0) t_7$0))
