...
(assert (= (ep$0 next_4$0 FP_6$0 y$0) t_32$0))

(assert (= (ep$0 next_4$0 FP_6$0 x_1$0) t_31$0))

(assert (= (ep$0 next_4$0 FP_6$0 t_2$0) t_30$0))

(assert (= (ep$0 next_4$0 FP_6$0 null$0) t_29$0))

(assert (= (ep$0 next$0 FP_4$0 y$0) t_28$0))

(assert (= (ep$0 next$0 FP_4$0 x_1$0) t_27$0))

(assert (= (ep$0 next$0 FP_4$0 t_2$0) t_26$0))

(assert (= (ep$0 next$0 FP_4$0 null$0) t_25$0))

(assert (= (read$0 next_5$0 root_x_1$0) t_24$0))
