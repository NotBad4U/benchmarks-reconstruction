...
(assert (= (ep$0 prev$0 FP_1$0 sk_?e$0) t_11$0))

(assert (= (ep$0 prev$0 FP_1$0 b_1$0) t_10$0))

(assert (= (ep$0 prev$0 FP_1$0 b$0) t_9$0))

(assert (= (ep$0 prev$0 FP_1$0 a_1$0) t_8$0))

(assert (= (ep$0 prev$0 FP_1$0 a$0) t_7$0))

(assert (= (ep$0 prev$0 FP_1$0 null$0) t_6$0))

(assert (= (ep$0 next$0 FP_1$0 sk_?e$0) t_5$0))

(assert (= (ep$0 next$0 FP_1$0 b_1$0) t_4$0))
