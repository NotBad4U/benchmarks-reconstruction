...
(assert (= (ep$0 next$0 FP_1$0 tmp_2$0) t_10$0))

(assert (= (ep$0 next$0 FP_1$0 lst_1$0) t_9$0))

(assert (= (ep$0 next$0 FP_1$0 lst$0) t_8$0))

(assert (= (ep$0 next$0 FP_1$0 curr_3$0) t_7$0))

(assert (= (ep$0 next$0 FP_1$0 curr_2$0) t_6$0))

(assert (= (ep$0 next$0 FP_1$0 null$0) t_5$0))
