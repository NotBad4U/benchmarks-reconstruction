...
(assert (= (ep$0 next_2$0 FP_3$0 tmp_2$0) t_13$0))

(assert (= (ep$0 next_2$0 FP_3$0 sk_?e_4$0) t_12$0))

(assert (= (ep$0 next_2$0 FP_3$0 rev$0) t_11$0))

(assert (= (ep$0 next_2$0 FP_3$0 res_5$0) t_10$0))

(assert (= (ep$0 next_2$0 FP_3$0 res_4$0) t_9$0))

(assert (= (ep$0 next_2$0 FP_3$0 curr$0) t_8$0))

(assert (= (ep$0 next_2$0 FP_3$0 null$0) t_7$0))

(assert (= (read$0 (write$0 next$0 curr$0 rev$0) curr$0) t_6$0))
    ...
    (forall ((?x Loc) (?y Loc) (?z Loc))
            (or (and (Btwn$0 next_2$0 ?x ?z ?y) (Btwn$0 next_3$0 ?x ?z ?y))
                (and (not (Btwn$0 next_2$0 ?x ?z ?y))
                     (not (Btwn$0 next_3$0 ?x ?z ?y)))
                (not
                     (or (Btwn$0 next_2$0 ?x ?y (ep$0 next_2$0 FP_3$0 ?x))
                         (and (Btwn$0 next_2$0 ?x ?y ?y)
                              (not
                                   (Btwn$0 next_2$0 ?x
                                     (ep$0 next_2$0 FP_3$0 ?x)
                                     (ep$0 next_2$0 FP_3$0 ?x))))))))))
