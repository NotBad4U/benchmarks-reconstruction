...
(assert (= (read$0 next$0 tmp_4$0) t_37$0))

(assert (= (read$0 (write$0 next$0 tmp_4$0 prv_4$0) tmp_4$0) t_36$0))

(assert (= (read$0 (write$0 next$0 tmp_4$0 prv_4$0) start_init$0) t_35$0))

(assert (= (read$0 (write$0 next$0 tmp_4$0 prv_4$0) end_init$0) t_34$0))

(assert (= (read$0 (write$0 next$0 tmp_4$0 prv_4$0) curr_4$0) t_33$0))
