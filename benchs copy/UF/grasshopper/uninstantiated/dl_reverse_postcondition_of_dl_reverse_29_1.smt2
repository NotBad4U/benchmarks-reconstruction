...
(assert (= (ep$0 prev$0 FP_1$0 start_1$0) t_32$0))

(assert (= (ep$0 prev$0 FP_1$0 start$0) t_31$0))

(assert (= (ep$0 prev$0 FP_1$0 sk_l2_1$0) t_30$0))

(assert (= (ep$0 prev$0 FP_1$0 sk_l1_1$0) t_29$0))

(assert (= (ep$0 prev$0 FP_1$0 prv_3$0) t_28$0))

(assert (= (ep$0 prev$0 FP_1$0 prv_2$0) t_27$0))

(assert (= (ep$0 prev$0 FP_1$0 end_1$0) t_26$0))

(assert (= (ep$0 prev$0 FP_1$0 end$0) t_25$0))

(assert (= (ep$0 prev$0 FP_1$0 curr_3$0) t_24$0))

(assert (= (ep$0 prev$0 FP_1$0 curr_2$0) t_23$0))

(assert (= (ep$0 prev$0 FP_1$0 null$0) t_22$0))

(assert (= (ep$0 next$0 FP_1$0 start_1$0) t_21$0))

(assert (= (ep$0 next$0 FP_1$0 start$0) t_20$0))

(assert (= (ep$0 next$0 FP_1$0 sk_l2_1$0) t_19$0))

(assert (= (ep$0 next$0 FP_1$0 sk_l1_1$0) t_18$0))

(assert (= (ep$0 next$0 FP_1$0 prv_3$0) t_17$0))

(assert (= (ep$0 next$0 FP_1$0 prv_2$0) t_16$0))

(assert (= (ep$0 next$0 FP_1$0 end_1$0) t_15$0))

(assert (= (ep$0 next$0 FP_1$0 end$0) t_14$0))

(assert (= (ep$0 next$0 FP_1$0 curr_3$0) t_13$0))

(assert (= (ep$0 next$0 FP_1$0 curr_2$0) t_12$0))

(assert (= (ep$0 next$0 FP_1$0 null$0) t_11$0))

(assert (= (read$0 prev_1$0 start$0) t_10$0))

(assert (= (read$0 prev_1$0 prv_2$0) t_9$0))

(assert (= (read$0 prev_1$0 curr_2$0) t_8$0))

(assert (= (read$0 prev$0 sk_l2_1$0) t_7$0))

(assert (= (read$0 prev$0 prv_3$0) t_6$0))

(assert (= (read$0 prev$0 end$0) t_5$0))

(assert (= (read$0 prev$0 curr_3$0) t_4$0))

(assert (= (read$0 next_1$0 end$0) t_3$0))

(assert (= (read$0 next$0 start_1$0) t_2$0))

(assert (= (read$0 next$0 sk_l1_1$0) t_1$0))

(assert (= (read$0 next$0 end_1$0) t$0))
