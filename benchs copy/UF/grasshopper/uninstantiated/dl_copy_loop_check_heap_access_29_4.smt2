...
(assert (= (read$0 next$0 d_4$0) t_46$0))

(assert (= (read$0 (write$0 next$0 d_4$0 null$0) old_curr_init$0) t_45$0))

(assert (= (read$0 (write$0 next$0 d_4$0 null$0) d_init$0) t_44$0))

(assert (= (read$0 (write$0 next$0 d_4$0 null$0) d_4$0) t_43$0))

(assert (= (read$0 (write$0 next$0 d_4$0 null$0) b_init$0) t_42$0))
