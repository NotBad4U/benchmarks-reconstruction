...
(assert (or (Btwn$0 next$0 curr_init$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_16$0 next$0 curr_init$0 null$0))))

(assert (or (Btwn$0 next$0 lst_init$0 curr_init$0 curr_init$0)
    (not (lseg_struct$0 sk_?X_17$0 next$0 lst_init$0 curr_init$0))))

(assert (= curr_5$0 curr_init$0))

(assert (= lst_3$0 lst_init$0))

(assert (= emptyset$0 (intersection$0 sk_?X_17$0 sk_?X_16$0)))

(assert (= sk_?X_15$0 FP$0))

(assert (= sk_?X_17$0 (lseg_domain$0 next$0 lst_init$0 curr_init$0)))

(assert (lseg_struct$0 sk_?X_16$0 next$0 curr_init$0 null$0))

(assert (= sk_?X_18$0 (union$0 sk_?X_20$0 sk_?X_19$0)))

(assert (= sk_?X_20$0 (lseg_domain$0 next$0 lst_3$0 curr_6$0)))
...
(assert (or (in$0 sk_?e_2$0 (intersection$0 sk_?X_20$0 sk_?X_19$0))
    ...
    (not (Btwn$0 next$0 lst_3$0 curr_6$0 curr_6$0))))
...
(assert (or (Btwn$0 next$0 curr_6$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_19$0 next$0 curr_6$0 null$0))))

(assert (or (Btwn$0 next$0 lst_3$0 curr_6$0 curr_6$0)
    (not (lseg_struct$0 sk_?X_20$0 next$0 lst_3$0 curr_6$0))))

(assert (= FP_Caller_2$0 (setminus$0 FP_Caller$0 FP$0)))

(assert (= curr_6$0 (read$0 next$0 curr_5$0)))

(assert (= Alloc$0 (union$0 FP_Caller$0 Alloc$0)))

(assert (= sk_?X_15$0 (union$0 sk_?X_17$0 sk_?X_16$0)))

(assert (= sk_?X_16$0 (lseg_domain$0 next$0 curr_init$0 null$0)))

(assert (= FP_Caller$0 (union$0 FP$0 FP_Caller$0)))

(assert (lseg_struct$0 sk_?X_17$0 next$0 lst_init$0 curr_init$0))

(assert (= sk_?X_19$0 (lseg_domain$0 next$0 curr_6$0 null$0)))
...
(assert (forall ((l1 Loc))
        (or
            ...
            (and
                 ...
                 (not (in$0 l1 (lseg_domain$0 next$0 lst_3$0 curr_6$0)))))))
