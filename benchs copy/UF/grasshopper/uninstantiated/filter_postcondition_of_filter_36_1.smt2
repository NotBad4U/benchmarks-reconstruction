...
(assert (= (ep$0 next$0 FP_1$0 x$0) t_8$0))

(assert (= (ep$0 next$0 FP_1$0 sk_?e_2$0) t_7$0))

(assert (= (ep$0 next$0 FP_1$0 res_2$0) t_6$0))

(assert (= (ep$0 next$0 FP_1$0 res_1$0) t_5$0))

(assert (= (ep$0 next$0 FP_1$0 curr_3$0) t_4$0))

(assert (= (ep$0 next$0 FP_1$0 curr_2$0) t_3$0))

(assert (= (ep$0 next$0 FP_1$0 null$0) t_2$0))

(assert (= (read$0 next_1$0 prv_2$0) t_1$0))

(assert (= (read$0 next$0 prv_3$0) t$0))
