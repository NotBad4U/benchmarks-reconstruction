...
(assert (= (read$0 next$0 curr$0) t_16$0))

(assert (= (read$0 next$0 cp_1$0) t_15$0))

(assert (= (read$0 (write$0 next$0 cp_1$0 old_cp_2$0) curr$0) t_14$0))

(assert (= (read$0 (write$0 next$0 cp_1$0 old_cp_2$0) cp_1$0) t_13$0))
