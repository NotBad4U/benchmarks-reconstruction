...
(assert (= (ep$0 next$0 FP_5$0 sk_?e_4$0) t_11$0))

(assert (= (ep$0 next$0 FP_5$0 lst_5$0) t_10$0))

(assert (= (ep$0 next$0 FP_5$0 lst_1$0) t_9$0))

(assert (= (ep$0 next$0 FP_5$0 curr_10$0) t_8$0))

(assert (= (ep$0 next$0 FP_5$0 curr_9$0) t_7$0))

(assert (= (ep$0 next$0 FP_5$0 null$0) t_6$0))
