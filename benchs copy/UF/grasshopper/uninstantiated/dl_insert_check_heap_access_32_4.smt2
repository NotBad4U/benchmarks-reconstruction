...
(assert (= (ep$0 prev$0 FP_1$0 prv_3$0) t_59$0))

(assert (= (ep$0 prev$0 FP_1$0 prv_2$0) t_58$0))

(assert (= (ep$0 prev$0 FP_1$0 d_2$0) t_57$0))

(assert (= (ep$0 prev$0 FP_1$0 d_1$0) t_56$0))

(assert (= (ep$0 prev$0 FP_1$0 curr_3$0) t_55$0))

(assert (= (ep$0 prev$0 FP_1$0 curr_2$0) t_54$0))

(assert (= (ep$0 prev$0 FP_1$0 c_2$0) t_53$0))

(assert (= (ep$0 prev$0 FP_1$0 c_1$0) t_52$0))

(assert (= (ep$0 prev$0 FP_1$0 b$0) t_51$0))

(assert (= (ep$0 prev$0 FP_1$0 a$0) t_50$0))

(assert (= (ep$0 prev$0 FP_1$0 null$0) t_49$0))

(assert (= (ep$0 next$0 FP_1$0 prv_3$0) t_48$0))

(assert (= (ep$0 next$0 FP_1$0 prv_2$0) t_47$0))

(assert (= (ep$0 next$0 FP_1$0 d_2$0) t_46$0))

(assert (= (ep$0 next$0 FP_1$0 d_1$0) t_45$0))

(assert (= (ep$0 next$0 FP_1$0 curr_3$0) t_44$0))

(assert (= (ep$0 next$0 FP_1$0 curr_2$0) t_43$0))

(assert (= (ep$0 next$0 FP_1$0 c_2$0) t_42$0))

(assert (= (ep$0 next$0 FP_1$0 c_1$0) t_41$0))

(assert (= (ep$0 next$0 FP_1$0 b$0) t_40$0))

(assert (= (ep$0 next$0 FP_1$0 a$0) t_39$0))

(assert (= (ep$0 next$0 FP_1$0 null$0) t_38$0))

(assert (= (read$0 (write$0 next$0 elt$0 curr_3$0) prv_3$0) t_37$0))

(assert (= (read$0 (write$0 next$0 elt$0 curr_3$0) prv_2$0) t_36$0))

(assert (= (read$0 (write$0 next$0 elt$0 curr_3$0) elt$0) t_35$0))

(assert (= (read$0 (write$0 next$0 elt$0 curr_3$0) d_2$0) t_34$0))

(assert (= (read$0 (write$0 next$0 elt$0 curr_3$0) d_1$0) t_33$0))

(assert (= (read$0 (write$0 next$0 elt$0 curr_3$0) curr_3$0) t_32$0))

(assert (= (read$0 (write$0 next$0 elt$0 curr_3$0) b$0) t_31$0))
...
(assert (or (not Axiom_11$0)
    (forall ((l1 Loc) (l2 Loc))
            (or (= (read$0 prev$0 l2) l1) (not (= (read$0 next$0 l1) l2))
                (not (in$0 l1 sk_?X_40$0)) (not (in$0 l2 sk_?X_40$0))))))
...
(assert (or (not Axiom_15$0)
    (forall ((l1 Loc) (l2 Loc))
            (or (= (read$0 prev$0 l2) l1) (not (= (read$0 next$0 l1) l2))
                (not (in$0 l1 sk_?X_31$0)) (not (in$0 l2 sk_?X_31$0))))))
...
(assert (or (not Axiom_14$0)
    (forall ((l1 Loc) (l2 Loc))
            (or (= (read$0 prev$0 l2) l1) (not (= (read$0 next$0 l1) l2))
                (not (in$0 l1 sk_?X_34$0)) (not (in$0 l2 sk_?X_34$0))))))
