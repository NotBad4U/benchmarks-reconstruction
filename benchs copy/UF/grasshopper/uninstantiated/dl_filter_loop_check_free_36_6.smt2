...
(assert (= (read$0 prev$0 curr_5$0) t_51$0))

(assert (= (read$0 next$0 prv_4$0) t_50$0))

(assert (= (read$0 (write$0 prev$0 curr_5$0 prv_4$0) curr_init$0) t_49$0))

(assert (= (read$0 (write$0 prev$0 curr_5$0 prv_4$0) curr_5$0) t_48$0))

(assert (= (read$0 (write$0 prev$0 curr_5$0 prv_4$0) c_init$0) t_47$0))

(assert (= (read$0 (write$0 next$0 prv_4$0 curr_5$0) prv_init$0) t_46$0))

(assert (= (read$0 (write$0 next$0 prv_4$0 curr_5$0) prv_4$0) t_45$0))

(assert (= (read$0 (write$0 next$0 prv_4$0 curr_5$0) d_init$0) t_44$0))

(assert (= (read$0 (write$0 next$0 prv_4$0 curr_5$0) curr_4$0) t_43$0))
