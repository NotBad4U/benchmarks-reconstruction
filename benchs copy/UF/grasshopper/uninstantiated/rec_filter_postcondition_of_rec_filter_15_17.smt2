...
(set-info :source |
  ...
  tests/spl/sl/rec_filter.spl:15:17-26:A postcondition of procedure rec_filter might not hold at this return point
...
(assert (or (Btwn$0 next$0 res_4$0 null$0 null$0)
    (not (lseg_struct$0 sk_?X_1$0 next$0 res_4$0 null$0))))
...
(assert (or
    (and (in$0 sk_?e$0 (lseg_domain$0 next$0 res_4$0 null$0))
         (not (in$0 sk_?e$0 sk_?X_1$0)))
    (and (in$0 sk_?e$0 sk_?X_1$0)
         (not (in$0 sk_?e$0 (lseg_domain$0 next$0 res_4$0 null$0))))
    (not (Btwn$0 next$0 res_4$0 null$0 null$0))))

(assert (forall ((l1 Loc))
        (or
            (and (Btwn$0 next$0 res_4$0 l1 null$0)
                 (in$0 l1 (lseg_domain$0 next$0 res_4$0 null$0))
                 (not (= l1 null$0)))
            (and (or (= l1 null$0) (not (Btwn$0 next$0 res_4$0 l1 null$0)))
                 (not (in$0 l1 (lseg_domain$0 next$0 res_4$0 null$0)))))))
