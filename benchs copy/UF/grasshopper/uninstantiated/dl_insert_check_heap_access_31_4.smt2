...
(assert (= (ep$0 prev$0 FP_1$0 prv_3$0) t_30$0))

(assert (= (ep$0 prev$0 FP_1$0 prv_2$0) t_29$0))

(assert (= (ep$0 prev$0 FP_1$0 elt$0) t_28$0))

(assert (= (ep$0 prev$0 FP_1$0 d_2$0) t_27$0))

(assert (= (ep$0 prev$0 FP_1$0 d_1$0) t_26$0))

(assert (= (ep$0 prev$0 FP_1$0 curr_3$0) t_25$0))

(assert (= (ep$0 prev$0 FP_1$0 curr_2$0) t_24$0))

(assert (= (ep$0 prev$0 FP_1$0 c_2$0) t_23$0))

(assert (= (ep$0 prev$0 FP_1$0 c_1$0) t_22$0))

(assert (= (ep$0 prev$0 FP_1$0 b$0) t_21$0))

(assert (= (ep$0 prev$0 FP_1$0 a$0) t_20$0))

(assert (= (ep$0 prev$0 FP_1$0 null$0) t_19$0))

(assert (= (ep$0 next$0 FP_1$0 prv_3$0) t_18$0))

(assert (= (ep$0 next$0 FP_1$0 prv_2$0) t_17$0))

(assert (= (ep$0 next$0 FP_1$0 elt$0) t_16$0))

(assert (= (ep$0 next$0 FP_1$0 d_2$0) t_15$0))

(assert (= (ep$0 next$0 FP_1$0 d_1$0) t_14$0))

(assert (= (ep$0 next$0 FP_1$0 curr_3$0) t_13$0))

(assert (= (ep$0 next$0 FP_1$0 curr_2$0) t_12$0))

(assert (= (ep$0 next$0 FP_1$0 c_2$0) t_11$0))

(assert (= (ep$0 next$0 FP_1$0 c_1$0) t_10$0))

(assert (= (ep$0 next$0 FP_1$0 b$0) t_9$0))
...
(assert (or (not Axiom_7$0)
    (forall ((l1 Loc) (l2 Loc))
            (or (= (read$0 prev$0 l2) l1) (not (= (read$0 next$0 l1) l2))
                (not (in$0 l1 sk_?X_24$0)) (not (in$0 l2 sk_?X_24$0))))))
...
(assert (or (not Axiom_10$0)
    (forall ((l1 Loc) (l2 Loc))
            (or (= (read$0 prev$0 l2) l1) (not (= (read$0 next$0 l1) l2))
                (not (in$0 l1 sk_?X_19$0)) (not (in$0 l2 sk_?X_19$0))))))
