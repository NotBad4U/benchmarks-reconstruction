...
;;	       IF VARIABLE_unread_[CONSTANT_self_] # {}
;;	         THEN /\ \E CONSTANT_i_ \in VARIABLE_unread_[CONSTANT_self_] :
;;	                    /\ ?VARIABLE_unread_#prime
;;	                       = [VARIABLE_unread_ EXCEPT
;;	                            ![CONSTANT_self_] = VARIABLE_unread_[CONSTANT_self_]
;;	                                                \ {CONSTANT_i_}]
;;	                    /\ IF
;;	                         VARIABLE_num_[CONSTANT_i_]
;;	                         > VARIABLE_max_[CONSTANT_self_]
;;	                         THEN /\ ?VARIABLE_max_#prime
;;	                                 = [VARIABLE_max_ EXCEPT
;;	                                      ![CONSTANT_self_] = VARIABLE_num_[CONSTANT_i_]]
;;	                         ELSE /\ TRUE
;;	                              /\ ?VARIABLE_max_#prime = VARIABLE_max_
;;	              /\ ?VARIABLE_pc_#prime
;;	                 = [VARIABLE_pc_ EXCEPT ![CONSTANT_self_] = "p2"]
;;	         ELSE /\ ?VARIABLE_pc_#prime
;;	                 = [VARIABLE_pc_ EXCEPT ![CONSTANT_self_] = "p3"]
;;	              /\ /\ ?VARIABLE_unread_#prime = VARIABLE_unread_
;;	                 /\ ?VARIABLE_max_#prime = VARIABLE_max_ ,
;;	       VARIABLE_pc_[CONSTANT_self_] = "p2" ,
...
;; Proof obligation #27
;; Generated from file "./examples/Bakery.tla", line 328, characters 5-6
