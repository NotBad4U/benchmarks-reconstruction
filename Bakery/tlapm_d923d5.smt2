...
;;	       \/ VARIABLE_num_[VARIABLE_nxt_[CONSTANT_self_]] = 0
;;	       \/ \/ VARIABLE_num_[CONSTANT_self_]
;;	             < VARIABLE_num_[VARIABLE_nxt_[CONSTANT_self_]]
;;	          \/ /\ VARIABLE_num_[VARIABLE_nxt_[CONSTANT_self_]]
;;	                = VARIABLE_num_[CONSTANT_self_]
;;	             /\ CONSTANT_self_ =< VARIABLE_nxt_[CONSTANT_self_] ,
;;	       VARIABLE_pc_[CONSTANT_self_] = "p6" ,
;;	       ?VARIABLE_unread_#prime
;;	       = [VARIABLE_unread_ EXCEPT
;;	            ![CONSTANT_self_] = VARIABLE_unread_[CONSTANT_self_]
;;	                                \ {VARIABLE_nxt_[CONSTANT_self_]}] ,
;;	       ?VARIABLE_pc_#prime = [VARIABLE_pc_ EXCEPT ![CONSTANT_self_] = "p5"] ,
...
;; Proof obligation #45
;; Generated from file "./examples/Bakery.tla", line 348, characters 5-6
