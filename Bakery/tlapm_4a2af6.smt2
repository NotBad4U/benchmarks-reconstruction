...
;;	                    ?VARIABLE_nxt_#prime
;;	                    = [VARIABLE_nxt_ EXCEPT ![CONSTANT_self_] = CONSTANT_i_]
;;	              /\ ~VARIABLE_flag_[?VARIABLE_nxt_#prime[CONSTANT_self_]]
;;	              /\ ?VARIABLE_pc_#prime
;;	                 = [VARIABLE_pc_ EXCEPT ![CONSTANT_self_] = "p6"]
;;	         ELSE /\ ?VARIABLE_pc_#prime
;;	                 = [VARIABLE_pc_ EXCEPT ![CONSTANT_self_] = "cs"]
;;	              /\ ?VARIABLE_nxt_#prime = VARIABLE_nxt_ ,
;;	       VARIABLE_pc_[CONSTANT_self_] = "p5" ,
...
;; Proof obligation #42
;; Generated from file "./examples/Bakery.tla", line 344, characters 5-6
