...
fd -tf -e 'smt2' -j $(nproc) | \
  ...
  'cvc5 --produce-proofs --dump-proofs  --proof-format-mode=alethe --proof-granularity=dsl-rewrite --proof-alethe-res-pivots --proof-elim-subtypes --print-arith-lit-token ./{} > '"$OUTPUT_DIR"'/proofs/{.}.proof' \;
