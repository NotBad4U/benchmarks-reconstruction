...
;;	             ?VARIABLE_maxBal_#prime[CONSTANT_a_]
;;	             >= ?VARIABLE_maxVBal_#prime[CONSTANT_a_] 
;;	PROVE  \A CONSTANT_m_ \in ?VARIABLE_msgs_#prime :
;;	          /\ CONSTANT_m_.type = "1b"
;;	             => (/\ CONSTANT_m_.bal
...
;;	          /\ CONSTANT_m_.type = "2a"
;;	             => (/\ ?h39afa(CONSTANT_m_.val, CONSTANT_m_.bal)
...
;; Proof obligation #125
;; Generated from file "./Paxos.tla", line 343, characters 9-10
