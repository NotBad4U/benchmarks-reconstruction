...
;;	       /\ ~(\E CONSTANT_m_ \in VARIABLE_msgs_ :
;;	               CONSTANT_m_.type = "2a" /\ CONSTANT_m_.bal = CONSTANT_bb_)
...
;;	                         \/ \E CONSTANT_c_ \in 0..CONSTANT_bb_ - 1 :
;;	                               /\ \A CONSTANT_m_ \in CONSTANT_S_ :
;;	                                     CONSTANT_m_.maxVBal =< CONSTANT_c_
;;	                               /\ \E CONSTANT_m_ \in CONSTANT_S_ :
;;	                                     /\ CONSTANT_m_.maxVBal = CONSTANT_c_
;;	                                     /\ CONSTANT_m_.maxVal = CONSTANT_v__1
;;	             /\ ?VARIABLE_msgs_#prime
;;	                = VARIABLE_msgs_
;;	                  \cup {[type |-> "2a", bal |-> CONSTANT_bb_,
;;	                         val |-> CONSTANT_v__1]} ,
...
;; Proof obligation #18
;; Generated from file "./Paxos.tla", line 246, characters 3-4
