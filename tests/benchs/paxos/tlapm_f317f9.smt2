...
;;	PROVE  \E CONSTANT_Q1_ \in CONSTANT_Quorums_ :
;;	          \A CONSTANT_a_ \in CONSTANT_Q1_ :
;;	             CONSTANT_VotedForIn_(CONSTANT_a_, CONSTANT_v1_, CONSTANT_b1_)
;; TLA+ Proof Manager 1.5.0
;; Proof obligation #243
;; Generated from file "./Paxos.tla", line 483, characters 7-8
...
(assert
  (!
    (not
      (exists ((smt__CONSTANTunderscore_Q1underscore_ Idv))
        (and
          (smt__TLAunderscore_underscore_Mem
