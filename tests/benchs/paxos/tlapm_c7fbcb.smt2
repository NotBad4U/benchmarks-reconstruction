...
;;	                CONSTANT_VotedForIn_(CONSTANT_a_, CONSTANT_v_, CONSTANT_c_)
;;	                \/ STATE_WontVoteIn_(CONSTANT_a_, CONSTANT_c_) ,
...
;;	          \E CONSTANT_Q_ \in CONSTANT_Quorums_ :
;;	             \A CONSTANT_a__1 \in CONSTANT_Q_ :
;;	                CONSTANT_VotedForIn_(CONSTANT_a__1, CONSTANT_v_, CONSTANT_c_)
;;	                \/ ?h3ffed(CONSTANT_a__1, CONSTANT_c_)
;; TLA+ Proof Manager 1.5.0
;; Proof obligation #21
;; Generated from file "./Paxos.tla", line 278, characters 5-6
...
(declare-fun smt__TLAunderscore_underscore_Anonunderscore_h3ffed (Idv
  Idv) Idv)
    ...
    (=>
      ...
      (=>
        (=
          ...
          smt__TLAunderscore_underscore_Ttunderscore_Idv)
        (=
          (smt__TLAunderscore_underscore_Anonunderscore_h3ffed
            smt__CONSTANTunderscore_aaunderscore_
            smt__CONSTANTunderscore_bbunderscore_)
          smt__TLAunderscore_underscore_Ttunderscore_Idv)))))
