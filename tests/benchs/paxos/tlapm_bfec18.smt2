...
;;	       NEW CONSTANT CONSTANT_m1_ \in ?VARIABLE_msgs_#prime,
...
;; Proof obligation #38
;; Generated from file "./Paxos.tla", line 270, characters 17-18
...
(declare-fun smt__CONSTANTunderscore_m1underscore_ () Idv)

(assert
  (smt__TLAunderscore_underscore_Mem smt__CONSTANTunderscore_m1underscore_
    smt__VARIABLEunderscore_msgsunderscore_underscore_prime))
