...
;;	       [type |-> "2b", val |-> CONSTANT_vv_, bal |-> CONSTANT_bb_,
;;	        acc |-> CONSTANT_aa_]
;;	       \notin VARIABLE_msgs_ ,
;;	       [type |-> "2b", val |-> CONSTANT_vv_, bal |-> CONSTANT_bb_,
;;	        acc |-> CONSTANT_aa_]
;;	       \in ?VARIABLE_msgs_#prime 
;;	PROVE  CONSTANT_aa_ = CONSTANT_a_ /\ CONSTANT_m_.bal = CONSTANT_bb_
;; TLA+ Proof Manager 1.5.0
;; Proof obligation #42
;; Generated from file "./Paxos.tla", line 272, characters 7-8
      ...
      (and
        ...
        (smt__TLAunderscore_underscore_TrigEqunderscore_Idv
          (smt__TLAunderscore_underscore_FunApp
            smt__CONSTANTunderscore_munderscore_
            smt__TLAunderscore_underscore_StrLitunderscore_bal)
          smt__CONSTANTunderscore_bbunderscore_))) :named |Goal|))
