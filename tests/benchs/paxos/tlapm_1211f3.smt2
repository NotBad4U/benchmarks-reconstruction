...
;;	       /\ (/\ VARIABLE_msgs_
;;	              \in SUBSET ([type : {"1a"}, bal : CONSTANT_Ballots_]
;;	                          \cup [type : {"1b"}, bal : CONSTANT_Ballots_,
;;	                                maxVBal : CONSTANT_Ballots_ \cup {-1},
;;	                                maxVal : CONSTANT_Values_
;;	                                         \cup {CONSTANT_None_},
;;	                                acc : CONSTANT_Acceptors_]
;;	                          \cup [type : {"2a"}, bal : CONSTANT_Ballots_,
;;	                                val : CONSTANT_Values_]
;;	                          \cup [type : {"2b"}, bal : CONSTANT_Ballots_,
;;	                                val : CONSTANT_Values_,
;;	                                acc : CONSTANT_Acceptors_])
;;	           /\ VARIABLE_maxVBal_
...
;; Proof obligation #5
;; Generated from file "./Paxos.tla", line 204, characters 1-2
...
;; Axiom: StrLitDistinct 1a 2a
(assert
  (!
    (distinct smt__TLAunderscore_underscore_StrLitunderscore_1a
      smt__TLAunderscore_underscore_StrLitunderscore_2a)
    :named |StrLitDistinct 1a 2a|))
