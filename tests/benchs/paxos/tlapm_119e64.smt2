...
;;	                                              /\ CONSTANT_m_.bal
;;	                                                 = CONSTANT_b_},
;;	       \A CONSTANT_m_ \in CONSTANT_S_ : CONSTANT_m_.maxVBal = -1 ,
;;	       /\ \A CONSTANT_a_ \in CONSTANT_Q_ :
;;	             \E CONSTANT_m_ \in CONSTANT_S_ : CONSTANT_m_.acc = CONSTANT_a_
;;	       /\ \/ \A CONSTANT_m_ \in CONSTANT_S_ : CONSTANT_m_.maxVBal = -1
...
;;	                          ~CONSTANT_VotedForIn_(CONSTANT_a_, CONSTANT_v__1,
;;	                                                CONSTANT_c_)
;;	                    /\ VARIABLE_maxBal_[CONSTANT_a_] > CONSTANT_c_)
;; TLA+ Proof Manager 1.5.0
;; Proof obligation #176
;; Generated from file "./Paxos.tla", line 403, characters 11-12
