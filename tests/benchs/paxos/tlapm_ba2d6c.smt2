...
;;	        maxVBal |-> VARIABLE_maxVBal_[CONSTANT_a_],
;;	        maxVal |-> VARIABLE_maxVal_[CONSTANT_a_], acc |-> CONSTANT_a_].bal
;;	       =< ?VARIABLE_maxBal_#prime[[type |-> "1b", bal |-> CONSTANT_m_.bal,
;;	                                   maxVBal |-> VARIABLE_maxVBal_[CONSTANT_a_],
;;	                                   maxVal |-> VARIABLE_maxVal_[CONSTANT_a_],
;;	                                   acc |-> CONSTANT_a_].acc] ,
;;	       \/ /\ [type |-> "1b", bal |-> CONSTANT_m_.bal,
...
;;	             = -1 ,
;;	       \A CONSTANT_c_
;;	          \in [type |-> "1b", bal |-> CONSTANT_m_.bal,
;;	               maxVBal |-> VARIABLE_maxVBal_[CONSTANT_a_],
;;	               maxVal |-> VARIABLE_maxVal_[CONSTANT_a_], acc |-> CONSTANT_a_].maxVBal
;;	              + 1..[type |-> "1b", bal |-> CONSTANT_m_.bal,
;;	                    maxVBal |-> VARIABLE_maxVBal_[CONSTANT_a_],
;;	                    maxVal |-> VARIABLE_maxVal_[CONSTANT_a_],
;;	                    acc |-> CONSTANT_a_].bal
;;	                   - 1 :
...
;;	       /\ (\A CONSTANT_m__1 \in VARIABLE_msgs_ :
;;	              /\ CONSTANT_m__1.type = "1b"
;;	                 => (/\ CONSTANT_m__1.bal
;;	                        =< VARIABLE_maxBal_[CONSTANT_m__1.acc]
;;	                     /\ \/ /\ CONSTANT_m__1.maxVal \in CONSTANT_Values_
;;	                           /\ CONSTANT_m__1.maxVBal \in Nat
;;	                           /\ CONSTANT_VotedForIn_(CONSTANT_m__1.acc,
;;	                                                   CONSTANT_m__1.maxVal,
;;	                                                   CONSTANT_m__1.maxVBal)
;;	                        \/ /\ CONSTANT_m__1.maxVal = CONSTANT_None_
;;	                           /\ CONSTANT_m__1.maxVBal = -1
;;	                     /\ \A CONSTANT_c_
;;	                           \in CONSTANT_m__1.maxVBal + 1..CONSTANT_m__1.bal
;;	                                                          - 1 :
;;	                           ~(\E CONSTANT_v_ \in CONSTANT_Values_ :
;;	                                CONSTANT_VotedForIn_(CONSTANT_m__1.acc,
;;	                                                     CONSTANT_v_,
;;	                                                     CONSTANT_c_)))
;;	              /\ CONSTANT_m__1.type = "2a"
;;	                 => (/\ STATE_SafeAt_(CONSTANT_m__1.val, CONSTANT_m__1.bal)
;;	                     /\ \A CONSTANT_ma_ \in VARIABLE_msgs_ :
;;	                           CONSTANT_ma_.type = "2a"
;;	                           /\ CONSTANT_ma_.bal = CONSTANT_m__1.bal
;;	                           => CONSTANT_ma_ = CONSTANT_m__1)
;;	              /\ CONSTANT_m__1.type = "2b"
;;	                 => (/\ \E CONSTANT_ma_ \in VARIABLE_msgs_ :
;;	                           /\ CONSTANT_ma_.type = "2a"
;;	                           /\ CONSTANT_ma_.bal = CONSTANT_m__1.bal
;;	                           /\ CONSTANT_ma_.val = CONSTANT_m__1.val
;;	                     /\ CONSTANT_m__1.bal
;;	                        =< VARIABLE_maxVBal_[CONSTANT_m__1.acc]))
;;	       /\ STATE_AccInv_ /\ ACTION_Next_
;;	       /\ (/\ ?VARIABLE_msgs_#prime
;;	              \in SUBSET ([type : {"1a"}, bal : Nat]
;;	                          \cup [type : {"1b"}, bal : Nat,
;;	                                maxVBal : Nat \cup {-1},
...
;;	PROVE  \A CONSTANT_m__1 \in ?VARIABLE_msgs_#prime :
;;	          /\ CONSTANT_m__1.type = "1b"
;;	             => (/\ CONSTANT_m__1.bal
;;	                    =< ?VARIABLE_maxBal_#prime[CONSTANT_m__1.acc]
;;	                 /\ \/ /\ CONSTANT_m__1.maxVal \in CONSTANT_Values_
;;	                       /\ CONSTANT_m__1.maxVBal \in Nat
;;	                       /\ CONSTANT_VotedForIn_(CONSTANT_m__1.acc,
;;	                                               CONSTANT_m__1.maxVal,
...
;;	                       /\ CONSTANT_m__1.maxVBal = -1
;;	                 /\ \A CONSTANT_c_
;;	                       \in CONSTANT_m__1.maxVBal + 1..CONSTANT_m__1.bal - 1 :
;;	                       ~(\E CONSTANT_v_ \in CONSTANT_Values_ :
;;	                            CONSTANT_VotedForIn_(CONSTANT_m__1.acc,
;;	                                                 CONSTANT_v_, CONSTANT_c_)))
;;	          /\ CONSTANT_m__1.type = "2a"
;;	             => (/\ ?h39afa(CONSTANT_m__1.val, CONSTANT_m__1.bal)
...
;;	                       /\ CONSTANT_ma_.val = CONSTANT_m__1.val
;;	                 /\ CONSTANT_m__1.bal
;;	                    =< ?VARIABLE_maxVBal_#prime[CONSTANT_m__1.acc])
;; TLA+ Proof Manager 1.5.0
;; Proof obligation #132
;; Generated from file "./Paxos.tla", line 364, characters 9-10
                ...
                (=>
                  ...
                  (smt__TLAunderscore_underscore_IntLteq
                    ...
                    (smt__TLAunderscore_underscore_FunApp
                      smt__VARIABLEunderscore_maxBalunderscore_
                      smt__CONSTANTunderscore_aunderscore__1)))))
            (forall ((smt__CONSTANTunderscore_munderscore__1 Idv))
              (=>
                (smt__TLAunderscore_underscore_Mem
