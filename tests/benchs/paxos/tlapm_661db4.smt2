...
;;	       NEW CONSTANT CONSTANT_Q2_ \in CONSTANT_Quorums_,
;;	       NEW CONSTANT CONSTANT_Q1_ \in CONSTANT_Quorums_,
;;	       \A CONSTANT_a_ \in CONSTANT_Q2_ :
;;	          CONSTANT_VotedForIn_(CONSTANT_a_, CONSTANT_v2_, CONSTANT_b1_)
;;	          \/ (/\ \A CONSTANT_v_ \in CONSTANT_Values_ :
;;	                    ~CONSTANT_VotedForIn_(CONSTANT_a_, CONSTANT_v_,
;;	                                          CONSTANT_b1_)
;;	              /\ VARIABLE_maxBal_[CONSTANT_a_] > CONSTANT_b1_) ,
;;	       \A CONSTANT_a_ \in CONSTANT_Q1_ :
;;	          CONSTANT_VotedForIn_(CONSTANT_a_, CONSTANT_v1_, CONSTANT_b1_) ,
;;	       /\ CONSTANT_Quorums_ \subseteq SUBSET CONSTANT_Acceptors_
;;	       /\ \A CONSTANT_Q1__1, CONSTANT_Q2__1 \in CONSTANT_Quorums_ :
;;	             CONSTANT_Q1__1 \cap CONSTANT_Q2__1 # {} ,
;;	       STATE_MsgInv_
;;	       => (\A CONSTANT_a1_, CONSTANT_a2_ \in CONSTANT_Acceptors_,
;;	              CONSTANT_b_ \in Nat,
;;	              CONSTANT_v1__1, CONSTANT_v2__1 \in CONSTANT_Values_ :
;;	              CONSTANT_VotedForIn_(CONSTANT_a1_, CONSTANT_v1__1, CONSTANT_b_)
;;	              /\ CONSTANT_VotedForIn_(CONSTANT_a2_, CONSTANT_v2__1,
;;	                                      CONSTANT_b_)
;;	              => CONSTANT_v1__1 = CONSTANT_v2__1) 
;;	PROVE  CONSTANT_v1_ = CONSTANT_v2_
;; TLA+ Proof Manager 1.5.0
;; Proof obligation #231
;; Generated from file "./Paxos.tla", line 484, characters 15-16
...
(declare-fun smt__CONSTANTunderscore_Q2underscore_ () Idv)

(assert
  (smt__TLAunderscore_underscore_Mem smt__CONSTANTunderscore_Q2underscore_
...
(declare-fun smt__CONSTANTunderscore_Q1underscore_ () Idv)

(assert
  (smt__TLAunderscore_underscore_Mem smt__CONSTANTunderscore_Q1underscore_
    smt__CONSTANTunderscore_Quorumsunderscore_))
...
(assert
  (and
    ...
    (forall
      ((smt__CONSTANTunderscore_Q1underscore__1 Idv)
        (smt__CONSTANTunderscore_Q2underscore__1 Idv))
      (=>
        (and
          (smt__TLAunderscore_underscore_Mem
            smt__CONSTANTunderscore_Q1underscore__1
            smt__CONSTANTunderscore_Quorumsunderscore_)
          (smt__TLAunderscore_underscore_Mem
            smt__CONSTANTunderscore_Q2underscore__1
            smt__CONSTANTunderscore_Quorumsunderscore_))
        (not
          (smt__TLAunderscore_underscore_TrigEqunderscore_Setdollarsignunderscore_Idvdollarsignunderscore_
  ...
  (=>
    ...
    (forall
      ((smt__CONSTANTunderscore_a1underscore_ Idv)
        ...
        (smt__CONSTANTunderscore_v1underscore__1 Idv)
        (smt__CONSTANTunderscore_v2underscore__1 Idv))
      (=>
        (and
          (smt__TLAunderscore_underscore_Mem
          ...
          (smt__TLAunderscore_underscore_Mem
            ...
            smt__TLAunderscore_underscore_NatSet)
          (smt__TLAunderscore_underscore_Mem
            smt__CONSTANTunderscore_v1underscore__1
            smt__CONSTANTunderscore_Valuesunderscore_)
          (smt__TLAunderscore_underscore_Mem
            smt__CONSTANTunderscore_v2underscore__1
            smt__CONSTANTunderscore_Valuesunderscore_))
        (=>
          (and
            (=
