...
;;	       CONSTANT_N_ \in Nat 
;;	PROVE  (/\ VARIABLE_num_ \in [1..CONSTANT_N_ -> Nat]
...
;;	                                    \in VARIABLE_unread_[CONSTANT_j_]
;;	                           \/ VARIABLE_pc_[CONSTANT_j_] = "p7"))
;;	       => (\A CONSTANT_i_, CONSTANT_j_ \in 1..CONSTANT_N_ :
;;	              CONSTANT_i_ # CONSTANT_j_
;;	              => ~(/\ VARIABLE_pc_[CONSTANT_i_] = "cs"
;;	                   /\ VARIABLE_pc_[CONSTANT_j_] = "cs"))
;; TLA+ Proof Manager 1.5.0
;; Proof obligation #55
;; Generated from file "./examples/Bakery.tla", line 363, characters 3-4
                      ...
                      (and
                        ...
                        (or
                          ...
                          (smt__TLAunderscore_underscore_TrigEqunderscore_Idv
                            ...
                            smt__TLAunderscore_underscore_StrLitunderscore_p7))))))))))
        (forall
          ((smt__CONSTANTunderscore_iunderscore_ Idv)
            (smt__CONSTANTunderscore_junderscore_ Idv))
          (=>
            (and
              (smt__TLAunderscore_underscore_Mem
                smt__CONSTANTunderscore_iunderscore_
