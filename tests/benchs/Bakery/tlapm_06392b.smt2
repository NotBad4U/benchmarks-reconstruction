...
;;	       (\E CONSTANT_self_ \in 1..CONSTANT_N_ :
;;	           ACTION_p1_(CONSTANT_self_) \/ ACTION_p2_(CONSTANT_self_)
;;	           \/ ACTION_p3_(CONSTANT_self_) \/ ACTION_p4_(CONSTANT_self_)
;;	           \/ ACTION_p5_(CONSTANT_self_) \/ ACTION_p6_(CONSTANT_self_)
;;	           \/ ACTION_cs_(CONSTANT_self_) \/ ACTION_p7_(CONSTANT_self_))
;;	       \/ ?h6fbaa = STATE_vars_ ,
;;	       ASSUME NEW CONSTANT CONSTANT_self_ \in 1..CONSTANT_N_,
;;	              ACTION_p1_(CONSTANT_self_) 
;;	       PROVE  ?h15bf9
;;	              /\ (\A CONSTANT_i_ \in 1..CONSTANT_N_ : ?h222f4(CONSTANT_i_)) ,
;;	       ASSUME NEW CONSTANT CONSTANT_self_ \in 1..CONSTANT_N_,
;;	              ACTION_p2_(CONSTANT_self_) 
;;	       PROVE  ?h15bf9
;;	              /\ (\A CONSTANT_i_ \in 1..CONSTANT_N_ : ?h222f4(CONSTANT_i_)) ,
;;	       ASSUME NEW CONSTANT CONSTANT_self_ \in 1..CONSTANT_N_,
;;	              ACTION_p3_(CONSTANT_self_) 
;;	       PROVE  ?h15bf9
;;	              /\ (\A CONSTANT_i_ \in 1..CONSTANT_N_ : ?h222f4(CONSTANT_i_)) ,
;;	       ASSUME NEW CONSTANT CONSTANT_self_ \in 1..CONSTANT_N_,
;;	              ACTION_p4_(CONSTANT_self_) 
;;	       PROVE  ?h15bf9
;;	              /\ (\A CONSTANT_i_ \in 1..CONSTANT_N_ : ?h222f4(CONSTANT_i_)) ,
;;	       ASSUME NEW CONSTANT CONSTANT_self_ \in 1..CONSTANT_N_,
;;	              ACTION_p5_(CONSTANT_self_) 
;;	       PROVE  ?h15bf9
;;	              /\ (\A CONSTANT_i_ \in 1..CONSTANT_N_ : ?h222f4(CONSTANT_i_)) ,
;;	       ASSUME NEW CONSTANT CONSTANT_self_ \in 1..CONSTANT_N_,
;;	              ACTION_p6_(CONSTANT_self_) 
;;	       PROVE  ?h15bf9
;;	              /\ (\A CONSTANT_i_ \in 1..CONSTANT_N_ : ?h222f4(CONSTANT_i_)) ,
;;	       ASSUME NEW CONSTANT CONSTANT_self_ \in 1..CONSTANT_N_,
;;	              ACTION_cs_(CONSTANT_self_) 
;;	       PROVE  ?h15bf9
;;	              /\ (\A CONSTANT_i_ \in 1..CONSTANT_N_ : ?h222f4(CONSTANT_i_)) ,
;;	       ASSUME NEW CONSTANT CONSTANT_self_ \in 1..CONSTANT_N_,
;;	              ACTION_p7_(CONSTANT_self_) 
;;	       PROVE  ?h15bf9
;;	              /\ (\A CONSTANT_i_ \in 1..CONSTANT_N_ : ?h222f4(CONSTANT_i_)) ,
...
;; Proof obligation #8
;; Generated from file "./examples/Bakery.tla", line 360, characters 5-6
...
(assert
  (or
    (exists ((smt__CONSTANTunderscore_selfunderscore_ Idv))
      (and
        (smt__TLAunderscore_underscore_Mem
              ...
              (or
                (or
                  (or
                    (or
                      (=
                        (smt__ACTIONunderscore_p1underscore_
                          smt__CONSTANTunderscore_selfunderscore_)
                        smt__TLAunderscore_underscore_Ttunderscore_Idv)
                      (=
                        (smt__ACTIONunderscore_p2underscore_
                          smt__CONSTANTunderscore_selfunderscore_)
                        smt__TLAunderscore_underscore_Ttunderscore_Idv))
                    (=
                      (smt__ACTIONunderscore_p3underscore_
                        smt__CONSTANTunderscore_selfunderscore_)
                      smt__TLAunderscore_underscore_Ttunderscore_Idv))
                  (=
                    (smt__ACTIONunderscore_p4underscore_
                      smt__CONSTANTunderscore_selfunderscore_)
                    smt__TLAunderscore_underscore_Ttunderscore_Idv))
                (=
                  (smt__ACTIONunderscore_p5underscore_
                    smt__CONSTANTunderscore_selfunderscore_)
                  smt__TLAunderscore_underscore_Ttunderscore_Idv))
              (=
                (smt__ACTIONunderscore_p6underscore_
                  smt__CONSTANTunderscore_selfunderscore_)
                smt__TLAunderscore_underscore_Ttunderscore_Idv))
            (=
              (smt__ACTIONunderscore_csunderscore_
                smt__CONSTANTunderscore_selfunderscore_)
              smt__TLAunderscore_underscore_Ttunderscore_Idv))
          (=
            (smt__ACTIONunderscore_p7underscore_
              smt__CONSTANTunderscore_selfunderscore_)
            smt__TLAunderscore_underscore_Ttunderscore_Idv))))
...
(assert
  (forall ((smt__CONSTANTunderscore_selfunderscore_ Idv))
    (=>
      (smt__TLAunderscore_underscore_Mem
        smt__CONSTANTunderscore_selfunderscore_
        (smt__TLAunderscore_underscore_IntRange
