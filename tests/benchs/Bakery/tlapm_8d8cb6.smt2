...
;;	       NEW CONSTANT CONSTANT_i_ \in 1..CONSTANT_N_,
;;	       \/ /\ ?VARIABLE_flag_#prime
;;	             = [VARIABLE_flag_ EXCEPT
;;	                  ![CONSTANT_self_] = ~VARIABLE_flag_[CONSTANT_self_]]
;;	          /\ ?VARIABLE_pc_#prime
...
;;	       VARIABLE_pc_[CONSTANT_self_] = "p1" ,
;;	       ?VARIABLE_unread_#prime
;;	       = [VARIABLE_unread_ EXCEPT
;;	            ![CONSTANT_self_] = 1..CONSTANT_N_ \ {CONSTANT_self_}] ,
;;	       ?VARIABLE_max_#prime = [VARIABLE_max_ EXCEPT ![CONSTANT_self_] = 0] ,
;;	       ?VARIABLE_num_#prime = VARIABLE_num_ ,
;;	       ?VARIABLE_nxt_#prime = VARIABLE_nxt_ 
;;	PROVE  /\ /\ ?VARIABLE_pc_#prime[CONSTANT_i_] \in {"p1", "p2"}
;;	             => ?VARIABLE_num_#prime[CONSTANT_i_] = 0
;;	          /\ ?VARIABLE_num_#prime[CONSTANT_i_] = 0
;;	             => ?VARIABLE_pc_#prime[CONSTANT_i_] \in {"p1", "p2", "p3", "p7"}
;;	       /\ /\ ?VARIABLE_flag_#prime[CONSTANT_i_]
;;	             => ?VARIABLE_pc_#prime[CONSTANT_i_] \in {"p1", "p2", "p3", "p4"}
;;	          /\ ?VARIABLE_pc_#prime[CONSTANT_i_] \in {"p2", "p3"}
;;	             => ?VARIABLE_flag_#prime[CONSTANT_i_]
;;	       /\ ?VARIABLE_pc_#prime[CONSTANT_i_] \in {"p5", "p6"}
;;	          => (\A CONSTANT_j_
;;	                 \in (1..CONSTANT_N_ \ ?VARIABLE_unread_#prime[CONSTANT_i_])
;;	                     \ {CONSTANT_i_} :
;;	                 /\ ?VARIABLE_num_#prime[CONSTANT_i_] > 0
...
;;	                                = ?VARIABLE_num_#prime[CONSTANT_i_]
;;	                             /\ CONSTANT_i_ =< CONSTANT_j_
;;	                       /\ ?VARIABLE_pc_#prime[CONSTANT_j_] \in {"p5", "p6"}
;;	                          => CONSTANT_i_
;;	                             \in ?VARIABLE_unread_#prime[CONSTANT_j_]
...
;; Proof obligation #25
;; Generated from file "./examples/Bakery.tla", line 323, characters 7-8
...
(declare-fun smt__CONSTANTunderscore_iunderscore_ () Idv)
    ...
    (and
      (smt__TLAunderscore_underscore_TrigEqunderscore_Idv
        ...
        (smt__TLAunderscore_underscore_FunExcept
          ...
          (smt__TLAunderscore_underscore_Castunderscore_Bool
            (not
              (=
                (smt__TLAunderscore_underscore_FunApp
                  smt__VARIABLEunderscore_flagunderscore_
