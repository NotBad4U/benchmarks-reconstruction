...
;;	                    /\ ?VARIABLE_pc_#prime
;;	                       = [VARIABLE_pc_ EXCEPT ![CONSTANT_self_] = "p7"]
;;	               ELSE /\ ?VARIABLE_num_#prime
;;	                       = [VARIABLE_num_ EXCEPT ![CONSTANT_self_] = 0]
;;	                    /\ ?VARIABLE_pc_#prime
;;	                       = [VARIABLE_pc_ EXCEPT ![CONSTANT_self_] = "p1"] ,
;;	       VARIABLE_pc_[CONSTANT_self_] = "p7" ,
...
;; Proof obligation #50
;; Generated from file "./examples/Bakery.tla", line 356, characters 5-6
