...
(declare-fun f53 (S18 S20) S1)
(declare-fun f54 (S5) S1)
(declare-fun f55 (S9) S1)
(declare-fun f56 (S18) S1)
(declare-fun f57 (S11) S1)
(declare-fun f58 (S7) S1)
(declare-fun f59 (S5) S1)
(declare-fun f60 (S9) S1)
(declare-fun f61 (S18) S1)
(declare-fun f62 (S11) S1)
(declare-fun f63 (S7) S1)
...
(assert (forall ((?v0 S4) (?v1 S5)) (= (= (f15 ?v0 ?v1) f1) (= (f5 ?v1 ?v0) f1))))
(assert (forall ((?v0 S8) (?v1 S9)) (= (= (f25 ?v0 ?v1) f1) (= (f9 ?v1 ?v0) f1))))
(assert (forall ((?v0 S20) (?v1 S18)) (= (= (f31 ?v0 ?v1) f1) (= (f53 ?v1 ?v0) f1))))
(assert (forall ((?v0 S10) (?v1 S11)) (= (= (f26 ?v0 ?v1) f1) (= (f11 ?v1 ?v0) f1))))
(assert (forall ((?v0 S6) (?v1 S7)) (= (= (f20 ?v0 ?v1) f1) (= (f7 ?v1 ?v0) f1))))
(assert (forall ((?v0 S2) (?v1 S3)) (= (= (f14 ?v0 ?v1) f1) (= (f3 ?v1 ?v0) f1))))
(assert (forall ((?v0 S5)) (= (= (f54 ?v0) f1) (forall ((?v1 S2) (?v2 S2) (?v3 S2)) (let ((?v_0 (f17 f18 ?v1))) (=> (= (f15 (f16 ?v_0 ?v2) ?v0) f1) (=> (= (f15 (f16 (f17 f18 ?v2) ?v3) ?v0) f1) (= (f15 (f16 ?v_0 ?v3) ?v0) f1))))))))
(assert (forall ((?v0 S9)) (= (= (f55 ?v0) f1) (forall ((?v1 S6) (?v2 S6) (?v3 S6)) (let ((?v_0 (f40 f41 ?v1))) (=> (= (f25 (f39 ?v_0 ?v2) ?v0) f1) (=> (= (f25 (f39 (f40 f41 ?v2) ?v3) ?v0) f1) (= (f25 (f39 ?v_0 ?v3) ?v0) f1))))))))
(assert (forall ((?v0 S18)) (= (= (f56 ?v0) f1) (forall ((?v1 S10) (?v2 S10) (?v3 S10)) (let ((?v_0 (f36 f37 ?v1))) (=> (= (f31 (f35 ?v_0 ?v2) ?v0) f1) (=> (= (f31 (f35 (f36 f37 ?v2) ?v3) ?v0) f1) (= (f31 (f35 ?v_0 ?v3) ?v0) f1))))))))
(assert (forall ((?v0 S11)) (= (= (f57 ?v0) f1) (forall ((?v1 S8) (?v2 S8) (?v3 S8)) (let ((?v_0 (f28 f29 ?v1))) (=> (= (f26 (f27 ?v_0 ?v2) ?v0) f1) (=> (= (f26 (f27 (f28 f29 ?v2) ?v3) ?v0) f1) (= (f26 (f27 ?v_0 ?v3) ?v0) f1))))))))
(assert (forall ((?v0 S7)) (= (= (f58 ?v0) f1) (forall ((?v1 S4) (?v2 S4) (?v3 S4)) (let ((?v_0 (f22 f23 ?v1))) (=> (= (f20 (f21 ?v_0 ?v2) ?v0) f1) (=> (= (f20 (f21 (f22 f23 ?v2) ?v3) ?v0) f1) (= (f20 (f21 ?v_0 ?v3) ?v0) f1))))))))
(assert (forall ((?v0 S5)) (= (= (f59 ?v0) f1) (forall ((?v1 S2)) (not (= (f15 (f16 (f17 f18 ?v1) ?v1) ?v0) f1))))))
(assert (forall ((?v0 S9)) (= (= (f60 ?v0) f1) (forall ((?v1 S6)) (not (= (f25 (f39 (f40 f41 ?v1) ?v1) ?v0) f1))))))
(assert (forall ((?v0 S18)) (= (= (f61 ?v0) f1) (forall ((?v1 S10)) (not (= (f31 (f35 (f36 f37 ?v1) ?v1) ?v0) f1))))))
(assert (forall ((?v0 S11)) (= (= (f62 ?v0) f1) (forall ((?v1 S8)) (not (= (f26 (f27 (f28 f29 ?v1) ?v1) ?v0) f1))))))
(assert (forall ((?v0 S7)) (= (= (f63 ?v0) f1) (forall ((?v1 S4)) (not (= (f20 (f21 (f22 f23 ?v1) ?v1) ?v0) f1))))))
(assert (not (forall ((?v0 S26) (?v1 S2) (?v2 S2)) (let ((?v_0 (forall ((?v3 S27)) (let ((?v_3 (f64 ?v0 ?v3))) (and (= (f54 ?v_3) f1) (and (= (f59 ?v_3) f1) (= (f13 f43 ?v_3) f1)))))) (?v_2 (f16 (f17 f18 ?v1) ?v2)) (?v_1 (f66 ?v0))) (=> (forall ((?v3 S26)) (=> (forall ((?v4 S27)) (let ((?v_4 (f64 ?v3 ?v4))) (and (= (f54 ?v_4) f1) (and (= (f59 ?v_4) f1) (= (f13 f43 ?v_4) f1))))) (forall ((?v4 S2) (?v5 S2)) (let ((?v_5 (f16 (f17 f18 ?v4) ?v5))) (=> (not (= ?v4 ?v5)) (=> (= (f15 ?v_5 (f64 ?v3 f65)) f1) (= (f15 ?v_5 (f66 ?v3)) f1))))))) (=> ?v_0 (=> (= (f15 ?v_2 ?v_1) f1) (=> (=> ?v_0 (and (= (f54 ?v_1) f1) (and (= (f59 ?v_1) f1) (= (f13 f43 ?v_1) f1)))) (= (f15 ?v_2 (f64 ?v0 f65)) f1)))))))))
(check-sat)
(exit)
