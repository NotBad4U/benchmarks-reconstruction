...
(assert (forall ((?v0 S6) (?v1 S6)) (= (= (f3 (f8 f9 ?v0) (f8 f9 ?v1)) f1) (= (f19 ?v0 ?v1) f1))))
...
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f3 (f4 f13 ?v0) (f4 f13 ?v1)) f1) (= (f3 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2)) (= (f4 (f5 f11 f15) ?v0) f15)))
(assert (forall ((?v0 S2) (?v1 S2)) (= (f4 (f5 f11 (f4 f13 ?v0)) ?v1) (f4 f13 (f4 (f5 f11 ?v0) ?v1)))))
...
(assert (forall ((?v0 S2)) (= (f4 (f5 f11 ?v0) f7) ?v0)))
(assert (forall ((?v0 S2)) (= (f4 (f5 f11 f7) ?v0) ?v0)))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f3 (f4 f12 ?v0) (f4 f12 ?v1)) f1) (= (f3 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (=> (= (f3 ?v0 ?v1) f1) (= (f3 (f4 (f5 f6 ?v0) ?v2) (f4 (f5 f6 ?v1) ?v2)) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (f4 (f5 f11 (f4 f12 ?v0)) (f4 f12 ?v1)) (f4 f12 (f4 (f5 f11 ?v0) ?v1)))))
...
(assert (forall ((?v0 S2) (?v1 S2)) (=> (= (f18 ?v0) f1) (=> (= (f18 ?v1) f1) (= (f18 (f4 (f5 f11 ?v0) ?v1)) f1)))))
...
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f4 f12 ?v2))) (= (f4 (f5 f11 (f4 (f5 f6 ?v0) ?v1)) ?v_0) (f4 (f5 f6 (f4 (f5 f11 ?v0) ?v_0)) (f4 (f5 f11 ?v1) ?v_0))))))
(assert (forall ((?v0 S2) (?v1 S6) (?v2 S6)) (let ((?v_0 (f26 f31 (f29 f30 ?v0)))) (= (f25 ?v_0 (f25 (f26 f27 ?v1) ?v2)) (f25 (f26 f27 (f25 ?v_0 ?v1)) (f25 ?v_0 ?v2))))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (let ((?v_0 (f5 f11 (f4 f12 ?v0)))) (= (f4 ?v_0 (f4 (f5 f6 ?v1) ?v2)) (f4 (f5 f6 (f4 ?v_0 ?v1)) (f4 ?v_0 ?v2))))))
(assert (forall ((?v0 S2)) (= (f4 (f5 f6 (f4 f12 f15)) ?v0) ?v0)))
(assert (forall ((?v0 S2)) (= (f4 (f5 f6 ?v0) (f4 f12 f15)) ?v0)))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f3 (f4 f12 ?v0) (f4 f12 ?v1)) f1) (= (f3 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S2)) (= (f4 (f5 f11 (f4 f12 ?v0)) (f4 (f5 f11 (f4 f12 ?v1)) ?v2)) (f4 (f5 f11 (f4 f12 (f4 (f5 f11 ?v0) ?v1))) ?v2))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (f4 (f5 f11 (f4 f12 ?v0)) (f4 f12 ?v1)) (f4 f12 (f4 (f5 f11 ?v0) ?v1)))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (f4 f12 (f4 (f5 f11 ?v0) ?v1)) (f4 (f5 f11 (f4 f12 ?v0)) (f4 f12 ?v1)))))
...
(assert (forall ((?v0 S2)) (= (f4 f14 ?v0) (f4 (f5 f6 (f4 (f5 f6 f7) ?v0)) ?v0))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f3 ?v0 (f4 (f5 f6 ?v1) f7)) f1) (or (= (f3 ?v0 ?v1) f1) (= ?v0 ?v1)))))
(assert (forall ((?v0 S6)) (let ((?v_0 (f8 f9 ?v0))) (= (f4 f12 ?v_0) ?v_0))))
(assert (forall ((?v0 S6)) (= (f29 f30 (f8 f9 ?v0)) (f25 f33 ?v0))))
(assert (forall ((?v0 S2)) (let ((?v_0 (f4 f12 ?v0))) (= (f4 f12 (f4 f14 ?v0)) (f4 (f5 f6 (f4 (f5 f6 f7) ?v_0)) ?v_0)))))
(assert (forall ((?v0 S2)) (= (f4 (f5 f11 (f4 f12 (f4 f14 f15))) ?v0) ?v0)))
(assert (forall ((?v0 S2)) (= (f4 (f5 f11 ?v0) (f4 f12 (f4 f14 f15))) ?v0)))
(assert (= (f29 f30 (f4 f14 f15)) f28))
(assert (= (f4 f12 (f4 f14 f15)) f7))
(assert (= (f4 f12 (f4 f14 f15)) f7))
(assert (= f7 (f4 f12 (f4 f14 f15))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (f4 (f5 f11 (f4 f14 ?v0)) ?v1) (f4 (f5 f6 (f4 f13 (f4 (f5 f11 ?v0) ?v1))) ?v1))))
(assert (forall ((?v0 S2)) (= (f4 (f5 f11 (f4 (f5 f6 f7) f7)) (f4 f12 ?v0)) (f4 f12 (f4 f13 ?v0)))))
(assert (forall ((?v0 S6)) (= (f25 (f26 f31 (f29 f30 (f4 f13 (f4 f14 f15)))) ?v0) (f25 (f26 f27 ?v0) ?v0))))
