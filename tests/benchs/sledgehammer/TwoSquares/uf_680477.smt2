...
(assert (forall ((?v0 S2) (?v1 S2)) (let ((?v_1 (f14 f15 ?v0)) (?v_0 (f14 f15 ?v1))) (= (= (f20 ?v_1 ?v_0) f1) (not (= (f27 ?v_0 ?v_1) f1))))))
(assert (forall ((?v0 S2) (?v1 S2)) (let ((?v_1 (f7 f26 ?v0)) (?v_0 (f7 f26 ?v1))) (= (= (f19 ?v_1 ?v_0) f1) (not (= (f3 ?v_0 ?v_1) f1))))))
...
(assert (forall ((?v0 S2)) (= (f7 (f8 f9 (f7 f26 f18)) ?v0) ?v0)))
(assert (forall ((?v0 S2)) (= (f7 (f8 f9 ?v0) (f7 f26 f18)) ?v0)))
(assert (forall ((?v0 S2) (?v1 S2)) (= (f7 (f8 f9 (f7 f17 ?v0)) (f7 f16 ?v1)) (f7 f17 (f7 (f8 f9 ?v0) ?v1)))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (f7 (f8 f9 (f7 f16 ?v0)) (f7 f17 ?v1)) (f7 f17 (f7 (f8 f9 ?v0) ?v1)))))
(assert (forall ((?v0 S2)) (= (= (f3 (f7 f26 ?v0) f6) f1) (= (f3 ?v0 f18) f1))))
(assert (forall ((?v0 S2)) (= (= (f3 f6 (f7 f26 ?v0)) f1) (= (f3 f18 ?v0) f1))))
(assert (forall ((?v0 S2)) (= (= (f3 (f7 f17 ?v0) f18) f1) (= (f3 ?v0 f18) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f3 (f7 f17 ?v0) (f7 f16 ?v1)) f1) (= (f3 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f3 (f7 f17 ?v0) (f7 f16 ?v1)) f1) (= (f3 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2)) (= (= (f3 (f7 f17 ?v0) f6) f1) (= (f3 ?v0 f6) f1))))
(assert (forall ((?v0 S2)) (= (= (f3 (f7 f16 ?v0) f18) f1) (= (f3 ?v0 f18) f1))))
(assert (forall ((?v0 S2)) (= (= (f3 f18 (f7 f16 ?v0)) f1) (= (f3 f18 ?v0) f1))))
(assert (= (= (f3 f18 f6) f1) false))
(assert (forall ((?v0 S2)) (= (= (f3 (f7 f16 ?v0) f6) f1) (= (f3 ?v0 f6) f1))))
(assert (forall ((?v0 S2)) (= (f7 f17 ?v0) (f7 (f8 f9 (f7 (f8 f9 f5) ?v0)) ?v0))))
(assert (forall ((?v0 S2)) (not (= (f7 (f8 f9 (f7 (f8 f9 f5) ?v0)) ?v0) f6))))
(assert (forall ((?v0 S2) (?v1 S2)) (=> (= (f19 f18 ?v0) f1) (=> (= (f19 f18 ?v1) f1) (= (f21 (f22 f28 (f14 f15 ?v0)) (f14 f15 ?v1)) (f14 f15 (f7 (f8 f9 ?v0) ?v1)))))))
(assert (forall ((?v0 S2) (?v1 S2)) (=> (= (f19 f18 ?v0) f1) (=> (= (f19 f18 ?v1) f1) (= (f7 (f8 f9 (f7 f26 ?v0)) (f7 f26 ?v1)) (f7 f26 (f7 (f8 f9 ?v0) ?v1)))))))
(assert (= (f3 f6 f5) f1))
(assert (forall ((?v0 S2)) (=> (= (f19 f6 ?v0) f1) (= (f3 f6 (f7 (f8 f9 f5) ?v0)) f1))))
(assert (forall ((?v0 S2)) (= (f7 (f8 f9 (f7 f26 ?v0)) f5) (f7 f26 (f7 (f8 f9 ?v0) (f7 f17 f18))))))
(assert (forall ((?v0 S2)) (= (f7 (f8 f9 f5) (f7 f26 ?v0)) (f7 f26 (f7 (f8 f9 (f7 f17 f18)) ?v0)))))
(assert (forall ((?v0 S2)) (= (= (f3 (f7 f26 ?v0) f5) f1) (= (f3 ?v0 (f7 f17 f18)) f1))))
(assert (forall ((?v0 S2)) (= (= (f3 f5 (f7 f26 ?v0)) f1) (= (f3 (f7 f17 f18) ?v0) f1))))
(assert (forall ((?v0 S2)) (let ((?v_0 (f7 f26 ?v0))) (= (f7 f26 (f7 f16 ?v0)) (f7 (f8 f9 (f7 (f8 f9 f6) ?v_0)) ?v_0)))))
(assert (forall ((?v0 S2)) (let ((?v_0 (f7 f26 ?v0))) (= (f7 f26 (f7 f17 ?v0)) (f7 (f8 f9 (f7 (f8 f9 f5) ?v_0)) ?v_0)))))
(assert (forall ((?v0 S2)) (= (= (f19 (f7 f17 ?v0) f18) f1) (= (f3 ?v0 f18) f1))))
(assert (forall ((?v0 S2)) (= (= (f3 f18 (f7 f17 ?v0)) f1) (= (f19 f18 ?v0) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f19 (f7 f17 ?v0) (f7 f16 ?v1)) f1) (= (f3 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f19 (f7 f17 ?v0) (f7 f16 ?v1)) f1) (= (f3 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f3 (f7 f16 ?v0) (f7 f17 ?v1)) f1) (= (f19 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f3 (f7 f16 ?v0) (f7 f17 ?v1)) f1) (= (f19 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2)) (= (= (f19 f5 ?v0) f1) (= (f3 f6 ?v0) f1))))
(assert (forall ((?v0 S2)) (= (= (f7 f17 ?v0) f18) false)))
(assert (forall ((?v0 S2)) (= (= f18 (f7 f17 ?v0)) false)))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f7 f17 ?v0) (f7 f16 ?v1)) false)))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f7 f16 ?v0) (f7 f17 ?v1)) false)))
(assert (forall ((?v0 S2)) (= (= (f7 f16 ?v0) f18) (= ?v0 f18))))
(assert (forall ((?v0 S2)) (= (= f18 (f7 f16 ?v0)) (= f18 ?v0))))
(assert (= (f7 f16 f18) f18))
(assert (= f18 f6))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f19 (f7 f17 ?v0) (f7 f17 ?v1)) f1) (= (f19 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f19 (f7 f17 ?v0) (f7 f17 ?v1)) f1) (= (f19 ?v0 ?v1) f1))))
(assert (= (= (f19 f18 f18) f1) true))
(assert (not (= f6 f5)))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f19 (f7 f16 ?v0) (f7 f16 ?v1)) f1) (= (f19 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f19 (f7 f16 ?v0) (f7 f16 ?v1)) f1) (= (f19 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (let ((?v_0 (f14 f15 (f7 f16 (f7 f17 f18))))) (= (= (f3 f6 (f7 (f8 f9 (f10 (f11 f12 ?v0) ?v_0)) (f10 (f11 f12 ?v1) ?v_0))) f1) (or (not (= ?v0 f6)) (not (= ?v1 f6)))))))
(assert (forall ((?v0 S2) (?v1 S2)) (let ((?v_0 (f14 f15 (f7 f16 (f7 f17 f18))))) (not (= (f3 (f7 (f8 f9 (f10 (f11 f12 ?v0) ?v_0)) (f10 (f11 f12 ?v1) ?v_0)) f6) f1)))))
(assert (= (f7 (f8 f9 f5) f5) (f7 f26 (f7 f16 (f7 f17 f18)))))
(assert (= (f21 (f22 f28 f25) f25) (f14 f15 (f7 f16 (f7 f17 f18)))))
(assert (= (f7 (f8 f9 f5) f5) (f7 f26 (f7 f16 (f7 f17 f18)))))
(assert (= (f7 f26 f18) f6))
(assert (= (f14 f15 f18) f24))
(assert (= (f7 f26 f18) f6))
(assert (= f6 (f7 f26 f18)))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f19 (f7 f26 ?v0) (f7 f26 ?v1)) f1) (= (f19 ?v0 ?v1) f1))))
(assert (forall ((?v0 S2)) (= (= (f19 f18 (f7 f17 ?v0)) f1) (= (f19 f18 ?v0) f1))))
(assert (forall ((?v0 S2) (?v1 S2)) (= (= (f19 (f7 f16 ?v0) (f7 f17 ?v1)) f1) (= (f19 ?v0 ?v1) f1))))
(check-sat)
(exit)
