...
(assert (not (=> (= (f16 (f17 (f20 f21) (f22 (f23 f11) f24)) (f22 (f23 f4) f24)) f1) (forall ((?v0 S2)) (let ((?v_1 (f17 (f20 f21) (f22 (f23 f11) f24))) (?v_0 (f7 f8 (f9 ?v0)))) (=> (= (f16 ?v_1 (f17 (f18 (f5 f6 ?v_0 (f10 ?v_0))) f19)) f1) (= (f16 ?v_1 (f17 (f18 (f5 f6 ?v_0 (f10 (f12 f13 ?v0)))) f19)) f1)))))))
(check-sat)
(exit)
