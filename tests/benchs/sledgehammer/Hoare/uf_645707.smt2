...
(assert (forall ((?v0 S6)) (= (f12 f41 (f9 f10 ?v0)) (f12 (f13 f29 ?v0) f38))))
(assert (forall ((?v0 S6)) (= (f12 f41 (f9 f11 ?v0)) (f12 (f13 f29 ?v0) f38))))
(assert (forall ((?v0 S6) (?v1 S7)) (= (f12 f41 (f12 (f13 f14 ?v0) ?v1)) (ite (= (f8 ?v1 ?v0) f1) (f12 (f13 f29 ?v0) f38) f38))))
(assert (forall ((?v0 S6) (?v1 S7)) (= (f12 f41 (f12 (f13 f15 ?v0) ?v1)) (ite (= (f8 ?v1 ?v0) f1) (f12 (f13 f29 ?v0) f38) f38))))
(assert (forall ((?v0 S7) (?v1 S6)) (=> (= ?v0 f38) (not (= (f25 (f39 f40 ?v1) ?v0) f1)))))
(assert (forall ((?v0 S7)) (= (= (f12 f41 ?v0) f38) (forall ((?v1 S6)) (not (= (f8 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S6)) (= (= (f25 (f39 f40 ?v0) f38) f1) false)))
(assert (forall ((?v0 S7)) (= (= f38 (f12 f41 ?v0)) (forall ((?v1 S6)) (not (= (f8 ?v0 ?v1) f1))))))
