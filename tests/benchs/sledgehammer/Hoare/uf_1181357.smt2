...
(assert (forall ((?v0 S2)) (= (f48 f49 (f12 (f13 f39 ?v0) f46)) ?v0)))
(assert (forall ((?v0 S2)) (= (= (f3 f46 ?v0) f1) (= f50 f1))))
(assert (forall ((?v0 S2)) (= (= (f3 f46 ?v0) f1) (= f50 f1))))
(assert (forall ((?v0 S3) (?v1 S8)) (= (f15 (f36 f37 ?v0) (f12 (f13 f39 (f40 (f41 (f42 f43 ?v1) f51) ?v1)) f46)) f1)))
(assert (forall ((?v0 S3) (?v1 S8) (?v2 S7) (?v3 S24)) (= (f15 (f36 f37 ?v0) (f12 (f13 f39 (f40 (f41 (f42 f43 (f28 (f29 f30 ?v1) ?v2)) (f52 (f53 f54 ?v2) ?v3)) ?v1)) f46)) f1)))
(assert (forall ((?v0 S3) (?v1 S8) (?v2 S24) (?v3 S8) (?v4 S24) (?v5 S8)) (let ((?v_0 (f36 f37 ?v0)) (?v_1 (f42 f43 ?v1))) (=> (= (f15 ?v_0 (f12 (f13 f39 (f40 (f41 ?v_1 ?v2) ?v3)) f46)) f1) (=> (= (f15 ?v_0 (f12 (f13 f39 (f40 (f41 (f42 f43 ?v3) ?v4) ?v5)) f46)) f1) (= (f15 ?v_0 (f12 (f13 f39 (f40 (f41 ?v_1 (f52 (f55 f56 ?v2) ?v4)) ?v5)) f46)) f1))))))
...
(assert (forall ((?v0 S8) (?v1 S8) (?v2 S3)) (=> (forall ((?v3 S6) (?v4 S5)) (=> (= (f7 (f8 ?v0 ?v3) ?v4) f1) (= (f7 (f8 ?v1 ?v3) ?v4) f1))) (= (f15 (f36 f37 ?v2) (f12 (f13 f39 (f40 (f41 (f42 f43 ?v0) f51) ?v1)) f46)) f1))))
