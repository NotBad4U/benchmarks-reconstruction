...
(declare-fun f43 (S3 S6 S15 S6 S15) S1)
(declare-fun f44 (S3 S13 S13) S1)
(declare-fun f45 (S3 S13 S13 S2 S13) S1)
(declare-fun f46 (S3 S13 S13 S2 S13) S1)
(assert (not (= f1 f2)))
...
(assert (forall ((?v0 S3) (?v1 S6) (?v2 S15) (?v3 S11) (?v4 S4) (?v5 S17) (?v6 S13) (?v7 S20) (?v8 S13)) (let ((?v_0 (f20 (f21 f22 ?v4) ?v5))) (=> (= (f43 ?v0 ?v1 ?v2 (f9 f10 (f11 f12 ?v3)) ?v_0) f1) (=> (= (f18 ?v4 ?v3) (f25 (f26 ?v6 ?v7))) (=> (not (= (f29 (f30 (f31 f32 ?v6) ?v8) (f34 (f35 ?v0))) f1)) (= (f43 ?v0 (f7 (f37 f38 ?v8) ?v1) ?v2 (f7 f8 (f9 f10 (f11 f12 (f13 f14 f15)))) ?v_0) f1)))))))
(assert (forall ((?v0 S3) (?v1 S6) (?v2 S15) (?v3 S11) (?v4 S4) (?v5 S17) (?v6 S13) (?v7 S20) (?v8 S13)) (let ((?v_0 (f9 f10 (f11 f12 ?v3))) (?v_1 (f20 (f21 f22 ?v4) ?v5))) (=> (= (f43 ?v0 ?v1 ?v2 ?v_0 ?v_1) f1) (=> (= (f18 ?v4 ?v3) (f25 (f26 ?v6 ?v7))) (=> (= (f29 (f30 (f31 f32 ?v6) ?v8) (f34 (f35 ?v0))) f1) (= (f43 ?v0 (f7 (f37 f38 ?v8) ?v1) ?v2 ?v_0 ?v_1) f1)))))))
(assert (forall ((?v0 S21) (?v1 S22)) (=> (= (f29 ?v0 ?v1) f1) (= (f29 ?v0 (f34 ?v1)) f1))))
(assert (forall ((?v0 S3) (?v1 S13) (?v2 S13)) (= (= (f44 ?v0 ?v1 ?v2) f1) (= (f29 (f30 (f31 f32 ?v1) ?v2) (f35 ?v0)) f1))))
(assert (forall ((?v0 S3) (?v1 S13) (?v2 S13) (?v3 S2) (?v4 S13) (?v5 S13)) (=> (= (f45 ?v0 ?v1 ?v2 ?v3 ?v4) f1) (=> (= (f29 (f30 (f31 f32 ?v5) ?v1) (f34 (f35 ?v0))) f1) (= (f45 ?v0 ?v5 ?v2 ?v3 ?v4) f1)))))
...
(assert (forall ((?v0 S3) (?v1 S13) (?v2 S13) (?v3 S2) (?v4 S13)) (=> (= (f46 ?v0 ?v1 ?v2 ?v3 ?v4) f1) (= (f29 (f30 (f31 f32 ?v1) ?v4) (f34 (f35 ?v0))) f1))))
(assert (forall ((?v0 S6) (?v1 S3) (?v2 S15)) (=> (= (f41 ?v0) f1) (= (f43 ?v1 ?v0 ?v2 ?v0 ?v2) f1))))
(check-sat)
(exit)
