...
(declare-fun f130 (S85 S84) S38)
(declare-fun f131 (S86 S84) S85)
(declare-fun f132 (S87 S38) S86)
(declare-fun f133 () S87)
(declare-fun f134 (S88 S84) S54)
...
(assert (forall ((?v0 S38) (?v1 S47) (?v2 S42) (?v3 S38) (?v4 S47) (?v5 S42) (?v6 S52) (?v7 S42)) (let ((?v_0 (f49 f50 ?v0)) (?v_1 (f62 f63 ?v1)) (?v_2 (f49 f50 ?v3)) (?v_3 (f62 f63 ?v4)) (?v_5 (f77 ?v6)) (?v_4 (f129 ?v7))) (=> (= (f27 (f28 (f29 f30 (f48 ?v_0 (f61 ?v_1 ?v2))) (f48 ?v_2 (f61 ?v_3 ?v5))) ?v_5) f1) (= (f27 (f28 (f29 f30 (f48 ?v_0 (f61 ?v_1 (f128 ?v_4 ?v2)))) (f48 ?v_2 (f61 ?v_3 (f128 ?v_4 ?v5)))) ?v_5) f1)))))
...
(assert (forall ((?v0 S27)) (=> (forall ((?v1 S42) (?v2 S42)) (=> (= ?v0 (f55 (f56 f57 ?v1) ?v2)) false)) false)))
(assert (forall ((?v0 S15)) (=> (forall ((?v1 S33) (?v2 S33)) (=> (= ?v0 (f42 (f43 f44 ?v1) ?v2)) false)) false)))
(assert (forall ((?v0 S38) (?v1 S84) (?v2 S84) (?v3 S33) (?v4 S52)) (let ((?v_0 (f68 f69 ?v0))) (= (f27 (f28 (f29 f30 (f48 (f49 f50 (f130 (f131 (f132 f133 ?v_0) ?v1) ?v2)) ?v3)) (f48 (f49 f50 ?v_0) ?v3)) (f77 ?v4)) f1))))
(assert (forall ((?v0 S84) (?v1 S38) (?v2 S33) (?v3 S52)) (let ((?v_0 (f68 f69 ?v1))) (= (f27 (f28 (f29 f30 (f48 (f49 f50 (f68 (f134 f135 ?v0) ?v_0)) ?v2)) (f48 (f49 f50 ?v_0) ?v2)) (f77 ?v3)) f1))))
(assert (forall ((?v0 S84) (?v1 S38) (?v2 S38) (?v3 S84) (?v4 S84)) (not (= (f68 (f134 f135 ?v0) ?v1) (f130 (f131 (f132 f133 ?v2) ?v3) ?v4)))))
(assert (forall ((?v0 S38) (?v1 S84) (?v2 S84) (?v3 S84) (?v4 S38)) (not (= (f130 (f131 (f132 f133 ?v0) ?v1) ?v2) (f68 (f134 f135 ?v3) ?v4)))))
(assert (forall ((?v0 S84) (?v1 S38) (?v2 S84) (?v3 S38)) (= (= (f68 (f134 f135 ?v0) ?v1) (f68 (f134 f135 ?v2) ?v3)) (and (= ?v0 ?v2) (= ?v1 ?v3)))))
(assert (forall ((?v0 S38) (?v1 S84) (?v2 S84) (?v3 S38) (?v4 S84) (?v5 S84)) (= (= (f130 (f131 (f132 f133 ?v0) ?v1) ?v2) (f130 (f131 (f132 f133 ?v3) ?v4) ?v5)) (and (= ?v0 ?v3) (and (= ?v1 ?v4) (= ?v2 ?v5))))))
(assert (forall ((?v0 S38) (?v1 S84) (?v2 S38)) (not (= (f68 f69 ?v0) (f68 (f134 f135 ?v1) ?v2)))))
(assert (forall ((?v0 S38) (?v1 S38) (?v2 S84) (?v3 S84)) (not (= (f68 f69 ?v0) (f130 (f131 (f132 f133 ?v1) ?v2) ?v3)))))
(assert (forall ((?v0 S84) (?v1 S38) (?v2 S38)) (not (= (f68 (f134 f135 ?v0) ?v1) (f68 f69 ?v2)))))
(assert (forall ((?v0 S38) (?v1 S84) (?v2 S84) (?v3 S38)) (not (= (f130 (f131 (f132 f133 ?v0) ?v1) ?v2) (f68 f69 ?v3)))))
(assert (forall ((?v0 S38) (?v1 S84) (?v2 S84) (?v3 S38) (?v4 S38) (?v5 S38)) (not (= (f130 (f131 (f132 f133 ?v0) ?v1) ?v2) (f68 (f84 (f85 f86 ?v3) ?v4) ?v5)))))
(check-sat)
(exit)
