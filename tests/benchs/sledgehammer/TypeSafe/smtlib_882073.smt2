...
(declare-fun f112 (S16 S71) S73)
(declare-fun f113 (S74 S27) S26)
(declare-fun f114 (S75 S76) S1)
(declare-fun f115 (S30 S30) S75)
(declare-fun f116 (S28 S74) S76)
(declare-fun f117 (S77 S3) S2)
(declare-fun f118 (S78 S79) S1)
(declare-fun f119 (S6 S6) S78)
(declare-fun f120 (S4 S77) S79)
(declare-fun f121 (S80 S9) S4)
(declare-fun f122 (S81 S80) S2)
(declare-fun f123 (S10) S81)
...
(declare-fun f130 (S86 S42) S42)
(declare-fun f131 (S42) S86)
(declare-fun f132 (S87 S53) S53)
(declare-fun f133 (S53) S87)
(declare-fun f134 (S42) S43)
...
(assert (forall ((?v0 S16) (?v1 S15) (?v2 S15) (?v3 S15) (?v4 S71)) (let ((?v_0 (f22 f23 ?v1))) (=> (= (f17 ?v0 ?v1) f1) (=> (= (f20 (f21 (f22 f23 ?v2) ?v3) (f109 ?v4 ?v1)) f1) (= (f110 (f111 (f21 ?v_0 ?v2) (f21 ?v_0 ?v3)) (f112 ?v0 ?v4)) f1))))))
(assert (forall ((?v0 S28) (?v1 S27) (?v2 S27) (?v3 S27) (?v4 S74)) (let ((?v_0 (f36 f37 ?v1))) (=> (= (f31 ?v0 ?v1) f1) (=> (= (f34 (f35 (f36 f37 ?v2) ?v3) (f113 ?v4 ?v1)) f1) (= (f114 (f115 (f35 ?v_0 ?v2) (f35 ?v_0 ?v3)) (f116 ?v0 ?v4)) f1))))))
(assert (forall ((?v0 S4) (?v1 S3) (?v2 S3) (?v3 S3) (?v4 S77)) (let ((?v_0 (f8 f9 ?v1))) (=> (= (f3 ?v0 ?v1) f1) (=> (= (f6 (f7 (f8 f9 ?v2) ?v3) (f117 ?v4 ?v1)) f1) (= (f118 (f119 (f7 ?v_0 ?v2) (f7 ?v_0 ?v3)) (f120 ?v0 ?v4)) f1))))))
(assert (forall ((?v0 S10) (?v1 S9) (?v2 S9) (?v3 S9) (?v4 S80)) (let ((?v_0 (f15 f16 ?v1))) (=> (= (f10 ?v0 ?v1) f1) (=> (= (f13 (f14 (f15 f16 ?v2) ?v3) (f121 ?v4 ?v1)) f1) (= (f6 (f7 (f8 f9 (f14 ?v_0 ?v2)) (f14 ?v_0 ?v3)) (f122 (f123 ?v0) ?v4)) f1))))))
...
(assert (forall ((?v0 S38) (?v1 S47) (?v2 S42) (?v3 S38) (?v4 S47) (?v5 S42) (?v6 S52) (?v7 S42)) (let ((?v_0 (f49 f50 ?v0)) (?v_1 (f62 f63 ?v1)) (?v_2 (f49 f50 ?v3)) (?v_3 (f62 f63 ?v4)) (?v_5 (f79 ?v6)) (?v_4 (f131 ?v7))) (=> (= (f27 (f28 (f29 f30 (f48 ?v_0 (f61 ?v_1 ?v2))) (f48 ?v_2 (f61 ?v_3 ?v5))) ?v_5) f1) (= (f27 (f28 (f29 f30 (f48 ?v_0 (f61 ?v_1 (f130 ?v_4 ?v2)))) (f48 ?v_2 (f61 ?v_3 (f130 ?v_4 ?v5)))) ?v_5) f1)))))
...
(assert (forall ((?v0 S53) (?v1 S53)) (= (f92 ?v0 (f132 (f133 ?v1) ?v0)) f1)))
(assert (forall ((?v0 S42) (?v1 S42)) (= (f51 (f134 ?v0) (f130 (f131 ?v1) ?v0)) f1)))
(assert (forall ((?v0 S53) (?v1 S53)) (let ((?v_0 (f132 (f133 ?v0) ?v1))) (= (= (f92 ?v0 ?v_0) f1) (= ?v_0 (f132 (f133 ?v1) ?v0))))))
(assert (forall ((?v0 S42) (?v1 S42)) (let ((?v_0 (f130 (f131 ?v0) ?v1))) (= (= (f51 (f134 ?v0) ?v_0) f1) (= ?v_0 (f130 (f131 ?v1) ?v0))))))
(assert (forall ((?v0 S53) (?v1 S53) (?v2 S53)) (let ((?v_0 (f132 (f133 ?v0) ?v2))) (=> (= (f92 ?v0 ?v1) f1) (=> (= (f92 ?v2 ?v1) f1) (=> (= (f92 ?v0 ?v_0) f1) (= (f92 ?v_0 ?v1) f1)))))))
(assert (forall ((?v0 S42) (?v1 S42) (?v2 S42)) (let ((?v_0 (f134 ?v0)) (?v_1 (f130 (f131 ?v0) ?v2))) (=> (= (f51 ?v_0 ?v1) f1) (=> (= (f51 (f134 ?v2) ?v1) f1) (=> (= (f51 ?v_0 ?v_1) f1) (= (f51 (f134 ?v_1) ?v1) f1)))))))
(assert (forall ((?v0 S53) (?v1 S53) (?v2 S53)) (=> (= (f92 (f132 (f133 ?v0) ?v1) ?v2) f1) (= (f92 ?v1 ?v2) f1))))
(assert (forall ((?v0 S42) (?v1 S42) (?v2 S42)) (=> (= (f51 (f134 (f130 (f131 ?v0) ?v1)) ?v2) f1) (= (f51 (f134 ?v1) ?v2) f1))))
(assert (forall ((?v0 S38) (?v1 S47) (?v2 S42) (?v3 S38) (?v4 S47) (?v5 S42) (?v6 S52) (?v7 S42)) (let ((?v_0 (f49 f50 ?v0)) (?v_1 (f62 f63 ?v1)) (?v_2 (f49 f50 ?v3)) (?v_3 (f62 f63 ?v4)) (?v_5 (f135 (f79 ?v6))) (?v_4 (f131 ?v7))) (=> (= (f27 (f28 (f29 f30 (f48 ?v_0 (f61 ?v_1 ?v2))) (f48 ?v_2 (f61 ?v_3 ?v5))) ?v_5) f1) (= (f27 (f28 (f29 f30 (f48 ?v_0 (f61 ?v_1 (f130 ?v_4 ?v2)))) (f48 ?v_2 (f61 ?v_3 (f130 ?v_4 ?v5)))) ?v_5) f1)))))
(assert (forall ((?v0 S38) (?v1 S38) (?v2 S38) (?v3 S33) (?v4 S52)) (let ((?v_0 (f68 f136 ?v0))) (= (f27 (f28 (f29 f30 (f48 (f49 f50 (f68 (f85 (f86 f87 ?v_0) ?v1) ?v2)) ?v3)) (f48 (f49 f50 ?v_0) ?v3)) (f79 ?v4)) f1))))
(assert (forall ((?v0 S56) (?v1 S38) (?v2 S33) (?v3 S52)) (let ((?v_0 (f68 f136 ?v1))) (= (f27 (f28 (f29 f30 (f48 (f49 f50 (f68 (f69 f70 ?v0) ?v_0)) ?v2)) (f48 (f49 f50 ?v_0) ?v2)) (f79 ?v3)) f1))))
(assert (forall ((?v0 S38) (?v1 S38)) (= (= (f68 f136 ?v0) (f68 f136 ?v1)) (= ?v0 ?v1))))
(assert (forall ((?v0 S38)) (= (f90 (f68 f136 ?v0)) (f90 ?v0))))
(assert (forall ((?v0 S38) (?v1 S56) (?v2 S38)) (not (= (f68 f136 ?v0) (f68 (f69 f70 ?v1) ?v2)))))
(assert (forall ((?v0 S56) (?v1 S38) (?v2 S38)) (not (= (f68 (f69 f70 ?v0) ?v1) (f68 f136 ?v2)))))
(assert (forall ((?v0 S38) (?v1 S38) (?v2 S38) (?v3 S38)) (not (= (f68 (f85 (f86 f87 ?v0) ?v1) ?v2) (f68 f136 ?v3)))))
(assert (forall ((?v0 S38) (?v1 S38) (?v2 S38) (?v3 S38)) (not (= (f68 f136 ?v0) (f68 (f85 (f86 f87 ?v1) ?v2) ?v3)))))
(check-sat)
(exit)
