...
;;	       CONSTANT_d_ \in 0..CONSTANT_c_ - 1 ,
;;	       (\A CONSTANT_m_ \in VARIABLE_msgs_ :
;;	           /\ CONSTANT_m_.type = "1b"
;;	              => (/\ CONSTANT_m_.bal =< VARIABLE_maxBal_[CONSTANT_m_.acc]
;;	                  /\ \/ /\ CONSTANT_m_.maxVal \in CONSTANT_Values_
...
;;	                  /\ \A CONSTANT_c__1
;;	                        \in CONSTANT_m_.maxVBal + 1..CONSTANT_m_.bal - 1 :
;;	                        ~(\E CONSTANT_v__1 \in CONSTANT_Values_ :
;;	                             CONSTANT_VotedForIn_(CONSTANT_m_.acc,
;;	                                                  CONSTANT_v__1,
;;	                                                  CONSTANT_c__1)))
;;	           /\ CONSTANT_m_.type = "2a"
;;	              => (/\ \A CONSTANT_c__1 \in 0..CONSTANT_m_.bal - 1 :
;;	                        \E CONSTANT_Q__1 \in CONSTANT_Quorums_ :
;;	                           \A CONSTANT_a_ \in CONSTANT_Q__1 :
;;	                              CONSTANT_VotedForIn_(CONSTANT_a_,
;;	                                                   CONSTANT_m_.val,
;;	                                                   CONSTANT_c__1)
;;	                              \/ STATE_WontVoteIn_(CONSTANT_a_,
;;	                                                   CONSTANT_c__1)
;;	                  /\ \A CONSTANT_ma__1 \in VARIABLE_msgs_ :
;;	                        CONSTANT_ma__1.type = "2a"
;;	                        /\ CONSTANT_ma__1.bal = CONSTANT_m_.bal
;;	                        => CONSTANT_ma__1 = CONSTANT_m_)
;;	           /\ CONSTANT_m_.type = "2b"
;;	              => (/\ \E CONSTANT_ma__1 \in VARIABLE_msgs_ :
;;	                        /\ CONSTANT_ma__1.type = "2a"
;;	                        /\ CONSTANT_ma__1.bal = CONSTANT_m_.bal
;;	                        /\ CONSTANT_ma__1.val = CONSTANT_m_.val
;;	                  /\ CONSTANT_m_.bal =< VARIABLE_maxVBal_[CONSTANT_m_.acc]))
;;	       /\ (/\ VARIABLE_msgs_
;;	              \in SUBSET ([type : {"1a"}, bal : Nat]
;;	                          \cup [type : {"1b"}, bal : Nat,
;;	                                maxVBal : Nat \cup {-1},
;;	                                maxVal : CONSTANT_Values_
;;	                                         \cup {CONSTANT_None_},
;;	                                acc : CONSTANT_Acceptors_]
;;	                          \cup [type : {"2a"}, bal : Nat,
;;	                                val : CONSTANT_Values_]
...
;;	       => (\A CONSTANT_a_ \in CONSTANT_Acceptors_,
;;	              CONSTANT_v__1 \in CONSTANT_Values_, CONSTANT_b__1 \in Nat :
;;	              CONSTANT_VotedForIn_(CONSTANT_a_, CONSTANT_v__1, CONSTANT_b__1)
;;	              => (\A CONSTANT_c__1 \in 0..CONSTANT_b__1 - 1 :
;;	                     \E CONSTANT_Q__1 \in CONSTANT_Quorums_ :
;;	                        \A CONSTANT_a__1 \in CONSTANT_Q__1 :
;;	                           CONSTANT_VotedForIn_(CONSTANT_a__1, CONSTANT_v__1,
;;	                                                CONSTANT_c__1)
;;	                           \/ STATE_WontVoteIn_(CONSTANT_a__1, CONSTANT_c__1))
;;	                 /\ CONSTANT_b__1 =< VARIABLE_maxVBal_[CONSTANT_a_]) 
...
;;	             \/ STATE_WontVoteIn_(CONSTANT_q_, CONSTANT_d_)
;; TLA+ Proof Manager 1.5.0
;; Proof obligation #185
;; Generated from file "./Paxos.tla", line 416, characters 13-14
          ...
          (and
                ...
                (or
                  ...
                  (and
                    ...
                    (smt__TLAunderscore_underscore_TrigEqunderscore_Idv
                      ...
                      (smt__TLAunderscore_underscore_IntUminus
                        (smt__TLAunderscore_underscore_Castunderscore_Int 1)))))
                (forall ((smt__CONSTANTunderscore_cunderscore__1 Idv))
                  (=>
                    (smt__TLAunderscore_underscore_Mem
                      smt__CONSTANTunderscore_cunderscore__1
                      (smt__TLAunderscore_underscore_IntRange
                        (smt__TLAunderscore_underscore_IntPlus
                          (smt__TLAunderscore_underscore_FunApp
                            smt__CONSTANTunderscore_munderscore_
                        ...
                        (smt__TLAunderscore_underscore_IntMinus
                          ...
                          (smt__TLAunderscore_underscore_Castunderscore_Int 1))))
                    (not
                      (exists ((smt__CONSTANTunderscore_vunderscore__1 Idv))
                        (and
                          (smt__TLAunderscore_underscore_Mem
                      ...
                      (smt__TLAunderscore_underscore_IntRange
                        ...
                        (smt__TLAunderscore_underscore_IntMinus
                          (smt__TLAunderscore_underscore_FunApp
                            ...
                            smt__TLAunderscore_underscore_StrLitunderscore_bal)
                          (smt__TLAunderscore_underscore_Castunderscore_Int 1))))
                    (exists ((smt__CONSTANTunderscore_Qunderscore__1 Idv))
                      (and
                        (smt__TLAunderscore_underscore_Mem
                          smt__CONSTANTunderscore_Qunderscore__1
                          smt__CONSTANTunderscore_Quorumsunderscore_)
                        (forall ((smt__CONSTANTunderscore_aunderscore_ Idv))
                          (=>
                            (smt__TLAunderscore_underscore_Mem
                            ...
                            (or
                              ...
                              (=
                                (smt__STATEunderscore_WontVoteInunderscore_
                                  ...
                                  smt__CONSTANTunderscore_cunderscore__1)
                                smt__TLAunderscore_underscore_Ttunderscore_Idv))))))))
                (forall ((smt__CONSTANTunderscore_maunderscore__1 Idv))
                  (=>
                    (smt__TLAunderscore_underscore_Mem
                      smt__CONSTANTunderscore_maunderscore__1
                      smt__VARIABLEunderscore_msgsunderscore_)
                    (=>
                      (and
                        (smt__TLAunderscore_underscore_TrigEqunderscore_Idv
            ...
            (=>
              (smt__TLAunderscore_underscore_TrigEqunderscore_Idv
                ...
                smt__TLAunderscore_underscore_StrLitunderscore_2b)
              (and
                (exists ((smt__CONSTANTunderscore_maunderscore__1 Idv))
                  (and
                    (smt__TLAunderscore_underscore_Mem
                      smt__CONSTANTunderscore_maunderscore__1
                      smt__VARIABLEunderscore_msgsunderscore_)
