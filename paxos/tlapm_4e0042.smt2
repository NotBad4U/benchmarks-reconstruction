...
;;	       \A CONSTANT_c_ \in 0..CONSTANT_b2_ - 1 :
;;	          \E CONSTANT_Q_ \in CONSTANT_Quorums_ :
;;	             \A CONSTANT_a_ \in CONSTANT_Q_ :
;;	                CONSTANT_VotedForIn_(CONSTANT_a_, CONSTANT_v2_, CONSTANT_c_)
;;	                \/ STATE_WontVoteIn_(CONSTANT_a_, CONSTANT_c_) ,
;;	       CONSTANT_b1_ < CONSTANT_b2_ 
;;	PROVE  \E CONSTANT_Q2_ \in CONSTANT_Quorums_ :
;;	          \A CONSTANT_a_ \in CONSTANT_Q2_ :
;;	             CONSTANT_VotedForIn_(CONSTANT_a_, CONSTANT_v2_, CONSTANT_b1_)
;;	             \/ STATE_WontVoteIn_(CONSTANT_a_, CONSTANT_b1_)
;; TLA+ Proof Manager 1.5.0
;; Proof obligation #240
;; Generated from file "./Paxos.tla", line 481, characters 7-8
...
(assert
  (!
    (not
      (exists ((smt__CONSTANTunderscore_Q2underscore_ Idv))
        (and
          (smt__TLAunderscore_underscore_Mem
