...
;;	       STATE_MsgInv_ /\ STATE_TypeOK_
;;	       => (\A CONSTANT_a_ \in CONSTANT_Acceptors_,
;;	              CONSTANT_v_ \in CONSTANT_Values_, CONSTANT_b_ \in Nat :
;;	              CONSTANT_VotedForIn_(CONSTANT_a_, CONSTANT_v_, CONSTANT_b_)
;;	              => STATE_SafeAt_(CONSTANT_v_, CONSTANT_b_)
;;	                 /\ CONSTANT_b_ =< VARIABLE_maxVBal_[CONSTANT_a_]) ,
;;	       \A CONSTANT_Q_ \in CONSTANT_Quorums_ : CONSTANT_Q_ # {} ,
...
;;	PROVE  STATE_SafeAt_(CONSTANT_v2_, CONSTANT_b2_)
;; TLA+ Proof Manager 1.5.0
;; Proof obligation #236
;; Generated from file "./Paxos.tla", line 478, characters 7-8
