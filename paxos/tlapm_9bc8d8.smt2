...
;;	                  CONSTANT_ChosenIn_(CONSTANT_v1_, CONSTANT_b_))
;;	              /\ (\E CONSTANT_b_ \in Nat :
;;	                     CONSTANT_ChosenIn_(CONSTANT_v2_, CONSTANT_b_))
;;	              => CONSTANT_v1_ = CONSTANT_v2_)
;; TLA+ Proof Manager 1.5.0
;; Proof obligation #226
;; Generated from file "./Paxos.tla", line 465, characters 5-6
...
(assert
  (=>
    ...
    (forall ((smt__CONSTANTunderscore_v1underscore_ Idv))
      (=>
        (smt__TLAunderscore_underscore_Mem
          smt__CONSTANTunderscore_v1underscore_
          smt__CONSTANTunderscore_Valuesunderscore_)
        (forall ((smt__CONSTANTunderscore_v2underscore_ Idv))
          (=>
            (smt__TLAunderscore_underscore_Mem
              smt__CONSTANTunderscore_v2underscore_
              smt__CONSTANTunderscore_Valuesunderscore_)
            (forall ((smt__CONSTANTunderscore_b1underscore_ Idv))
              (=>
                (smt__TLAunderscore_underscore_Mem
                  smt__CONSTANTunderscore_b1underscore_
                  smt__TLAunderscore_underscore_NatSet)
                (forall ((smt__CONSTANTunderscore_b2underscore_ Idv))
                  (=>
                    (smt__TLAunderscore_underscore_Mem
