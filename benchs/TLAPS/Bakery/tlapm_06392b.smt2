...
;;	       (\E CST_self_ \in 1..CST_N_ :
;;	           ACTION_p1_(CST_self_) \/ ACTION_p2_(CST_self_)
;;	           \/ ACTION_p3_(CST_self_) \/ ACTION_p4_(CST_self_)
;;	           \/ ACTION_p5_(CST_self_) \/ ACTION_p6_(CST_self_)
;;	           \/ ACTION_cs_(CST_self_) \/ ACTION_p7_(CST_self_))
;;	       \/ ?h6fbaa = STATE_vars_ ,
;;	       ASSUME NEW CONSTANT CST_self_ \in 1..CST_N_,
;;	              ACTION_p1_(CST_self_) 
;;	       PROVE  ?h15bf9
;;	              /\ (\A CST_i_ \in 1..CST_N_ : ?h222f4(CST_i_)) ,
;;	       ASSUME NEW CONSTANT CST_self_ \in 1..CST_N_,
;;	              ACTION_p2_(CST_self_) 
;;	       PROVE  ?h15bf9
;;	              /\ (\A CST_i_ \in 1..CST_N_ : ?h222f4(CST_i_)) ,
;;	       ASSUME NEW CONSTANT CST_self_ \in 1..CST_N_,
;;	              ACTION_p3_(CST_self_) 
;;	       PROVE  ?h15bf9
;;	              /\ (\A CST_i_ \in 1..CST_N_ : ?h222f4(CST_i_)) ,
;;	       ASSUME NEW CONSTANT CST_self_ \in 1..CST_N_,
;;	              ACTION_p4_(CST_self_) 
;;	       PROVE  ?h15bf9
;;	              /\ (\A CST_i_ \in 1..CST_N_ : ?h222f4(CST_i_)) ,
;;	       ASSUME NEW CONSTANT CST_self_ \in 1..CST_N_,
;;	              ACTION_p5_(CST_self_) 
;;	       PROVE  ?h15bf9
;;	              /\ (\A CST_i_ \in 1..CST_N_ : ?h222f4(CST_i_)) ,
;;	       ASSUME NEW CONSTANT CST_self_ \in 1..CST_N_,
;;	              ACTION_p6_(CST_self_) 
;;	       PROVE  ?h15bf9
;;	              /\ (\A CST_i_ \in 1..CST_N_ : ?h222f4(CST_i_)) ,
;;	       ASSUME NEW CONSTANT CST_self_ \in 1..CST_N_,
;;	              ACTION_cs_(CST_self_) 
;;	       PROVE  ?h15bf9
;;	              /\ (\A CST_i_ \in 1..CST_N_ : ?h222f4(CST_i_)) ,
;;	       ASSUME NEW CONSTANT CST_self_ \in 1..CST_N_,
;;	              ACTION_p7_(CST_self_) 
;;	       PROVE  ?h15bf9
;;	              /\ (\A CST_i_ \in 1..CST_N_ : ?h222f4(CST_i_)) ,
;;	       ASSUME ?h6fbaa = STATE_vars_ 
;;	       PROVE  ?h15bf9
;;	              /\ (\A CST_i_ \in 1..CST_N_ : ?h222f4(CST_i_)) 
;;	PROVE  ?h15bf9 /\ (\A CST_i_ \in 1..CST_N_ : ?h222f4(CST_i_))
