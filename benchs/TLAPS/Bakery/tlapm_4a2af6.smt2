...
;;	       IF VAR_unread_[CST_self_] # {}
;;	         THEN /\ \E CST_i_ \in VAR_unread_[CST_self_] :
;;	                    ?VAR_nxt_#prime
;;	                    = [VAR_nxt_ EXCEPT ![CST_self_] = CST_i_]
;;	              /\ ~VAR_flag_[?VAR_nxt_#prime[CST_self_]]
;;	              /\ ?VAR_pc_#prime
;;	                 = [VAR_pc_ EXCEPT ![CST_self_] = "p6"]
;;	         ELSE /\ ?VAR_pc_#prime
;;	                 = [VAR_pc_ EXCEPT ![CST_self_] = "cs"]
;;	              /\ ?VAR_nxt_#prime = VAR_nxt_ ,
;;	       VAR_pc_[CST_self_] = "p5" ,
...
(declare-fun TrigEq_Setdollarsign_Idvdollarsign_ (Idv
  Idv) Bool)
...
(assert
  (!
    (forall ((smt__x Idv) (smt__y Idv))
      (!
        (=
          (TrigEq_Setdollarsign_Idvdollarsign_
            smt__x smt__y) (= smt__x smt__y))
        :pattern ((TrigEq_Setdollarsign_Idvdollarsign_
