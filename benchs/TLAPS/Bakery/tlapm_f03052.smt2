...
;;	       CST_N_ \in Nat 
;;	PROVE  (/\ VAR_num_ = [CST_i_ \in 1..CST_N_ |-> 0]
;;	        /\ VAR_flag_ = [CST_i_ \in 1..CST_N_ |-> FALSE]
;;	        /\ VAR_unread_ \in [1..CST_N_ -> SUBSET 1..CST_N_]
;;	        /\ VAR_max_ \in [1..CST_N_ -> Nat]
;;	        /\ VAR_nxt_ \in [1..CST_N_ -> 1..CST_N_]
;;	        /\ VAR_pc_ = [CST_self_ \in 1..CST_N_ |-> "p1"])
...
(declare-fun FunFcn_flatnd_1 (Idv) Idv)
    ...
    (forall ((smt__a Idv))
      (!
        (FunIsafcn
          (FunFcn_flatnd_1
            smt__a))
        :pattern ((FunFcn_flatnd_1
                    smt__a)))) :named |FunConstrIsafcn _FunFcn_flatnd_1|))
        ...
        (=
          (FunDom
            (FunFcn_flatnd_1
              smt__a)) smt__a)
        :pattern ((FunFcn_flatnd_1
                    smt__a)))) :named |FunDomDef _FunFcn_flatnd_1|))
  ...
  (!
    (forall ((smt__a Idv) (smt__x Idv))
      (!
        ...
        :pattern ((Mem smt__x smt__a)
                   (FunFcn_flatnd_1
                     smt__a)))) :named |FunAppDef _FunFcn_flatnd_1|))

;; Axiom: FunTyping _FunFcn_flatnd_1
(assert
  (!
    (forall ((smt__a Idv) (smt__b Idv))
      (!
        (=>
          ...
          (Mem
            (FunFcn_flatnd_1
              smt__a) (FunSet smt__a smt__b)))
        :pattern ((FunFcn_flatnd_1
                    smt__a)
                   (FunSet smt__a smt__b))))
    :named |FunTyping _FunFcn_flatnd_1|))

(declare-fun FunFcn_flatnd_2 (Idv) Idv)

;; Axiom: FunConstrIsafcn _FunFcn_flatnd_2
(assert
  (!
    (forall ((smt__a Idv))
      (!
        (FunIsafcn
          (FunFcn_flatnd_2
            smt__a))
        :pattern ((FunFcn_flatnd_2
                    smt__a)))) :named |FunConstrIsafcn _FunFcn_flatnd_2|))

;; Axiom: FunDomDef _FunFcn_flatnd_2
(assert
  (!
    (forall ((smt__a Idv))
      (!
        (=
          (FunDom
            (FunFcn_flatnd_2
              smt__a)) smt__a)
        :pattern ((FunFcn_flatnd_2
                    smt__a)))) :named |FunDomDef _FunFcn_flatnd_2|))

;; Axiom: FunAppDef _FunFcn_flatnd_2
(assert
  (!
    (forall ((smt__a Idv) (smt__x Idv))
      (!
        ...
        :pattern ((Mem smt__x smt__a)
                   (FunFcn_flatnd_2
                     smt__a)))) :named |FunAppDef _FunFcn_flatnd_2|))

;; Axiom: FunTyping _FunFcn_flatnd_2
(assert
  (!
    (forall ((smt__a Idv) (smt__b Idv))
      (!
        ...
        :pattern ((FunFcn_flatnd_2
                    smt__a)
                   (FunSet smt__a smt__b))))
    :named |FunTyping _FunFcn_flatnd_2|))

(declare-fun FunFcn_flatnd_3 (Idv) Idv)

;; Axiom: FunConstrIsafcn _FunFcn_flatnd_3
(assert
  (!
    (forall ((smt__a Idv))
      (!
        (FunIsafcn
          (FunFcn_flatnd_3
            smt__a))
        :pattern ((FunFcn_flatnd_3
                    smt__a)))) :named |FunConstrIsafcn _FunFcn_flatnd_3|))

;; Axiom: FunDomDef _FunFcn_flatnd_3
(assert
  (!
    (forall ((smt__a Idv))
      (!
        (=
          (FunDom
            (FunFcn_flatnd_3
              smt__a)) smt__a)
        :pattern ((FunFcn_flatnd_3
                    smt__a)))) :named |FunDomDef _FunFcn_flatnd_3|))

;; Axiom: FunAppDef _FunFcn_flatnd_3
(assert
  (!
    (forall ((smt__a Idv) (smt__x Idv))
      (!
        ...
        :pattern ((Mem smt__x smt__a)
                   (FunFcn_flatnd_3
                     smt__a)))) :named |FunAppDef _FunFcn_flatnd_3|))

;; Axiom: FunTyping _FunFcn_flatnd_3
(assert
  (!
    (forall ((smt__a Idv) (smt__b Idv))
      (!
        ...
        :pattern ((FunFcn_flatnd_3
                    smt__a)
                   (FunSet smt__a smt__b))))
    :named |FunTyping _FunFcn_flatnd_3|))
