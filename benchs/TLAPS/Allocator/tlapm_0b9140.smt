...
;;	       ASSUME ~(CST_c1_ = CST_clt_ \/ CST_c2_ = CST_clt_) 
;;	       PROVE  CST_c1_ = CST_c2_ ,
;;	       ASSUME CST_c1_ = CST_clt_ 
;;	       PROVE  CST_c1_ = CST_c2_ ,
;;	       ASSUME CST_c2_ = CST_clt_ 
;;	       PROVE  CST_c1_ = CST_c2_ 
;;	PROVE  CST_c1_ = CST_c2_
    ...
    (not
      (or
        (TrigEq___Idv CST___c1___
          CST___clt___)
        (TrigEq___Idv CST___c2___
          CST___clt___)))
    (TrigEq___Idv CST___c1___ CST___c2___)))

(assert
  (=>
    (TrigEq___Idv CST___c1___ CST___clt___)
    (TrigEq___Idv CST___c1___ CST___c2___)))

(assert
  (=>
    (TrigEq___Idv CST___c2___ CST___clt___)
    (TrigEq___Idv CST___c1___ CST___c2___)))
