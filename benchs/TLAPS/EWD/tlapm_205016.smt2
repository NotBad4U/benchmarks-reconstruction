...
;;	       /\ ((\/ /\ VAR_tpos_ = 0
;;	               /\ VAR_tcolor_ = "black" \/ VAR_color_[0] = "black"
;;	               /\ ?VAR_tpos_#prime = CST_N_ - 1
;;	               /\ ?VAR_tcolor_#prime = "white"
;;	               /\ ?VAR_active_#prime = VAR_active_
;;	               /\ ?VAR_color_#prime
;;	                  = [VAR_color_ EXCEPT ![0] = "white"]
;;	            \/ \E CST_i_ \in 0..CST_N_ - 1 \ {0} :
;;	                  /\ VAR_tpos_ = CST_i_
;;	                  /\ ~VAR_active_[CST_i_]
;;	                     \/ VAR_color_[CST_i_] = "black"
;;	                     \/ VAR_tcolor_ = "black"
;;	                  /\ ?VAR_tpos_#prime = CST_i_ - 1
;;	                  /\ ?VAR_tcolor_#prime
;;	                     = (IF VAR_color_[CST_i_] = "black"
;;	                          THEN "black"
;;	                          ELSE VAR_tcolor_)
;;	                  /\ ?VAR_active_#prime = VAR_active_
;;	                  /\ ?VAR_color_#prime
;;	                     = [VAR_color_ EXCEPT ![CST_i_] = "white"])
...
;;	               /\ ?VAR_tcolor_#prime = VAR_tcolor_))
;;	       => (\/ P0::\A CST_i_ \in 0..CST_N_ - 1 :
;;	                     ?VAR_tpos_#prime < CST_i_
;;	                     => ~?VAR_active_#prime[CST_i_]
;;	           \/ P1::\E CST_j_ \in 0..?VAR_tpos_#prime :
;;	                     ?VAR_color_#prime[CST_j_] = "black"
;;	           \/ P2::(?VAR_tcolor_#prime = "black"))
